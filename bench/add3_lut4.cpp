...
std::vector<long>
test_add3_lut4(FHEContext& ctx, uint8_t a = 0, uint8_t b = 0)
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 3 (LUT4 _13_ INIT 0x8778 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 2 (LUT4 _12_ INIT 0x1777 PERM 2301) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut0idx2 = [](long I) -> long {
        /* GATE 5 (LUT2 _15_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_a0 + 2 * ct_b0 + 4 * ct_a1 + 8 * ct_b1;
...
static void
BM_add3_lut4(benchmark::State& state)
{
    FHEContext ctx;
...
BENCHMARK(BM_add3_lut4)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
