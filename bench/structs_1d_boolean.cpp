...
test_structs_1d_boolean(FHEContext& ctx, uint64_t data = 0)
{
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 2 * gout148 + gout67;
    ...
    test_out.push_back(ctx.decrypt(&gout92)); /* out9 */
