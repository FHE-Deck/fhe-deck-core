...
test_structs_1d_boolean(FHEContext& ctx, uint64_t data = 0)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 2 * ct_data25 + ct_data57;
    Ciphertext gout0 = ctx.eval_lut(&gin0, nand2);
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 2 * ct_data12 + ct_data44;
    Ciphertext gout1 = ctx.eval_lut(&gin1, xor2);
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 2 * ct_data20 + ct_data52;
    Ciphertext gout2 = ctx.eval_lut(&gin2, nand2);
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 2 * ct_data10 + ct_data42;
    Ciphertext gout3 = ctx.eval_lut(&gin3, xor2);
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 2 * ct_data4 + ct_data36;
    Ciphertext gout4 = ctx.eval_lut(&gin4, xor2);
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 2 * ct_data17 + ct_data49;
    Ciphertext gout5 = ctx.eval_lut(&gin5, or2);
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 2 * ct_data4 + ct_data36;
    Ciphertext gout6 = ctx.eval_lut(&gin6, nand2);
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 2 * ct_data19 + ct_data51;
    Ciphertext gout7 = ctx.eval_lut(&gin7, xor2);
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 2 * ct_data11 + ct_data43;
    Ciphertext gout8 = ctx.eval_lut(&gin8, xnor2);
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 2 * ct_data14 + ct_data46;
    Ciphertext gout9 = ctx.eval_lut(&gin9, nand2);
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 2 * ct_data13 + ct_data45;
    Ciphertext gout10 = ctx.eval_lut(&gin10, xor2);
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 2 * ct_data25 + ct_data57;
    Ciphertext gout11 = ctx.eval_lut(&gin11, xor2);
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 2 * ct_data30 + ct_data62;
    Ciphertext gout12 = ctx.eval_lut(&gin12, xnor2);
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 2 * ct_data20 + ct_data52;
    Ciphertext gout13 = ctx.eval_lut(&gin13, xor2);
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 2 * ct_data14 + ct_data46;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 2 * ct_data15 + ct_data47;
    Ciphertext gout22 = ctx.eval_lut(&gin22, nand2);
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 2 * ct_data17 + ct_data49;
    Ciphertext gout23 = ctx.eval_lut(&gin23, xor2);
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 2 * ct_data23 + ct_data55;
    Ciphertext gout24 = ctx.eval_lut(&gin24, nand2);
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 2 * ct_data23 + ct_data55;
    Ciphertext gout25 = ctx.eval_lut(&gin25, or2);
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 2 * ct_data1 + ct_data33;
    Ciphertext gout26 = ctx.eval_lut(&gin26, nand2);
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 2 * ct_data28 + ct_data60;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 2 * ct_data11 + ct_data43;
    Ciphertext gout49 = ctx.eval_lut(&gin49, or2);
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 2 * ct_data21 + ct_data53;
    Ciphertext gout50 = ctx.eval_lut(&gin50, or2);
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 2 * ct_data7 + ct_data39;
    Ciphertext gout51 = ctx.eval_lut(&gin51, or2);
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 2 * ct_data3 + ct_data35;
    Ciphertext gout52 = ctx.eval_lut(&gin52, xor2);
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 2 * ct_data13 + ct_data45;
    Ciphertext gout53 = ctx.eval_lut(&gin53, or2);
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 2 * ct_data19 + ct_data51;
    Ciphertext gout54 = ctx.eval_lut(&gin54, or2);
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 2 * ct_data21 + ct_data53;
    Ciphertext gout55 = ctx.eval_lut(&gin55, xor2);
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 2 * ct_data9 + ct_data41;
    Ciphertext gout56 = ctx.eval_lut(&gin56, xnor2);
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 2 * ct_data6 + ct_data38;
    Ciphertext gout57 = ctx.eval_lut(&gin57, nand2);
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 2 * ct_data22 + ct_data54;
    Ciphertext gout58 = ctx.eval_lut(&gin58, xor2);
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 2 * ct_data29 + ct_data61;
    ...
    test_out.push_back(ctx.decrypt(&gout116)); /* out17 */
    ...
    test_out.push_back(ctx.decrypt(&gout134)); /* out23 */
    test_out.push_back(ctx.decrypt(&gout138)); /* out24 */
    test_out.push_back(ctx.decrypt(&gout140)); /* out25 */
    test_out.push_back(ctx.decrypt(&gout143)); /* out26 */
    test_out.push_back(ctx.decrypt(&gout147)); /* out27 */
    test_out.push_back(ctx.decrypt(&gout150)); /* out28 */
