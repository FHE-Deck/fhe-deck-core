...
test_structs_1d_boolean(FHEContext& ctx, uint64_t data = 0)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 2 * ct_data2 + ct_data34;
    Ciphertext gout0 = ctx.eval_lut(&gin0, xor2);
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 2 * ct_data8 + ct_data40;
    Ciphertext gout1 = ctx.eval_lut(&gin1, nand2);
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 2 * ct_data16 + ct_data48;
    Ciphertext gout2 = ctx.eval_lut(&gin2, xor2);
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 2 * ct_data7 + ct_data39;
    Ciphertext gout3 = ctx.eval_lut(&gin3, nand2);
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 2 * ct_data1 + ct_data33;
    Ciphertext gout4 = ctx.eval_lut(&gin4, xor2);
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 2 * ct_data24 + ct_data56;
    Ciphertext gout5 = ctx.eval_lut(&gin5, xor2);
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 2 * ct_data24 + ct_data56;
    Ciphertext gout6 = ctx.eval_lut(&gin6, nand2);
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 2 * ct_data11 + ct_data43;
    Ciphertext gout7 = ctx.eval_lut(&gin7, or2);
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 2 * ct_data21 + ct_data53;
    Ciphertext gout8 = ctx.eval_lut(&gin8, nand2);
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 2 * ct_data9 + ct_data41;
    Ciphertext gout9 = ctx.eval_lut(&gin9, xnor2);
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 2 * ct_data12 + ct_data44;
    Ciphertext gout10 = ctx.eval_lut(&gin10, nand2);
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 2 * ct_data16 + ct_data48;
    Ciphertext gout11 = ctx.eval_lut(&gin11, nand2);
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 2 * ct_data7 + ct_data39;
    Ciphertext gout12 = ctx.eval_lut(&gin12, or2);
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 2 * ct_data6 + ct_data38;
    Ciphertext gout13 = ctx.eval_lut(&gin13, nand2);
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 2 * ct_data29 + ct_data61;
    Ciphertext gout14 = ctx.eval_lut(&gin14, nand2);
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 2 * ct_data21 + ct_data53;
    Ciphertext gout15 = ctx.eval_lut(&gin15, or2);
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 2 * ct_data27 + ct_data59;
    Ciphertext gout16 = ctx.eval_lut(&gin16, xor2);
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 2 * ct_data22 + ct_data54;
    Ciphertext gout17 = ctx.eval_lut(&gin17, nand2);
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 2 * ct_data10 + ct_data42;
    Ciphertext gout18 = ctx.eval_lut(&gin18, nand2);
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 2 * ct_data19 + ct_data51;
    Ciphertext gout19 = ctx.eval_lut(&gin19, or2);
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 2 * ct_data21 + ct_data53;
    Ciphertext gout20 = ctx.eval_lut(&gin20, xor2);
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 2 * ct_data29 + ct_data61;
    Ciphertext gout21 = ctx.eval_lut(&gin21, xor2);
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 2 * ct_data3 + ct_data35;
    Ciphertext gout22 = ctx.eval_lut(&gin22, nand2);
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 2 * ct_data3 + ct_data35;
    Ciphertext gout23 = ctx.eval_lut(&gin23, xor2);
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 2 * ct_data13 + ct_data45;
    Ciphertext gout24 = ctx.eval_lut(&gin24, nand2);
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 2 * ct_data6 + ct_data38;
    Ciphertext gout25 = ctx.eval_lut(&gin25, xor2);
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 2 * ct_data13 + ct_data45;
    Ciphertext gout26 = ctx.eval_lut(&gin26, or2);
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 2 * ct_data19 + ct_data51;
    Ciphertext gout27 = ctx.eval_lut(&gin27, nand2);
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 2 * ct_data27 + ct_data59;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 2 * ct_data22 + ct_data54;
    Ciphertext gout30 = ctx.eval_lut(&gin30, xor2);
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 2 * ct_data10 + ct_data42;
    Ciphertext gout31 = ctx.eval_lut(&gin31, xor2);
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 2 * ct_data4 + ct_data36;
    Ciphertext gout32 = ctx.eval_lut(&gin32, xor2);
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 2 * ct_data17 + ct_data49;
    Ciphertext gout33 = ctx.eval_lut(&gin33, or2);
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 2 * ct_data4 + ct_data36;
    Ciphertext gout34 = ctx.eval_lut(&gin34, nand2);
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 2 * ct_data19 + ct_data51;
    Ciphertext gout35 = ctx.eval_lut(&gin35, xor2);
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 2 * ct_data25 + ct_data57;
    Ciphertext gout36 = ctx.eval_lut(&gin36, nand2);
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 2 * ct_data14 + ct_data46;
    Ciphertext gout37 = ctx.eval_lut(&gin37, nand2);
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 2 * ct_data13 + ct_data45;
    Ciphertext gout38 = ctx.eval_lut(&gin38, xor2);
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 2 * ct_data17 + ct_data49;
    Ciphertext gout39 = ctx.eval_lut(&gin39, nand2);
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 2 * ct_data25 + ct_data57;
    Ciphertext gout40 = ctx.eval_lut(&gin40, xor2);
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 2 * ct_data27 + ct_data59;
    Ciphertext gout41 = ctx.eval_lut(&gin41, or2);
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 2 * ct_data12 + ct_data44;
    Ciphertext gout42 = ctx.eval_lut(&gin42, xor2);
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 2 * ct_data20 + ct_data52;
    Ciphertext gout43 = ctx.eval_lut(&gin43, nand2);
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 2 * ct_data20 + ct_data52;
    Ciphertext gout44 = ctx.eval_lut(&gin44, xor2);
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 2 * ct_data11 + ct_data43;
    Ciphertext gout45 = ctx.eval_lut(&gin45, nand2);
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 2 * ct_data5 + ct_data37;
    Ciphertext gout46 = ctx.eval_lut(&gin46, xor2);
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 2 * ct_data14 + ct_data46;
    Ciphertext gout47 = ctx.eval_lut(&gin47, xor2);
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 2 * ct_data9 + ct_data41;
    Ciphertext gout48 = ctx.eval_lut(&gin48, or2);
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 2 * ct_data23 + ct_data55;
    ...
    test_out.push_back(ctx.decrypt(&gout83)); /* out6 */
    ...
    test_out.push_back(ctx.decrypt(&gout109)); /* out14 */
    test_out.push_back(ctx.decrypt(&gout111)); /* out15 */
    test_out.push_back(ctx.decrypt(&gout115)); /* out16 */
    test_out.push_back(ctx.decrypt(&gout117)); /* out17 */
    test_out.push_back(ctx.decrypt(&gout121)); /* out18 */
    test_out.push_back(ctx.decrypt(&gout123)); /* out19 */
    test_out.push_back(ctx.decrypt(&gout127)); /* out20 */
    test_out.push_back(ctx.decrypt(&gout129)); /* out21 */
    test_out.push_back(ctx.decrypt(&gout133)); /* out22 */
    test_out.push_back(ctx.decrypt(&gout138)); /* out23 */
    test_out.push_back(ctx.decrypt(&gout136)); /* out24 */
    test_out.push_back(ctx.decrypt(&gout141)); /* out25 */
    test_out.push_back(ctx.decrypt(&gout144)); /* out26 */
    test_out.push_back(ctx.decrypt(&gout147)); /* out27 */
    test_out.push_back(ctx.decrypt(&gout149)); /* out28 */
    test_out.push_back(ctx.decrypt(&gout152)); /* out29 */
    test_out.push_back(ctx.decrypt(&gout155)); /* out30 */
