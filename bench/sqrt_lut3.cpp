...
test_sqrt_lut3(FHEContext& ctx, uint16_t num = 0)
{
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_num0 + 2 * ct_num1;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_num13 + 2 * ct_num15;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * gout0[0] + 2 * gout3[0] + 4 * ct_num12;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_num14 + 2 * ct_num15;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_num13 + 2 * ct_num12 + 4 * gout8[0];
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * gout3[0] + 2 * ct_num12 + 4 * gout8[0];
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout10[0] + 2 * gout0[0] + 4 * ct_num12;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_num11 + 2 * ct_num10 + 4 * gout11[0];
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout7[0] + 2 * ct_num10 + 4 * gout11[0];
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * gout9[2] + 2 * gout11[0];
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout13[0] + 2 * gout12[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * gout9[1] + 2 * gout5[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * gout14[0] + 2 * gout16[0] + 4 * gout8[1];
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout15[0] + 2 * gout16[0] + 4 * ct_num14;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * gout18[0] + 2 * gout17[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout7[0] + 2 * gout19[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * gout12[0] + 2 * gout15[1] + 4 * gout19[0];
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * gout21[0] + 2 * gout8[1];
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout22[0] + 2 * gout23[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout16[0] + 2 * gout24[0] + 4 * gout19[0];
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout26[1] + 2 * gout25[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout28[1] + 2 * gout21[0] + 4 * gout8[1];
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout25[0] + 2 * gout28[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout1[0] + 2 * gout19[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout32[0] + 2 * gout8[1];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout6[0] + 2 * ct_num6 + 4 * gout31[0];
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_num7 + 2 * ct_num6 + 4 * gout31[0];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout23[0] + 2 * gout26[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout28[1] + 2 * gout24[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_num8 + 2 * gout33[0];
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout17[0] + 2 * gout40[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout35[0] + 2 * gout36[0] + 4 * gout19[0];
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout42[0] + 2 * gout39[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout34[0] + 2 * gout44[1] + 4 * ct_num14;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout45[0] + 2 * gout38[0];
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout40[0] + 2 * gout45[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout6[0] + 2 * gout46[0] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout4[0] + 2 * ct_num4 + 4 * gout47[0];
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout39[0] + 2 * gout43[0] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout37[0] + 2 * gout44[0] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout36[0] + 2 * gout42[1] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout44[1] + 2 * gout47[0] + 4 * gout8[1];
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout55[0] + 2 * gout32[0] + 4 * gout41[0];
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout57[1] + 2 * gout52[0] + 4 * gout19[0];
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout58[1] + 2 * gout53[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout59[0] + 2 * gout9[0] + 4 * gout50[0];
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout60[0] + 2 * gout8[1] + 4 * gout51[0];
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout56[0] + 2 * gout61[1] + 4 * gout51[0];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout61[0] + 2 * gout56[0];
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout57[0] + 2 * gout63[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout4[0] + 2 * gout63[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout53[0] + 2 * gout59[1] + 4 * gout64[1];
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout50[0] + 2 * gout60[1] + 4 * gout64[1];
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout52[0] + 2 * gout58[0] + 4 * gout64[1];
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout47[0] + 2 * gout63[0];
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout63[0] + 2 * gout54[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * ct_num3 + 2 * ct_num2 + 4 * gout64[1];
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout2[0] + 2 * ct_num2 + 4 * gout64[1];
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout70[0] + 2 * gout64[0] + 4 * gout19[0];
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout72[0] + 2 * gout71[0] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout67[0] + 2 * ct_num14 + 4 * gout62[0];
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout65[0] + 2 * gout69[0] + 4 * ct_num4;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout11[0] + 2 * gout68[0] + 4 * gout73[1];
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout77[1] + 2 * gout66[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout76[0] + 2 * gout74[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout78[1] + 2 * gout8[1] + 4 * gout67[0];
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout73[0] + 2 * gout79[0] + 4 * gout77[0];
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout78[0] + 2 * gout81[0] + 4 * gout80[0];
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout82[0] + 2 * gout75[0] + 4 * ct_num15;
    std::vector<Ciphertext> gout83 = ctx.eval_lut_amortized(&gin83, lut83);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout83[0])); /* out0 */
