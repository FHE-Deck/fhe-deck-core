...
test_sum_lut2(FHEContext& ctx, uint32_t a = 0, uint32_t b = 0)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_a25 + 2 * ct_b25;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_a16 + 2 * ct_b16;
    ...
    lut2.push_back(ctx.genrate_lut(lut2idx2));
    flut2.push_back(lut2idx2);
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_a23 + 2 * ct_b23;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_a13 + 2 * ct_b13;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_a30 + 2 * ct_b30;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_a12 + 2 * ct_b12;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_a11 + 2 * ct_b11;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_a31 + 2 * ct_b31;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_a2 + 2 * ct_b2;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_a27 + 2 * ct_b27;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_a1 + 2 * ct_b1;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_a4 + 2 * ct_b4;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_a20 + 2 * ct_b20;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_a6 + 2 * ct_b6;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_a24 + 2 * ct_b24;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_a8 + 2 * ct_b8;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_a15 + 2 * ct_b15;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_a29 + 2 * ct_b29;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_a5 + 2 * ct_b5;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_a3 + 2 * ct_b3;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_a10 + 2 * ct_b10;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_a0 + 2 * ct_b0;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_a22 + 2 * ct_b22;
    ...
    lut24.push_back(ctx.genrate_lut(lut24idx2));
    flut24.push_back(lut24idx2);
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_a21 + 2 * ct_b21;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_a19 + 2 * ct_b19;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_a7 + 2 * ct_b7;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_a14 + 2 * ct_b14;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_a18 + 2 * ct_b18;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_a28 + 2 * ct_b28;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_a9 + 2 * ct_b9;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout22[1] + 2 * gout10[0];
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout32[1] + 2 * gout10[1];
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout33[0] + 2 * gout8[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout34[1] + 2 * gout8[1];
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout35[0] + 2 * gout19[1];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout36[0] + 2 * gout19[0];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout37[0] + 2 * gout11[0];
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout38[1] + 2 * gout11[1];
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout39[0] + 2 * gout18[0];
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout40[1] + 2 * gout18[1];
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout41[0] + 2 * gout13[0];
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout42[0] + 2 * gout13[1];
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout43[0] + 2 * gout26[0];
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout44[1] + 2 * gout26[1];
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout45[0] + 2 * gout15[0];
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout46[0] + 2 * gout15[1];
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout47[0] + 2 * gout31[1];
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout48[0] + 2 * gout31[0];
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout49[0] + 2 * gout20[0];
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout50[1] + 2 * gout20[1];
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout6[0] + 2 * gout51[0];
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout51[0] + 2 * gout6[1];
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout53[0] + 2 * gout6[2];
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout54[0] + 2 * gout5[1];
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout55[0] + 2 * gout5[0];
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout56[0] + 2 * gout3[0];
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout3[1] + 2 * gout56[0];
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout58[0] + 2 * gout3[2];
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout59[0] + 2 * gout27[0];
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout60[0] + 2 * gout27[1];
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout61[0] + 2 * gout16[1];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout16[0] + 2 * gout61[0];
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout63[0] + 2 * gout16[2];
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout64[0] + 2 * gout1[0];
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout65[0] + 2 * gout1[1];
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout66[0] + 2 * gout21[2];
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout21[0] + 2 * gout66[0];
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout68[0] + 2 * gout21[1];
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout69[0] + 2 * gout29[0];
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout70[1] + 2 * gout29[1];
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout71[0] + 2 * gout25[0];
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout25[1] + 2 * gout71[0];
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout73[0] + 2 * gout25[2];
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout74[0] + 2 * gout12[0];
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout75[0] + 2 * gout12[1];
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout76[0] + 2 * gout24[0];
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout24[1] + 2 * gout76[0];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout78[0] + 2 * gout24[2];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout79[0] + 2 * gout23[1];
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout80[0] + 2 * gout23[0];
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout81[0] + 2 * gout2[0];
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout2[1] + 2 * gout81[0];
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout83[0] + 2 * gout2[2];
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout84[0] + 2 * gout14[1];
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout85[0] + 2 * gout14[0];
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout86[0] + 2 * gout0[0];
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout0[1] + 2 * gout86[0];
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout88[0] + 2 * gout0[2];
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout90[1] + 2 * gout28[0];
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout91[0] + 2 * gout9[1];
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout9[2] + 2 * gout91[0];
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout93[0] + 2 * gout9[0];
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout94[0] + 2 * gout30[0];
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout95[1] + 2 * gout30[1];
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout96[0] + 2 * gout17[1];
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout97[0] + 2 * gout17[0];
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * gout98[0] + 2 * gout4[0];
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout99[0] + 2 * gout4[1];
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * gout100[0] + 2 * gout7[0];
    std::vector<Ciphertext> gout101 = ctx.eval_lut_amortized(&gin101, lut101);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout22[0])); /* out0 */
    test_out.push_back(ctx.decrypt(&gout32[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout34[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout36[1])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout38[0])); /* out4 */
    ...
    test_out.push_back(ctx.decrypt(&gout48[1])); /* out9 */
    test_out.push_back(ctx.decrypt(&gout50[0])); /* out10 */
    test_out.push_back(ctx.decrypt(&gout52[0])); /* out11 */
    test_out.push_back(ctx.decrypt(&gout55[1])); /* out12 */
    ...
    test_out.push_back(ctx.decrypt(&gout70[0])); /* out18 */
    ...
    test_out.push_back(ctx.decrypt(&gout85[1])); /* out24 */
    test_out.push_back(ctx.decrypt(&gout87[0])); /* out25 */
    test_out.push_back(ctx.decrypt(&gout90[0])); /* out26 */
    test_out.push_back(ctx.decrypt(&gout92[0])); /* out27 */
    test_out.push_back(ctx.decrypt(&gout95[0])); /* out28 */
    test_out.push_back(ctx.decrypt(&gout97[1])); /* out29 */
    test_out.push_back(ctx.decrypt(&gout99[1])); /* out30 */
