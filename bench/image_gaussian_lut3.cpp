...
test_image_gaussian_lut3(FHEContext& ctx, std::vector<uint64_t> window = { 0 })
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_window65 + 2 * ct_window56;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_window2 + 2 * ct_window9;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_window16 + 2 * ct_window0;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * gout3[1] + 2 * ct_window48 + 4 * ct_window64;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_window49 + 2 * ct_window40;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * gout0[0] + 2 * ct_window66 + 4 * ct_window57;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_window25 + 2 * ct_window32;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_window49 + 2 * ct_window40 + 4 * gout0[1];
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * gout6[1] + 2 * ct_window67 + 4 * ct_window58;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * gout2[1] + 2 * ct_window2 + 4 * ct_window9;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout9[0] + 2 * ct_window68 + 4 * ct_window59;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * gout5[0] + 2 * ct_window50 + 4 * ct_window41;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout3[0] + 2 * ct_window17 + 4 * gout2[0];
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * gout1[0] + 2 * gout2[1] + 4 * ct_window18;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout13[0] + 2 * ct_window18 + 4 * gout14[0];
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * gout7[0] + 2 * ct_window26 + 4 * ct_window33;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * gout12[0] + 2 * ct_window51 + 4 * ct_window42;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout16[0] + 2 * ct_window27 + 4 * ct_window34;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * gout11[0] + 2 * ct_window69 + 4 * ct_window60;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout13[1] + 2 * ct_window24;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * gout12[1] + 2 * gout6[0];
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * gout17[0] + 2 * gout9[1];
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * gout17[1] + 2 * ct_window52 + 4 * ct_window43;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * gout13[0] + 2 * gout14[0] + 4 * gout7[1];
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout18[1] + 2 * ct_window28 + 4 * ct_window35;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout10[0] + 2 * ct_window3 + 4 * ct_window10;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout20[1] + 2 * gout8[1] + 4 * gout4[0];
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout23[0] + 2 * ct_window53 + 4 * ct_window44;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout15[0] + 2 * gout26[0] + 4 * ct_window19;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout28[1] + 2 * gout19[0];
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout21[0] + 2 * gout20[0] + 4 * gout24[0];
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout25[1] + 2 * ct_window29 + 4 * ct_window36;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout26[1] + 2 * ct_window4 + 4 * ct_window11;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout27[1] + 2 * gout27[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout19[1] + 2 * ct_window70 + 4 * ct_window61;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout33[0] + 2 * ct_window5 + 4 * ct_window12;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout35[1] + 2 * ct_window71 + 4 * ct_window62;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout32[1] + 2 * ct_window30 + 4 * ct_window37;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout20[0] + 2 * gout7[1] + 4 * gout24[0];
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout38[0] + 2 * ct_window31 + 4 * ct_window38;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout39[0] + 2 * gout29[0] + 4 * gout16[1];
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout40[0] + 2 * ct_window39;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout23[1] + 2 * gout11[1];
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout12[1] + 2 * gout6[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout36[1] + 2 * ct_window6 + 4 * ct_window13;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout28[0] + 2 * ct_window54 + 4 * ct_window45;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout37[0] + 2 * ct_window63;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout29[1] + 2 * gout33[1] + 4 * ct_window20;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout8[0] + 2 * gout34[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout41[1] + 2 * gout22[0] + 4 * gout39[0];
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout48[0] + 2 * gout36[0] + 4 * ct_window21;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout46[1] + 2 * ct_window55 + 4 * ct_window46;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout17[0] + 2 * gout9[1] + 4 * gout50[0];
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout51[1] + 2 * gout45[0] + 4 * ct_window22;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout52[0] + 2 * ct_window47;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout45[1] + 2 * ct_window7 + 4 * ct_window14;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout46[0] + 2 * gout35[0];
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout48[1] + 2 * gout18[0] + 4 * gout41[0];
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout44[0] + 2 * gout49[0] + 4 * gout50[0];
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout55[0] + 2 * gout47[1];
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout54[0] + 2 * gout56[0] + 4 * ct_window23;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout51[0] + 2 * gout25[0] + 4 * gout58[0];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout52[1] + 2 * gout37[1];
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout58[1] + 2 * gout43[0] + 4 * gout41[0];
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout61[0] + 2 * ct_window15 + 4 * gout56[1];
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout23[1] + 2 * gout11[1] + 4 * gout64[0];
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout62[1] + 2 * gout58[0] + 4 * gout30[0];
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout53[0] + 2 * gout64[0] + 4 * gout59[0];
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout68[1] + 2 * gout66[0] + 4 * gout67[0];
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout54[1] + 2 * gout32[0] + 4 * gout62[0];
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout65[0] + 2 * gout40[0] + 4 * ct_window39;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout70[1] + 2 * gout57[0] + 4 * gout62[0];
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout46[0] + 2 * gout35[0] + 4 * gout72[0];
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout28[1] + 2 * gout19[0] + 4 * gout67[0];
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout61[1] + 2 * gout38[1] + 4 * gout70[0];
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout75[1] + 2 * gout70[0] + 4 * gout63[0];
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout65[1] + 2 * gout40[1] + 4 * gout75[0];
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout77[0] + 2 * gout71[0];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout69[1] + 2 * gout74[0] + 4 * gout72[0];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout71[1] + 2 * gout42[0] + 4 * gout78[0];
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout52[1] + 2 * gout37[1] + 4 * gout76[0];
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout77[1] + 2 * gout60[0] + 4 * gout75[0];
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout78[1] + 2 * gout55[1] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout79[1] + 2 * gout73[0] + 4 * gout76[0];
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout84[0] + 2 * gout81[0] + 4 * gout82[0];
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout55[0] + 2 * gout47[1] + 4 * gout82[0];
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout78[0] + 2 * gout83[0] + 4 * gout80[0];
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout85[0] + 2 * gout86[0] + 4 * gout83[1];
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout87[0] + 2 * gout88[1] + 4 * gout87[1];
    std::vector<Ciphertext> gout89 = ctx.eval_lut_amortized(&gin89, lut89);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout68[0])); /* out0 */
    test_out.push_back(ctx.decrypt(&gout69[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout79[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout84[1])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout85[1])); /* out4 */
