...
test_image_sharpen_lut4(FHEContext& ctx, uint64_t window = 0)
{
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_window57 + 2 * ct_window25 + 4 * ct_window9;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_window59 + 2 * ct_window27 + 4 * ct_window11;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_window10 + 2 * ct_window42;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_window45 + 2 * ct_window35;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_window62 + 2 * ct_window30 + 4 * ct_window14;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_window56 + 2 * ct_window24 + 4 * ct_window8;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_window61 + 2 * ct_window29 + 4 * ct_window13;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_window63 + 2 * ct_window39 + 4 * gout9[0] + 8 * gout5[0];
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout2[0] + 2 * gout6[1] + 4 * ct_window44 + 8 * ct_window34;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * gout6[0] + 2 * gout8[0] + 4 * ct_window45 + 8 * ct_window35;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout0[0] + 2 * gout2[1] + 4 * ct_window43 + 8 * ct_window33;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * gout8[1] + 2 * gout5[1] + 4 * ct_window46 + 8 * ct_window36;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout1[0] + 2 * gout3[0] + 4 * ct_window58 + 8 * ct_window26;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * gout7[1] + 2 * ct_window40 + 4 * ct_window32;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_window43 + 2 * gout13[0] + 4 * gout11[0] + 8 * ct_window33;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout7[0] + 2 * gout1[1] + 4 * ct_window41;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * gout12[1] + 2 * ct_window45 + 4 * gout11[1] + 8 * ct_window35;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout18[0] + 2 * gout15[1] + 4 * gout16[1] + 8 * gout18[1];
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * gout12[0] + 2 * gout14[0] + 4 * gout4[0];
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * gout15[0] + 2 * ct_window10 + 4 * ct_window42 + 8 * gout13[1];
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_window44 + 2 * gout19[0] + 4 * gout17[1] + 8 * ct_window34;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_window32 + 2 * gout16[1] + 4 * gout18[1] + 8 * ct_window33;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout11[1] + 2 * ct_window44 + 4 * gout19[0] + 8 * ct_window34;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout25[0] + 2 * gout21[1] + 4 * gout4[0] + 8 * ct_window38;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout17[1] + 2 * gout23[0] + 4 * ct_window37;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout10[0] + 2 * gout14[1] + 4 * gout26[0] + 8 * gout21[0];
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout20[1] + 2 * gout20[0] + 4 * ct_window34;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout20[0] + 2 * gout24[1] + 4 * gout24[0] + 8 * ct_window34;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout22[1] + 2 * ct_window10 + 4 * ct_window42 + 8 * gout20[2];
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout22[0] + 2 * gout17[0] + 4 * ct_window36;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout20[2] + 2 * ct_window35 + 4 * gout31[0];
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout29[0] + 2 * gout30[0] + 4 * ct_window35 + 8 * gout31[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout26[1] + 2 * ct_window38 + 4 * gout27[0];
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout23[0] + 2 * gout32[0] + 4 * ct_window37;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout33[0] + 2 * gout34[1] + 4 * gout32[1] + 8 * gout36[1];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout37[0] + 2 * gout36[0] + 4 * gout27[0] + 8 * gout35[0];
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout37[1] + 2 * gout38[1] + 4 * gout38[0] + 8 * gout28[0];
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout37[1] + 2 * gout38[1] + 4 * gout34[0] + 8 * gout30[1];
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout34[0] + 2 * gout40[0] + 4 * gout39[1] + 8 * gout39[0];
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout30[1] + 2 * gout40[0] + 4 * gout39[1] + 8 * gout39[0];
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout40[0] + 2 * gout39[1] + 4 * gout16[0] + 8 * gout39[0];
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout24[2] + 2 * gout40[0] + 4 * gout39[1] + 8 * gout39[0];
