...
test_relu_lut4(FHEContext& ctx, uint16_t x = 0)
{
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_x10 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_x12 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_x0 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_x15 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_x5 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_x14 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_x6 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_x9 + 2 * ct_x15;
    std::vector<Ciphertext> gout14 = ctx.eval_lut_amortized(&gin14, lut14);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout5[0])); /* out0 */
    ...
    test_out.push_back(ctx.decrypt(&gout12[0])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout11[0])); /* out7 */
    test_out.push_back(ctx.decrypt(&gout7[0])); /* out8 */
    test_out.push_back(ctx.decrypt(&gout14[0])); /* out9 */
    test_out.push_back(ctx.decrypt(&gout2[0])); /* out10 */
    ...
    test_out.push_back(ctx.decrypt(&gout10[0])); /* out14 */
    return test_out;
}
