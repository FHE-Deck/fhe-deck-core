...
test_relu_lut4(FHEContext& ctx, uint16_t x = 0)
{
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_x13 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_x15 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_x0 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_x8 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_x3 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_x10 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_x5 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_x12 + 2 * ct_x15;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_x14 + 2 * ct_x15;
    std::vector<Ciphertext> gout14 = ctx.eval_lut_amortized(&gin14, lut14);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout8[0])); /* out0 */
    ...
    test_out.push_back(ctx.decrypt(&gout11[0])); /* out10 */
    test_out.push_back(ctx.decrypt(&gout5[0])); /* out11 */
    test_out.push_back(ctx.decrypt(&gout13[0])); /* out12 */
