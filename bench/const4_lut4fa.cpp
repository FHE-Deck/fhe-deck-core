...
std::vector<long>
test_const4_lut4fa(FHEContext& ctx, uint8_t a = 0)
{
...
static void
BM_const4_lut4fa(benchmark::State& state)
{
    FHEContext ctx;
    ...
    for (auto _ : state) {
        test_const4_lut4fa(ctx);
    }
}

BENCHMARK(BM_const4_lut4fa)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
