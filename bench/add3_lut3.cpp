...
std::vector<long>
test_add3_lut3(FHEContext& ctx, uint8_t a = 0, uint8_t b = 0)
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 6 (LUT2 _19_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 3 (LUT2 _16_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut2idx0 = [](long I) -> long {
        /* GATE 5 (LUT3 _18_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut2idx1 = [](long I) -> long {
        /* GATE 1 (LUT3 _14_ INIT 0xd4 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
...
static void
BM_add3_lut3(benchmark::State& state)
{
    FHEContext ctx;
...
BENCHMARK(BM_add3_lut3)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
