...
test_sum_boolean(FHEContext& ctx, uint32_t a = 0, uint32_t b = 0)
{
    ...
    test_out.push_back(ctx.decrypt(&gout105)); /* out11 */
    test_out.push_back(ctx.decrypt(&gout108)); /* out12 */
    test_out.push_back(ctx.decrypt(&gout111)); /* out13 */
    test_out.push_back(ctx.decrypt(&gout114)); /* out14 */
    test_out.push_back(ctx.decrypt(&gout116)); /* out15 */
    ...
    test_out.push_back(ctx.decrypt(&gout162)); /* out30 */
