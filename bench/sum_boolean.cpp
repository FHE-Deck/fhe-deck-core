...
test_sum_boolean(FHEContext& ctx, uint32_t a = 0, uint32_t b = 0)
{
    ...
    test_out.push_back(ctx.decrypt(&gout86)); /* out5 */
    test_out.push_back(ctx.decrypt(&gout89)); /* out6 */
    ...
    test_out.push_back(ctx.decrypt(&gout103)); /* out10 */
    test_out.push_back(ctx.decrypt(&gout108)); /* out11 */
    test_out.push_back(ctx.decrypt(&gout106)); /* out12 */
    test_out.push_back(ctx.decrypt(&gout112)); /* out13 */
    test_out.push_back(ctx.decrypt(&gout114)); /* out14 */
    ...
    test_out.push_back(ctx.decrypt(&gout125)); /* out18 */
    test_out.push_back(ctx.decrypt(&gout129)); /* out19 */
    test_out.push_back(ctx.decrypt(&gout132)); /* out20 */
    test_out.push_back(ctx.decrypt(&gout134)); /* out21 */
    test_out.push_back(ctx.decrypt(&gout138)); /* out22 */
    test_out.push_back(ctx.decrypt(&gout142)); /* out23 */
    test_out.push_back(ctx.decrypt(&gout143)); /* out24 */
    test_out.push_back(ctx.decrypt(&gout148)); /* out25 */
    test_out.push_back(ctx.decrypt(&gout149)); /* out26 */
