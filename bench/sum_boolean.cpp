...
test_sum_boolean(FHEContext& ctx, uint32_t a = 0, uint32_t b = 0)
{
    ...
    test_out.push_back(ctx.decrypt(&gout119)); /* out16 */
    ...
    test_out.push_back(ctx.decrypt(&gout131)); /* out20 */
    test_out.push_back(ctx.decrypt(&gout134)); /* out21 */
    test_out.push_back(ctx.decrypt(&gout138)); /* out22 */
    test_out.push_back(ctx.decrypt(&gout140)); /* out23 */
