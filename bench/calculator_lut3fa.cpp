...
std::vector<long>
test_calculator_lut3fa(FHEContext& ctx, uint8_t op = 0, uint16_t x = 0, uint16_t y = 0)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_x9 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_x1 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_x1 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_x0 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_x11 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_x1 + 2 * ct_y13;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_x2 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_x10 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_y3 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_x12 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_x6 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_x13 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_x2 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_x4 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_y12 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_x0 + 2 * ct_y3;
    std::vector<Ciphertext> gout16 = ctx.eval_lut_amortized(&gin16, lut16);

    std::cerr << "\rFA17    ";
    Ciphertext gin17 = 0 + 1 * ct_x0 + 2 * ct_x1 + 1 * ct_y0 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_x6 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_y0 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_x1 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_y4 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_x2 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_y1 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_x5 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_y2 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_x14 + 2 * ct_y1 + 4 * ct_y15;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_x4 + 2 * gout15[0] + 4 * ct_y11;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_x10 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_x2 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_x4 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_x8 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * ct_x4 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_y5 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_x2 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_y0 + 2 * ct_x15 + 4 * gout26[0];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * ct_x1 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * ct_y6 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_x0 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_x12 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_x1 + 2 * ct_y14;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_x1 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * ct_x1 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * ct_y0 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * ct_x7 + 2 * ct_y8 + 4 * gout18[0];
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout3[0] + 2 * ct_x0 + 4 * ct_y1;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout1[0] + 2 * ct_x0 + 4 * ct_y10;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout37[0] + 2 * ct_x0 + 4 * ct_y4;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_y8 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * ct_x2 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * ct_x10 + 2 * gout38[0] + 4 * ct_y5;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * ct_x2 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * ct_x8 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * ct_x0 + 2 * gout41[0] + 4 * ct_y15;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * ct_x4 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_y4 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * ct_x10 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * ct_y4 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * ct_x1 + 2 * ct_y6;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * ct_y1 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * ct_x11 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * ct_x4 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * ct_y3 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * ct_x1 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * ct_y3 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * ct_y2 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * ct_op6 + 2 * ct_op7;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * ct_x0 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * ct_x12 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * ct_x1 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * ct_x1 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * ct_y6 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * ct_y9 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * ct_y2 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * ct_x4 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * ct_y6 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout6[0] + 2 * ct_y12 + 4 * ct_x2;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * ct_x2 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * ct_y7 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * ct_x0 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * ct_y3 + 2 * ct_x6;
    std::vector<Ciphertext> gout94 = ctx.eval_lut_amortized(&gin94, lut94);

    std::cerr << "\rINV95   ";
    std::vector<Ciphertext> gout95;
    gout95.push_back(1 - ct_y1);

    std::cerr << "\rINV96   ";
    std::vector<Ciphertext> gout96;
    gout96.push_back(1 - ct_y9);
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * ct_y3 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * ct_y6 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * ct_y2 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * gout63[0] + 2 * gout84[0] + 4 * gout54[0];
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * ct_x1 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * gout28[0] + 2 * gout25[0] + 4 * gout5[0];
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * ct_y1 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * ct_x0 + 2 * ct_y12;
    std::vector<Ciphertext> gout117 = ctx.eval_lut_amortized(&gin117, lut117);

    std::cerr << "\rINV118   ";
    std::vector<Ciphertext> gout118;
    gout118.push_back(1 - ct_y12);

    std::cerr << "\rINV119   ";
    std::vector<Ciphertext> gout119;
    gout119.push_back(1 - ct_y3);
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * ct_x2 + 2 * ct_y7;
    std::vector<Ciphertext> gout120 = ctx.eval_lut_amortized(&gin120, lut120);

    std::cerr << "\rINV121   ";
    std::vector<Ciphertext> gout121;
    gout121.push_back(1 - ct_y11);
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * ct_x4 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * ct_y0 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * ct_y4 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * ct_x9 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * ct_x11 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout77[0] + 2 * gout93[0] + 4 * gout89[0];
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout20[0] + 2 * gout4[0] + 4 * gout32[0];
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * ct_x12 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * ct_y6 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * ct_x4 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * ct_y8 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * ct_y10 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * gout90[0] + 2 * ct_y14 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * ct_y5 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * ct_x8 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * ct_y7 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout47[1] + 2 * gout79[1];
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * ct_x13 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout61[0] + 2 * gout53[0] + 4 * gout30[0];
    std::vector<Ciphertext> gout140 = ctx.eval_lut_amortized(&gin140, lut140);

    std::cerr << "\rFA141    ";
    Ciphertext gin141 = 1 + 1 * ct_x0 + 2 * ct_x1 + 1 * gout86[0] + 2 * gout95[0];
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * ct_x14 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * gout124[0] + 2 * gout136[0] + 4 * gout115[0];
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * ct_x10 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout14[0] + 2 * ct_y9 + 4 * ct_x5;
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * ct_op4 + 2 * ct_op5 + 4 * gout73[0];
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * ct_y4 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * ct_x1 + 2 * ct_y12;
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * ct_y7 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * ct_y6 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * ct_x8 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT152   ";
    Ciphertext gin152 = 1 * ct_y7 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * ct_y6 + 2 * ct_x4;
    std::vector<Ciphertext> gout153 = ctx.eval_lut_amortized(&gin153, lut153);

    std::cerr << "\rFA154    ";
    Ciphertext gin154 = gout17[2] + 1 * ct_x2 + 2 * ct_x3 + 1 * ct_y2 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * gout58[0] + 2 * gout76[0] + 4 * gout69[0];
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout145[0] + 2 * ct_x3 + 4 * ct_y11;
    std::vector<Ciphertext> gout156 = ctx.eval_lut_amortized(&gin156, lut156);

    std::cerr << "\rFA157    ";
    Ciphertext gin157 = gout154[2] + 1 * ct_x4 + 2 * ct_x5 + 1 * ct_y4 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout57[0] + 2 * gout71[0] + 4 * gout67[0];
    std::vector<Ciphertext> gout158 = ctx.eval_lut_amortized(&gin158, lut158);

    std::cerr << "\rFA159    ";
    Ciphertext gin159 = gout141[2] + 1 * ct_x2 + 2 * ct_x3 + 1 * gout80[0] + 2 * gout119[0];
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout21[0] + 2 * gout34[0] + 4 * gout31[0];
    std::vector<Ciphertext> gout160 = ctx.eval_lut_amortized(&gin160, lut160);

    std::cerr << "\rFA161    ";
    Ciphertext gin161 = gout159[2] + 1 * ct_x4 + 2 * ct_x5 + 1 * gout116[0] + 2 * gout112[0];
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout2[0] + 2 * gout146[0];
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout131[0] + 2 * gout156[0] + 4 * gout24[0];
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout0[0] + 2 * gout151[0] + 4 * gout8[0];
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * ct_x2 + 2 * ct_y13 + 4 * gout27[0];
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout163[0] + 2 * gout165[0] + 4 * gout45[0];
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * gout56[0] + 2 * gout49[0] + 4 * gout78[0];
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout46[1] + 2 * gout128[0];
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout100[0] + 2 * gout122[0] + 4 * gout94[0];
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * ct_x8 + 2 * ct_y7 + 4 * gout51[0];
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout117[0] + 2 * gout6[0];
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout110[0] + 2 * gout99[0] + 4 * gout123[0];
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout13[0] + 2 * gout43[0] + 4 * gout19[0];
    std::vector<Ciphertext> gout173 = ctx.eval_lut_amortized(&gin173, lut173);

    std::cerr << "\rFA174    ";
    Ciphertext gin174 = gout157[2] + 1 * ct_x6 + 2 * ct_x7 + 1 * ct_y6 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout91[0] + 2 * gout85[0] + 4 * gout81[0];
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout120[0] + 2 * gout108[0] + 4 * gout130[0];
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * ct_x13 + 2 * ct_y2 + 4 * gout40[0];
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout177[0] + 2 * gout36[0];
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout65[0] + 2 * gout60[0] + 4 * gout75[0];
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout68[0] + 2 * gout39[0] + 4 * gout35[0];
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout23[0] + 2 * gout29[0] + 4 * gout52[0];
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * gout16[0] + 2 * gout68[0];
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout180[1] + 2 * ct_x0 + 4 * ct_y6;
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout12[0] + 2 * gout10[0] + 4 * gout142[0];
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout134[0] + 2 * gout90[1] + 4 * gout55[0];
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout62[0] + 2 * ct_x0 + 4 * ct_y7;
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout155[0] + 2 * gout186[1];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout66[0] + 2 * gout82[0] + 4 * gout97[0];
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout147[0] + 2 * gout135[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout164[0] + 2 * gout109[0] + 4 * gout160[1];
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout127[0] + 2 * gout176[1] + 4 * gout188[1];
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout64[0] + 2 * gout59[0] + 4 * gout88[0];
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * ct_op1 + 2 * ct_op0 + 4 * gout146[0];
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout133[0] + 2 * gout22[0] + 4 * gout131[0];
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout113[0] + 2 * gout102[0] + 4 * gout125[0];
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout92[0] + 2 * gout87[0] + 4 * gout98[0];
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout79[0] + 2 * gout175[1] + 4 * gout117[0];
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout186[0] + 2 * gout127[1] + 4 * gout140[1];
    std::vector<Ciphertext> gout198 = ctx.eval_lut_amortized(&gin198, lut198);

    std::cerr << "\rFA199    ";
    Ciphertext gin199 = gout161[2] + 1 * ct_x6 + 2 * ct_x7 + 1 * gout107[0] + 2 * gout104[0];
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout152[0] + 2 * gout11[0] + 4 * gout150[0];
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout129[0] + 2 * gout126[0] + 4 * gout139[0];
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout144[0] + 2 * ct_x11 + 4 * ct_y3;
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout148[0] + 2 * ct_x0 + 4 * ct_y13;
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * gout137[0] + 2 * gout132[0] + 4 * gout106[0];
    ...
    std::cerr << "\rLUT205   ";
    Ciphertext gin205 = 1 * gout198[1] + 2 * ct_x0 + 4 * ct_y9;
    ...
    std::cerr << "\rLUT206   ";
    Ciphertext gin206 = 1 * gout111[1] + 2 * gout192[1] + 4 * gout155[1];
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout109[1] + 2 * gout179[0] + 4 * gout158[0];
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * gout167[0] + 2 * gout196[0] + 4 * gout160[0];
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout149[0] + 2 * gout7[0] + 4 * gout153[0];
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * gout173[0] + 2 * gout181[1] + 4 * gout48[0];
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * gout196[1] + 2 * gout204[1] + 4 * gout158[1];
    ...
    std::cerr << "\rLUT212   ";
    Ciphertext gin212 = 1 * ct_op0 + 2 * gout162[0];
    ...
    std::cerr << "\rLUT213   ";
    Ciphertext gin213 = 1 * gout204[0] + 2 * gout200[1] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT214   ";
    Ciphertext gin214 = 1 * gout46[1] + 2 * gout128[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT215   ";
    Ciphertext gin215 = 1 * gout192[0] + 2 * gout172[0] + 4 * gout140[0];
    ...
    std::cerr << "\rLUT216   ";
    Ciphertext gin216 = 1 * gout105[1] + 2 * gout195[0] + 4 * gout169[0];
    ...
    std::cerr << "\rLUT217   ";
    Ciphertext gin217 = 1 * gout202[0] + 2 * ct_x9 + 4 * ct_y5;
    ...
    std::cerr << "\rLUT218   ";
    Ciphertext gin218 = 1 * gout128[1] + 2 * gout173[1] + 4 * gout16[0];
    ...
    std::cerr << "\rLUT219   ";
    Ciphertext gin219 = 1 * ct_x0 + 2 * ct_y0 + 4 * gout212[0];
    ...
    std::cerr << "\rLUT220   ";
    Ciphertext gin220 = 1 * gout172[1] + 2 * gout105[0] + 4 * gout188[0];
    ...
    std::cerr << "\rLUT221   ";
    Ciphertext gin221 = 1 * gout181[0] + 2 * gout111[0] + 4 * gout180[0];
    std::vector<Ciphertext> gout221 = ctx.eval_lut_amortized(&gin221, lut221);

    std::cerr << "\rFA222    ";
    Ciphertext gin222 = gout174[2] + 1 * ct_x8 + 2 * ct_x9 + 1 * ct_y8 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT223   ";
    Ciphertext gin223 = 1 * gout179[1] + 2 * gout201[1] + 4 * gout143[1];
    ...
    std::cerr << "\rLUT224   ";
    Ciphertext gin224 = 1 * gout168[0] + 2 * gout218[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT225   ";
    Ciphertext gin225 = 1 * gout195[1] + 2 * gout164[1] + 4 * gout189[0];
    ...
    std::cerr << "\rLUT226   ";
    Ciphertext gin226 = 1 * gout218[1] + 2 * gout210[0];
    std::vector<Ciphertext> gout226 = ctx.eval_lut_amortized(&gin226, lut226);

    std::cerr << "\rFA227    ";
    Ciphertext gin227 = gout199[2] + 1 * ct_x8 + 2 * ct_x9 + 1 * gout101[0] + 2 * gout96[0];
    std::vector<Ciphertext> gout227 = ctx.eval_lut_amortized(&gin227, decomp);
    ...
    std::cerr << "\rLUT228   ";
    Ciphertext gin228 = 1 * gout168[0] + 2 * gout218[0];
    ...
    std::cerr << "\rLUT229   ";
    Ciphertext gin229 = 1 * gout221[1] + 2 * gout206[0] + 4 * gout183[0];
    ...
    std::cerr << "\rLUT230   ";
    Ciphertext gin230 = 1 * gout215[0] + 2 * gout220[0] + 4 * gout198[0];
    ...
    std::cerr << "\rLUT232   ";
    Ciphertext gin232 = 1 * ct_x11 + 2 * ct_y4 + 4 * gout184[1];
    ...
    std::cerr << "\rLUT233   ";
    Ciphertext gin233 = 1 * gout217[0] + 2 * gout202[1] + 4 * gout170[0];
    ...
    std::cerr << "\rLUT234   ";
    Ciphertext gin234 = 1 * gout190[1] + 2 * gout207[0] + 4 * gout208[1];
    ...
    std::cerr << "\rLUT235   ";
    Ciphertext gin235 = 1 * gout191[0] + 2 * gout47[0];
    ...
    std::cerr << "\rLUT236   ";
    Ciphertext gin236 = 1 * gout157[1] + 2 * gout161[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT237   ";
    Ciphertext gin237 = 1 * gout236[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT238   ";
    Ciphertext gin238 = 1 * gout222[0] + 2 * gout227[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT239   ";
    Ciphertext gin239 = 1 * gout238[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT240   ";
    Ciphertext gin240 = 1 * gout156[1] + 2 * gout134[1] + 4 * gout194[0];
    ...
    std::cerr << "\rLUT241   ";
    Ciphertext gin241 = 1 * gout175[0] + 2 * gout194[1] + 4 * gout203[0];
    ...
    std::cerr << "\rLUT242   ";
    Ciphertext gin242 = 1 * gout206[1] + 2 * gout215[1] + 4 * gout187[1];
    ...
    std::cerr << "\rLUT243   ";
    Ciphertext gin243 = 1 * gout209[1] + 2 * gout167[1] + 4 * gout189[1];
    ...
    std::cerr << "\rLUT244   ";
    Ciphertext gin244 = 1 * gout217[1] + 2 * gout184[0] + 4 * gout201[0];
    ...
    std::cerr << "\rLUT245   ";
    Ciphertext gin245 = 1 * gout174[0] + 2 * gout199[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT246   ";
    Ciphertext gin246 = 1 * gout245[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT247   ";
    Ciphertext gin247 = 1 * gout222[1] + 2 * gout227[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT248   ";
    Ciphertext gin248 = 1 * gout17[0] + 2 * gout141[0] + 4 * gout231[0];
    std::vector<Ciphertext> gout248 = ctx.eval_lut_amortized(&gin248, lut248);

    std::cerr << "\rFA249    ";
    Ciphertext gin249 = gout227[2] + 1 * ct_x10 + 2 * ct_x11 + 1 * gout83[0] + 2 * gout121[0];
    std::vector<Ciphertext> gout249 = ctx.eval_lut_amortized(&gin249, decomp);
    ...
    std::cerr << "\rLUT250   ";
    Ciphertext gin250 = 1 * gout220[1] + 2 * gout216[0] + 4 * gout191[1];
    ...
    std::cerr << "\rLUT251   ";
    Ciphertext gin251 = 1 * gout247[0] + 2 * gout212[0];
    std::vector<Ciphertext> gout251 = ctx.eval_lut_amortized(&gin251, lut251);

    std::cerr << "\rFA252    ";
    Ciphertext gin252 = gout222[2] + 1 * ct_x10 + 2 * ct_x11 + 1 * ct_y10 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT253   ";
    Ciphertext gin253 = 1 * gout207[1] + 2 * gout223[1] + 4 * gout211[0];
    ...
    std::cerr << "\rLUT254   ";
    Ciphertext gin254 = 1 * gout176[0] + 2 * gout209[0] + 4 * gout169[1];
    ...
    std::cerr << "\rLUT255   ";
    Ciphertext gin255 = 1 * gout225[1] + 2 * gout190[0] + 4 * gout243[0];
    ...
    std::cerr << "\rLUT256   ";
    Ciphertext gin256 = 1 * gout254[1] + 2 * gout138[1];
    ...
    std::cerr << "\rLUT257   ";
    Ciphertext gin257 = 1 * gout248[0] + 2 * gout212[0];
    std::vector<Ciphertext> gout257 = ctx.eval_lut_amortized(&gin257, lut257);

    std::cerr << "\rFA258    ";
    Ciphertext gin258 = gout252[2] + 1 * ct_x12 + 2 * ct_x13 + 1 * ct_y12 + 2 * ct_y13;
    std::vector<Ciphertext> gout258 = ctx.eval_lut_amortized(&gin258, decomp);
    ...
    std::cerr << "\rLUT259   ";
    Ciphertext gin259 = 1 * gout197[1] + 2 * gout241[0] + 4 * gout208[0];
    ...
    std::cerr << "\rLUT260   ";
    Ciphertext gin260 = 1 * gout138[0] + 2 * gout197[0] + 4 * gout243[1];
    std::vector<Ciphertext> gout260 = ctx.eval_lut_amortized(&gin260, lut260);

    std::cerr << "\rFA261    ";
    Ciphertext gin261 = gout258[2] + 1 * ct_x14 + 2 * ct_x15 + 1 * ct_y14 + 2 * ct_y15;
    std::vector<Ciphertext> gout261 = ctx.eval_lut_amortized(&gin261, decomp);
    ...
    std::cerr << "\rLUT262   ";
    Ciphertext gin262 = 1 * gout242[1] + 2 * gout230[1] + 4 * gout187[0];
    std::vector<Ciphertext> gout262 = ctx.eval_lut_amortized(&gin262, lut262);

    std::cerr << "\rFA263    ";
    Ciphertext gin263 = gout249[2] + 1 * ct_x12 + 2 * ct_x13 + 1 * gout118[0] + 2 * gout114[0];
    std::vector<Ciphertext> gout263 = ctx.eval_lut_amortized(&gin263, decomp);
    ...
    std::cerr << "\rLUT264   ";
    Ciphertext gin264 = 1 * gout252[0] + 2 * gout249[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT265   ";
    Ciphertext gin265 = 1 * gout210[1] + 2 * gout221[0] + 4 * gout182[0];
    ...
    std::cerr << "\rLUT267   ";
    Ciphertext gin267 = 1 * gout244[1] + 2 * gout213[1] + 4 * gout223[0];
    ...
    std::cerr << "\rLUT268   ";
    Ciphertext gin268 = 1 * gout17[1] + 2 * gout141[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT269   ";
    Ciphertext gin269 = 1 * gout162[0] + 2 * gout231[0];
    ...
    std::cerr << "\rLUT270   ";
    Ciphertext gin270 = 1 * gout229[1] + 2 * gout242[0] + 4 * gout183[1];
    ...
    std::cerr << "\rLUT271   ";
    Ciphertext gin271 = 1 * gout270[1] + 2 * gout262[0];
    ...
    std::cerr << "\rLUT272   ";
    Ciphertext gin272 = 1 * gout228[0] + 2 * gout226[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT273   ";
    Ciphertext gin273 = 1 * gout154[1] + 2 * gout159[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT274   ";
    Ciphertext gin274 = 1 * gout154[0] + 2 * gout159[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT275   ";
    Ciphertext gin275 = 1 * gout240[0] + 2 * gout241[1] + 4 * gout211[1];
    ...
    std::cerr << "\rLUT276   ";
    Ciphertext gin276 = 1 * gout273[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT277   ";
    Ciphertext gin277 = 1 * gout157[0] + 2 * gout161[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT278   ";
    Ciphertext gin278 = 1 * gout228[0] + 2 * gout226[1];
    ...
    std::cerr << "\rLUT279   ";
    Ciphertext gin279 = 1 * gout277[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT280   ";
    Ciphertext gin280 = 1 * gout166[0] + 2 * gout233[0] + 4 * gout178[0];
    ...
    std::cerr << "\rLUT281   ";
    Ciphertext gin281 = 1 * gout275[1] + 2 * gout185[0];
    ...
    std::cerr << "\rLUT282   ";
    Ciphertext gin282 = 1 * gout240[1] + 2 * gout232[0] + 4 * gout200[0];
    ...
    std::cerr << "\rLUT283   ";
    Ciphertext gin283 = 1 * gout234[1] + 2 * gout253[0] + 4 * gout259[1];
    ...
    std::cerr << "\rLUT284   ";
    Ciphertext gin284 = 1 * gout174[1] + 2 * gout199[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT285   ";
    Ciphertext gin285 = 1 * gout267[1] + 2 * gout244[0] + 4 * gout213[0];
    ...
    std::cerr << "\rLUT286   ";
    Ciphertext gin286 = 1 * gout216[1] + 2 * gout225[0] + 4 * gout254[0];
    ...
    std::cerr << "\rLUT287   ";
    Ciphertext gin287 = 1 * gout252[1] + 2 * gout249[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT288   ";
    Ciphertext gin288 = 1 * gout230[0] + 2 * gout250[0] + 4 * gout205[0];
    ...
    std::cerr << "\rLUT289   ";
    Ciphertext gin289 = 1 * gout265[1] + 2 * gout229[0];
    ...
    std::cerr << "\rLUT290   ";
    Ciphertext gin290 = 1 * gout258[0] + 2 * gout263[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT291   ";
    Ciphertext gin291 = 1 * gout286[0] + 2 * gout255[1] + 4 * gout256[1];
    ...
    std::cerr << "\rLUT292   ";
    Ciphertext gin292 = 1 * gout290[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT293   ";
    Ciphertext gin293 = 1 * gout259[0] + 2 * gout171[0];
    ...
    std::cerr << "\rLUT294   ";
    Ciphertext gin294 = 1 * gout257[0] + 2 * gout219[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT295   ";
    Ciphertext gin295 = 1 * gout255[0] + 2 * gout234[0] + 4 * gout260[1];
    ...
    std::cerr << "\rLUT296   ";
    Ciphertext gin296 = 1 * gout267[0] + 2 * gout275[0] + 4 * gout253[1];
    ...
    std::cerr << "\rLUT297   ";
    Ciphertext gin297 = 1 * gout291[1] + 2 * gout295[1] + 4 * gout256[0];
    std::vector<Ciphertext> gout297 = ctx.eval_lut_amortized(&gin297, lut297);

    std::cerr << "\rFA298    ";
    Ciphertext gin298 = gout263[2] + 1 * ct_x14 + 2 * ct_x15 + 1 * gout103[0] + 2 * gout72[0];
    std::vector<Ciphertext> gout298 = ctx.eval_lut_amortized(&gin298, decomp);
    ...
    std::cerr << "\rLUT299   ";
    Ciphertext gin299 = 1 * gout258[1] + 2 * gout263[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT300   ";
    Ciphertext gin300 = 1 * gout299[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT301   ";
    Ciphertext gin301 = 1 * gout295[0] + 2 * gout283[0] + 4 * gout260[0];
    ...
    std::cerr << "\rLUT302   ";
    Ciphertext gin302 = 1 * gout226[0] + 2 * gout265[0];
    ...
    std::cerr << "\rLUT303   ";
    Ciphertext gin303 = 1 * gout268[0] + 2 * gout46[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT304   ";
    Ciphertext gin304 = 1 * gout303[0] + 2 * gout269[0];
    ...
    std::cerr << "\rLUT305   ";
    Ciphertext gin305 = 1 * gout280[0] + 2 * gout285[0] + 4 * gout282[0];
    ...
    std::cerr << "\rLUT306   ";
    Ciphertext gin306 = 1 * gout274[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT307   ";
    Ciphertext gin307 = 1 * gout224[0] + 2 * gout276[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT308   ";
    Ciphertext gin308 = 1 * gout305[0] + 2 * gout296[0] + 4 * gout281[0];
    ...
    std::cerr << "\rLUT309   ";
    Ciphertext gin309 = 1 * gout261[0] + 2 * gout298[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT310   ";
    Ciphertext gin310 = 1 * gout309[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT311   ";
    Ciphertext gin311 = 1 * gout272[0] + 2 * gout279[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT312   ";
    Ciphertext gin312 = 1 * gout297[1] + 2 * gout301[1];
    ...
    std::cerr << "\rLUT313   ";
    Ciphertext gin313 = 1 * gout287[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT314   ";
    Ciphertext gin314 = 1 * gout278[0] + 2 * gout302[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT315   ";
    Ciphertext gin315 = 1 * gout250[1] + 2 * gout286[1] + 4 * gout235[0];
    ...
    std::cerr << "\rLUT316   ";
    Ciphertext gin316 = 1 * gout289[1] + 2 * gout270[0];
    ...
    std::cerr << "\rLUT317   ";
    Ciphertext gin317 = 1 * gout314[0] + 2 * gout237[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT318   ";
    Ciphertext gin318 = 1 * gout296[1] + 2 * gout293[0] + 4 * gout283[1];
    ...
    std::cerr << "\rLUT319   ";
    Ciphertext gin319 = 1 * gout262[1] + 2 * gout288[0];
    ...
    std::cerr << "\rLUT320   ";
    Ciphertext gin320 = 1 * gout261[1] + 2 * gout298[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT321   ";
    Ciphertext gin321 = 1 * gout320[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT322   ";
    Ciphertext gin322 = 1 * gout278[0] + 2 * gout302[1];
    ...
    std::cerr << "\rLUT323   ";
    Ciphertext gin323 = 1 * gout302[0] + 2 * gout289[0];
    ...
    std::cerr << "\rLUT324   ";
    Ciphertext gin324 = 1 * gout316[0] + 2 * gout271[0];
    ...
    std::cerr << "\rLUT325   ";
    Ciphertext gin325 = 1 * gout271[1] + 2 * gout319[1];
    ...
    std::cerr << "\rLUT326   ";
    Ciphertext gin326 = 1 * gout214[0] + 2 * gout306[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT327   ";
    Ciphertext gin327 = 1 * gout288[1] + 2 * gout315[0] + 4 * gout205[1];
    ...
    std::cerr << "\rLUT328   ";
    Ciphertext gin328 = 1 * gout308[0] + 2 * gout318[0];
    ...
    std::cerr << "\rLUT329   ";
    Ciphertext gin329 = 1 * gout319[0] + 2 * gout327[0];
    ...
    std::cerr << "\rLUT330   ";
    Ciphertext gin330 = 1 * gout315[1] + 2 * gout291[0] + 4 * gout235[1];
    ...
    std::cerr << "\rLUT331   ";
    Ciphertext gin331 = 1 * gout323[0] + 2 * gout322[0] + 4 * gout323[1];
    ...
    std::cerr << "\rLUT332   ";
    Ciphertext gin332 = 1 * gout323[0] + 2 * gout322[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT333   ";
    Ciphertext gin333 = 1 * gout301[0] + 2 * gout318[1];
    ...
    std::cerr << "\rLUT334   ";
    Ciphertext gin334 = 1 * gout323[0] + 2 * gout322[0] + 4 * gout316[1];
    ...
    std::cerr << "\rLUT335   ";
    Ciphertext gin335 = 1 * gout332[0] + 2 * gout246[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT336   ";
    Ciphertext gin336 = 1 * gout323[1] + 2 * gout316[1];
    ...
    std::cerr << "\rLUT337   ";
    Ciphertext gin337 = 1 * gout331[0] + 2 * gout316[1];
    ...
    std::cerr << "\rLUT338   ";
    Ciphertext gin338 = 1 * gout325[0] + 2 * gout329[1];
    ...
    std::cerr << "\rLUT339   ";
    Ciphertext gin339 = 1 * gout330[1] + 2 * gout297[0];
    ...
    std::cerr << "\rLUT340   ";
    Ciphertext gin340 = 1 * gout324[0] + 2 * gout334[0];
    ...
    std::cerr << "\rLUT341   ";
    Ciphertext gin341 = 1 * gout324[1] + 2 * gout325[1];
    ...
    std::cerr << "\rLUT342   ";
    Ciphertext gin342 = 1 * gout312[1] + 2 * gout333[1];
    ...
    std::cerr << "\rLUT343   ";
    Ciphertext gin343 = 1 * gout340[0] + 2 * gout341[0];
    ...
    std::cerr << "\rLUT344   ";
    Ciphertext gin344 = 1 * gout327[1] + 2 * gout330[0];
    ...
    std::cerr << "\rLUT345   ";
    Ciphertext gin345 = 1 * gout339[1] + 2 * gout312[0];
    ...
    std::cerr << "\rLUT346   ";
    Ciphertext gin346 = 1 * gout328[0] + 2 * gout333[0] + 4 * gout293[1];
    ...
    std::cerr << "\rLUT347   ";
    Ciphertext gin347 = 1 * gout336[0] + 2 * gout324[0];
    ...
    std::cerr << "\rLUT348   ";
    Ciphertext gin348 = 1 * gout347[1] + 2 * gout334[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT349   ";
    Ciphertext gin349 = 1 * gout284[0] + 2 * gout337[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT350   ";
    Ciphertext gin350 = 1 * gout329[0] + 2 * gout344[0];
    ...
    std::cerr << "\rLUT351   ";
    Ciphertext gin351 = 1 * gout348[0] + 2 * gout239[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT352   ";
    Ciphertext gin352 = 1 * gout269[0] + 2 * gout349[0];
    ...
    std::cerr << "\rLUT353   ";
    Ciphertext gin353 = 1 * gout347[0] + 2 * gout340[0];
    ...
    std::cerr << "\rLUT354   ";
    Ciphertext gin354 = 1 * gout344[1] + 2 * gout339[0];
    ...
    std::cerr << "\rLUT355   ";
    Ciphertext gin355 = 1 * gout324[1] + 2 * gout325[1] + 4 * gout347[0];
    ...
    std::cerr << "\rLUT356   ";
    Ciphertext gin356 = 1 * gout343[0] + 2 * gout355[0] + 4 * gout338[1];
    ...
    std::cerr << "\rLUT357   ";
    Ciphertext gin357 = 1 * gout353[0] + 2 * gout341[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT358   ";
    Ciphertext gin358 = 1 * gout357[0] + 2 * gout251[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT359   ";
    Ciphertext gin359 = 1 * gout343[0] + 2 * gout355[0];
    ...
    std::cerr << "\rLUT360   ";
    Ciphertext gin360 = 1 * gout359[0] + 2 * gout338[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT361   ";
    Ciphertext gin361 = 1 * gout356[0] + 2 * gout338[0] + 4 * gout350[0];
    ...
    std::cerr << "\rLUT362   ";
    Ciphertext gin362 = 1 * gout360[0] + 2 * gout266[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT363   ";
    Ciphertext gin363 = 1 * gout361[1] + 2 * gout350[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT364   ";
    Ciphertext gin364 = 1 * gout363[0] + 2 * gout313[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT365   ";
    Ciphertext gin365 = 1 * gout350[1] + 2 * gout361[0] + 4 * gout354[0];
    ...
    std::cerr << "\rLUT366   ";
    Ciphertext gin366 = 1 * gout365[0] + 2 * gout354[1] + 4 * gout345[0];
    ...
    std::cerr << "\rLUT367   ";
    Ciphertext gin367 = 1 * gout345[1] + 2 * gout366[0];
    ...
    std::cerr << "\rLUT368   ";
    Ciphertext gin368 = 1 * gout367[0] + 2 * gout342[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT369   ";
    Ciphertext gin369 = 1 * gout368[0] + 2 * gout310[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT370   ";
    Ciphertext gin370 = 1 * gout345[1] + 2 * gout366[0] + 4 * gout342[0];
    ...
    std::cerr << "\rLUT371   ";
    Ciphertext gin371 = 1 * gout312[1] + 2 * gout333[1] + 4 * gout370[0];
    ...
    std::cerr << "\rLUT372   ";
    Ciphertext gin372 = 1 * gout371[0] + 2 * gout346[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT373   ";
    Ciphertext gin373 = 1 * gout365[1] + 2 * gout354[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT374   ";
    Ciphertext gin374 = 1 * gout373[0] + 2 * gout292[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT375   ";
    Ciphertext gin375 = 1 * gout365[0] + 2 * gout354[1];
    ...
    std::cerr << "\rLUT376   ";
    Ciphertext gin376 = 1 * gout375[0] + 2 * gout345[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT377   ";
    Ciphertext gin377 = 1 * gout376[0] + 2 * gout300[0] + 4 * gout269[0];
    ...
    std::cerr << "\rLUT378   ";
    Ciphertext gin378 = 1 * gout372[0] + 2 * gout321[0] + 4 * gout269[0];
    std::vector<Ciphertext> gout378 = ctx.eval_lut_amortized(&gin378, lut378);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout294[0])); /* out0 */
    test_out.push_back(ctx.decrypt(&gout304[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout326[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout307[0])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout311[0])); /* out4 */
    test_out.push_back(ctx.decrypt(&gout317[0])); /* out5 */
    test_out.push_back(ctx.decrypt(&gout335[0])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout352[0])); /* out7 */
    test_out.push_back(ctx.decrypt(&gout351[0])); /* out8 */
    test_out.push_back(ctx.decrypt(&gout358[0])); /* out9 */
    test_out.push_back(ctx.decrypt(&gout362[0])); /* out10 */
    test_out.push_back(ctx.decrypt(&gout364[0])); /* out11 */
    test_out.push_back(ctx.decrypt(&gout374[0])); /* out12 */
    test_out.push_back(ctx.decrypt(&gout377[0])); /* out13 */
    test_out.push_back(ctx.decrypt(&gout369[0])); /* out14 */
    test_out.push_back(ctx.decrypt(&gout378[0])); /* out15 */
    return test_out;
}

static void
BM_calculator_lut3fa(benchmark::State& state)
{
    FHEContext ctx;
    ...
    for (auto _ : state) {
        test_calculator_lut3fa(ctx);
    }
}

BENCHMARK(BM_calculator_lut3fa)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
