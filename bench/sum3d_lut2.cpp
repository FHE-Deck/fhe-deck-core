...
test_sum3d_lut2(FHEContext& ctx, std::vector<uint64_t> out = { 0 })
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_out51 + 2 * ct_out59;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_out147 + 2 * ct_out155;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_out76 + 2 * ct_out84;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_out125 + 2 * ct_out133;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_out26 + 2 * ct_out34;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_out48 + 2 * ct_out56;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_out169 + 2 * ct_out177;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_out31 + 2 * ct_out39;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_out24 + 2 * ct_out32;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_out5 + 2 * ct_out13;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_out6 + 2 * ct_out14;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout0[0] + 2 * ct_out67;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_out146 + 2 * ct_out154;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout1[0] + 2 * ct_out163;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_out171 + 2 * ct_out179;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout8[0] + 2 * ct_out40;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_out97 + 2 * ct_out105;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_out73 + 2 * ct_out81;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_out78 + 2 * ct_out86;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_out100 + 2 * ct_out108;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_out127 + 2 * ct_out135;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_out126 + 2 * ct_out134;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_out120 + 2 * ct_out128;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_out170 + 2 * ct_out178;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * gout13[1] + 2 * gout1[1];
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_out173 + 2 * ct_out181;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_out96 + 2 * ct_out104;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_out124 + 2 * ct_out132;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout15[1] + 2 * gout8[1];
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_out77 + 2 * ct_out85;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout2[1] + 2 * ct_out92;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout6[1] + 2 * ct_out185;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout22[0] + 2 * ct_out136;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * ct_out3 + 2 * ct_out11;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_out72 + 2 * ct_out80;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_out121 + 2 * ct_out129;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout11[1] + 2 * gout0[1];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * ct_out148 + 2 * ct_out156;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * ct_out103 + 2 * ct_out111;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout3[0] + 2 * ct_out141;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_out29 + 2 * ct_out37;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_out151 + 2 * ct_out159;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_out30 + 2 * ct_out38;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * ct_out150 + 2 * ct_out158;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * ct_out1 + 2 * ct_out9;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * ct_out52 + 2 * ct_out60;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * ct_out101 + 2 * ct_out109;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout38[1] + 2 * ct_out119;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * ct_out2 + 2 * ct_out10;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_out123 + 2 * ct_out131;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout26[1] + 2 * ct_out112;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout18[0] + 2 * ct_out94;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout4[1] + 2 * ct_out42;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout14[1] + 2 * ct_out187;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * ct_out75 + 2 * ct_out83;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout48[0] + 2 * ct_out18;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout54[0] + 2 * ct_out91;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_out174 + 2 * ct_out182;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * ct_out54 + 2 * ct_out62;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout10[0] + 2 * ct_out22;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout31[0] + 2 * gout6[0];
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout27[1] + 2 * ct_out140;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout39[0] + 2 * gout3[1];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout51[0] + 2 * gout18[1];
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * ct_out175 + 2 * ct_out183;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * ct_out50 + 2 * ct_out58;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout23[0] + 2 * ct_out186;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * ct_out122 + 2 * ct_out130;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * ct_out74 + 2 * ct_out82;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * ct_out98 + 2 * ct_out106;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout20[0] + 2 * ct_out143;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * ct_out25 + 2 * ct_out33;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * ct_out149 + 2 * ct_out157;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * ct_out49 + 2 * ct_out57;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * ct_out168 + 2 * ct_out176;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout37[0] + 2 * ct_out164;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout69[0] + 2 * ct_out114;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * ct_out28 + 2 * ct_out36;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * ct_out79 + 2 * ct_out87;
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout70[1] + 2 * gout20[1];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout21[0] + 2 * ct_out142;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout16[0] + 2 * ct_out113;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout25[0] + 2 * ct_out189;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * ct_out144 + 2 * ct_out152;
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout7[1] + 2 * ct_out47;
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout29[0] + 2 * ct_out93;
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout49[1] + 2 * ct_out139;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout57[0] + 2 * ct_out190;
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout75[0] + 2 * gout37[1];
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout47[1] + 2 * gout38[0];
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * ct_out172 + 2 * ct_out180;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout19[1] + 2 * ct_out116;
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout84[0] + 2 * gout7[0];
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout52[0] + 2 * gout4[0];
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * ct_out4 + 2 * ct_out12;
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout55[0] + 2 * gout48[1];
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout83[1] + 2 * ct_out160;
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * ct_out102 + 2 * ct_out110;
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * ct_out0 + 2 * ct_out8;
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * ct_out27 + 2 * ct_out35;
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout85[1] + 2 * gout29[1];
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * gout35[0] + 2 * ct_out137;
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * gout40[1] + 2 * ct_out45;
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * gout61[1] + 2 * gout27[0];
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * ct_out55 + 2 * ct_out63;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * ct_out99 + 2 * ct_out107;
    ...
    std::cerr << "\rLUT106   ";
    Ciphertext gin106 = 1 * gout44[1] + 2 * ct_out17;
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * ct_out145 + 2 * ct_out153;
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * ct_out53 + 2 * ct_out61;
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * ct_out7 + 2 * ct_out15;
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * gout9[1] + 2 * ct_out21;
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * gout17[1] + 2 * ct_out89;
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * gout43[0] + 2 * ct_out166;
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * gout99[0] + 2 * ct_out43;
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * gout32[1] + 2 * gout22[1];
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * gout50[0] + 2 * gout26[0];
    ...
    std::cerr << "\rLUT116   ";
    Ciphertext gin116 = 1 * gout5[1] + 2 * ct_out64;
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout46[0] + 2 * ct_out117;
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * gout12[0] + 2 * ct_out162;
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout33[1] + 2 * ct_out19;
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * gout80[1] + 2 * gout21[1];
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout86[1] + 2 * gout49[0];
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * gout74[0] + 2 * ct_out184;
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * gout115[0] + 2 * gout81[1];
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * gout104[1] + 2 * ct_out71;
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * gout58[1] + 2 * ct_out70;
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * gout96[1] + 2 * gout83[0];
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout34[1] + 2 * ct_out88;
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout30[0] + 2 * gout2[0];
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * gout64[0] + 2 * ct_out191;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout87[0] + 2 * gout57[1];
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * gout107[0] + 2 * ct_out161;
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout42[1] + 2 * ct_out46;
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * gout53[0] + 2 * gout14[0];
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * gout112[1] + 2 * gout43[1];
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * gout122[0] + 2 * gout74[1];
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout116[1] + 2 * gout127[0];
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * gout60[0] + 2 * gout66[1];
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout78[0] + 2 * ct_out95;
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * gout45[0] + 2 * ct_out68;
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout50[1] + 2 * gout32[0];
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout127[1] + 2 * gout34[0];
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * gout94[1] + 2 * ct_out20;
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * gout76[1] + 2 * gout69[1];
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout125[1] + 2 * gout58[0];
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout121[0] + 2 * gout75[1];
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * gout116[0] + 2 * gout5[0];
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout59[1] + 2 * gout10[1];
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * gout72[1] + 2 * ct_out165;
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * gout95[0] + 2 * gout113[1];
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout56[0] + 2 * gout54[1];
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout67[1] + 2 * ct_out138;
    ...
    std::cerr << "\rLUT152   ";
    Ciphertext gin152 = 1 * gout119[0] + 2 * gout33[0];
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout73[1] + 2 * ct_out65;
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout77[1] + 2 * ct_out44;
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * gout65[0] + 2 * ct_out66;
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout41[0] + 2 * ct_out167;
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout136[0] + 2 * gout15[0];
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout66[0] + 2 * gout23[1];
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * gout71[0] + 2 * ct_out41;
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout118[0] + 2 * gout12[1];
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout68[1] + 2 * ct_out90;
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout148[1] + 2 * gout72[0];
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout108[0] + 2 * ct_out69;
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout109[0] + 2 * ct_out23;
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout132[0] + 2 * gout42[0];
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout62[0] + 2 * gout112[0];
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * gout113[0] + 2 * gout99[1];
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout101[0] + 2 * gout35[1];
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout81[0] + 2 * gout16[1];
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * gout141[0] + 2 * gout136[1];
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout152[0] + 2 * gout154[1];
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout117[1] + 2 * gout46[1];
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout98[0] + 2 * ct_out16;
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout97[1] + 2 * ct_out118;
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout131[1] + 2 * gout107[1];
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout114[0] + 2 * gout131[0];
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * gout123[0] + 2 * gout101[1];
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout91[0] + 2 * gout19[0];
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout144[0] + 2 * gout124[0];
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout110[1] + 2 * gout9[0];
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout140[1] + 2 * gout96[0];
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * gout135[0] + 2 * gout31[1];
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout155[0] + 2 * gout65[1];
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout82[1] + 2 * gout25[1];
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout159[1] + 2 * gout71[1];
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout90[1] + 2 * ct_out188;
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout186[1] + 2 * gout90[0];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout102[0] + 2 * gout40[0];
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout178[0] + 2 * gout117[0];
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout183[0] + 2 * gout11[0];
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout169[0] + 2 * gout76[0];
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout180[0] + 2 * gout132[1];
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * gout103[0] + 2 * gout148[0];
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout105[0] + 2 * ct_out115;
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout158[0] + 2 * gout53[1];
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout153[0] + 2 * gout73[0];
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout143[0] + 2 * gout194[1];
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout156[1] + 2 * gout41[1];
    ...
    std::cerr << "\rLUT199   ";
    Ciphertext gin199 = 1 * gout106[0] + 2 * gout44[0];
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout24[0] + 2 * gout145[0];
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout163[1] + 2 * gout108[1];
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout129[1] + 2 * gout64[1];
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout200[1] + 2 * gout145[1];
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * gout182[0] + 2 * gout106[1];
    ...
    std::cerr << "\rLUT205   ";
    Ciphertext gin205 = 1 * gout164[1] + 2 * gout109[1];
    ...
    std::cerr << "\rLUT206   ";
    Ciphertext gin206 = 1 * gout137[1] + 2 * gout55[1];
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout196[0] + 2 * gout155[1];
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * gout142[0] + 2 * gout94[0];
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout177[0] + 2 * gout140[0];
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * gout111[1] + 2 * gout17[0];
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * gout161[1] + 2 * gout68[0];
    ...
    std::cerr << "\rLUT212   ";
    Ciphertext gin212 = 1 * gout79[0] + 2 * gout198[0];
    ...
    std::cerr << "\rLUT213   ";
    Ciphertext gin213 = 1 * gout130[0] + 2 * gout129[0];
    ...
    std::cerr << "\rLUT214   ";
    Ciphertext gin214 = 1 * gout184[0] + 2 * gout87[1];
    ...
    std::cerr << "\rLUT215   ";
    Ciphertext gin215 = 1 * gout124[1] + 2 * gout104[0];
    ...
    std::cerr << "\rLUT216   ";
    Ciphertext gin216 = 1 * gout189[0] + 2 * gout39[1];
    ...
    std::cerr << "\rLUT217   ";
    Ciphertext gin217 = 1 * gout174[0] + 2 * gout97[0];
    ...
    std::cerr << "\rLUT218   ";
    Ciphertext gin218 = 1 * gout194[0] + 2 * gout105[1];
    ...
    std::cerr << "\rLUT219   ";
    Ciphertext gin219 = 1 * gout154[0] + 2 * gout77[0];
    ...
    std::cerr << "\rLUT220   ";
    Ciphertext gin220 = 1 * gout208[0] + 2 * gout102[1];
    ...
    std::cerr << "\rLUT221   ";
    Ciphertext gin221 = 1 * gout36[0] + 2 * gout139[1];
    ...
    std::cerr << "\rLUT222   ";
    Ciphertext gin222 = 1 * gout218[0] + 2 * gout91[1];
    ...
    std::cerr << "\rLUT223   ";
    Ciphertext gin223 = 1 * gout138[1] + 2 * gout78[1];
    ...
    std::cerr << "\rLUT224   ";
    Ciphertext gin224 = 1 * gout173[0] + 2 * gout98[1];
    ...
    std::cerr << "\rLUT225   ";
    Ciphertext gin225 = 1 * gout199[0] + 2 * gout52[1];
    ...
    std::cerr << "\rLUT226   ";
    Ciphertext gin226 = 1 * gout179[1] + 2 * gout138[0];
    ...
    std::cerr << "\rLUT227   ";
    Ciphertext gin227 = 1 * gout149[1] + 2 * gout93[0];
    ...
    std::cerr << "\rLUT228   ";
    Ciphertext gin228 = 1 * gout139[0] + 2 * gout45[1];
    ...
    std::cerr << "\rLUT229   ";
    Ciphertext gin229 = 1 * gout147[0] + 2 * gout84[1];
    ...
    std::cerr << "\rLUT230   ";
    Ciphertext gin230 = 1 * gout221[1] + 2 * gout30[1];
    ...
    std::cerr << "\rLUT231   ";
    Ciphertext gin231 = 1 * gout162[0] + 2 * gout166[1];
    ...
    std::cerr << "\rLUT232   ";
    Ciphertext gin232 = 1 * gout220[1] + 2 * gout219[0];
    ...
    std::cerr << "\rLUT233   ";
    Ciphertext gin233 = 1 * gout191[1] + 2 * gout151[1];
    ...
    std::cerr << "\rLUT234   ";
    Ciphertext gin234 = 1 * gout227[0] + 2 * gout149[0];
    ...
    std::cerr << "\rLUT235   ";
    Ciphertext gin235 = 1 * gout230[1] + 2 * gout221[0];
    ...
    std::cerr << "\rLUT236   ";
    Ciphertext gin236 = 1 * gout168[0] + 2 * gout118[1];
    ...
    std::cerr << "\rLUT237   ";
    Ciphertext gin237 = 1 * gout201[0] + 2 * gout125[0];
    ...
    std::cerr << "\rLUT238   ";
    Ciphertext gin238 = 1 * gout197[1] + 2 * gout86[0];
    ...
    std::cerr << "\rLUT239   ";
    Ciphertext gin239 = 1 * gout231[0] + 2 * gout166[0];
    ...
    std::cerr << "\rLUT240   ";
    Ciphertext gin240 = 1 * gout187[0] + 2 * gout82[0];
    ...
    std::cerr << "\rLUT241   ";
    Ciphertext gin241 = 1 * gout151[0] + 2 * gout67[0];
    ...
    std::cerr << "\rLUT242   ";
    Ciphertext gin242 = 1 * gout126[0] + 2 * gout176[1];
    ...
    std::cerr << "\rLUT243   ";
    Ciphertext gin243 = 1 * gout172[0] + 2 * gout174[1];
    ...
    std::cerr << "\rLUT244   ";
    Ciphertext gin244 = 1 * gout146[0] + 2 * gout153[1];
    ...
    std::cerr << "\rLUT245   ";
    Ciphertext gin245 = 1 * gout244[1] + 2 * gout111[0];
    ...
    std::cerr << "\rLUT246   ";
    Ciphertext gin246 = 1 * gout177[1] + 2 * gout123[1];
    ...
    std::cerr << "\rLUT247   ";
    Ciphertext gin247 = 1 * gout207[1] + 2 * gout161[0];
    ...
    std::cerr << "\rLUT248   ";
    Ciphertext gin248 = 1 * gout224[0] + 2 * gout159[0];
    ...
    std::cerr << "\rLUT249   ";
    Ciphertext gin249 = 1 * gout120[0] + 2 * gout156[0];
    ...
    std::cerr << "\rLUT250   ";
    Ciphertext gin250 = 1 * gout217[0] + 2 * gout47[0];
    ...
    std::cerr << "\rLUT251   ";
    Ciphertext gin251 = 1 * gout233[0] + 2 * gout191[0];
    ...
    std::cerr << "\rLUT252   ";
    Ciphertext gin252 = 1 * gout216[1] + 2 * gout189[1];
    ...
    std::cerr << "\rLUT253   ";
    Ciphertext gin253 = 1 * gout241[0] + 2 * gout13[0];
    ...
    std::cerr << "\rLUT254   ";
    Ciphertext gin254 = 1 * gout209[0] + 2 * gout242[1];
    ...
    std::cerr << "\rLUT255   ";
    Ciphertext gin255 = 1 * gout171[1] + 2 * gout167[0];
    ...
    std::cerr << "\rLUT256   ";
    Ciphertext gin256 = 1 * gout122[1] + 2 * gout173[1];
    ...
    std::cerr << "\rLUT257   ";
    Ciphertext gin257 = 1 * gout213[1] + 2 * gout164[0];
    ...
    std::cerr << "\rLUT258   ";
    Ciphertext gin258 = 1 * gout192[1] + 2 * gout188[0];
    ...
    std::cerr << "\rLUT259   ";
    Ciphertext gin259 = 1 * gout206[1] + 2 * gout137[0];
    ...
    std::cerr << "\rLUT260   ";
    Ciphertext gin260 = 1 * gout254[1] + 2 * gout209[1];
    ...
    std::cerr << "\rLUT261   ";
    Ciphertext gin261 = 1 * gout133[0] + 2 * gout186[0];
    ...
    std::cerr << "\rLUT262   ";
    Ciphertext gin262 = 1 * gout243[0] + 2 * gout80[0];
    ...
    std::cerr << "\rLUT263   ";
    Ciphertext gin263 = 1 * gout228[0] + 2 * gout163[0];
    ...
    std::cerr << "\rLUT264   ";
    Ciphertext gin264 = 1 * gout195[0] + 2 * gout119[1];
    ...
    std::cerr << "\rLUT265   ";
    Ciphertext gin265 = 1 * gout88[0] + 2 * gout193[0];
    ...
    std::cerr << "\rLUT266   ";
    Ciphertext gin266 = 1 * gout252[0] + 2 * gout262[1];
    ...
    std::cerr << "\rLUT267   ";
    Ciphertext gin267 = 1 * gout250[0] + 2 * gout70[0];
    ...
    std::cerr << "\rLUT268   ";
    Ciphertext gin268 = 1 * gout267[0] + 2 * gout250[1];
    ...
    std::cerr << "\rLUT269   ";
    Ciphertext gin269 = 1 * gout190[0] + 2 * gout56[1];
    ...
    std::cerr << "\rLUT270   ";
    Ciphertext gin270 = 1 * gout204[1] + 2 * gout182[1];
    ...
    std::cerr << "\rLUT271   ";
    Ciphertext gin271 = 1 * gout225[0] + 2 * gout185[0];
    ...
    std::cerr << "\rLUT272   ";
    Ciphertext gin272 = 1 * gout263[1] + 2 * gout85[0];
    ...
    std::cerr << "\rLUT273   ";
    Ciphertext gin273 = 1 * gout204[0] + 2 * gout256[0];
    ...
    std::cerr << "\rLUT274   ";
    Ciphertext gin274 = 1 * gout242[0] + 2 * gout176[0];
    ...
    std::cerr << "\rLUT275   ";
    Ciphertext gin275 = 1 * gout229[0] + 2 * gout165[0];
    ...
    std::cerr << "\rLUT276   ";
    Ciphertext gin276 = 1 * gout232[1] + 2 * gout220[0];
    ...
    std::cerr << "\rLUT277   ";
    Ciphertext gin277 = 1 * gout246[0] + 2 * gout233[1];
    ...
    std::cerr << "\rLUT278   ";
    Ciphertext gin278 = 1 * gout257[0] + 2 * gout213[0];
    ...
    std::cerr << "\rLUT279   ";
    Ciphertext gin279 = 1 * gout240[1] + 2 * gout110[0];
    ...
    std::cerr << "\rLUT280   ";
    Ciphertext gin280 = 1 * gout239[0] + 2 * gout257[1];
    ...
    std::cerr << "\rLUT281   ";
    Ciphertext gin281 = 1 * gout247[1] + 2 * gout207[0];
    ...
    std::cerr << "\rLUT282   ";
    Ciphertext gin282 = 1 * gout175[0] + 2 * gout236[1];
    ...
    std::cerr << "\rLUT283   ";
    Ciphertext gin283 = 1 * gout222[1] + 2 * gout61[0];
    ...
    std::cerr << "\rLUT284   ";
    Ciphertext gin284 = 1 * gout254[0] + 2 * gout181[0];
    ...
    std::cerr << "\rLUT285   ";
    Ciphertext gin285 = 1 * gout234[0] + 2 * gout255[0];
    ...
    std::cerr << "\rLUT286   ";
    Ciphertext gin286 = 1 * gout251[0] + 2 * gout238[1];
    ...
    std::cerr << "\rLUT287   ";
    Ciphertext gin287 = 1 * gout214[0] + 2 * gout59[0];
    ...
    std::cerr << "\rLUT288   ";
    Ciphertext gin288 = 1 * gout203[0] + 2 * gout279[1];
    ...
    std::cerr << "\rLUT289   ";
    Ciphertext gin289 = 1 * gout205[0] + 2 * gout92[0];
    ...
    std::cerr << "\rLUT290   ";
    Ciphertext gin290 = 1 * gout238[0] + 2 * gout197[0];
    ...
    std::cerr << "\rLUT291   ";
    Ciphertext gin291 = 1 * gout226[1] + 2 * gout179[0];
    ...
    std::cerr << "\rLUT292   ";
    Ciphertext gin292 = 1 * gout272[1] + 2 * gout263[0];
    ...
    std::cerr << "\rLUT293   ";
    Ciphertext gin293 = 1 * gout245[1] + 2 * gout244[0];
    ...
    std::cerr << "\rLUT294   ";
    Ciphertext gin294 = 1 * gout160[0] + 2 * gout253[1];
    ...
    std::cerr << "\rLUT295   ";
    Ciphertext gin295 = 1 * gout275[1] + 2 * gout229[1];
    ...
    std::cerr << "\rLUT296   ";
    Ciphertext gin296 = 1 * gout294[1] + 2 * gout253[0];
    ...
    std::cerr << "\rLUT297   ";
    Ciphertext gin297 = 1 * gout255[1] + 2 * gout171[0];
    ...
    std::cerr << "\rLUT298   ";
    Ciphertext gin298 = 1 * gout237[0] + 2 * gout51[1];
    ...
    std::cerr << "\rLUT299   ";
    Ciphertext gin299 = 1 * gout248[1] + 2 * gout28[0];
    ...
    std::cerr << "\rLUT300   ";
    Ciphertext gin300 = 1 * gout181[1] + 2 * gout256[1];
    ...
    std::cerr << "\rLUT301   ";
    Ciphertext gin301 = 1 * gout262[0] + 2 * gout243[1];
    ...
    std::cerr << "\rLUT302   ";
    Ciphertext gin302 = 1 * gout261[1] + 2 * gout142[1];
    ...
    std::cerr << "\rLUT303   ";
    Ciphertext gin303 = 1 * gout274[0] + 2 * gout206[0];
    ...
    std::cerr << "\rLUT304   ";
    Ciphertext gin304 = 1 * gout276[0] + 2 * gout258[1];
    ...
    std::cerr << "\rLUT305   ";
    Ciphertext gin305 = 1 * gout277[1] + 2 * gout282[0];
    ...
    std::cerr << "\rLUT306   ";
    Ciphertext gin306 = 1 * gout287[0] + 2 * gout214[1];
    ...
    std::cerr << "\rLUT307   ";
    Ciphertext gin307 = 1 * gout264[0] + 2 * gout195[1];
    ...
    std::cerr << "\rLUT308   ";
    Ciphertext gin308 = 1 * gout268[0] + 2 * gout89[0];
    ...
    std::cerr << "\rLUT309   ";
    Ciphertext gin309 = 1 * gout299[1] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT310   ";
    Ciphertext gin310 = 1 * gout284[1] + 2 * gout273[0];
    ...
    std::cerr << "\rLUT311   ";
    Ciphertext gin311 = 1 * gout290[0] + 2 * gout283[1];
    ...
    std::cerr << "\rLUT312   ";
    Ciphertext gin312 = 1 * gout305[0] + 2 * gout277[0];
    ...
    std::cerr << "\rLUT313   ";
    Ciphertext gin313 = 1 * gout285[0] + 2 * gout230[0];
    ...
    std::cerr << "\rLUT314   ";
    Ciphertext gin314 = 1 * gout134[0] + 2 * gout249[0];
    ...
    std::cerr << "\rLUT315   ";
    Ciphertext gin315 = 1 * gout296[0] + 2 * gout302[0];
    ...
    std::cerr << "\rLUT316   ";
    Ciphertext gin316 = 1 * gout308[1] + 2 * gout212[1];
    ...
    std::cerr << "\rLUT317   ";
    Ciphertext gin317 = 1 * gout309[1] + 2 * gout157[0];
    ...
    std::cerr << "\rLUT318   ";
    Ciphertext gin318 = 1 * gout310[0] + 2 * gout284[0];
    ...
    std::cerr << "\rLUT319   ";
    Ciphertext gin319 = 1 * gout298[0] + 2 * gout237[1];
    ...
    std::cerr << "\rLUT320   ";
    Ciphertext gin320 = 1 * gout269[0] + 2 * gout190[1];
    ...
    std::cerr << "\rLUT321   ";
    Ciphertext gin321 = 1 * gout307[0] + 2 * gout315[1];
    ...
    std::cerr << "\rLUT322   ";
    Ciphertext gin322 = 1 * gout258[0] + 2 * gout192[0];
    ...
    std::cerr << "\rLUT323   ";
    Ciphertext gin323 = 1 * gout322[0] + 2 * gout275[0];
    ...
    std::cerr << "\rLUT324   ";
    Ciphertext gin324 = 1 * gout311[0] + 2 * gout200[0];
    ...
    std::cerr << "\rLUT325   ";
    Ciphertext gin325 = 1 * gout271[1] + 2 * gout225[1];
    ...
    std::cerr << "\rLUT326   ";
    Ciphertext gin326 = 1 * gout286[1] + 2 * gout294[0];
    ...
    std::cerr << "\rLUT327   ";
    Ciphertext gin327 = 1 * gout282[1] + 2 * gout236[0];
    ...
    std::cerr << "\rLUT328   ";
    Ciphertext gin328 = 1 * gout266[0] + 2 * gout231[1];
    ...
    std::cerr << "\rLUT329   ";
    Ciphertext gin329 = 1 * gout265[1] + 2 * gout193[1];
    ...
    std::cerr << "\rLUT330   ";
    Ciphertext gin330 = 1 * gout324[1] + 2 * gout311[1];
    ...
    std::cerr << "\rLUT331   ";
    Ciphertext gin331 = 1 * gout306[0] + 2 * gout280[1];
    ...
    std::cerr << "\rLUT332   ";
    Ciphertext gin332 = 1 * gout308[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT333   ";
    Ciphertext gin333 = 1 * gout301[0] + 2 * gout267[1];
    ...
    std::cerr << "\rLUT334   ";
    Ciphertext gin334 = 1 * gout314[0] + 2 * gout249[1];
    ...
    std::cerr << "\rLUT335   ";
    Ciphertext gin335 = 1 * gout299[0] + 2 * gout248[0];
    ...
    std::cerr << "\rLUT336   ";
    Ciphertext gin336 = 1 * gout283[0] + 2 * gout222[0];
    ...
    std::cerr << "\rLUT337   ";
    Ciphertext gin337 = 1 * gout300[0] + 2 * gout157[1];
    ...
    std::cerr << "\rLUT338   ";
    Ciphertext gin338 = 1 * gout279[0] + 2 * gout240[0];
    ...
    std::cerr << "\rLUT339   ";
    Ciphertext gin339 = 1 * gout302[1] + 2 * gout261[0];
    ...
    std::cerr << "\rLUT340   ";
    Ciphertext gin340 = 1 * gout312[0] + 2 * gout326[1];
    ...
    std::cerr << "\rLUT341   ";
    Ciphertext gin341 = 1 * gout293[0] + 2 * gout317[1];
    ...
    std::cerr << "\rLUT342   ";
    Ciphertext gin342 = 1 * gout331[1] + 2 * gout280[0];
    ...
    std::cerr << "\rLUT343   ";
    Ciphertext gin343 = 1 * gout295[0] + 2 * gout289[0];
    ...
    std::cerr << "\rLUT344   ";
    Ciphertext gin344 = 1 * gout334[0] + 2 * gout202[0];
    ...
    std::cerr << "\rLUT345   ";
    Ciphertext gin345 = 1 * gout325[0] + 2 * gout227[1];
    ...
    std::cerr << "\rLUT346   ";
    Ciphertext gin346 = 1 * gout321[1] + 2 * gout315[0];
    ...
    std::cerr << "\rLUT347   ";
    Ciphertext gin347 = 1 * gout323[1] + 2 * gout226[0];
    ...
    std::cerr << "\rLUT348   ";
    Ciphertext gin348 = 1 * gout297[0] + 2 * gout232[0];
    ...
    std::cerr << "\rLUT349   ";
    Ciphertext gin349 = 1 * gout313[0] + 2 * gout285[1];
    ...
    std::cerr << "\rLUT350   ";
    Ciphertext gin350 = 1 * gout328[0] + 2 * gout266[1];
    ...
    std::cerr << "\rLUT351   ";
    Ciphertext gin351 = 1 * gout336[0] + 2 * gout216[0];
    ...
    std::cerr << "\rLUT352   ";
    Ciphertext gin352 = 1 * gout326[0] + 2 * gout286[0];
    ...
    std::cerr << "\rLUT353   ";
    Ciphertext gin353 = 1 * gout260[0] + 2 * gout305[1];
    ...
    std::cerr << "\rLUT354   ";
    Ciphertext gin354 = 1 * gout304[1] + 2 * gout298[1];
    ...
    std::cerr << "\rLUT355   ";
    Ciphertext gin355 = 1 * gout270[0] + 2 * gout303[1];
    ...
    std::cerr << "\rLUT356   ";
    Ciphertext gin356 = 1 * gout310[1] + 2 * gout300[1];
    ...
    std::cerr << "\rLUT357   ";
    Ciphertext gin357 = 1 * gout333[0] + 2 * gout314[1];
    ...
    std::cerr << "\rLUT358   ";
    Ciphertext gin358 = 1 * gout332[0] + 2 * gout316[1];
    ...
    std::cerr << "\rLUT359   ";
    Ciphertext gin359 = 1 * gout335[0] + 2 * gout271[0];
    ...
    std::cerr << "\rLUT360   ";
    Ciphertext gin360 = 1 * gout210[0] + 2 * gout341[1];
    ...
    std::cerr << "\rLUT361   ";
    Ciphertext gin361 = 1 * gout343[1] + 2 * gout215[0];
    ...
    std::cerr << "\rLUT362   ";
    Ciphertext gin362 = 1 * gout345[1] + 2 * gout269[1];
    ...
    std::cerr << "\rLUT363   ";
    Ciphertext gin363 = 1 * gout354[1] + 2 * gout304[0];
    ...
    std::cerr << "\rLUT364   ";
    Ciphertext gin364 = 1 * gout342[0] + 2 * gout361[1];
    ...
    std::cerr << "\rLUT365   ";
    Ciphertext gin365 = 1 * gout362[0] + 2 * gout345[0];
    ...
    std::cerr << "\rLUT366   ";
    Ciphertext gin366 = 1 * gout350[0] + 2 * gout357[0];
    ...
    std::cerr << "\rLUT367   ";
    Ciphertext gin367 = 1 * gout329[0] + 2 * gout287[1];
    ...
    std::cerr << "\rLUT368   ";
    Ciphertext gin368 = 1 * gout348[0] + 2 * gout272[0];
    ...
    std::cerr << "\rLUT369   ";
    Ciphertext gin369 = 1 * gout355[1] + 2 * gout303[0];
    ...
    std::cerr << "\rLUT370   ";
    Ciphertext gin370 = 1 * gout327[0] + 2 * gout264[1];
    ...
    std::cerr << "\rLUT371   ";
    Ciphertext gin371 = 1 * gout339[0] + 2 * gout288[1];
    ...
    std::cerr << "\rLUT372   ";
    Ciphertext gin372 = 1 * gout278[0] + 2 * gout344[1];
    ...
    std::cerr << "\rLUT373   ";
    Ciphertext gin373 = 1 * gout353[0] + 2 * gout355[0];
    ...
    std::cerr << "\rLUT374   ";
    Ciphertext gin374 = 1 * gout366[1] + 2 * gout331[0];
    ...
    std::cerr << "\rLUT375   ";
    Ciphertext gin375 = 1 * gout351[1] + 2 * gout265[0];
    ...
    std::cerr << "\rLUT376   ";
    Ciphertext gin376 = 1 * gout375[0] + 2 * gout351[0];
    ...
    std::cerr << "\rLUT377   ";
    Ciphertext gin377 = 1 * gout371[0] + 2 * gout288[0];
    ...
    std::cerr << "\rLUT378   ";
    Ciphertext gin378 = 1 * gout374[0] + 2 * gout366[0];
    ...
    std::cerr << "\rLUT379   ";
    Ciphertext gin379 = 1 * gout369[0] + 2 * gout362[1];
    ...
    std::cerr << "\rLUT380   ";
    Ciphertext gin380 = 1 * gout356[0] + 2 * gout317[0];
    ...
    std::cerr << "\rLUT381   ";
    Ciphertext gin381 = 1 * gout357[1] + 2 * gout333[1];
    ...
    std::cerr << "\rLUT382   ";
    Ciphertext gin382 = 1 * gout352[0] + 2 * gout324[0];
    ...
    std::cerr << "\rLUT383   ";
    Ciphertext gin383 = 1 * gout360[0] + 2 * gout341[0];
    ...
    std::cerr << "\rLUT384   ";
    Ciphertext gin384 = 1 * gout347[1] + 2 * gout323[0];
    ...
    std::cerr << "\rLUT385   ";
    Ciphertext gin385 = 1 * gout318[0] + 2 * gout373[1];
    ...
    std::cerr << "\rLUT386   ";
    Ciphertext gin386 = 1 * gout373[0] + 2 * gout353[1];
    ...
    std::cerr << "\rLUT387   ";
    Ciphertext gin387 = 1 * gout368[1] + 2 * gout348[1];
    ...
    std::cerr << "\rLUT388   ";
    Ciphertext gin388 = 1 * gout359[1] + 2 * gout247[0];
    ...
    std::cerr << "\rLUT389   ";
    Ciphertext gin389 = 1 * gout376[0] + 2 * gout328[1];
    ...
    std::cerr << "\rLUT390   ";
    Ciphertext gin390 = 1 * gout377[0] + 2 * gout354[0];
    ...
    std::cerr << "\rLUT391   ";
    Ciphertext gin391 = 1 * gout382[1] + 2 * gout321[0];
    ...
    std::cerr << "\rLUT392   ";
    Ciphertext gin392 = 1 * gout380[0] + 2 * gout337[0];
    ...
    std::cerr << "\rLUT393   ";
    Ciphertext gin393 = 1 * gout361[0] + 2 * gout343[0];
    ...
    std::cerr << "\rLUT394   ";
    Ciphertext gin394 = 1 * gout388[0] + 2 * gout273[1];
    ...
    std::cerr << "\rLUT395   ";
    Ciphertext gin395 = 1 * gout380[1] + 2 * gout356[1];
    ...
    std::cerr << "\rLUT396   ";
    Ciphertext gin396 = 1 * gout372[1] + 2 * gout344[0];
    ...
    std::cerr << "\rLUT397   ";
    Ciphertext gin397 = 1 * gout259[0] + 2 * gout370[0];
    ...
    std::cerr << "\rLUT398   ";
    Ciphertext gin398 = 1 * gout330[0] + 2 * gout375[1];
    ...
    std::cerr << "\rLUT399   ";
    Ciphertext gin399 = 1 * gout381[0] + 2 * gout332[1];
    ...
    std::cerr << "\rLUT400   ";
    Ciphertext gin400 = 1 * gout346[0] + 2 * gout368[0];
    ...
    std::cerr << "\rLUT401   ";
    Ciphertext gin401 = 1 * gout384[0] + 2 * gout364[1];
    ...
    std::cerr << "\rLUT402   ";
    Ciphertext gin402 = 1 * gout387[0] + 2 * gout390[1];
    ...
    std::cerr << "\rLUT403   ";
    Ciphertext gin403 = 1 * gout338[0] + 2 * gout367[0];
    ...
    std::cerr << "\rLUT404   ";
    Ciphertext gin404 = 1 * gout402[0] + 2 * gout390[0];
    ...
    std::cerr << "\rLUT405   ";
    Ciphertext gin405 = 1 * gout340[1] + 2 * gout397[0];
    ...
    std::cerr << "\rLUT406   ";
    Ciphertext gin406 = 1 * gout386[0] + 2 * gout405[1];
    ...
    std::cerr << "\rLUT407   ";
    Ciphertext gin407 = 1 * gout349[0] + 2 * gout400[0];
    ...
    std::cerr << "\rLUT408   ";
    Ciphertext gin408 = 1 * gout404[0] + 2 * gout319[0];
    ...
    std::cerr << "\rLUT409   ";
    Ciphertext gin409 = 1 * gout403[1] + 2 * gout367[1];
    ...
    std::cerr << "\rLUT410   ";
    Ciphertext gin410 = 1 * gout399[0] + 2 * gout372[0];
    ...
    std::cerr << "\rLUT411   ";
    Ciphertext gin411 = 1 * gout389[0] + 2 * gout403[0];
    ...
    std::cerr << "\rLUT412   ";
    Ciphertext gin412 = 1 * gout397[1] + 2 * gout370[1];
    ...
    std::cerr << "\rLUT413   ";
    Ciphertext gin413 = 1 * gout378[0] + 2 * gout410[0];
    ...
    std::cerr << "\rLUT414   ";
    Ciphertext gin414 = 1 * gout413[0] + 2 * gout401[0];
    ...
    std::cerr << "\rLUT415   ";
    Ciphertext gin415 = 1 * gout388[1] + 2 * gout359[0];
    ...
    std::cerr << "\rLUT416   ";
    Ciphertext gin416 = 1 * gout410[1] + 2 * gout399[1];
    ...
    std::cerr << "\rLUT417   ";
    Ciphertext gin417 = 1 * gout63[0] + 2 * gout408[0];
    ...
    std::cerr << "\rLUT418   ";
    Ciphertext gin418 = 1 * gout391[1] + 2 * gout382[0];
    ...
    std::cerr << "\rLUT419   ";
    Ciphertext gin419 = 1 * gout401[1] + 2 * gout364[0];
    ...
    std::cerr << "\rLUT420   ";
    Ciphertext gin420 = 1 * gout414[0] + 2 * gout413[1];
    ...
    std::cerr << "\rLUT421   ";
    Ciphertext gin421 = 1 * gout394[0] + 2 * gout309[0];
    ...
    std::cerr << "\rLUT422   ";
    Ciphertext gin422 = 1 * gout409[0] + 2 * gout347[0];
    ...
    std::cerr << "\rLUT423   ";
    Ciphertext gin423 = 1 * gout398[1] + 2 * gout371[1];
    ...
    std::cerr << "\rLUT424   ";
    Ciphertext gin424 = 1 * gout411[0] + 2 * gout389[1];
    ...
    std::cerr << "\rLUT425   ";
    Ciphertext gin425 = 1 * gout407[1] + 2 * gout400[1];
    ...
    std::cerr << "\rLUT426   ";
    Ciphertext gin426 = 1 * gout396[0] + 2 * gout289[1];
    ...
    std::cerr << "\rLUT427   ";
    Ciphertext gin427 = 1 * gout392[1] + 2 * gout170[0];
    ...
    std::cerr << "\rLUT428   ";
    Ciphertext gin428 = 1 * gout405[0] + 2 * gout340[0];
    ...
    std::cerr << "\rLUT429   ";
    Ciphertext gin429 = 1 * gout428[0] + 2 * gout391[0];
    ...
    std::cerr << "\rLUT430   ";
    Ciphertext gin430 = 1 * gout393[0] + 2 * gout426[0];
    ...
    std::cerr << "\rLUT431   ";
    Ciphertext gin431 = 1 * gout412[0] + 2 * gout313[1];
    ...
    std::cerr << "\rLUT432   ";
    Ciphertext gin432 = 1 * gout415[0] + 2 * gout379[1];
    ...
    std::cerr << "\rLUT433   ";
    Ciphertext gin433 = 1 * gout418[0] + 2 * gout423[1];
    ...
    std::cerr << "\rLUT434   ";
    Ciphertext gin434 = 1 * gout416[0] + 2 * gout358[0];
    ...
    std::cerr << "\rLUT435   ";
    Ciphertext gin435 = 1 * gout417[0] + 2 * gout408[1];
    ...
    std::cerr << "\rLUT436   ";
    Ciphertext gin436 = 1 * gout385[1] + 2 * gout421[0];
    ...
    std::cerr << "\rLUT437   ";
    Ciphertext gin437 = 1 * gout434[1] + 2 * gout430[0];
    ...
    std::cerr << "\rLUT438   ";
    Ciphertext gin438 = 1 * gout421[1] + 2 * gout394[1];
    ...
    std::cerr << "\rLUT439   ";
    Ciphertext gin439 = 1 * gout423[0] + 2 * gout398[0];
    ...
    std::cerr << "\rLUT440   ";
    Ciphertext gin440 = 1 * gout363[0] + 2 * gout422[0];
    ...
    std::cerr << "\rLUT441   ";
    Ciphertext gin441 = 1 * gout424[0] + 2 * gout374[1];
    ...
    std::cerr << "\rLUT442   ";
    Ciphertext gin442 = 1 * gout395[0] + 2 * gout436[0];
    ...
    std::cerr << "\rLUT443   ";
    Ciphertext gin443 = 1 * gout425[0] + 2 * gout292[0];
    ...
    std::cerr << "\rLUT444   ";
    Ciphertext gin444 = 1 * gout439[0] + 2 * gout411[1];
    ...
    std::cerr << "\rLUT445   ";
    Ciphertext gin445 = 1 * gout427[0] + 2 * gout392[0];
    ...
    std::cerr << "\rLUT446   ";
    Ciphertext gin446 = 1 * gout432[0] + 2 * gout379[0];
    ...
    std::cerr << "\rLUT447   ";
    Ciphertext gin447 = 1 * gout433[1] + 2 * gout407[0];
    ...
    std::cerr << "\rLUT448   ";
    Ciphertext gin448 = 1 * gout442[1] + 2 * gout360[1];
    ...
    std::cerr << "\rLUT449   ";
    Ciphertext gin449 = 1 * gout436[1] + 2 * gout385[0];
    ...
    std::cerr << "\rLUT450   ";
    Ciphertext gin450 = 1 * gout448[1] + 2 * gout442[0];
    ...
    std::cerr << "\rLUT451   ";
    Ciphertext gin451 = 1 * gout437[0] + 2 * gout434[0];
    ...
    std::cerr << "\rLUT452   ";
    Ciphertext gin452 = 1 * gout406[0] + 2 * gout432[1];
    ...
    std::cerr << "\rLUT453   ";
    Ciphertext gin453 = 1 * gout430[1] + 2 * gout426[1];
    ...
    std::cerr << "\rLUT454   ";
    Ciphertext gin454 = 1 * gout445[0] + 2 * gout448[0];
    ...
    std::cerr << "\rLUT455   ";
    Ciphertext gin455 = 1 * gout438[0] + 2 * gout281[0];
    ...
    std::cerr << "\rLUT456   ";
    Ciphertext gin456 = 1 * gout365[0] + 2 * gout431[0];
    ...
    std::cerr << "\rLUT457   ";
    Ciphertext gin457 = 1 * gout420[0] + 2 * gout437[1];
    ...
    std::cerr << "\rLUT458   ";
    Ciphertext gin458 = 1 * gout446[0] + 2 * gout320[0];
    ...
    std::cerr << "\rLUT459   ";
    Ciphertext gin459 = 1 * gout444[1] + 2 * gout402[1];
    ...
    std::cerr << "\rLUT460   ";
    Ciphertext gin460 = 1 * gout441[1] + 2 * gout440[1];
    ...
    std::cerr << "\rLUT461   ";
    Ciphertext gin461 = 1 * gout211[0] + 2 * gout455[0];
    ...
    std::cerr << "\rLUT462   ";
    Ciphertext gin462 = 1 * gout100[0] + 2 * gout443[1];
    ...
    std::cerr << "\rLUT463   ";
    Ciphertext gin463 = 1 * gout462[0] + 2 * gout443[0];
    ...
    std::cerr << "\rLUT464   ";
    Ciphertext gin464 = 1 * gout440[0] + 2 * gout422[1];
    ...
    std::cerr << "\rLUT465   ";
    Ciphertext gin465 = 1 * gout461[1] + 2 * gout455[1];
    ...
    std::cerr << "\rLUT466   ";
    Ciphertext gin466 = 1 * gout447[0] + 2 * gout433[0];
    ...
    std::cerr << "\rLUT467   ";
    Ciphertext gin467 = 1 * gout460[0] + 2 * gout441[0];
    ...
    std::cerr << "\rLUT468   ";
    Ciphertext gin468 = 1 * gout449[0] + 2 * gout452[0];
    ...
    std::cerr << "\rLUT469   ";
    Ciphertext gin469 = 1 * gout466[0] + 2 * gout459[1];
    ...
    std::cerr << "\rLUT470   ";
    Ciphertext gin470 = 1 * gout456[0] + 2 * gout431[1];
    ...
    std::cerr << "\rLUT471   ";
    Ciphertext gin471 = 1 * gout451[0] + 2 * gout316[0];
    ...
    std::cerr << "\rLUT472   ";
    Ciphertext gin472 = 1 * gout429[1] + 2 * gout456[1];
    ...
    std::cerr << "\rLUT473   ";
    Ciphertext gin473 = 1 * gout150[0] + 2 * gout458[1];
    ...
    std::cerr << "\rLUT474   ";
    Ciphertext gin474 = 1 * gout459[0] + 2 * gout444[0];
    ...
    std::cerr << "\rLUT475   ";
    Ciphertext gin475 = 1 * gout452[1] + 2 * gout406[1];
    ...
    std::cerr << "\rLUT476   ";
    Ciphertext gin476 = 1 * gout454[1] + 2 * gout170[1];
    ...
    std::cerr << "\rLUT477   ";
    Ciphertext gin477 = 1 * gout468[0] + 2 * gout461[0];
    ...
    std::cerr << "\rLUT478   ";
    Ciphertext gin478 = 1 * gout469[1] + 2 * gout462[1];
    ...
    std::cerr << "\rLUT479   ";
    Ciphertext gin479 = 1 * gout457[0] + 2 * gout419[0];
    ...
    std::cerr << "\rLUT480   ";
    Ciphertext gin480 = 1 * gout471[0] + 2 * gout453[0];
    ...
    std::cerr << "\rLUT481   ";
    Ciphertext gin481 = 1 * gout479[0] + 2 * gout457[1];
    ...
    std::cerr << "\rLUT482   ";
    Ciphertext gin482 = 1 * gout467[0] + 2 * gout414[1];
    ...
    std::cerr << "\rLUT483   ";
    Ciphertext gin483 = 1 * gout464[0] + 2 * gout291[0];
    ...
    std::cerr << "\rLUT484   ";
    Ciphertext gin484 = 1 * gout474[0] + 2 * gout460[1];
    ...
    std::cerr << "\rLUT485   ";
    Ciphertext gin485 = 1 * gout472[0] + 2 * gout429[0];
    ...
    std::cerr << "\rLUT486   ";
    Ciphertext gin486 = 1 * gout481[0] + 2 * gout480[0];
    ...
    std::cerr << "\rLUT487   ";
    Ciphertext gin487 = 1 * gout476[1] + 2 * gout454[0];
    ...
    std::cerr << "\rLUT488   ";
    Ciphertext gin488 = 1 * gout470[0] + 2 * gout235[0];
    ...
    std::cerr << "\rLUT489   ";
    Ciphertext gin489 = 1 * gout485[0] + 2 * gout447[1];
    ...
    std::cerr << "\rLUT490   ";
    Ciphertext gin490 = 1 * gout450[0] + 2 * gout477[0];
    ...
    std::cerr << "\rLUT491   ";
    Ciphertext gin491 = 1 * gout475[0] + 2 * gout472[1];
    ...
    std::cerr << "\rLUT492   ";
    Ciphertext gin492 = 1 * gout491[1] + 2 * gout473[0];
    ...
    std::cerr << "\rLUT493   ";
    Ciphertext gin493 = 1 * gout473[1] + 2 * gout458[0];
    ...
    std::cerr << "\rLUT494   ";
    Ciphertext gin494 = 1 * gout478[1] + 2 * gout469[0];
    ...
    std::cerr << "\rLUT495   ";
    Ciphertext gin495 = 1 * gout477[1] + 2 * gout468[1];
    ...
    std::cerr << "\rLUT496   ";
    Ciphertext gin496 = 1 * gout480[1] + 2 * gout471[1];
    ...
    std::cerr << "\rLUT497   ";
    Ciphertext gin497 = 1 * gout223[0] + 2 * gout483[1];
    ...
    std::cerr << "\rLUT498   ";
    Ciphertext gin498 = 1 * gout490[1] + 2 * gout383[0];
    ...
    std::cerr << "\rLUT499   ";
    Ciphertext gin499 = 1 * gout487[0] + 2 * gout498[1];
    ...
    std::cerr << "\rLUT500   ";
    Ciphertext gin500 = 1 * gout495[0] + 2 * gout492[1];
    ...
    std::cerr << "\rLUT501   ";
    Ciphertext gin501 = 1 * gout484[0] + 2 * gout417[1];
    ...
    std::cerr << "\rLUT502   ";
    Ciphertext gin502 = 1 * gout128[0] + 2 * gout488[1];
    ...
    std::cerr << "\rLUT503   ";
    Ciphertext gin503 = 1 * gout486[1] + 2 * gout496[0];
    ...
    std::cerr << "\rLUT504   ";
    Ciphertext gin504 = 1 * gout494[0] + 2 * gout501[0];
    ...
    std::cerr << "\rLUT505   ";
    Ciphertext gin505 = 1 * gout498[0] + 2 * gout490[0];
    ...
    std::cerr << "\rLUT506   ";
    Ciphertext gin506 = 1 * gout492[0] + 2 * gout491[0];
    ...
    std::cerr << "\rLUT507   ";
    Ciphertext gin507 = 1 * gout501[1] + 2 * gout484[1];
    ...
    std::cerr << "\rLUT508   ";
    Ciphertext gin508 = 1 * gout500[0] + 2 * gout465[0];
    ...
    std::cerr << "\rLUT509   ";
    Ciphertext gin509 = 1 * gout502[0] + 2 * gout488[0];
    ...
    std::cerr << "\rLUT510   ";
    Ciphertext gin510 = 1 * gout482[0] + 2 * gout497[1];
    ...
    std::cerr << "\rLUT511   ";
    Ciphertext gin511 = 1 * gout497[0] + 2 * gout483[0];
    ...
    std::cerr << "\rLUT512   ";
    Ciphertext gin512 = 1 * gout489[0] + 2 * gout502[1];
    ...
    std::cerr << "\rLUT513   ";
    Ciphertext gin513 = 1 * gout505[0] + 2 * gout508[0];
    ...
    std::cerr << "\rLUT514   ";
    Ciphertext gin514 = 1 * gout512[1] + 2 * gout489[1];
    ...
    std::cerr << "\rLUT515   ";
    Ciphertext gin515 = 1 * gout513[1] + 2 * gout499[0];
    ...
    std::cerr << "\rLUT516   ";
    Ciphertext gin516 = 1 * gout514[0] + 2 * gout478[0];
    ...
    std::cerr << "\rLUT517   ";
    Ciphertext gin517 = 1 * gout510[0] + 2 * gout482[1];
    ...
    std::cerr << "\rLUT518   ";
    Ciphertext gin518 = 1 * gout508[1] + 2 * gout500[1];
    ...
    std::cerr << "\rLUT519   ";
    Ciphertext gin519 = 1 * gout507[0] + 2 * gout510[1];
    ...
    std::cerr << "\rLUT520   ";
    Ciphertext gin520 = 1 * gout519[1] + 2 * gout435[0];
    ...
    std::cerr << "\rLUT521   ";
    Ciphertext gin521 = 1 * gout504[1] + 2 * gout463[0];
    ...
    std::cerr << "\rLUT522   ";
    Ciphertext gin522 = 1 * gout506[0] + 2 * gout512[0];
    ...
    std::cerr << "\rLUT523   ";
    Ciphertext gin523 = 1 * gout515[1] + 2 * gout513[0];
    ...
    std::cerr << "\rLUT524   ";
    Ciphertext gin524 = 1 * gout516[1] + 2 * gout509[0];
    ...
    std::cerr << "\rLUT525   ";
    Ciphertext gin525 = 1 * gout517[0] + 2 * gout479[1];
    ...
    std::cerr << "\rLUT526   ";
    Ciphertext gin526 = 1 * gout520[0] + 2 * gout519[0];
    ...
    std::cerr << "\rLUT527   ";
    Ciphertext gin527 = 1 * gout521[0] + 2 * gout504[0];
    ...
    std::cerr << "\rLUT528   ";
    Ciphertext gin528 = 1 * gout522[0] + 2 * gout493[0];
    ...
    std::cerr << "\rLUT529   ";
    Ciphertext gin529 = 1 * gout527[0] + 2 * gout520[1];
    ...
    std::cerr << "\rLUT530   ";
    Ciphertext gin530 = 1 * gout524[1] + 2 * gout516[0];
    ...
    std::cerr << "\rLUT531   ";
    Ciphertext gin531 = 1 * gout525[0] + 2 * gout511[0];
    ...
    std::cerr << "\rLUT532   ";
    Ciphertext gin532 = 1 * gout528[0] + 2 * gout522[1];
    ...
    std::cerr << "\rLUT533   ";
    Ciphertext gin533 = 1 * gout532[0] + 2 * gout524[0];
    ...
    std::cerr << "\rLUT534   ";
    Ciphertext gin534 = 1 * gout518[0] + 2 * gout528[1];
    ...
    std::cerr << "\rLUT535   ";
    Ciphertext gin535 = 1 * gout523[0] + 2 * gout534[0];
    ...
    lut536.push_back(ctx.genrate_lut(lut536idx2));
    flut536.push_back(lut536idx2);
    ...
    std::cerr << "\rLUT536   ";
    Ciphertext gin536 = 1 * gout526[0] + 2 * gout531[0];
    ...
    std::cerr << "\rLUT537   ";
    Ciphertext gin537 = 1 * gout531[1] + 2 * gout525[1];
    ...
    std::cerr << "\rLUT538   ";
    Ciphertext gin538 = 1 * gout530[0] + 2 * gout521[1];
    ...
    std::cerr << "\rLUT539   ";
    Ciphertext gin539 = 1 * gout535[0] + 2 * gout534[1];
    ...
    std::cerr << "\rLUT540   ";
    Ciphertext gin540 = 1 * gout537[0] + 2 * gout486[0];
    ...
    std::cerr << "\rLUT541   ";
    Ciphertext gin541 = 1 * gout539[0] + 2 * gout533[0];
    ...
    std::cerr << "\rLUT542   ";
    Ciphertext gin542 = 1 * gout541[1] + 2 * gout533[1];
    ...
    std::cerr << "\rLUT543   ";
    Ciphertext gin543 = 1 * gout542[0] + 2 * gout538[1];
    ...
    std::cerr << "\rLUT544   ";
    Ciphertext gin544 = 1 * gout543[0] + 2 * gout538[0];
    ...
    std::cerr << "\rLUT545   ";
    Ciphertext gin545 = 1 * gout544[0] + 2 * gout529[1];
    ...
    std::cerr << "\rLUT546   ";
    Ciphertext gin546 = 1 * gout545[0] + 2 * gout529[0];
    ...
    std::cerr << "\rLUT547   ";
    Ciphertext gin547 = 1 * gout546[0] + 2 * gout536[1];
    ...
    std::cerr << "\rLUT548   ";
    Ciphertext gin548 = 1 * gout536[0] + 2 * gout546[0];
    ...
    std::cerr << "\rLUT549   ";
    Ciphertext gin549 = 1 * gout548[0] + 2 * gout536[2];
    ...
    std::cerr << "\rLUT550   ";
    Ciphertext gin550 = 1 * gout549[0] + 2 * gout540[0];
    ...
    std::cerr << "\rLUT551   ";
    Ciphertext gin551 = 1 * gout550[1] + 2 * gout540[1];
    ...
    std::cerr << "\rLUT552   ";
    Ciphertext gin552 = 1 * gout551[0] + 2 * gout503[0];
    std::vector<Ciphertext> gout552 = ctx.eval_lut_amortized(&gin552, lut552);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout337[1])); /* out192 */
    test_out.push_back(ctx.decrypt(&gout427[1])); /* out193 */
    test_out.push_back(ctx.decrypt(&gout476[0])); /* out194 */
    test_out.push_back(ctx.decrypt(&gout499[1])); /* out195 */
    test_out.push_back(ctx.decrypt(&gout515[0])); /* out196 */
    test_out.push_back(ctx.decrypt(&gout535[1])); /* out197 */
    test_out.push_back(ctx.decrypt(&gout541[0])); /* out198 */
    test_out.push_back(ctx.decrypt(&gout543[1])); /* out199 */
    test_out.push_back(ctx.decrypt(&gout545[1])); /* out200 */
    test_out.push_back(ctx.decrypt(&gout547[0])); /* out201 */
    test_out.push_back(ctx.decrypt(&gout550[0])); /* out202 */
    test_out.push_back(ctx.decrypt(&gout552[1])); /* out203 */
    test_out.push_back(ctx.decrypt(&gout552[0])); /* out204 */
    return test_out;
}
