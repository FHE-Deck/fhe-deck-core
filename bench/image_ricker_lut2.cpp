...
std::vector<long>
test_image_ricker_lut2(FHEContext& ctx, std::vector<uint64_t> window = { 0 })
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 20 (LUT2 _1013_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 321 (LUT2 _1314_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_window26 + 2 * ct_window42;
    ...
    auto lut1idx0 = [](long I) -> long {
        /* GATE 80 (LUT2 _1073_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut1idx1 = [](long I) -> long {
        /* GATE 117 (LUT2 _1110_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_window28 + 2 * ct_window44;
    ...
    auto lut2idx0 = [](long I) -> long {
        /* GATE 306 (LUT2 _1299_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut2idx1 = [](long I) -> long {
        /* GATE 300 (LUT2 _1293_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_window24 + 2 * ct_window40;
    ...
    auto lut3idx0 = [](long I) -> long {
        /* GATE 299 (LUT2 _1292_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut3idx1 = [](long I) -> long {
        /* GATE 305 (LUT2 _1298_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * gout2[1] + 2 * ct_window48;
    ...
    auto lut4idx0 = [](long I) -> long {
        /* GATE 319 (LUT2 _1312_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut4idx1 = [](long I) -> long {
        /* GATE 11 (LUT2 _1004_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_window2 + 2 * ct_window10;
    ...
    auto lut5idx0 = [](long I) -> long {
        /* GATE 297 (LUT2 _1290_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut5idx1 = [](long I) -> long {
        /* GATE 326 (LUT2 _1319_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_window25 + 2 * ct_window41;
    ...
    auto lut6idx0 = [](long I) -> long {
        /* GATE 142 (LUT2 _1135_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut6idx1 = [](long I) -> long {
        /* GATE 172 (LUT2 _1165_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_window6 + 2 * ct_window14;
    ...
    auto lut7idx0 = [](long I) -> long {
        /* GATE 112 (LUT2 _1105_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut7idx1 = [](long I) -> long {
        /* GATE 149 (LUT2 _1142_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_window29 + 2 * ct_window45;
    ...
    auto lut8idx0 = [](long I) -> long {
        /* GATE 181 (LUT2 _1174_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut8idx1 = [](long I) -> long {
        /* GATE 144 (LUT2 _1137_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_window30 + 2 * ct_window46;
    ...
    auto lut9idx0 = [](long I) -> long {
        /* GATE 108 (LUT2 _1101_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut9idx1 = [](long I) -> long {
        /* GATE 78 (LUT2 _1071_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_window4 + 2 * ct_window12;
    ...
    auto lut10idx0 = [](long I) -> long {
        /* GATE 296 (LUT2 _1289_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut10idx1 = [](long I) -> long {
        /* GATE 325 (LUT2 _1318_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * gout5[0] + 2 * ct_window49;
    ...
    auto lut11idx0 = [](long I) -> long {
        /* GATE 317 (LUT2 _1310_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut11idx1 = [](long I) -> long {
        /* GATE 295 (LUT2 _1288_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_window1 + 2 * ct_window9;
    ...
    auto lut12idx0 = [](long I) -> long {
        /* GATE 324 (LUT2 _1317_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * gout10[1] + 2 * gout5[1];
    ...
    auto lut13idx0 = [](long I) -> long {
        /* GATE 174 (LUT2 _1167_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut13idx1 = [](long I) -> long {
        /* GATE 202 (LUT2 _1195_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_window7 + 2 * ct_window15;
    ...
    auto lut14idx0 = [](long I) -> long {
        /* GATE 10 (LUT2 _1003_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut14idx1 = [](long I) -> long {
        /* GATE 318 (LUT2 _1311_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * gout4[0] + 2 * ct_window18;
    ...
    auto lut15idx0 = [](long I) -> long {
        /* GATE 171 (LUT2 _1164_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut15idx1 = [](long I) -> long {
        /* GATE 141 (LUT2 _1134_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout6[0] + 2 * ct_window22;
    ...
    auto lut16idx0 = [](long I) -> long {
        /* GATE 13 (LUT2 _1006_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut16idx1 = [](long I) -> long {
        /* GATE 76 (LUT2 _1069_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_window3 + 2 * ct_window11;
    ...
    auto lut17idx0 = [](long I) -> long {
        /* GATE 201 (LUT2 _1194_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut17idx1 = [](long I) -> long {
        /* GATE 173 (LUT2 _1166_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * gout13[0] + 2 * ct_window23;
    ...
    auto lut18idx0 = [](long I) -> long {
        /* GATE 292 (LUT2 _1285_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut18idx1 = [](long I) -> long {
        /* GATE 293 (LUT2 _1286_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_window0 + 2 * ct_window8;
    ...
    auto lut19idx0 = [](long I) -> long {
        /* GATE 19 (LUT2 _1012_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut19idx1 = [](long I) -> long {
        /* GATE 320 (LUT2 _1313_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * gout0[1] + 2 * ct_window50;
    ...
    auto lut20idx0 = [](long I) -> long {
        /* GATE 33 (LUT2 _1026_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut20idx1 = [](long I) -> long {
        /* GATE 32 (LUT2 _1025_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_window56 + 2 * ct_window64;
    ...
    auto lut21idx0 = [](long I) -> long {
        /* GATE 15 (LUT2 _1008_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut21idx1 = [](long I) -> long {
        /* GATE 85 (LUT2 _1078_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_window27 + 2 * ct_window43;
    ...
    auto lut22idx0 = [](long I) -> long {
        /* GATE 200 (LUT2 _1193_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * gout17[0] + 2 * gout13[1];
    ...
    auto lut23idx0 = [](long I) -> long {
        /* GATE 116 (LUT2 _1109_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut23idx1 = [](long I) -> long {
        /* GATE 79 (LUT2 _1072_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * gout1[0] + 2 * ct_window52;
    ...
    auto lut24idx0 = [](long I) -> long {
        /* GATE 140 (LUT2 _1133_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut24idx1 = [](long I) -> long {
        /* GATE 110 (LUT2 _1103_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_window5 + 2 * ct_window13;
    ...
    auto lut25idx0 = [](long I) -> long {
        /* GATE 304 (LUT2 _1297_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout3[1] + 2 * gout2[0];
    ...
    auto lut26idx0 = [](long I) -> long {
        /* GATE 205 (LUT2 _1198_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut26idx1 = [](long I) -> long {
        /* GATE 176 (LUT2 _1169_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_window31 + 2 * ct_window47;
    ...
    auto lut27idx0 = [](long I) -> long {
        /* GATE 75 (LUT2 _1068_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut27idx1 = [](long I) -> long {
        /* GATE 12 (LUT2 _1005_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout16[0] + 2 * ct_window19;
    ...
    auto lut28idx0 = [](long I) -> long {
        /* GATE 323 (LUT2 _1316_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut28idx1 = [](long I) -> long {
        /* GATE 23 (LUT2 _1016_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout12[0] + 2 * ct_window58;
    ...
    auto lut29idx0 = [](long I) -> long {
        /* GATE 170 (LUT2 _1163_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout15[0] + 2 * gout6[1];
    ...
    auto lut30idx0 = [](long I) -> long {
        /* GATE 115 (LUT2 _1108_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout23[0] + 2 * gout1[1];
    ...
    auto lut31idx0 = [](long I) -> long {
        /* GATE 180 (LUT2 _1173_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut31idx1 = [](long I) -> long {
        /* GATE 143 (LUT2 _1136_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout8[1] + 2 * ct_window54;
    ...
    auto lut32idx0 = [](long I) -> long {
        /* GATE 111 (LUT2 _1104_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut32idx1 = [](long I) -> long {
        /* GATE 148 (LUT2 _1141_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout7[0] + 2 * ct_window53;
    ...
    auto lut33idx0 = [](long I) -> long {
        /* GATE 107 (LUT2 _1100_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut33idx1 = [](long I) -> long {
        /* GATE 77 (LUT2 _1070_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout9[1] + 2 * ct_window20;
    ...
    auto lut34idx0 = [](long I) -> long {
        /* GATE 316 (LUT2 _1309_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut34idx1 = [](long I) -> long {
        /* GATE 294 (LUT2 _1287_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout11[1] + 2 * ct_window17;
    ...
    auto lut35idx0 = [](long I) -> long {
        /* GATE 169 (LUT2 _1162_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut35idx1 = [](long I) -> long {
        /* GATE 199 (LUT2 _1192_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout29[0] + 2 * gout17[1];
    ...
    auto lut36idx0 = [](long I) -> long {
        /* GATE 74 (LUT2 _1067_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout27[0] + 2 * gout16[1];
    ...
    auto lut37idx0 = [](long I) -> long {
        /* GATE 9 (LUT2 _1002_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout14[0] + 2 * gout4[1];
    ...
    auto lut38idx0 = [](long I) -> long {
        /* GATE 303 (LUT2 _1296_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut38idx1 = [](long I) -> long {
        /* GATE 329 (LUT2 _1322_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout25[0] + 2 * ct_window57;
    ...
    auto lut39idx0 = [](long I) -> long {
        /* GATE 175 (LUT2 _1168_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut39idx1 = [](long I) -> long {
        /* GATE 204 (LUT2 _1197_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout26[1] + 2 * ct_window55;
    ...
    auto lut40idx0 = [](long I) -> long {
        /* GATE 203 (LUT2 _1196_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout39[1] + 2 * gout26[0];
    ...
    auto lut41idx0 = [](long I) -> long {
        /* GATE 198 (LUT2 _1191_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut41idx1 = [](long I) -> long {
        /* GATE 168 (LUT2 _1161_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout35[0] + 2 * gout39[0];
    ...
    auto lut42idx0 = [](long I) -> long {
        /* GATE 301 (LUT2 _1294_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut42idx1 = [](long I) -> long {
        /* GATE 291 (LUT2 _1284_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout18[0] + 2 * ct_window16;
    ...
    auto lut43idx0 = [](long I) -> long {
        /* GATE 147 (LUT2 _1140_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout32[1] + 2 * gout7[1];
    ...
    auto lut44idx0 = [](long I) -> long {
        /* GATE 152 (LUT2 _1145_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut44idx1 = [](long I) -> long {
        /* GATE 114 (LUT2 _1107_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout30[0] + 2 * ct_window61;
    ...
    auto lut45idx0 = [](long I) -> long {
        /* GATE 328 (LUT2 _1321_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut45idx1 = [](long I) -> long {
        /* GATE 302 (LUT2 _1295_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout38[0] + 2 * ct_window65;
    ...
    auto lut46idx0 = [](long I) -> long {
        /* GATE 18 (LUT2 _1011_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout19[0] + 2 * gout0[0];
    ...
    auto lut47idx0 = [](long I) -> long {
        /* GATE 315 (LUT2 _1308_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout34[0] + 2 * gout11[0];
    ...
    auto lut48idx0 = [](long I) -> long {
        /* GATE 314 (LUT2 _1307_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut48idx1 = [](long I) -> long {
        /* GATE 6 (LUT2 _0999_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout47[0] + 2 * gout14[1];
    ...
    auto lut49idx0 = [](long I) -> long {
        /* GATE 139 (LUT2 _1132_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut49idx1 = [](long I) -> long {
        /* GATE 109 (LUT2 _1102_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout24[1] + 2 * ct_window21;
    ...
    auto lut50idx0 = [](long I) -> long {
        /* GATE 14 (LUT2 _1007_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut50idx1 = [](long I) -> long {
        /* GATE 84 (LUT2 _1077_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout21[0] + 2 * ct_window51;
    ...
    auto lut51idx0 = [](long I) -> long {
        /* GATE 8 (LUT2 _1001_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut51idx1 = [](long I) -> long {
        /* GATE 71 (LUT2 _1064_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout37[0] + 2 * gout27[1];
    ...
    auto lut52idx0 = [](long I) -> long {
        /* GATE 322 (LUT2 _1315_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut52idx1 = [](long I) -> long {
        /* GATE 22 (LUT2 _1015_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout28[0] + 2 * ct_window66;
    ...
    auto lut53idx0 = [](long I) -> long {
        /* GATE 88 (LUT2 _1081_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut53idx1 = [](long I) -> long {
        /* GATE 17 (LUT2 _1010_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout46[0] + 2 * ct_window59;
    ...
    auto lut54idx0 = [](long I) -> long {
        /* GATE 113 (LUT2 _1106_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut54idx1 = [](long I) -> long {
        /* GATE 151 (LUT2 _1144_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout44[1] + 2 * ct_window69;
    ...
    auto lut55idx0 = [](long I) -> long {
        /* GATE 106 (LUT2 _1099_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout33[0] + 2 * gout9[0];
    ...
    auto lut56idx0 = [](long I) -> long {
        /* GATE 327 (LUT2 _1320_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout45[0] + 2 * gout38[1];
    ...
    auto lut57idx0 = [](long I) -> long {
        /* GATE 179 (LUT2 _1172_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout31[0] + 2 * gout8[0];
    ...
    auto lut58idx0 = [](long I) -> long {
        /* GATE 73 (LUT2 _1066_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut58idx1 = [](long I) -> long {
        /* GATE 103 (LUT2 _1096_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout36[0] + 2 * gout33[1];
    ...
    auto lut59idx0 = [](long I) -> long {
        /* GATE 146 (LUT2 _1139_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut59idx1 = [](long I) -> long {
        /* GATE 184 (LUT2 _1177_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout43[0] + 2 * ct_window62;
    ...
    auto lut60idx0 = [](long I) -> long {
        /* GATE 197 (LUT2 _1190_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout41[0] + 2 * gout35[1];
    ...
    auto lut61idx0 = [](long I) -> long {
        /* GATE 313 (LUT2 _1306_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut61idx1 = [](long I) -> long {
        /* GATE 5 (LUT2 _0998_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout48[0] + 2 * gout19[1];
    ...
    auto lut62idx0 = [](long I) -> long {
        /* GATE 150 (LUT2 _1143_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout54[1] + 2 * gout44[0];
    ...
    auto lut63idx0 = [](long I) -> long {
        /* GATE 208 (LUT2 _1201_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut63idx1 = [](long I) -> long {
        /* GATE 178 (LUT2 _1171_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout57[0] + 2 * ct_window63;
    ...
    auto lut64idx0 = [](long I) -> long {
        /* GATE 4 (LUT2 _0997_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout61[1] + 2 * gout48[1];
    ...
    auto lut65idx0 = [](long I) -> long {
        /* GATE 290 (LUT2 _1283_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout42[1] + 2 * gout18[1];
    ...
    auto lut66idx0 = [](long I) -> long {
        /* GATE 21 (LUT2 _1014_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout52[1] + 2 * gout28[1];
    ...
    auto lut67idx0 = [](long I) -> long {
        /* GATE 145 (LUT2 _1138_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut67idx1 = [](long I) -> long {
        /* GATE 183 (LUT2 _1176_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout59[0] + 2 * ct_window70;
    ...
    auto lut68idx0 = [](long I) -> long {
        /* GATE 298 (LUT2 _1291_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut68idx1 = [](long I) -> long {
        /* GATE 31 (LUT2 _1024_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout3[0] + 2 * gout42[0];
    ...
    auto lut69idx0 = [](long I) -> long {
        /* GATE 138 (LUT2 _1131_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout49[0] + 2 * gout24[0];
    ...
    auto lut70idx0 = [](long I) -> long {
        /* GATE 216 (LUT2 _1209_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut70idx1 = [](long I) -> long {
        /* GATE 196 (LUT2 _1189_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout60[0] + 2 * gout22[0];
    ...
    auto lut71idx0 = [](long I) -> long {
        /* GATE 289 (LUT2 _1282_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut71idx1 = [](long I) -> long {
        /* GATE 312 (LUT2 _1305_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout65[0] + 2 * gout34[1];
    ...
    auto lut72idx0 = [](long I) -> long {
        /* GATE 7 (LUT2 _1000_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut72idx1 = [](long I) -> long {
        /* GATE 70 (LUT2 _1063_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout51[0] + 2 * gout50[0];
    ...
    auto lut73idx0 = [](long I) -> long {
        /* GATE 30 (LUT2 _1023_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout68[1] + 2 * gout20[1];
    ...
    auto lut74idx0 = [](long I) -> long {
        /* GATE 83 (LUT2 _1076_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout50[1] + 2 * gout21[1];
    ...
    auto lut75idx0 = [](long I) -> long {
        /* GATE 29 (LUT2 _1022_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout73[0] + 2 * gout20[0];
    ...
    auto lut76idx0 = [](long I) -> long {
        /* GATE 135 (LUT2 _1128_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut76idx1 = [](long I) -> long {
        /* GATE 105 (LUT2 _1098_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout55[0] + 2 * gout49[1];
    ...
    auto lut77idx0 = [](long I) -> long {
        /* GATE 87 (LUT2 _1080_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut77idx1 = [](long I) -> long {
        /* GATE 16 (LUT2 _1009_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout53[1] + 2 * ct_window67;
    ...
    auto lut78idx0 = [](long I) -> long {
        /* GATE 182 (LUT2 _1175_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout67[1] + 2 * gout59[1];
    ...
    auto lut79idx0 = [](long I) -> long {
        /* GATE 69 (LUT2 _1062_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout72[1] + 2 * gout51[1];
    ...
    auto lut80idx0 = [](long I) -> long {
        /* GATE 82 (LUT2 _1075_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut80idx1 = [](long I) -> long {
        /* GATE 120 (LUT2 _1113_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout74[0] + 2 * ct_window60;
    ...
    auto lut81idx0 = [](long I) -> long {
        /* GATE 104 (LUT2 _1097_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut81idx1 = [](long I) -> long {
        /* GATE 134 (LUT2 _1127_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout76[1] + 2 * gout32[0];
    ...
    auto lut82idx0 = [](long I) -> long {
        /* GATE 207 (LUT2 _1200_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut82idx1 = [](long I) -> long {
        /* GATE 177 (LUT2 _1170_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout63[1] + 2 * ct_window71;
    ...
    auto lut83idx0 = [](long I) -> long {
        /* GATE 81 (LUT2 _1074_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut83idx1 = [](long I) -> long {
        /* GATE 119 (LUT2 _1112_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout80[0] + 2 * ct_window68;
    ...
    auto lut84idx0 = [](long I) -> long {
        /* GATE 86 (LUT2 _1079_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout77[0] + 2 * gout53[0];
    ...
    auto lut85idx0 = [](long I) -> long {
        /* GATE 72 (LUT2 _1065_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut85idx1 = [](long I) -> long {
        /* GATE 102 (LUT2 _1095_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout58[0] + 2 * gout23[1];
    ...
    auto lut86idx0 = [](long I) -> long {
        /* GATE 3 (LUT2 _0996_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut86idx1 = [](long I) -> long {
        /* GATE 66 (LUT2 _1059_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout64[0] + 2 * gout72[0];
    ...
    auto lut87idx0 = [](long I) -> long {
        /* GATE 215 (LUT2 _1208_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut87idx1 = [](long I) -> long {
        /* GATE 195 (LUT2 _1188_ INIT 0x9 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout40[0] + 2 * gout70[1];
    ...
    auto lut88idx0 = [](long I) -> long {
        /* GATE 137 (LUT2 _1130_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut88idx1 = [](long I) -> long {
        /* GATE 167 (LUT2 _1160_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout69[0] + 2 * gout15[1];
    ...
    auto lut89idx0 = [](long I) -> long {
        /* GATE 136 (LUT2 _1129_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut89idx1 = [](long I) -> long {
        /* GATE 166 (LUT2 _1159_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout88[0] + 2 * gout31[1];
    ...
    auto lut90idx0 = [](long I) -> long {
        /* GATE 288 (LUT2 _1281_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut90idx1 = [](long I) -> long {
        /* GATE 311 (LUT2 _1304_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout71[0] + 2 * gout10[0];
    ...
    auto lut91idx0 = [](long I) -> long {
        /* GATE 165 (LUT2 _1158_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout89[1] + 2 * gout88[1];
    ...
    auto lut92idx0 = [](long I) -> long {
        /* GATE 101 (LUT2 _1094_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout85[1] + 2 * gout58[1];
    ...
    auto lut93idx0 = [](long I) -> long {
        /* GATE 307 (LUT2 _1300_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut93idx1 = [](long I) -> long {
        /* GATE 287 (LUT2 _1280_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout90[0] + 2 * gout68[0];
    ...
    auto lut94idx0 = [](long I) -> long {
        /* GATE 28 (LUT2 _1021_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut94idx1 = [](long I) -> long {
        /* GATE 286 (LUT2 _1279_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout93[1] + 2 * gout45[1];
    ...
    auto lut95idx0 = [](long I) -> long {
        /* GATE 118 (LUT2 _1111_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout83[1] + 2 * gout80[1];
    ...
    auto lut96idx0 = [](long I) -> long {
        /* GATE 285 (LUT2 _1278_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout93[0] + 2 * gout94[1];
    ...
    auto lut97idx0 = [](long I) -> long {
        /* GATE 27 (LUT2 _1020_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout94[0] + 2 * gout75[0];
    ...
    auto lut98idx0 = [](long I) -> long {
        /* GATE 26 (LUT2 _1019_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout94[1] + 2 * gout97[0];
    ...
    auto lut99idx0 = [](long I) -> long {
        /* GATE 133 (LUT2 _1126_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * gout81[1] + 2 * gout76[0];
    ...
    auto lut100idx0 = [](long I) -> long {
        /* GATE 100 (LUT2 _1093_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut100idx1 = [](long I) -> long {
        /* GATE 130 (LUT2 _1123_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout92[0] + 2 * gout81[0];
    ...
    auto lut101idx0 = [](long I) -> long {
        /* GATE 68 (LUT2 _1061_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut101idx1 = [](long I) -> long {
        /* GATE 98 (LUT2 _1091_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * gout79[0] + 2 * gout85[0];
    ...
    auto lut102idx0 = [](long I) -> long {
        /* GATE 65 (LUT2 _1058_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut102idx1 = [](long I) -> long {
        /* GATE 2 (LUT2 _0995_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * gout86[0] + 2 * gout77[1];
    ...
    auto lut103idx0 = [](long I) -> long {
        /* GATE 67 (LUT2 _1060_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut103idx1 = [](long I) -> long {
        /* GATE 97 (LUT2 _1090_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * gout101[0] + 2 * gout83[0];
    ...
    auto lut104idx0 = [](long I) -> long {
        /* GATE 206 (LUT2 _1199_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * gout82[0] + 2 * gout63[0];
    ...
    auto lut105idx0 = [](long I) -> long {
        /* GATE 214 (LUT2 _1207_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * gout87[0] + 2 * gout70[0];
    ...
    auto lut106idx0 = [](long I) -> long {
        /* GATE 310 (LUT2 _1303_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT106   ";
    Ciphertext gin106 = 1 * gout90[1] + 2 * gout71[1];
    ...
    auto lut107idx0 = [](long I) -> long {
        /* GATE 309 (LUT2 _1302_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut107idx1 = [](long I) -> long {
        /* GATE 1 (LUT2 _0994_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * gout106[0] + 2 * gout61[0];
    ...
    auto lut108idx0 = [](long I) -> long {
        /* GATE 129 (LUT2 _1122_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut108idx1 = [](long I) -> long {
        /* GATE 99 (LUT2 _1092_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * gout100[0] + 2 * gout54[0];
    ...
    auto lut109idx0 = [](long I) -> long {
        /* GATE 96 (LUT2 _1089_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * gout103[1] + 2 * gout101[1];
    ...
    auto lut110idx0 = [](long I) -> long {
        /* GATE 308 (LUT2 _1301_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut110idx1 = [](long I) -> long {
        /* GATE 334 (LUT2 _1327_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * gout107[0] + 2 * gout52[0];
    ...
    auto lut111idx0 = [](long I) -> long {
        /* GATE 132 (LUT2 _1125_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut111idx1 = [](long I) -> long {
        /* GATE 162 (LUT2 _1155_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * gout99[0] + 2 * gout89[0];
    ...
    auto lut112idx0 = [](long I) -> long {
        /* GATE 95 (LUT2 _1088_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut112idx1 = [](long I) -> long {
        /* GATE 125 (LUT2 _1118_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * gout109[0] + 2 * gout108[1];
    ...
    auto lut113idx0 = [](long I) -> long {
        /* GATE 128 (LUT2 _1121_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * gout108[0] + 2 * gout100[1];
    ...
    auto lut114idx0 = [](long I) -> long {
        /* GATE 333 (LUT2 _1326_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * gout110[1] + 2 * gout107[1];
    ...
    auto lut115idx0 = [](long I) -> long {
        /* GATE 64 (LUT2 _1057_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * gout102[0] + 2 * gout86[1];
    ...
    auto lut116idx0 = [](long I) -> long {
        /* GATE 164 (LUT2 _1157_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut116idx1 = [](long I) -> long {
        /* GATE 194 (LUT2 _1187_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT116   ";
    Ciphertext gin116 = 1 * gout91[0] + 2 * gout41[1];
    ...
    auto lut117idx0 = [](long I) -> long {
        /* GATE 330 (LUT2 _1323_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut117idx1 = [](long I) -> long {
        /* GATE 284 (LUT2 _1277_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout96[0] + 2 * gout110[0];
    ...
    auto lut118idx0 = [](long I) -> long {
        /* GATE 63 (LUT2 _1056_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut118idx1 = [](long I) -> long {
        /* GATE 93 (LUT2 _1086_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * gout115[0] + 2 * gout103[0];
    ...
    auto lut119idx0 = [](long I) -> long {
        /* GATE 131 (LUT2 _1124_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut119idx1 = [](long I) -> long {
        /* GATE 161 (LUT2 _1154_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout111[0] + 2 * gout67[0];
    ...
    auto lut120idx0 = [](long I) -> long {
        /* GATE 127 (LUT2 _1120_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut120idx1 = [](long I) -> long {
        /* GATE 157 (LUT2 _1150_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * gout113[0] + 2 * gout119[0];
    ...
    auto lut121idx0 = [](long I) -> long {
        /* GATE 160 (LUT2 _1153_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout119[1] + 2 * gout111[1];
    ...
    auto lut122idx0 = [](long I) -> long {
        /* GATE 332 (LUT2 _1325_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut122idx1 = [](long I) -> long {
        /* GATE 61 (LUT2 _1054_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * gout114[0] + 2 * gout102[1];
    ...
    auto lut123idx0 = [](long I) -> long {
        /* GATE 94 (LUT2 _1087_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut123idx1 = [](long I) -> long {
        /* GATE 124 (LUT2 _1117_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * gout112[0] + 2 * gout95[0];
    ...
    auto lut124idx0 = [](long I) -> long {
        /* GATE 60 (LUT2 _1053_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut124idx1 = [](long I) -> long {
        /* GATE 331 (LUT2 _1324_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * gout122[0] + 2 * gout66[0];
    ...
    auto lut125idx0 = [](long I) -> long {
        /* GATE 283 (LUT2 _1276_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut125idx1 = [](long I) -> long {
        /* GATE 25 (LUT2 _1018_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * gout117[1] + 2 * gout56[0];
    ...
    auto lut126idx0 = [](long I) -> long {
        /* GATE 163 (LUT2 _1156_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut126idx1 = [](long I) -> long {
        /* GATE 193 (LUT2 _1186_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * gout116[0] + 2 * gout82[1];
    ...
    auto lut127idx0 = [](long I) -> long {
        /* GATE 123 (LUT2 _1116_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout123[1] + 2 * gout112[1];
    ...
    auto lut128idx0 = [](long I) -> long {
        /* GATE 92 (LUT2 _1085_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut128idx1 = [](long I) -> long {
        /* GATE 62 (LUT2 _1055_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout118[0] + 2 * gout84[0];
    ...
    auto lut129idx0 = [](long I) -> long {
        /* GATE 59 (LUT2 _1052_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * gout124[0] + 2 * gout122[1];
    ...
    auto lut130idx0 = [](long I) -> long {
        /* GATE 24 (LUT2 _1017_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout125[1] + 2 * gout98[0];
    ...
    auto lut131idx0 = [](long I) -> long {
        /* GATE 159 (LUT2 _1152_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut131idx1 = [](long I) -> long {
        /* GATE 189 (LUT2 _1182_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * gout121[0] + 2 * gout126[0];
    ...
    auto lut132idx0 = [](long I) -> long {
        /* GATE 89 (LUT2 _1082_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut132idx1 = [](long I) -> long {
        /* GATE 58 (LUT2 _1051_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout129[0] + 2 * gout128[1];
    ...
    auto lut133idx0 = [](long I) -> long {
        /* GATE 126 (LUT2 _1119_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut133idx1 = [](long I) -> long {
        /* GATE 156 (LUT2 _1149_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * gout120[0] + 2 * gout62[0];
    ...
    auto lut134idx0 = [](long I) -> long {
        /* GATE 91 (LUT2 _1084_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * gout128[0] + 2 * gout118[1];
    ...
    auto lut135idx0 = [](long I) -> long {
        /* GATE 153 (LUT2 _1146_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut135idx1 = [](long I) -> long {
        /* GATE 122 (LUT2 _1115_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * gout127[0] + 2 * gout133[0];
    ...
    auto lut136idx0 = [](long I) -> long {
        /* GATE 155 (LUT2 _1148_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout133[1] + 2 * gout120[1];
    ...
    auto lut137idx0 = [](long I) -> long {
        /* GATE 282 (LUT2 _1275_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * gout125[0] + 2 * gout117[0];
    ...
    auto lut138idx0 = [](long I) -> long {
        /* GATE 192 (LUT2 _1185_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout126[1] + 2 * gout116[1];
    ...
    auto lut139idx0 = [](long I) -> long {
        /* GATE 158 (LUT2 _1151_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut139idx1 = [](long I) -> long {
        /* GATE 188 (LUT2 _1181_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * gout131[0] + 2 * gout78[0];
    ...
    auto lut140idx0 = [](long I) -> long {
        /* GATE 281 (LUT2 _1274_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut140idx1 = [](long I) -> long {
        /* GATE 57 (LUT2 _1050_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout137[0] + 2 * gout124[1];
    ...
    auto lut141idx0 = [](long I) -> long {
        /* GATE 121 (LUT2 _1114_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut141idx1 = [](long I) -> long {
        /* GATE 90 (LUT2 _1083_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout134[0] + 2 * gout123[0];
    ...
    auto lut142idx0 = [](long I) -> long {
        /* GATE 280 (LUT2 _1273_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut142idx1 = [](long I) -> long {
        /* GATE 56 (LUT2 _1049_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * gout140[0] + 2 * gout130[0];
    ...
    auto lut143idx0 = [](long I) -> long {
        /* GATE 279 (LUT2 _1272_ INIT 0x6 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut143idx1 = [](long I) -> long {
        /* GATE 231 (LUT2 _1224_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * ct_window32 + 2 * gout142[0];
    ...
    auto lut144idx0 = [](long I) -> long {
        /* GATE 213 (LUT2 _1206_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut144idx1 = [](long I) -> long {
        /* GATE 191 (LUT2 _1184_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout138[0] + 2 * gout87[1];
    ...
    auto lut145idx0 = [](long I) -> long {
        /* GATE 187 (LUT2 _1180_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout139[1] + 2 * gout131[1];
    ...
    auto lut146idx0 = [](long I) -> long {
        /* GATE 154 (LUT2 _1147_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut146idx1 = [](long I) -> long {
        /* GATE 185 (LUT2 _1178_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * gout136[0] + 2 * gout139[0];
    ...
    auto lut147idx0 = [](long I) -> long {
        /* GATE 212 (LUT2 _1205_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut147idx1 = [](long I) -> long {
        /* GATE 190 (LUT2 _1183_ INIT 0x9 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout104[0] + 2 * gout144[1];
    ...
    auto lut148idx0 = [](long I) -> long {
        /* GATE 209 (LUT2 _1202_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut148idx1 = [](long I) -> long {
        /* GATE 186 (LUT2 _1179_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * gout145[0] + 2 * gout147[1];
    ...
    auto lut149idx0 = [](long I) -> long {
        /* GATE 211 (LUT2 _1204_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * gout147[0] + 2 * gout144[0];
    ...
    auto lut150idx0 = [](long I) -> long {
        /* GATE 55 (LUT2 _1048_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout142[1] + 2 * gout140[1];
    ...
    auto lut151idx0 = [](long I) -> long {
        /* GATE 210 (LUT2 _1203_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut151idx1 = [](long I) -> long {
        /* GATE 247 (LUT2 _1240_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout149[0] + 2 * gout105[0];
    ...
    auto lut152idx0 = [](long I) -> long {
        /* GATE 230 (LUT2 _1223_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut152idx1 = [](long I) -> long {
        /* GATE 54 (LUT2 _1047_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT152   ";
    Ciphertext gin152 = 1 * gout150[0] + 2 * gout132[1];
    ...
    auto lut153idx0 = [](long I) -> long {
        /* GATE 53 (LUT2 _1046_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout152[1] + 2 * gout132[0];
    ...
    auto lut154idx0 = [](long I) -> long {
        /* GATE 229 (LUT2 _1222_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut154idx1 = [](long I) -> long {
        /* GATE 232 (LUT2 _1225_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout152[0] + 2 * ct_window33;
    ...
    auto lut155idx0 = [](long I) -> long {
        /* GATE 228 (LUT2 _1221_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut155idx1 = [](long I) -> long {
        /* GATE 263 (LUT2 _1256_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * gout154[0] + 2 * gout143[1];
    ...
    auto lut156idx0 = [](long I) -> long {
        /* GATE 52 (LUT2 _1045_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut156idx1 = [](long I) -> long {
        /* GATE 234 (LUT2 _1227_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout153[0] + 2 * gout141[1];
    ...
    auto lut157idx0 = [](long I) -> long {
        /* GATE 262 (LUT2 _1255_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout155[1] + 2 * gout143[0];
    ...
    auto lut158idx0 = [](long I) -> long {
        /* GATE 51 (LUT2 _1044_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout156[0] + 2 * gout141[0];
    ...
    auto lut159idx0 = [](long I) -> long {
        /* GATE 233 (LUT2 _1226_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut159idx1 = [](long I) -> long {
        /* GATE 235 (LUT2 _1228_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * gout156[1] + 2 * ct_window34;
    ...
    auto lut160idx0 = [](long I) -> long {
        /* GATE 227 (LUT2 _1220_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout155[0] + 2 * gout154[1];
    ...
    auto lut161idx0 = [](long I) -> long {
        /* GATE 226 (LUT2 _1219_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut161idx1 = [](long I) -> long {
        /* GATE 266 (LUT2 _1259_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout160[0] + 2 * gout159[0];
    ...
    auto lut162idx0 = [](long I) -> long {
        /* GATE 257 (LUT2 _1250_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout154[0] + 2 * gout143[0];
    ...
    auto lut163idx0 = [](long I) -> long {
        /* GATE 225 (LUT2 _1218_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout161[0] + 2 * gout159[1];
    ...
    auto lut164idx0 = [](long I) -> long {
        /* GATE 224 (LUT2 _1217_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut164idx1 = [](long I) -> long {
        /* GATE 50 (LUT2 _1043_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout158[0] + 2 * gout135[1];
    ...
    auto lut165idx0 = [](long I) -> long {
        /* GATE 256 (LUT2 _1249_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout159[0] + 2 * gout162[0];
    ...
    auto lut166idx0 = [](long I) -> long {
        /* GATE 236 (LUT2 _1229_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut166idx1 = [](long I) -> long {
        /* GATE 223 (LUT2 _1216_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout164[0] + 2 * ct_window35;
    ...
    auto lut167idx0 = [](long I) -> long {
        /* GATE 222 (LUT2 _1215_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut167idx1 = [](long I) -> long {
        /* GATE 255 (LUT2 _1248_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * gout166[1] + 2 * gout163[0];
    ...
    auto lut168idx0 = [](long I) -> long {
        /* GATE 49 (LUT2 _1042_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout164[1] + 2 * gout135[0];
    ...
    auto lut169idx0 = [](long I) -> long {
        /* GATE 48 (LUT2 _1041_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut169idx1 = [](long I) -> long {
        /* GATE 238 (LUT2 _1231_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout168[0] + 2 * gout146[0];
    ...
    auto lut170idx0 = [](long I) -> long {
        /* GATE 254 (LUT2 _1247_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * gout165[0] + 2 * gout167[1];
    ...
    auto lut171idx0 = [](long I) -> long {
        /* GATE 237 (LUT2 _1230_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut171idx1 = [](long I) -> long {
        /* GATE 239 (LUT2 _1232_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout169[1] + 2 * ct_window36;
    ...
    auto lut172idx0 = [](long I) -> long {
        /* GATE 47 (LUT2 _1040_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout169[0] + 2 * gout146[1];
    ...
    auto lut173idx0 = [](long I) -> long {
        /* GATE 221 (LUT2 _1214_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout167[0] + 2 * gout166[0];
    ...
    auto lut174idx0 = [](long I) -> long {
        /* GATE 241 (LUT2 _1234_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut174idx1 = [](long I) -> long {
        /* GATE 46 (LUT2 _1039_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout172[0] + 2 * gout148[1];
    ...
    auto lut175idx0 = [](long I) -> long {
        /* GATE 253 (LUT2 _1246_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut175idx1 = [](long I) -> long {
        /* GATE 220 (LUT2 _1213_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout173[0] + 2 * gout171[0];
    ...
    auto lut176idx0 = [](long I) -> long {
        /* GATE 45 (LUT2 _1038_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout174[1] + 2 * gout148[0];
    ...
    auto lut177idx0 = [](long I) -> long {
        /* GATE 219 (LUT2 _1212_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * gout175[1] + 2 * gout171[1];
    ...
    auto lut178idx0 = [](long I) -> long {
        /* GATE 240 (LUT2 _1233_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut178idx1 = [](long I) -> long {
        /* GATE 242 (LUT2 _1235_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout174[0] + 2 * ct_window37;
    ...
    auto lut179idx0 = [](long I) -> long {
        /* GATE 246 (LUT2 _1239_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut179idx1 = [](long I) -> long {
        /* GATE 44 (LUT2 _1037_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout176[0] + 2 * gout151[0];
    ...
    auto lut180idx0 = [](long I) -> long {
        /* GATE 252 (LUT2 _1245_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout170[0] + 2 * gout175[0];
    ...
    auto lut181idx0 = [](long I) -> long {
        /* GATE 245 (LUT2 _1238_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout179[0] + 2 * gout151[1];
    ...
    auto lut182idx0 = [](long I) -> long {
        /* GATE 43 (LUT2 _1036_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut182idx1 = [](long I) -> long {
        /* GATE 243 (LUT2 _1236_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * gout179[1] + 2 * ct_window38;
    ...
    auto lut183idx0 = [](long I) -> long {
        /* GATE 218 (LUT2 _1211_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut183idx1 = [](long I) -> long {
        /* GATE 251 (LUT2 _1244_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout177[0] + 2 * gout178[0];
    ...
    auto lut184idx0 = [](long I) -> long {
        /* GATE 250 (LUT2 _1243_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout180[0] + 2 * gout183[1];
    ...
    auto lut185idx0 = [](long I) -> long {
        /* GATE 259 (LUT2 _1252_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut185idx1 = [](long I) -> long {
        /* GATE 244 (LUT2 _1237_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout181[0] + 2 * ct_window39;
    ...
    auto lut186idx0 = [](long I) -> long {
        /* GATE 217 (LUT2 _1210_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout183[0] + 2 * gout178[1];
    ...
    auto lut187idx0 = [](long I) -> long {
        /* GATE 42 (LUT2 _1035_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut187idx1 = [](long I) -> long {
        /* GATE 249 (LUT2 _1242_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout182[0] + 2 * gout186[0];
    ...
    auto lut188idx0 = [](long I) -> long {
        /* GATE 41 (LUT2 _1034_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout187[0] + 2 * gout182[1];
    ...
    auto lut189idx0 = [](long I) -> long {
        /* GATE 248 (LUT2 _1241_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout184[0] + 2 * gout187[1];
    ...
    auto lut190idx0 = [](long I) -> long {
        /* GATE 258 (LUT2 _1251_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout185[0] + 2 * gout188[0];
    ...
    auto lut191idx0 = [](long I) -> long {
        /* GATE 261 (LUT2 _1254_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut191idx1 = [](long I) -> long {
        /* GATE 40 (LUT2 _1033_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout188[0] + 2 * gout185[1];
    ...
    auto lut192idx0 = [](long I) -> long {
        /* GATE 260 (LUT2 _1253_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout191[0] + 2 * gout185[0];
    ...
    auto lut193idx0 = [](long I) -> long {
        /* GATE 278 (LUT2 _1271_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut193idx1 = [](long I) -> long {
        /* GATE 39 (LUT2 _1032_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * gout191[1] + 2 * gout189[0];
    ...
    auto lut194idx0 = [](long I) -> long {
        /* GATE 38 (LUT2 _1031_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout193[1] + 2 * gout190[0];
    ...
    auto lut195idx0 = [](long I) -> long {
        /* GATE 37 (LUT2 _1030_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout192[0] + 2 * gout194[0];
    ...
    auto lut196idx0 = [](long I) -> long {
        /* GATE 272 (LUT2 _1265_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout180[0] + 2 * gout195[0];
    ...
    auto lut197idx0 = [](long I) -> long {
        /* GATE 276 (LUT2 _1269_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout190[0] + 2 * gout195[0];
    ...
    auto lut198idx0 = [](long I) -> long {
        /* GATE 268 (LUT2 _1261_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout165[0] + 2 * gout195[0];
    ...
    auto lut199idx0 = [](long I) -> long {
        /* GATE 36 (LUT2 _1029_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT199   ";
    Ciphertext gin199 = 1 * gout162[0] + 2 * gout195[0];
    ...
    auto lut200idx0 = [](long I) -> long {
        /* GATE 277 (LUT2 _1270_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout193[0] + 2 * gout194[0];
    ...
    auto lut201idx0 = [](long I) -> long {
        /* GATE 271 (LUT2 _1264_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout196[0] + 2 * gout183[1];
    ...
    auto lut202idx0 = [](long I) -> long {
        /* GATE 264 (LUT2 _1257_ INIT 0x8 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout155[1] + 2 * gout195[0];
    ...
    auto lut203idx0 = [](long I) -> long {
        /* GATE 35 (LUT2 _1028_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout157[0] + 2 * gout199[0];
    ...
    auto lut204idx0 = [](long I) -> long {
        /* GATE 267 (LUT2 _1260_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * gout198[0] + 2 * gout167[1];
    ...
    auto lut205idx0 = [](long I) -> long {
        /* GATE 270 (LUT2 _1263_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT205   ";
    Ciphertext gin205 = 1 * gout170[0] + 2 * gout195[0];
    ...
    auto lut206idx0 = [](long I) -> long {
        /* GATE 34 (LUT2 _1027_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT206   ";
    Ciphertext gin206 = 1 * gout203[0] + 2 * gout202[0];
    ...
    auto lut207idx0 = [](long I) -> long {
        /* GATE 274 (LUT2 _1267_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout195[0] + 2 * gout184[0];
    ...
    auto lut208idx0 = [](long I) -> long {
        /* GATE 265 (LUT2 _1258_ INIT 0x6 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * gout161[1] + 2 * gout199[0];
    ...
    auto lut209idx0 = [](long I) -> long {
        /* GATE 273 (LUT2 _1266_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout207[0] + 2 * gout187[1];
    ...
    auto lut210idx0 = [](long I) -> long {
        /* GATE 275 (LUT2 _1268_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * gout197[0] + 2 * gout200[0];
    ...
    auto lut211idx0 = [](long I) -> long {
        /* GATE 269 (LUT2 _1262_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * gout205[0] + 2 * gout175[0];
    std::vector<Ciphertext> gout211 = ctx.eval_lut_amortized(&gin211, lut211);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout143[0])); /* out0 */
    test_out.push_back(ctx.decrypt(&gout206[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout208[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout204[0])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout211[0])); /* out4 */
    test_out.push_back(ctx.decrypt(&gout201[0])); /* out5 */
    test_out.push_back(ctx.decrypt(&gout209[0])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout210[0])); /* out7 */
    return test_out;
}

static void
BM_image_ricker_lut2(benchmark::State& state)
{
    FHEContext ctx;
    ...
    for (auto _ : state) {
        test_image_ricker_lut2(ctx);
    }
}

BENCHMARK(BM_image_ricker_lut2)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
