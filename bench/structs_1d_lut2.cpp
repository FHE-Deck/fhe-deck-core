...
std::vector<long>
test_structs_1d_lut2(FHEContext& ctx, uint64_t data = 0)
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 30 (LUT2 _469_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 29 (LUT2 _468_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_data5 + 2 * ct_data37;
    ...
    auto lut1idx0 = [](long I) -> long {
        /* GATE 23 (LUT2 _462_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut1idx1 = [](long I) -> long {
        /* GATE 24 (LUT2 _463_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_data2 + 2 * ct_data34;
    ...
    auto lut2idx0 = [](long I) -> long {
        /* GATE 21 (LUT2 _460_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut2idx1 = [](long I) -> long {
        /* GATE 22 (LUT2 _461_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_data1 + 2 * ct_data33;
    ...
    auto lut3idx0 = [](long I) -> long {
        /* GATE 25 (LUT2 _464_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut3idx1 = [](long I) -> long {
        /* GATE 26 (LUT2 _465_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_data3 + 2 * ct_data35;
    ...
    auto lut4idx0 = [](long I) -> long {
        /* GATE 58 (LUT2 _497_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut4idx1 = [](long I) -> long {
        /* GATE 53 (LUT2 _492_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut4idx2 = [](long I) -> long {
        /* GATE 57 (LUT2 _496_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_data13 + 2 * ct_data45;
    ...
    auto lut5idx0 = [](long I) -> long {
        /* GATE 139 (LUT2 _578_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut5idx1 = [](long I) -> long {
        /* GATE 135 (LUT2 _574_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_data28 + 2 * ct_data60;
    ...
    auto lut6idx0 = [](long I) -> long {
        /* GATE 123 (LUT2 _562_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut6idx1 = [](long I) -> long {
        /* GATE 119 (LUT2 _558_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_data25 + 2 * ct_data57;
    ...
    auto lut7idx0 = [](long I) -> long {
        /* GATE 41 (LUT2 _480_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut7idx1 = [](long I) -> long {
        /* GATE 37 (LUT2 _476_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_data10 + 2 * ct_data42;
    ...
    auto lut8idx0 = [](long I) -> long {
        /* GATE 64 (LUT2 _503_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut8idx1 = [](long I) -> long {
        /* GATE 68 (LUT2 _507_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut8idx2 = [](long I) -> long {
        /* GATE 69 (LUT2 _508_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_data15 + 2 * ct_data47;
    ...
    auto lut9idx0 = [](long I) -> long {
        /* GATE 74 (LUT2 _513_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut9idx1 = [](long I) -> long {
        /* GATE 70 (LUT2 _509_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_data16 + 2 * ct_data48;
    ...
    auto lut10idx0 = [](long I) -> long {
        /* GATE 33 (LUT2 _472_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut10idx1 = [](long I) -> long {
        /* GATE 154 (LUT2 _593_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_data7 + 2 * ct_data39;
    ...
    auto lut11idx0 = [](long I) -> long {
        /* GATE 103 (LUT2 _542_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut11idx1 = [](long I) -> long {
        /* GATE 107 (LUT2 _546_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_data22 + 2 * ct_data54;
    ...
    auto lut12idx0 = [](long I) -> long {
        /* GATE 75 (LUT2 _514_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut12idx1 = [](long I) -> long {
        /* GATE 79 (LUT2 _518_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut12idx2 = [](long I) -> long {
        /* GATE 80 (LUT2 _519_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    lut12.push_back(ctx.genrate_lut(lut12idx2));
    flut12.push_back(lut12idx2);
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_data17 + 2 * ct_data49;
    ...
    auto lut13idx0 = [](long I) -> long {
        /* GATE 157 (LUT2 _596_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut13idx1 = [](long I) -> long {
        /* GATE 36 (LUT2 _475_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_data9 + 2 * ct_data41;
    ...
    auto lut14idx0 = [](long I) -> long {
        /* GATE 81 (LUT2 _520_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut14idx1 = [](long I) -> long {
        /* GATE 85 (LUT2 _524_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_data18 + 2 * ct_data50;
    ...
    auto lut15idx0 = [](long I) -> long {
        /* GATE 101 (LUT2 _540_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut15idx1 = [](long I) -> long {
        /* GATE 102 (LUT2 _541_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut15idx2 = [](long I) -> long {
        /* GATE 97 (LUT2 _536_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_data21 + 2 * ct_data53;
    ...
    auto lut16idx0 = [](long I) -> long {
        /* GATE 140 (LUT2 _579_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut16idx1 = [](long I) -> long {
        /* GATE 144 (LUT2 _583_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_data29 + 2 * ct_data61;
    ...
    auto lut17idx0 = [](long I) -> long {
        /* GATE 114 (LUT2 _553_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut17idx1 = [](long I) -> long {
        /* GATE 118 (LUT2 _557_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_data24 + 2 * ct_data56;
    ...
    auto lut18idx0 = [](long I) -> long {
        /* GATE 91 (LUT2 _530_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut18idx1 = [](long I) -> long {
        /* GATE 86 (LUT2 _525_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut18idx2 = [](long I) -> long {
        /* GATE 90 (LUT2 _529_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_data19 + 2 * ct_data51;
    ...
    auto lut19idx0 = [](long I) -> long {
        /* GATE 42 (LUT2 _481_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut19idx1 = [](long I) -> long {
        /* GATE 46 (LUT2 _485_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut19idx2 = [](long I) -> long {
        /* GATE 47 (LUT2 _486_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_data11 + 2 * ct_data43;
    ...
    auto lut20idx0 = [](long I) -> long {
        /* GATE 92 (LUT2 _531_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut20idx1 = [](long I) -> long {
        /* GATE 96 (LUT2 _535_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_data20 + 2 * ct_data52;
    ...
    auto lut21idx0 = [](long I) -> long {
        /* GATE 48 (LUT2 _487_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut21idx1 = [](long I) -> long {
        /* GATE 52 (LUT2 _491_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_data12 + 2 * ct_data44;
    ...
    auto lut22idx0 = [](long I) -> long {
        /* GATE 145 (LUT2 _584_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_data30 + 2 * ct_data62;
    ...
    auto lut23idx0 = [](long I) -> long {
        /* GATE 146 (LUT2 _585_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut23idx1 = [](long I) -> long {
        /* GATE 20 (LUT2 _459_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_data0 + 2 * ct_data32;
    ...
    auto lut24idx0 = [](long I) -> long {
        /* GATE 129 (LUT2 _568_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut24idx1 = [](long I) -> long {
        /* GATE 133 (LUT2 _572_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut24idx2 = [](long I) -> long {
        /* GATE 134 (LUT2 _573_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_data27 + 2 * ct_data59;
    ...
    auto lut25idx0 = [](long I) -> long {
        /* GATE 59 (LUT2 _498_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut25idx1 = [](long I) -> long {
        /* GATE 63 (LUT2 _502_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_data14 + 2 * ct_data46;
    ...
    auto lut26idx0 = [](long I) -> long {
        /* GATE 27 (LUT2 _466_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut26idx1 = [](long I) -> long {
        /* GATE 28 (LUT2 _467_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_data4 + 2 * ct_data36;
    ...
    auto lut27idx0 = [](long I) -> long {
        /* GATE 112 (LUT2 _551_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut27idx1 = [](long I) -> long {
        /* GATE 113 (LUT2 _552_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut27idx2 = [](long I) -> long {
        /* GATE 108 (LUT2 _547_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    lut27.push_back(ctx.genrate_lut(lut27idx2));
    flut27.push_back(lut27idx2);
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_data23 + 2 * ct_data55;
    ...
    auto lut28idx0 = [](long I) -> long {
        /* GATE 124 (LUT2 _563_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut28idx1 = [](long I) -> long {
        /* GATE 128 (LUT2 _567_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_data26 + 2 * ct_data58;
    ...
    auto lut29idx0 = [](long I) -> long {
        /* GATE 32 (LUT2 _471_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut29idx1 = [](long I) -> long {
        /* GATE 31 (LUT2 _470_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_data6 + 2 * ct_data38;
    ...
    auto lut30idx0 = [](long I) -> long {
        /* GATE 35 (LUT2 _474_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut30idx1 = [](long I) -> long {
        /* GATE 34 (LUT2 _473_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_data8 + 2 * ct_data40;
    ...
    auto lut31idx0 = [](long I) -> long {
        /* GATE 147 (LUT2 _586_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut31idx1 = [](long I) -> long {
        /* GATE 19 (LUT2 _458_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut32idx0 = [](long I) -> long {
        /* GATE 18 (LUT2 _457_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout31[1] + 2 * gout2[1];
    ...
    auto lut33idx0 = [](long I) -> long {
        /* GATE 17 (LUT2 _456_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut33idx1 = [](long I) -> long {
        /* GATE 148 (LUT2 _587_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout32[0] + 2 * gout1[0];
    ...
    auto lut34idx0 = [](long I) -> long {
        /* GATE 16 (LUT2 _455_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout33[0] + 2 * gout1[1];
    ...
    auto lut35idx0 = [](long I) -> long {
        /* GATE 149 (LUT2 _588_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut35idx1 = [](long I) -> long {
        /* GATE 15 (LUT2 _454_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout34[0] + 2 * gout3[0];
    ...
    auto lut36idx0 = [](long I) -> long {
        /* GATE 14 (LUT2 _453_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout35[1] + 2 * gout3[1];
    ...
    auto lut37idx0 = [](long I) -> long {
        /* GATE 13 (LUT2 _452_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut37idx1 = [](long I) -> long {
        /* GATE 150 (LUT2 _589_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout36[0] + 2 * gout26[0];
    ...
    auto lut38idx0 = [](long I) -> long {
        /* GATE 12 (LUT2 _451_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout37[0] + 2 * gout26[1];
    ...
    auto lut39idx0 = [](long I) -> long {
        /* GATE 11 (LUT2 _450_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut39idx1 = [](long I) -> long {
        /* GATE 151 (LUT2 _590_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout38[0] + 2 * gout0[1];
    ...
    auto lut40idx0 = [](long I) -> long {
        /* GATE 10 (LUT2 _449_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout39[0] + 2 * gout0[0];
    ...
    auto lut41idx0 = [](long I) -> long {
        /* GATE 9 (LUT2 _448_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut41idx1 = [](long I) -> long {
        /* GATE 152 (LUT2 _591_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout40[0] + 2 * gout29[1];
    ...
    auto lut42idx0 = [](long I) -> long {
        /* GATE 8 (LUT2 _447_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout41[0] + 2 * gout29[0];
    ...
    auto lut43idx0 = [](long I) -> long {
        /* GATE 153 (LUT2 _592_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut43idx1 = [](long I) -> long {
        /* GATE 7 (LUT2 _446_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout42[0] + 2 * gout10[1];
    ...
    auto lut44idx0 = [](long I) -> long {
        /* GATE 6 (LUT2 _445_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout43[1] + 2 * gout10[0];
    ...
    auto lut45idx0 = [](long I) -> long {
        /* GATE 155 (LUT2 _594_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut45idx1 = [](long I) -> long {
        /* GATE 5 (LUT2 _444_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout44[0] + 2 * gout30[1];
    ...
    auto lut46idx0 = [](long I) -> long {
        /* GATE 4 (LUT2 _443_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout45[1] + 2 * gout30[0];
    ...
    auto lut47idx0 = [](long I) -> long {
        /* GATE 156 (LUT2 _595_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut47idx1 = [](long I) -> long {
        /* GATE 3 (LUT2 _442_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout46[0] + 2 * gout13[0];
    ...
    auto lut48idx0 = [](long I) -> long {
        /* GATE 2 (LUT2 _441_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout47[1] + 2 * gout13[1];
    ...
    auto lut49idx0 = [](long I) -> long {
        /* GATE 1 (LUT2 _440_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut49idx1 = [](long I) -> long {
        /* GATE 40 (LUT2 _479_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout48[0] + 2 * gout7[1];
    ...
    auto lut50idx0 = [](long I) -> long {
        /* GATE 39 (LUT2 _478_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout49[1] + 2 * gout7[0];
    ...
    auto lut51idx0 = [](long I) -> long {
        /* GATE 38 (LUT2 _477_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout50[0] + 2 * gout19[0];
    ...
    auto lut52idx0 = [](long I) -> long {
        /* GATE 45 (LUT2 _484_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout19[1] + 2 * gout50[0];
    ...
    auto lut53idx0 = [](long I) -> long {
        /* GATE 44 (LUT2 _483_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout52[0] + 2 * gout19[2];
    ...
    auto lut54idx0 = [](long I) -> long {
        /* GATE 43 (LUT2 _482_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut54idx1 = [](long I) -> long {
        /* GATE 51 (LUT2 _490_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout53[0] + 2 * gout21[0];
    ...
    auto lut55idx0 = [](long I) -> long {
        /* GATE 50 (LUT2 _489_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout54[1] + 2 * gout21[1];
    ...
    auto lut56idx0 = [](long I) -> long {
        /* GATE 49 (LUT2 _488_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout55[0] + 2 * gout4[1];
    ...
    auto lut57idx0 = [](long I) -> long {
        /* GATE 56 (LUT2 _495_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout4[2] + 2 * gout55[0];
    ...
    auto lut58idx0 = [](long I) -> long {
        /* GATE 55 (LUT2 _494_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout57[0] + 2 * gout4[0];
    ...
    auto lut59idx0 = [](long I) -> long {
        /* GATE 54 (LUT2 _493_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut59idx1 = [](long I) -> long {
        /* GATE 62 (LUT2 _501_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout58[0] + 2 * gout25[0];
    ...
    auto lut60idx0 = [](long I) -> long {
        /* GATE 61 (LUT2 _500_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout59[1] + 2 * gout25[1];
    ...
    auto lut61idx0 = [](long I) -> long {
        /* GATE 67 (LUT2 _506_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout8[1] + 2 * gout60[0];
    ...
    auto lut62idx0 = [](long I) -> long {
        /* GATE 66 (LUT2 _505_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout61[0] + 2 * gout8[2];
    ...
    auto lut63idx0 = [](long I) -> long {
        /* GATE 60 (LUT2 _499_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout60[0] + 2 * gout8[0];
    ...
    auto lut64idx0 = [](long I) -> long {
        /* GATE 73 (LUT2 _512_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut64idx1 = [](long I) -> long {
        /* GATE 65 (LUT2 _504_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout62[0] + 2 * gout9[1];
    ...
    auto lut65idx0 = [](long I) -> long {
        /* GATE 72 (LUT2 _511_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout64[0] + 2 * gout9[0];
    ...
    auto lut66idx0 = [](long I) -> long {
        /* GATE 71 (LUT2 _510_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout65[0] + 2 * gout12[0];
    ...
    auto lut67idx0 = [](long I) -> long {
        /* GATE 78 (LUT2 _517_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout12[1] + 2 * gout65[0];
    ...
    auto lut68idx0 = [](long I) -> long {
        /* GATE 77 (LUT2 _516_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout67[0] + 2 * gout12[2];
    ...
    auto lut69idx0 = [](long I) -> long {
        /* GATE 76 (LUT2 _515_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut69idx1 = [](long I) -> long {
        /* GATE 84 (LUT2 _523_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout68[0] + 2 * gout14[0];
    ...
    auto lut70idx0 = [](long I) -> long {
        /* GATE 83 (LUT2 _522_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout69[1] + 2 * gout14[1];
    ...
    auto lut71idx0 = [](long I) -> long {
        /* GATE 82 (LUT2 _521_ INIT 0x9 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout18[1] + 2 * gout70[0];
    ...
    auto lut72idx0 = [](long I) -> long {
        /* GATE 89 (LUT2 _528_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout70[0] + 2 * gout18[2];
    ...
    auto lut73idx0 = [](long I) -> long {
        /* GATE 88 (LUT2 _527_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout72[0] + 2 * gout18[0];
    ...
    auto lut74idx0 = [](long I) -> long {
        /* GATE 95 (LUT2 _534_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut74idx1 = [](long I) -> long {
        /* GATE 87 (LUT2 _526_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout73[0] + 2 * gout20[0];
    ...
    auto lut75idx0 = [](long I) -> long {
        /* GATE 94 (LUT2 _533_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout74[0] + 2 * gout20[1];
    ...
    auto lut76idx0 = [](long I) -> long {
        /* GATE 93 (LUT2 _532_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout75[0] + 2 * gout15[2];
    ...
    auto lut77idx0 = [](long I) -> long {
        /* GATE 100 (LUT2 _539_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout15[0] + 2 * gout75[0];
    ...
    auto lut78idx0 = [](long I) -> long {
        /* GATE 99 (LUT2 _538_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout77[0] + 2 * gout15[1];
    ...
    auto lut79idx0 = [](long I) -> long {
        /* GATE 98 (LUT2 _537_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut79idx1 = [](long I) -> long {
        /* GATE 106 (LUT2 _545_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout78[0] + 2 * gout11[0];
    ...
    auto lut80idx0 = [](long I) -> long {
        /* GATE 105 (LUT2 _544_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout79[1] + 2 * gout11[1];
    ...
    auto lut81idx0 = [](long I) -> long {
        /* GATE 104 (LUT2 _543_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout80[0] + 2 * gout27[2];
    ...
    auto lut82idx0 = [](long I) -> long {
        /* GATE 111 (LUT2 _550_ INIT 0x1 PERM 10) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout27[0] + 2 * gout80[0];
    ...
    auto lut83idx0 = [](long I) -> long {
        /* GATE 110 (LUT2 _549_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout82[0] + 2 * gout27[1];
    ...
    auto lut84idx0 = [](long I) -> long {
        /* GATE 109 (LUT2 _548_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut84idx1 = [](long I) -> long {
        /* GATE 117 (LUT2 _556_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout83[0] + 2 * gout17[0];
    ...
    auto lut85idx0 = [](long I) -> long {
        /* GATE 116 (LUT2 _555_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout84[1] + 2 * gout17[1];
    ...
    auto lut86idx0 = [](long I) -> long {
        /* GATE 122 (LUT2 _561_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut86idx1 = [](long I) -> long {
        /* GATE 115 (LUT2 _554_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout85[0] + 2 * gout6[1];
    ...
    auto lut87idx0 = [](long I) -> long {
        /* GATE 121 (LUT2 _560_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout86[0] + 2 * gout6[0];
    ...
    auto lut88idx0 = [](long I) -> long {
        /* GATE 127 (LUT2 _566_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut88idx1 = [](long I) -> long {
        /* GATE 120 (LUT2 _559_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout87[0] + 2 * gout28[0];
    ...
    auto lut89idx0 = [](long I) -> long {
        /* GATE 126 (LUT2 _565_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout88[0] + 2 * gout28[1];
    ...
    auto lut90idx0 = [](long I) -> long {
        /* GATE 125 (LUT2 _564_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout89[0] + 2 * gout24[0];
    ...
    auto lut91idx0 = [](long I) -> long {
        /* GATE 132 (LUT2 _571_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout24[1] + 2 * gout89[0];
    ...
    auto lut92idx0 = [](long I) -> long {
        /* GATE 131 (LUT2 _570_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout91[0] + 2 * gout24[2];
    ...
    auto lut93idx0 = [](long I) -> long {
        /* GATE 130 (LUT2 _569_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut93idx1 = [](long I) -> long {
        /* GATE 138 (LUT2 _577_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout92[0] + 2 * gout5[1];
    ...
    auto lut94idx0 = [](long I) -> long {
        /* GATE 137 (LUT2 _576_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout93[1] + 2 * gout5[0];
    ...
    auto lut95idx0 = [](long I) -> long {
        /* GATE 136 (LUT2 _575_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut95idx1 = [](long I) -> long {
        /* GATE 143 (LUT2 _582_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout94[0] + 2 * gout16[0];
    ...
    auto lut96idx0 = [](long I) -> long {
        /* GATE 142 (LUT2 _581_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout95[1] + 2 * gout16[1];
    ...
    auto lut97idx0 = [](long I) -> long {
        /* GATE 141 (LUT2 _580_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout96[0] + 2 * gout22[0];
    std::vector<Ciphertext> gout97 = ctx.eval_lut_amortized(&gin97, lut97);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout23[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout31[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout33[1])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout35[0])); /* out4 */
    test_out.push_back(ctx.decrypt(&gout37[1])); /* out5 */
    test_out.push_back(ctx.decrypt(&gout39[1])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout41[1])); /* out7 */
    test_out.push_back(ctx.decrypt(&gout43[0])); /* out8 */
    test_out.push_back(ctx.decrypt(&gout45[0])); /* out9 */
    test_out.push_back(ctx.decrypt(&gout47[0])); /* out10 */
    test_out.push_back(ctx.decrypt(&gout49[0])); /* out11 */
    test_out.push_back(ctx.decrypt(&gout51[0])); /* out12 */
    test_out.push_back(ctx.decrypt(&gout54[0])); /* out13 */
    test_out.push_back(ctx.decrypt(&gout56[0])); /* out14 */
    test_out.push_back(ctx.decrypt(&gout59[0])); /* out15 */
    test_out.push_back(ctx.decrypt(&gout63[0])); /* out16 */
    test_out.push_back(ctx.decrypt(&gout64[1])); /* out17 */
    test_out.push_back(ctx.decrypt(&gout66[0])); /* out18 */
    test_out.push_back(ctx.decrypt(&gout69[0])); /* out19 */
    test_out.push_back(ctx.decrypt(&gout71[0])); /* out20 */
    test_out.push_back(ctx.decrypt(&gout74[1])); /* out21 */
    test_out.push_back(ctx.decrypt(&gout76[0])); /* out22 */
    test_out.push_back(ctx.decrypt(&gout79[0])); /* out23 */
    test_out.push_back(ctx.decrypt(&gout81[0])); /* out24 */
    test_out.push_back(ctx.decrypt(&gout84[0])); /* out25 */
    test_out.push_back(ctx.decrypt(&gout86[1])); /* out26 */
    test_out.push_back(ctx.decrypt(&gout88[1])); /* out27 */
    test_out.push_back(ctx.decrypt(&gout90[0])); /* out28 */
    test_out.push_back(ctx.decrypt(&gout93[0])); /* out29 */
    test_out.push_back(ctx.decrypt(&gout95[0])); /* out30 */
    test_out.push_back(ctx.decrypt(&gout97[0])); /* out31 */
    return test_out;
}

static void
BM_structs_1d_lut2(benchmark::State& state)
{
    FHEContext ctx;
    ...
    for (auto _ : state) {
        test_structs_1d_lut2(ctx);
    }
}

BENCHMARK(BM_structs_1d_lut2)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
