...
test_structs_1d_lut2(FHEContext& ctx, uint64_t data = 0)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_data19 + 2 * ct_data51;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_data8 + 2 * ct_data40;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_data5 + 2 * ct_data37;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_data6 + 2 * ct_data38;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_data0 + 2 * ct_data32;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_data14 + 2 * ct_data46;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_data4 + 2 * ct_data36;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_data17 + 2 * ct_data49;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_data1 + 2 * ct_data33;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_data21 + 2 * ct_data53;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * gout4[1] + 2 * gout8[0];
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_data13 + 2 * ct_data45;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_data7 + 2 * ct_data39;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_data24 + 2 * ct_data56;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_data2 + 2 * ct_data34;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_data9 + 2 * ct_data41;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * gout10[1] + 2 * gout8[1];
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_data27 + 2 * ct_data59;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_data30 + 2 * ct_data62;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_data26 + 2 * ct_data58;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_data12 + 2 * ct_data44;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_data22 + 2 * ct_data54;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * gout16[0] + 2 * gout14[1];
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_data28 + 2 * ct_data60;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_data18 + 2 * ct_data50;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_data11 + 2 * ct_data43;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_data29 + 2 * ct_data61;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_data25 + 2 * ct_data57;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_data15 + 2 * ct_data47;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_data3 + 2 * ct_data35;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_data20 + 2 * ct_data52;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_data16 + 2 * ct_data48;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * ct_data10 + 2 * ct_data42;
    ...
    lut33.push_back(ctx.genrate_lut(lut33idx2));
    flut33.push_back(lut33idx2);
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * ct_data23 + 2 * ct_data55;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout22[0] + 2 * gout14[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout34[0] + 2 * gout29[0];
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout35[0] + 2 * gout29[1];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout36[0] + 2 * gout6[0];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout37[1] + 2 * gout6[1];
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout38[0] + 2 * gout2[0];
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout39[1] + 2 * gout2[1];
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout40[0] + 2 * gout3[0];
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout41[0] + 2 * gout3[1];
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout42[0] + 2 * gout12[1];
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout43[0] + 2 * gout12[0];
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout44[0] + 2 * gout1[0];
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout45[0] + 2 * gout1[1];
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout47[0] + 2 * gout15[0];
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout48[0] + 2 * gout32[0];
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout49[1] + 2 * gout32[1];
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout50[0] + 2 * gout25[1];
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout25[2] + 2 * gout50[0];
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout52[0] + 2 * gout25[0];
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout53[0] + 2 * gout20[0];
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout54[0] + 2 * gout20[1];
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout55[0] + 2 * gout11[1];
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout11[2] + 2 * gout55[0];
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout57[0] + 2 * gout11[0];
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout58[0] + 2 * gout5[0];
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout59[0] + 2 * gout5[1];
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout28[2] + 2 * gout60[0];
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout61[0] + 2 * gout28[0];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout60[0] + 2 * gout28[1];
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout62[0] + 2 * gout31[0];
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout64[0] + 2 * gout31[1];
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout65[0] + 2 * gout7[2];
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout7[0] + 2 * gout65[0];
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout67[0] + 2 * gout7[1];
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout68[0] + 2 * gout24[0];
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout69[0] + 2 * gout24[1];
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout0[2] + 2 * gout70[0];
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout70[0] + 2 * gout0[0];
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout72[0] + 2 * gout0[1];
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout73[0] + 2 * gout30[0];
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout74[1] + 2 * gout30[1];
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout75[0] + 2 * gout9[2];
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout9[0] + 2 * gout75[0];
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout77[0] + 2 * gout9[1];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout78[0] + 2 * gout21[0];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout79[1] + 2 * gout21[1];
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout80[0] + 2 * gout33[0];
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout33[1] + 2 * gout80[0];
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout82[0] + 2 * gout33[2];
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout83[0] + 2 * gout13[1];
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout84[0] + 2 * gout13[0];
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout85[0] + 2 * gout27[0];
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout86[0] + 2 * gout27[1];
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout87[0] + 2 * gout19[1];
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout88[0] + 2 * gout19[0];
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout89[0] + 2 * gout17[0];
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout17[1] + 2 * gout89[0];
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout91[0] + 2 * gout17[2];
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout92[0] + 2 * gout23[0];
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout93[1] + 2 * gout23[1];
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout94[0] + 2 * gout26[0];
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout95[0] + 2 * gout26[1];
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout96[0] + 2 * gout18[0];
    std::vector<Ciphertext> gout97 = ctx.eval_lut_amortized(&gin97, lut97);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout4[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout10[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout22[1])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout35[1])); /* out4 */
    test_out.push_back(ctx.decrypt(&gout37[0])); /* out5 */
    test_out.push_back(ctx.decrypt(&gout39[0])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout41[1])); /* out7 */
    test_out.push_back(ctx.decrypt(&gout43[1])); /* out8 */
    test_out.push_back(ctx.decrypt(&gout45[1])); /* out9 */
    test_out.push_back(ctx.decrypt(&gout47[1])); /* out10 */
    test_out.push_back(ctx.decrypt(&gout49[0])); /* out11 */
    test_out.push_back(ctx.decrypt(&gout51[0])); /* out12 */
    test_out.push_back(ctx.decrypt(&gout54[1])); /* out13 */
    test_out.push_back(ctx.decrypt(&gout56[0])); /* out14 */
    test_out.push_back(ctx.decrypt(&gout59[1])); /* out15 */
    ...
    test_out.push_back(ctx.decrypt(&gout69[1])); /* out19 */
    test_out.push_back(ctx.decrypt(&gout71[0])); /* out20 */
    test_out.push_back(ctx.decrypt(&gout74[0])); /* out21 */
    ...
    test_out.push_back(ctx.decrypt(&gout84[1])); /* out25 */
    ...
    test_out.push_back(ctx.decrypt(&gout95[1])); /* out30 */
