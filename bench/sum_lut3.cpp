...
test_sum_lut3(FHEContext& ctx, uint32_t a = 0, uint32_t b = 0)
{
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * gout4[1] + 2 * ct_a5 + 4 * ct_b5;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * gout5[1] + 2 * ct_a6 + 4 * ct_b6;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * gout6[0] + 2 * ct_a7 + 4 * ct_b7;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * gout7[0] + 2 * ct_a8 + 4 * ct_b8;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * gout9[0] + 2 * ct_a10 + 4 * ct_b10;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * gout11[0] + 2 * ct_a12 + 4 * ct_b12;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout12[1] + 2 * ct_a13 + 4 * ct_b13;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * gout13[0] + 2 * ct_a14 + 4 * ct_b14;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * gout16[1] + 2 * ct_a17 + 4 * ct_b17;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout17[0] + 2 * ct_a18 + 4 * ct_b18;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * gout22[0] + 2 * ct_a23 + 4 * ct_b23;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout24[1] + 2 * ct_a25 + 4 * ct_b25;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout25[1] + 2 * ct_a26 + 4 * ct_b26;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout27[0] + 2 * ct_a28 + 4 * ct_b28;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout28[1] + 2 * ct_a29 + 4 * ct_b29;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout29[0] + 2 * ct_a30 + 4 * ct_b30;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout30[0] + 2 * ct_a31 + 4 * ct_b31;
    ...
    test_out.push_back(ctx.decrypt(&gout6[1])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout7[1])); /* out7 */
    test_out.push_back(ctx.decrypt(&gout8[0])); /* out8 */
    test_out.push_back(ctx.decrypt(&gout9[1])); /* out9 */
    test_out.push_back(ctx.decrypt(&gout10[0])); /* out10 */
    test_out.push_back(ctx.decrypt(&gout11[1])); /* out11 */
    test_out.push_back(ctx.decrypt(&gout12[0])); /* out12 */
    test_out.push_back(ctx.decrypt(&gout13[1])); /* out13 */
    ...
    test_out.push_back(ctx.decrypt(&gout17[1])); /* out17 */
    ...
    test_out.push_back(ctx.decrypt(&gout22[1])); /* out22 */
    ...
    test_out.push_back(ctx.decrypt(&gout27[1])); /* out27 */
    test_out.push_back(ctx.decrypt(&gout28[0])); /* out28 */
    test_out.push_back(ctx.decrypt(&gout29[1])); /* out29 */
    test_out.push_back(ctx.decrypt(&gout30[1])); /* out30 */
