...
std::vector<long>
test_add4_lut2(FHEContext& ctx, uint8_t a = 0, uint8_t b = 0)
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 9 (LUT2 _54_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 8 (LUT2 _53_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut1idx0 = [](long I) -> long {
        /* GATE 10 (LUT2 _55_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut1idx1 = [](long I) -> long {
        /* GATE 11 (LUT2 _56_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_a2 + 2 * ct_b2;
    ...
    auto lut2idx0 = [](long I) -> long {
        /* GATE 7 (LUT2 _52_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut2idx1 = [](long I) -> long {
        /* GATE 17 (LUT2 _62_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_a0 + 2 * ct_b0;
    ...
    auto lut3idx0 = [](long I) -> long {
        /* GATE 12 (LUT2 _57_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut3idx1 = [](long I) -> long {
        /* GATE 13 (LUT2 _58_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_a3 + 2 * ct_b3;
    ...
    auto lut4idx0 = [](long I) -> long {
        /* GATE 14 (LUT2 _59_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut4idx1 = [](long I) -> long {
        /* GATE 6 (LUT2 _51_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * gout2[0] + 2 * gout0[1];
    ...
    auto lut5idx0 = [](long I) -> long {
        /* GATE 5 (LUT2 _50_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * gout4[1] + 2 * gout0[0];
    ...
    auto lut6idx0 = [](long I) -> long {
        /* GATE 4 (LUT2 _49_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut6idx1 = [](long I) -> long {
        /* GATE 15 (LUT2 _60_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * gout5[0] + 2 * gout1[0];
    ...
    auto lut7idx0 = [](long I) -> long {
        /* GATE 3 (LUT2 _48_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * gout6[0] + 2 * gout1[1];
    ...
    auto lut8idx0 = [](long I) -> long {
        /* GATE 16 (LUT2 _61_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut8idx1 = [](long I) -> long {
        /* GATE 2 (LUT2 _47_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * gout7[0] + 2 * gout3[0];
    ...
    auto lut9idx0 = [](long I) -> long {
        /* GATE 1 (LUT2 _46_ INIT 0xe PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * gout8[1] + 2 * gout3[1];
    std::vector<Ciphertext> gout9 = ctx.eval_lut_amortized(&gin9, lut9);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout2[1])); /* out0 */
    test_out.push_back(ctx.decrypt(&gout4[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout6[1])); /* out2 */
...
static void
BM_add4_lut2(benchmark::State& state)
{
    FHEContext ctx;
...
BENCHMARK(BM_add4_lut2)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
