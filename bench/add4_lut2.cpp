...
test_add4_lut2(FHEContext& ctx, uint8_t a = 0, uint8_t b = 0)
{
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_a1 + 2 * ct_b1;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * gout0[0] + 2 * gout3[1];
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * gout4[0] + 2 * gout3[0];
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * gout5[0] + 2 * gout2[1];
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * gout6[1] + 2 * gout2[0];
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * gout7[0] + 2 * gout1[0];
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * gout8[0] + 2 * gout1[1];
    ...
    test_out.push_back(ctx.decrypt(&gout8[1])); /* out3 */
