...
std::vector<long>
test_image_ricker_lut4(FHEContext& ctx, std::vector<uint64_t> window = { 0 })
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 129 (LUT3 _543_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 106 (LUT3 _520_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_window51 + 2 * ct_window27 + 4 * ct_window43;
    ...
    auto lut1idx0 = [](long I) -> long {
        /* GATE 84 (LUT3 _498_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut1idx1 = [](long I) -> long {
        /* GATE 93 (LUT3 _507_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_window17 + 2 * ct_window1 + 4 * ct_window9;
    ...
    auto lut2idx0 = [](long I) -> long {
        /* GATE 12 (LUT3 _426_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut2idx1 = [](long I) -> long {
        /* GATE 26 (LUT3 _440_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut3idx0 = [](long I) -> long {
        /* GATE 23 (LUT3 _437_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut3idx1 = [](long I) -> long {
        /* GATE 32 (LUT3 _446_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_window23 + 2 * ct_window7 + 4 * ct_window15;
    ...
    auto lut4idx0 = [](long I) -> long {
        /* GATE 140 (LUT3 _554_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut4idx1 = [](long I) -> long {
        /* GATE 127 (LUT3 _541_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_window52 + 2 * ct_window28 + 4 * ct_window44;
    ...
    auto lut5idx0 = [](long I) -> long {
        /* GATE 86 (LUT4 _500_ INIT 0x17e8 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut5idx1 = [](long I) -> long {
        /* GATE 79 (LUT3 _493_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_window48 + 2 * ct_window24 + 4 * ct_window40 + 8 * ct_window57;
    ...
    auto lut6idx0 = [](long I) -> long {
        /* GATE 14 (LUT3 _428_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut6idx1 = [](long I) -> long {
        /* GATE 138 (LUT3 _552_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut7idx0 = [](long I) -> long {
        /* GATE 108 (LUT3 _522_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut7idx1 = [](long I) -> long {
        /* GATE 92 (LUT3 _506_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_window50 + 2 * ct_window26 + 4 * ct_window42;
    ...
    auto lut8idx0 = [](long I) -> long {
        /* GATE 24 (LUT3 _438_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut8idx1 = [](long I) -> long {
        /* GATE 33 (LUT3 _447_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_window55 + 2 * ct_window31 + 4 * ct_window47;
    ...
    auto lut9idx0 = [](long I) -> long {
        /* GATE 130 (LUT3 _544_ INIT 0x2b PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut9idx1 = [](long I) -> long {
        /* GATE 107 (LUT2 _521_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * gout7[0] + 2 * ct_window59 + 4 * ct_window67;
    ...
    auto lut10idx0 = [](long I) -> long {
        /* GATE 125 (LUT3 _539_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut10idx1 = [](long I) -> long {
        /* GATE 105 (LUT3 _519_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_window19 + 2 * ct_window3 + 4 * ct_window11;
    ...
    auto lut11idx0 = [](long I) -> long {
        /* GATE 15 (LUT3 _429_ INIT 0x2b PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut11idx1 = [](long I) -> long {
        /* GATE 139 (LUT2 _553_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout4[0] + 2 * ct_window61 + 4 * ct_window69;
    ...
    auto lut12idx0 = [](long I) -> long {
        /* GATE 126 (LUT3 _540_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut12idx1 = [](long I) -> long {
        /* GATE 136 (LUT3 _550_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut13idx0 = [](long I) -> long {
        /* GATE 27 (LUT3 _441_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut13idx1 = [](long I) -> long {
        /* GATE 13 (LUT2 _427_ INIT 0x9 PERM 02) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout6[0] + 2 * ct_window70 + 4 * ct_window62;
    ...
    auto lut14idx0 = [](long I) -> long {
        /* GATE 83 (LUT3 _497_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut14idx1 = [](long I) -> long {
        /* GATE 80 (LUT3 _494_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_window16 + 2 * ct_window0 + 4 * ct_window8;
    ...
    auto lut15idx0 = [](long I) -> long {
        /* GATE 104 (LUT3 _518_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut15idx1 = [](long I) -> long {
        /* GATE 94 (LUT3 _508_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_window18 + 2 * ct_window2 + 4 * ct_window10;
    ...
    auto lut16idx0 = [](long I) -> long {
        /* GATE 141 (LUT3 _555_ INIT 0x2b PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut16idx1 = [](long I) -> long {
        /* GATE 128 (LUT2 _542_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * gout0[0] + 2 * ct_window60 + 4 * ct_window68;
    ...
    auto lut17idx0 = [](long I) -> long {
        /* GATE 97 (LUT3 _511_ INIT 0x53 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut17idx1 = [](long I) -> long {
        /* GATE 85 (LUT2 _499_ INIT 0x6 PERM 20) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_window65 + 2 * ct_window57 + 4 * gout5[0];
    ...
    auto lut18idx0 = [](long I) -> long {
        /* GATE 124 (LUT3 _538_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut18idx1 = [](long I) -> long {
        /* GATE 134 (LUT3 _548_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout10[0] + 2 * gout12[0] + 4 * gout4[1];
    ...
    auto lut19idx0 = [](long I) -> long {
        /* GATE 10 (LUT3 _424_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut19idx1 = [](long I) -> long {
        /* GATE 137 (LUT3 _551_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_window21 + 2 * ct_window5 + 4 * ct_window13;
    ...
    auto lut20idx0 = [](long I) -> long {
        /* GATE 22 (LUT3 _436_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut20idx1 = [](long I) -> long {
        /* GATE 11 (LUT3 _425_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_window22 + 2 * ct_window6 + 4 * ct_window14;
    ...
    auto lut21idx0 = [](long I) -> long {
        /* GATE 34 (LUT3 _448_ INIT 0x2b PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut21idx1 = [](long I) -> long {
        /* GATE 25 (LUT2 _439_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * gout2[1] + 2 * ct_window63 + 4 * ct_window71;
    ...
    auto lut22idx0 = [](long I) -> long {
        /* GATE 9 (LUT3 _423_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut22idx1 = [](long I) -> long {
        /* GATE 20 (LUT3 _434_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * gout19[0] + 2 * gout20[1] + 4 * gout2[0];
    ...
    auto lut23idx0 = [](long I) -> long {
        /* GATE 82 (LUT3 _496_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut23idx1 = [](long I) -> long {
        /* GATE 89 (LUT3 _503_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_window49 + 2 * ct_window25 + 4 * ct_window41;
    ...
    auto lut24idx0 = [](long I) -> long {
        /* GATE 109 (LUT3 _523_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut24idx1 = [](long I) -> long {
        /* GATE 88 (LUT2 _502_ INIT 0x9 PERM 02) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * gout23[1] + 2 * ct_window66 + 4 * ct_window58;
    ...
    auto lut25idx0 = [](long I) -> long {
        /* GATE 81 (LUT3 _495_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut25idx1 = [](long I) -> long {
        /* GATE 90 (LUT3 _504_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout23[0] + 2 * gout14[0] + 4 * gout1[0];
    ...
    auto lut26idx0 = [](long I) -> long {
        /* GATE 91 (LUT3 _505_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut26idx1 = [](long I) -> long {
        /* GATE 102 (LUT3 _516_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout7[1] + 2 * gout1[1] + 4 * gout15[1];
    ...
    auto lut27idx0 = [](long I) -> long {
        /* GATE 100 (LUT4 _514_ INIT 0xb22b PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut27idx1 = [](long I) -> long {
        /* GATE 87 (LUT4 _501_ INIT 0x9669 PERM 2013) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout25[1] + 2 * gout26[0] + 4 * gout24[1] + 8 * ct_window66;
    ...
    auto lut28idx0 = [](long I) -> long {
        /* GATE 96 (LUT4 _510_ INIT 0x8ee8 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut28idx1 = [](long I) -> long {
        /* GATE 78 (LUT2 _492_ INIT 0x8 PERM 23) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_window56 + 2 * ct_window64 + 4 * gout5[1] + 8 * gout14[1];
    ...
    auto lut29idx0 = [](long I) -> long {
        /* GATE 103 (LUT3 _517_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut29idx1 = [](long I) -> long {
        /* GATE 123 (LUT3 _537_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout15[0] + 2 * gout10[1] + 4 * gout0[1];
    ...
    auto lut30idx0 = [](long I) -> long {
        /* GATE 8 (LUT3 _422_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut30idx1 = [](long I) -> long {
        /* GATE 135 (LUT3 _549_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout12[1] + 2 * gout19[1] + 4 * gout6[1];
    ...
    auto lut31idx0 = [](long I) -> long {
        /* GATE 31 (LUT3 _445_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut31idx1 = [](long I) -> long {
        /* GATE 21 (LUT3 _435_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout20[0] + 2 * gout3[0] + 4 * gout8[0];
    ...
    auto lut32idx0 = [](long I) -> long {
        /* GATE 6 (LUT4 _420_ INIT 0xb22b PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut32idx1 = [](long I) -> long {
        /* GATE 133 (LUT4 _547_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout18[1] + 2 * gout30[1] + 4 * gout11[1] + 8 * ct_window69;
    ...
    auto lut33idx0 = [](long I) -> long {
        /* GATE 30 (LUT3 _444_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut33idx1 = [](long I) -> long {
        /* GATE 40 (LUT3 _454_ INIT 0xe8 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout31[0] + 2 * gout3[1] + 4 * gout8[1];
    ...
    auto lut34idx0 = [](long I) -> long {
        /* GATE 29 (LUT4 _443_ INIT 0xb22b PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut34idx1 = [](long I) -> long {
        /* GATE 19 (LUT4 _433_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout22[1] + 2 * gout31[1] + 4 * gout21[1] + 8 * ct_window71;
    ...
    auto lut35idx0 = [](long I) -> long {
        /* GATE 39 (LUT3 _453_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut35idx1 = [](long I) -> long {
        /* GATE 28 (LUT3 _442_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout34[0] + 2 * gout33[0] + 4 * gout21[0];
    ...
    auto lut36idx0 = [](long I) -> long {
        /* GATE 95 (LUT4 _509_ INIT 0x9600 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut36idx1 = [](long I) -> long {
        /* GATE 77 (LUT3 _491_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout28[1] + 2 * gout25[0] + 4 * gout17[1] + 8 * gout28[0];
    ...
    auto lut37idx0 = [](long I) -> long {
        /* GATE 132 (LUT4 _546_ INIT 0xb22b PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut37idx1 = [](long I) -> long {
        /* GATE 122 (LUT4 _536_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout29[1] + 2 * gout18[0] + 4 * gout16[1] + 8 * ct_window68;
    ...
    auto lut38idx0 = [](long I) -> long {
        /* GATE 121 (LUT4 _535_ INIT 0xb22b PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut38idx1 = [](long I) -> long {
        /* GATE 101 (LUT4 _515_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout26[1] + 2 * gout29[0] + 4 * gout9[1] + 8 * ct_window67;
    ...
    auto lut39idx0 = [](long I) -> long {
        /* GATE 7 (LUT4 _421_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut39idx1 = [](long I) -> long {
        /* GATE 18 (LUT4 _432_ INIT 0xb22b PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout30[0] + 2 * gout22[0] + 4 * gout13[1] + 8 * ct_window70;
    ...
    auto lut40idx0 = [](long I) -> long {
        /* GATE 76 (LUT4 _490_ INIT 0x9600 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut40idx1 = [](long I) -> long {
        /* GATE 98 (LUT3 _512_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout36[1] + 2 * gout27[1] + 4 * gout17[0] + 8 * gout36[0];
    ...
    auto lut41idx0 = [](long I) -> long {
        /* GATE 36 (LUT3 _450_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut41idx1 = [](long I) -> long {
        /* GATE 17 (LUT3 _431_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout39[1] + 2 * gout34[1] + 4 * gout13[0];
    ...
    auto lut42idx0 = [](long I) -> long {
        /* GATE 38 (LUT2 _452_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout35[0] + 2 * gout33[1];
    ...
    auto lut43idx0 = [](long I) -> long {
        /* GATE 1 (LUT3 _415_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut43idx1 = [](long I) -> long {
        /* GATE 99 (LUT3 _513_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout27[0] + 2 * gout38[1] + 4 * gout24[0];
    ...
    auto lut44idx0 = [](long I) -> long {
        /* GATE 2 (LUT3 _416_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut44idx1 = [](long I) -> long {
        /* GATE 120 (LUT3 _534_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout38[0] + 2 * gout37[1] + 4 * gout9[0];
    ...
    auto lut45idx0 = [](long I) -> long {
        /* GATE 35 (LUT3 _449_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut45idx1 = [](long I) -> long {
        /* GATE 5 (LUT3 _419_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout32[0] + 2 * gout39[0] + 4 * gout11[0];
    ...
    auto lut46idx0 = [](long I) -> long {
        /* GATE 131 (LUT3 _545_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut46idx1 = [](long I) -> long {
        /* GATE 4 (LUT3 _418_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout37[0] + 2 * gout32[1] + 4 * gout16[0];
    ...
    auto lut47idx0 = [](long I) -> long {
        /* GATE 37 (LUT2 _451_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut47idx1 = [](long I) -> long {
        /* GATE 16 (LUT2 _430_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout41[1] + 2 * gout35[1];
    ...
    auto lut48idx0 = [](long I) -> long {
        /* GATE 110 (LUT4 _524_ INIT 0x1441 PERM 3012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut48idx1 = [](long I) -> long {
        /* GATE 118 (LUT3 _532_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut48idx2 = [](long I) -> long {
        /* GATE 75 (LUT3 _489_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    lut48.push_back(ctx.genrate_lut(lut48idx2));
    flut48.push_back(lut48idx2);
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout40[0] + 2 * gout40[1] + 4 * gout43[1] + 8 * ct_window32;
    ...
    auto lut49idx0 = [](long I) -> long {
        /* GATE 74 (LUT2 _488_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout48[2] + 2 * ct_window32;
    ...
    auto lut50idx0 = [](long I) -> long {
        /* GATE 119 (LUT2 _533_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut50idx1 = [](long I) -> long {
        /* GATE 3 (LUT2 _417_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout44[1] + 2 * gout46[0];
    ...
    auto lut51idx0 = [](long I) -> long {
        /* GATE 48 (LUT2 _462_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout43[0] + 2 * gout44[0];
    ...
    auto lut52idx0 = [](long I) -> long {
        /* GATE 117 (LUT4 _531_ INIT 0x7100 PERM 3012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut52idx1 = [](long I) -> long {
        /* GATE 46 (LUT4 _460_ INIT 0x8e71 PERM 3012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout43[0] + 2 * gout44[0] + 4 * gout50[0] + 8 * gout48[1];
    ...
    auto lut53idx0 = [](long I) -> long {
        /* GATE 47 (LUT4 _461_ INIT 0xb22b PERM 0321) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut53idx1 = [](long I) -> long {
        /* GATE 58 (LUT3 _472_ INIT 0x96 PERM 123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout48[0] + 2 * gout48[1] + 4 * gout51[0] + 8 * ct_window33;
    ...
    auto lut54idx0 = [](long I) -> long {
        /* GATE 57 (LUT2 _471_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout49[0] + 2 * gout53[1];
    ...
    auto lut55idx0 = [](long I) -> long {
        /* GATE 45 (LUT3 _459_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut55idx1 = [](long I) -> long {
        /* GATE 59 (LUT2 _473_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout52[1] + 2 * ct_window34 + 4 * gout53[0];
    ...
    auto lut56idx0 = [](long I) -> long {
        /* GATE 44 (LUT4 _458_ INIT 0x1ee1 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut56idx1 = [](long I) -> long {
        /* GATE 116 (LUT4 _530_ INIT 0x222b PERM 2301) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout52[0] + 2 * gout50[1] + 4 * gout46[1] + 8 * gout45[1];
    ...
    auto lut57idx0 = [](long I) -> long {
        /* GATE 115 (LUT4 _529_ INIT 0x7100 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut57idx1 = [](long I) -> long {
        /* GATE 49 (LUT4 _463_ INIT 0x8e71 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut57idx2 = [](long I) -> long {
        /* GATE 42 (LUT3 _456_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    lut57.push_back(ctx.genrate_lut(lut57idx2));
    flut57.push_back(lut57idx2);
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout56[1] + 2 * gout45[0] + 4 * gout41[0] + 8 * gout47[1];
    ...
    auto lut58idx0 = [](long I) -> long {
        /* GATE 51 (LUT4 _465_ INIT 0xe100 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut58idx1 = [](long I) -> long {
        /* GATE 114 (LUT4 _528_ INIT 0x1ee1 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout57[0] + 2 * gout47[0] + 4 * gout42[0] + 8 * ct_window38;
    ...
    auto lut59idx0 = [](long I) -> long {
        /* GATE 56 (LUT2 _470_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout54[0] + 2 * gout55[1];
    ...
    auto lut60idx0 = [](long I) -> long {
        /* GATE 50 (LUT4 _464_ INIT 0xab02 PERM 0321) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout35[0] + 2 * gout33[1] + 4 * gout57[0] + 8 * gout47[0];
    ...
    auto lut61idx0 = [](long I) -> long {
        /* GATE 60 (LUT3 _474_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut61idx1 = [](long I) -> long {
        /* GATE 43 (LUT3 _457_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout56[0] + 2 * gout55[0] + 4 * ct_window35;
    ...
    auto lut62idx0 = [](long I) -> long {
        /* GATE 55 (LUT2 _469_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout59[0] + 2 * gout61[0];
    ...
    auto lut63idx0 = [](long I) -> long {
        /* GATE 61 (LUT3 _475_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut63idx1 = [](long I) -> long {
        /* GATE 41 (LUT3 _455_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout57[2] + 2 * gout61[1] + 4 * ct_window36;
    ...
    auto lut64idx0 = [](long I) -> long {
        /* GATE 113 (LUT4 _527_ INIT 0x7100 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut64idx1 = [](long I) -> long {
        /* GATE 53 (LUT4 _467_ INIT 0x8e71 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut64idx2 = [](long I) -> long {
        /* GATE 62 (LUT3 _476_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout63[1] + 2 * gout57[1] + 4 * ct_window37 + 8 * gout58[1];
    ...
    auto lut65idx0 = [](long I) -> long {
        /* GATE 54 (LUT2 _468_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout62[0] + 2 * gout63[0];
    ...
    auto lut66idx0 = [](long I) -> long {
        /* GATE 63 (LUT4 _477_ INIT 0xe11e PERM 3201) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut66idx1 = [](long I) -> long {
        /* GATE 112 (LUT4 _526_ INIT 0x1117 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout60[0] + 2 * ct_window39 + 4 * gout58[0] + 8 * gout64[0];
    ...
    auto lut67idx0 = [](long I) -> long {
        /* GATE 72 (LUT4 _486_ INIT 0x4fb0 PERM 1230) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut67idx1 = [](long I) -> long {
        /* GATE 71 (LUT2 _485_ INIT 0x4 PERM 23) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout64[1] + 2 * gout64[2] + 4 * gout65[0] + 8 * gout66[1];
    ...
    auto lut68idx0 = [](long I) -> long {
        /* GATE 65 (LUT2 _479_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout54[0] + 2 * gout66[1];
    ...
    auto lut69idx0 = [](long I) -> long {
        /* GATE 69 (LUT2 _483_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout62[0] + 2 * gout66[1];
    ...
    auto lut70idx0 = [](long I) -> long {
        /* GATE 67 (LUT2 _481_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout59[0] + 2 * gout66[1];
    ...
    auto lut71idx0 = [](long I) -> long {
        /* GATE 64 (LUT3 _478_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout68[0] + 2 * gout55[1] + 4 * gout53[0];
    ...
    auto lut72idx0 = [](long I) -> long {
        /* GATE 66 (LUT2 _480_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout70[0] + 2 * gout61[0];
    ...
    auto lut73idx0 = [](long I) -> long {
        /* GATE 52 (LUT3 _466_ INIT 0x10 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout64[1] + 2 * gout64[2] + 4 * gout65[0];
    ...
    auto lut74idx0 = [](long I) -> long {
        /* GATE 111 (LUT4 _525_ INIT 0x42bd PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout48[2] + 2 * ct_window32 + 4 * gout66[1] + 8 * gout53[1];
    ...
    auto lut75idx0 = [](long I) -> long {
        /* GATE 68 (LUT2 _482_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout69[0] + 2 * gout63[0];
    ...
    auto lut76idx0 = [](long I) -> long {
        /* GATE 70 (LUT2 _484_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout67[1] + 2 * gout64[2];
    ...
    auto lut77idx0 = [](long I) -> long {
        /* GATE 73 (LUT3 _487_ INIT 0xb4 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout73[0] + 2 * gout66[0] + 4 * gout66[1];
    std::vector<Ciphertext> gout77 = ctx.eval_lut_amortized(&gin77, lut77);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout49[0])); /* out0 */
    test_out.push_back(ctx.decrypt(&gout74[0])); /* out1 */
    test_out.push_back(ctx.decrypt(&gout71[0])); /* out2 */
    test_out.push_back(ctx.decrypt(&gout72[0])); /* out3 */
    test_out.push_back(ctx.decrypt(&gout75[0])); /* out4 */
    test_out.push_back(ctx.decrypt(&gout76[0])); /* out5 */
    test_out.push_back(ctx.decrypt(&gout67[0])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout77[0])); /* out7 */
    return test_out;
}

static void
BM_image_ricker_lut4(benchmark::State& state)
{
    FHEContext ctx;
    ...
    for (auto _ : state) {
        test_image_ricker_lut4(ctx);
    }
}

BENCHMARK(BM_image_ricker_lut4)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
