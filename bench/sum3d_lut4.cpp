...
std::vector<long>
test_sum3d_lut4(FHEContext& ctx, std::vector<uint64_t> out = { 0 })
{
    ...
    auto lut0idx0 = [](long I) -> long {
        /* GATE 166 (LUT3 _1295_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut0idx1 = [](long I) -> long {
        /* GATE 210 (LUT3 _1339_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_out44 + 2 * ct_out28 + 4 * ct_out36;
    ...
    auto lut1idx0 = [](long I) -> long {
        /* GATE 8 (LUT3 _1137_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut1idx1 = [](long I) -> long {
        /* GATE 38 (LUT3 _1167_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_out16 + 2 * ct_out0 + 4 * ct_out8;
    ...
    auto lut2idx0 = [](long I) -> long {
        /* GATE 125 (LUT3 _1254_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut2idx1 = [](long I) -> long {
        /* GATE 148 (LUT3 _1277_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_out163 + 2 * ct_out147 + 4 * ct_out155;
    ...
    auto lut3idx0 = [](long I) -> long {
        /* GATE 61 (LUT3 _1190_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut3idx1 = [](long I) -> long {
        /* GATE 123 (LUT3 _1252_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_out162 + 2 * ct_out146 + 4 * ct_out154;
    ...
    auto lut4idx0 = [](long I) -> long {
        /* GATE 146 (LUT3 _1275_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut4idx1 = [](long I) -> long {
        /* GATE 195 (LUT3 _1324_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_out140 + 2 * ct_out124 + 4 * ct_out132;
    ...
    auto lut5idx0 = [](long I) -> long {
        /* GATE 305 (LUT3 _1434_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut5idx1 = [](long I) -> long {
        /* GATE 338 (LUT3 _1467_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut6idx0 = [](long I) -> long {
        /* GATE 124 (LUT3 _1253_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut6idx1 = [](long I) -> long {
        /* GATE 57 (LUT3 _1186_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_out138 + 2 * ct_out122 + 4 * ct_out130;
    ...
    auto lut7idx0 = [](long I) -> long {
        /* GATE 307 (LUT3 _1436_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut7idx1 = [](long I) -> long {
        /* GATE 261 (LUT3 _1390_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_out70 + 2 * ct_out54 + 4 * ct_out62;
    ...
    auto lut8idx0 = [](long I) -> long {
        /* GATE 81 (LUT3 _1210_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut8idx1 = [](long I) -> long {
        /* GATE 95 (LUT3 _1224_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_out90 + 2 * ct_out74 + 4 * ct_out82;
    ...
    auto lut9idx0 = [](long I) -> long {
        /* GATE 110 (LUT3 _1239_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut9idx1 = [](long I) -> long {
        /* GATE 164 (LUT3 _1293_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_out43 + 2 * ct_out27 + 4 * ct_out35;
    ...
    auto lut10idx0 = [](long I) -> long {
        /* GATE 236 (LUT3 _1365_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut10idx1 = [](long I) -> long {
        /* GATE 191 (LUT3 _1320_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_out117 + 2 * ct_out101 + 4 * ct_out109;
    ...
    auto lut11idx0 = [](long I) -> long {
        /* GATE 128 (LUT3 _1257_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut11idx1 = [](long I) -> long {
        /* GATE 149 (LUT3 _1278_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_out139 + 2 * ct_out123 + 4 * ct_out131;
    ...
    auto lut12idx0 = [](long I) -> long {
        /* GATE 296 (LUT3 _1425_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut13idx0 = [](long I) -> long {
        /* GATE 130 (LUT3 _1259_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut13idx1 = [](long I) -> long {
        /* GATE 144 (LUT3 _1273_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_out115 + 2 * ct_out99 + 4 * ct_out107;
    ...
    auto lut14idx0 = [](long I) -> long {
        /* GATE 42 (LUT3 _1171_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut14idx1 = [](long I) -> long {
        /* GATE 79 (LUT3 _1208_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_out65 + 2 * ct_out49 + 4 * ct_out57;
    ...
    auto lut15idx0 = [](long I) -> long {
        /* GATE 258 (LUT3 _1387_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut15idx1 = [](long I) -> long {
        /* GATE 303 (LUT3 _1432_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_out46 + 2 * ct_out30 + 4 * ct_out38;
    ...
    auto lut16idx0 = [](long I) -> long {
        /* GATE 108 (LUT3 _1237_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut16idx1 = [](long I) -> long {
        /* GATE 77 (LUT3 _1206_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_out42 + 2 * ct_out26 + 4 * ct_out34;
    ...
    auto lut17idx0 = [](long I) -> long {
        /* GATE 364 (LUT4 _1493_ INIT 0xe8 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut17idx1 = [](long I) -> long {
        /* GATE 337 (LUT4 _1466_ INIT 0xe817 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_out23 + 2 * ct_out7 + 4 * ct_out15 + 8 * gout5[1];
    ...
    auto lut18idx0 = [](long I) -> long {
        /* GATE 262 (LUT3 _1391_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut18idx1 = [](long I) -> long {
        /* GATE 313 (LUT3 _1442_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_out94 + 2 * ct_out78 + 4 * ct_out86;
    ...
    auto lut19idx0 = [](long I) -> long {
        /* GATE 12 (LUT3 _1141_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_out88 + 2 * ct_out72 + 4 * ct_out80;
    ...
    auto lut20idx0 = [](long I) -> long {
        /* GATE 150 (LUT3 _1279_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut20idx1 = [](long I) -> long {
        /* GATE 194 (LUT3 _1323_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_out164 + 2 * ct_out148 + 4 * ct_out156;
    ...
    auto lut21idx0 = [](long I) -> long {
        /* GATE 4 (LUT3 _1133_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut21idx1 = [](long I) -> long {
        /* GATE 21 (LUT3 _1150_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_out112 + 2 * ct_out96 + 4 * ct_out104;
    ...
    auto lut22idx0 = [](long I) -> long {
        /* GATE 214 (LUT3 _1343_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut22idx1 = [](long I) -> long {
        /* GATE 169 (LUT3 _1298_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_out68 + 2 * ct_out52 + 4 * ct_out60;
    ...
    auto lut23idx0 = [](long I) -> long {
        /* GATE 339 (LUT3 _1468_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut23idx1 = [](long I) -> long {
        /* GATE 308 (LUT3 _1437_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_out71 + 2 * ct_out55 + 4 * ct_out63;
    ...
    auto lut24idx0 = [](long I) -> long {
        /* GATE 119 (LUT3 _1248_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut24idx1 = [](long I) -> long {
        /* GATE 155 (LUT3 _1284_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_out187 + 2 * ct_out171 + 4 * ct_out179;
    ...
    auto lut25idx0 = [](long I) -> long {
        /* GATE 56 (LUT3 _1185_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut25idx1 = [](long I) -> long {
        /* GATE 129 (LUT3 _1258_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_out114 + 2 * ct_out98 + 4 * ct_out106;
    ...
    auto lut26idx0 = [](long I) -> long {
        /* GATE 147 (LUT3 _1276_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut26idx1 = [](long I) -> long {
        /* GATE 199 (LUT3 _1328_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout2[1] + 2 * gout11[1] + 4 * gout20[0];
    ...
    auto lut27idx0 = [](long I) -> long {
        /* GATE 295 (LUT3 _1424_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut27idx1 = [](long I) -> long {
        /* GATE 330 (LUT3 _1459_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_out191 + 2 * ct_out175 + 4 * ct_out183;
    ...
    auto lut28idx0 = [](long I) -> long {
        /* GATE 288 (LUT3 _1417_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut28idx1 = [](long I) -> long {
        /* GATE 238 (LUT3 _1367_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_out142 + 2 * ct_out126 + 4 * ct_out134;
    ...
    auto lut29idx0 = [](long I) -> long {
        /* GATE 104 (LUT3 _1233_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut29idx1 = [](long I) -> long {
        /* GATE 168 (LUT3 _1297_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_out67 + 2 * ct_out51 + 4 * ct_out59;
    ...
    auto lut30idx0 = [](long I) -> long {
        /* GATE 39 (LUT3 _1168_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut30idx1 = [](long I) -> long {
        /* GATE 75 (LUT3 _1204_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_out41 + 2 * ct_out25 + 4 * ct_out33;
    ...
    auto lut31idx0 = [](long I) -> long {
        /* GATE 190 (LUT3 _1319_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut31idx1 = [](long I) -> long {
        /* GATE 145 (LUT3 _1274_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_out116 + 2 * ct_out100 + 4 * ct_out108;
    ...
    auto lut32idx0 = [](long I) -> long {
        /* GATE 118 (LUT3 _1247_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut32idx1 = [](long I) -> long {
        /* GATE 67 (LUT3 _1196_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * ct_out186 + 2 * ct_out170 + 4 * ct_out178;
    ...
    auto lut33idx0 = [](long I) -> long {
        /* GATE 7 (LUT4 _1136_ INIT 0x6996 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut33idx1 = [](long I) -> long {
        /* GATE 29 (LUT4 _1158_ INIT 0x9600 PERM 1230) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout1[0] + 2 * ct_out184 + 4 * ct_out168 + 8 * ct_out176;
    ...
    auto lut34idx0 = [](long I) -> long {
        /* GATE 257 (LUT3 _1386_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut34idx1 = [](long I) -> long {
        /* GATE 203 (LUT3 _1332_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_out21 + 2 * ct_out5 + 4 * ct_out13;
    ...
    auto lut35idx0 = [](long I) -> long {
        /* GATE 156 (LUT3 _1285_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut35idx1 = [](long I) -> long {
        /* GATE 201 (LUT3 _1330_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_out188 + 2 * ct_out172 + 4 * ct_out180;
    ...
    auto lut36idx0 = [](long I) -> long {
        /* GATE 241 (LUT3 _1370_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut36idx1 = [](long I) -> long {
        /* GATE 192 (LUT3 _1321_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_out141 + 2 * ct_out125 + 4 * ct_out133;
    ...
    auto lut37idx0 = [](long I) -> long {
        /* GATE 105 (LUT3 _1234_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut37idx1 = [](long I) -> long {
        /* GATE 174 (LUT3 _1303_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * ct_out91 + 2 * ct_out75 + 4 * ct_out83;
    ...
    auto lut38idx0 = [](long I) -> long {
        /* GATE 249 (LUT3 _1378_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut38idx1 = [](long I) -> long {
        /* GATE 304 (LUT3 _1433_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * ct_out22 + 2 * ct_out6 + 4 * ct_out14;
    ...
    auto lut39idx0 = [](long I) -> long {
        /* GATE 66 (LUT3 _1195_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut39idx1 = [](long I) -> long {
        /* GATE 32 (LUT3 _1161_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_out185 + 2 * ct_out169 + 4 * ct_out177;
    ...
    auto lut40idx0 = [](long I) -> long {
        /* GATE 247 (LUT3 _1376_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut40idx1 = [](long I) -> long {
        /* GATE 202 (LUT3 _1331_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_out189 + 2 * ct_out173 + 4 * ct_out181;
    ...
    auto lut41idx0 = [](long I) -> long {
        /* GATE 165 (LUT3 _1294_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut41idx1 = [](long I) -> long {
        /* GATE 117 (LUT3 _1246_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_out19 + 2 * ct_out3 + 4 * ct_out11;
    ...
    auto lut42idx0 = [](long I) -> long {
        /* GATE 285 (LUT3 _1414_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_out143 + 2 * ct_out127 + 4 * ct_out135;
    ...
    auto lut43idx0 = [](long I) -> long {
        /* GATE 294 (LUT3 _1423_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut43idx1 = [](long I) -> long {
        /* GATE 248 (LUT3 _1377_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * ct_out190 + 2 * ct_out174 + 4 * ct_out182;
    ...
    auto lut44idx0 = [](long I) -> long {
        /* GATE 237 (LUT3 _1366_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut44idx1 = [](long I) -> long {
        /* GATE 283 (LUT3 _1412_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * ct_out118 + 2 * ct_out102 + 4 * ct_out110;
    ...
    auto lut45idx0 = [](long I) -> long {
        /* GATE 109 (LUT3 _1238_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut45idx1 = [](long I) -> long {
        /* GATE 68 (LUT3 _1197_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut46idx0 = [](long I) -> long {
        /* GATE 127 (LUT3 _1256_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut46idx1 = [](long I) -> long {
        /* GATE 142 (LUT3 _1271_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout11[0] + 2 * gout25[1] + 4 * gout13[0];
    ...
    auto lut47idx0 = [](long I) -> long {
        /* GATE 215 (LUT3 _1344_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut47idx1 = [](long I) -> long {
        /* GATE 260 (LUT3 _1389_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * ct_out69 + 2 * ct_out53 + 4 * ct_out61;
    ...
    auto lut48idx0 = [](long I) -> long {
        /* GATE 55 (LUT3 _1184_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut48idx1 = [](long I) -> long {
        /* GATE 22 (LUT3 _1151_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * ct_out113 + 2 * ct_out97 + 4 * ct_out105;
    ...
    auto lut49idx0 = [](long I) -> long {
        /* GATE 59 (LUT3 _1188_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut49idx1 = [](long I) -> long {
        /* GATE 27 (LUT3 _1156_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_out161 + 2 * ct_out145 + 4 * ct_out153;
    ...
    auto lut50idx0 = [](long I) -> long {
        /* GATE 33 (LUT3 _1162_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut50idx1 = [](long I) -> long {
        /* GATE 76 (LUT3 _1205_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * ct_out17 + 2 * ct_out1 + 4 * ct_out9;
    ...
    auto lut51idx0 = [](long I) -> long {
        /* GATE 103 (LUT3 _1232_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut51idx1 = [](long I) -> long {
        /* GATE 80 (LUT3 _1209_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut52idx0 = [](long I) -> long {
        /* GATE 309 (LUT3 _1438_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut52idx1 = [](long I) -> long {
        /* GATE 344 (LUT3 _1473_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * ct_out95 + 2 * ct_out79 + 4 * ct_out87;
    ...
    auto lut53idx0 = [](long I) -> long {
        /* GATE 244 (LUT3 _1373_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut53idx1 = [](long I) -> long {
        /* GATE 200 (LUT3 _1329_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout35[1] + 2 * gout40[1] + 4 * gout34[1];
    ...
    auto lut54idx0 = [](long I) -> long {
        /* GATE 256 (LUT3 _1385_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut54idx1 = [](long I) -> long {
        /* GATE 212 (LUT3 _1341_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut55idx0 = [](long I) -> long {
        /* GATE 37 (LUT3 _1166_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut55idx1 = [](long I) -> long {
        /* GATE 10 (LUT3 _1139_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * ct_out40 + 2 * ct_out24 + 4 * ct_out32;
    ...
    auto lut56idx0 = [](long I) -> long {
        /* GATE 60 (LUT3 _1189_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut56idx1 = [](long I) -> long {
        /* GATE 23 (LUT3 _1152_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * ct_out137 + 2 * ct_out121 + 4 * ct_out129;
    ...
    auto lut57idx0 = [](long I) -> long {
        /* GATE 242 (LUT3 _1371_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut57idx1 = [](long I) -> long {
        /* GATE 287 (LUT3 _1416_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_out166 + 2 * ct_out150 + 4 * ct_out158;
    ...
    auto lut58idx0 = [](long I) -> long {
        /* GATE 284 (LUT3 _1413_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * ct_out119 + 2 * ct_out103 + 4 * ct_out111;
    ...
    auto lut59idx0 = [](long I) -> long {
        /* GATE 43 (LUT3 _1172_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut59idx1 = [](long I) -> long {
        /* GATE 85 (LUT3 _1214_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * ct_out89 + 2 * ct_out73 + 4 * ct_out81;
    ...
    auto lut60idx0 = [](long I) -> long {
        /* GATE 196 (LUT3 _1325_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut60idx1 = [](long I) -> long {
        /* GATE 240 (LUT3 _1369_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * ct_out165 + 2 * ct_out149 + 4 * ct_out157;
    ...
    auto lut61idx0 = [](long I) -> long {
        /* GATE 31 (LUT3 _1160_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * ct_out184 + 2 * ct_out168 + 4 * ct_out176;
    ...
    auto lut62idx0 = [](long I) -> long {
        /* GATE 11 (LUT3 _1140_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut62idx1 = [](long I) -> long {
        /* GATE 41 (LUT3 _1170_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * ct_out64 + 2 * ct_out48 + 4 * ct_out56;
    ...
    auto lut63idx0 = [](long I) -> long {
        /* GATE 26 (LUT3 _1155_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut63idx1 = [](long I) -> long {
        /* GATE 5 (LUT3 _1134_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * ct_out136 + 2 * ct_out120 + 4 * ct_out128;
    ...
    auto lut64idx0 = [](long I) -> long {
        /* GATE 30 (LUT3 _1159_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut64idx1 = [](long I) -> long {
        /* GATE 63 (LUT3 _1192_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout61[0] + 2 * gout39[1] + 4 * gout50[0];
    ...
    auto lut65idx0 = [](long I) -> long {
        /* GATE 6 (LUT3 _1135_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut65idx1 = [](long I) -> long {
        /* GATE 25 (LUT3 _1154_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * ct_out160 + 2 * ct_out144 + 4 * ct_out152;
    ...
    auto lut66idx0 = [](long I) -> long {
        /* GATE 114 (LUT3 _1243_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut66idx1 = [](long I) -> long {
        /* GATE 65 (LUT3 _1194_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout39[0] + 2 * gout32[1] + 4 * gout45[1];
    ...
    auto lut67idx0 = [](long I) -> long {
        /* GATE 302 (LUT3 _1431_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut67idx1 = [](long I) -> long {
        /* GATE 336 (LUT3 _1465_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout15[1] + 2 * gout38[1] + 4 * gout5[0];
    ...
    auto lut68idx0 = [](long I) -> long {
        /* GATE 78 (LUT3 _1207_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut68idx1 = [](long I) -> long {
        /* GATE 94 (LUT3 _1223_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout14[1] + 2 * gout51[1] + 4 * gout8[0];
    ...
    auto lut69idx0 = [](long I) -> long {
        /* GATE 143 (LUT3 _1272_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut69idx1 = [](long I) -> long {
        /* GATE 188 (LUT3 _1317_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout13[1] + 2 * gout31[1] + 4 * gout4[0];
    ...
    auto lut70idx0 = [](long I) -> long {
        /* GATE 107 (LUT3 _1236_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut70idx1 = [](long I) -> long {
        /* GATE 162 (LUT3 _1291_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout16[0] + 2 * gout45[0] + 4 * gout9[0];
    ...
    auto lut71idx0 = [](long I) -> long {
        /* GATE 126 (LUT3 _1255_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut71idx1 = [](long I) -> long {
        /* GATE 54 (LUT3 _1183_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout48[0] + 2 * gout25[0] + 4 * gout6[1];
    ...
    auto lut72idx0 = [](long I) -> long {
        /* GATE 28 (LUT2 _1157_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut72idx1 = [](long I) -> long {
        /* GATE 70 (LUT2 _1199_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout33[1] + 2 * gout64[0];
    ...
    auto lut73idx0 = [](long I) -> long {
        /* GATE 220 (LUT3 _1349_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut73idx1 = [](long I) -> long {
        /* GATE 170 (LUT3 _1299_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * ct_out92 + 2 * ct_out76 + 4 * ct_out84;
    ...
    auto lut74idx0 = [](long I) -> long {
        /* GATE 266 (LUT3 _1395_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut74idx1 = [](long I) -> long {
        /* GATE 216 (LUT3 _1345_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * ct_out93 + 2 * ct_out77 + 4 * ct_out85;
    ...
    auto lut75idx0 = [](long I) -> long {
        /* GATE 325 (LUT3 _1454_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut75idx1 = [](long I) -> long {
        /* GATE 289 (LUT3 _1418_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * ct_out167 + 2 * ct_out151 + 4 * ct_out159;
    ...
    auto lut76idx0 = [](long I) -> long {
        /* GATE 157 (LUT3 _1286_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut76idx1 = [](long I) -> long {
        /* GATE 211 (LUT3 _1340_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * ct_out20 + 2 * ct_out4 + 4 * ct_out12;
    ...
    auto lut77idx0 = [](long I) -> long {
        /* GATE 291 (LUT3 _1420_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut77idx1 = [](long I) -> long {
        /* GATE 246 (LUT3 _1375_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout40[0] + 2 * gout43[1] + 4 * gout38[0];
    ...
    auto lut78idx0 = [](long I) -> long {
        /* GATE 73 (LUT3 _1202_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut78idx1 = [](long I) -> long {
        /* GATE 36 (LUT3 _1165_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout55[0] + 2 * gout1[1] + 4 * gout30[0];
    ...
    auto lut79idx0 = [](long I) -> long {
        /* GATE 328 (LUT3 _1457_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut79idx1 = [](long I) -> long {
        /* GATE 293 (LUT3 _1422_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout43[0] + 2 * gout27[0] + 4 * gout12[0];
    ...
    auto lut80idx0 = [](long I) -> long {
        /* GATE 122 (LUT3 _1251_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut80idx1 = [](long I) -> long {
        /* GATE 153 (LUT3 _1282_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout3[1] + 2 * gout6[0] + 4 * gout2[0];
    ...
    auto lut81idx0 = [](long I) -> long {
        /* GATE 259 (LUT3 _1388_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut81idx1 = [](long I) -> long {
        /* GATE 312 (LUT3 _1441_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout47[1] + 2 * gout7[1] + 4 * gout18[0];
    ...
    auto lut82idx0 = [](long I) -> long {
        /* GATE 343 (LUT3 _1472_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut82idx1 = [](long I) -> long {
        /* GATE 306 (LUT3 _1435_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout7[0] + 2 * gout23[1] + 4 * gout52[0];
    ...
    auto lut83idx0 = [](long I) -> long {
        /* GATE 292 (LUT3 _1421_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut83idx1 = [](long I) -> long {
        /* GATE 239 (LUT3 _1368_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout60[1] + 2 * gout36[0] + 4 * gout57[0];
    ...
    auto lut84idx0 = [](long I) -> long {
        /* GATE 329 (LUT3 _1458_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut84idx1 = [](long I) -> long {
        /* GATE 286 (LUT3 _1415_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout57[1] + 2 * gout28[0] + 4 * gout75[1];
    ...
    auto lut85idx0 = [](long I) -> long {
        /* GATE 40 (LUT3 _1169_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut85idx1 = [](long I) -> long {
        /* GATE 84 (LUT3 _1213_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout62[1] + 2 * gout14[0] + 4 * gout59[0];
    ...
    auto lut86idx0 = [](long I) -> long {
        /* GATE 58 (LUT3 _1187_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut86idx1 = [](long I) -> long {
        /* GATE 115 (LUT3 _1244_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout49[0] + 2 * gout56[0] + 4 * gout3[0];
    ...
    auto lut87idx0 = [](long I) -> long {
        /* GATE 44 (LUT4 _1173_ INIT 0x7ee8 PERM 3012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut87idx1 = [](long I) -> long {
        /* GATE 86 (LUT4 _1215_ INIT 0x8000 PERM 3012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * ct_out88 + 2 * ct_out72 + 4 * ct_out80 + 8 * gout62[0];
    ...
    auto lut88idx0 = [](long I) -> long {
        /* GATE 234 (LUT3 _1363_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut88idx1 = [](long I) -> long {
        /* GATE 189 (LUT3 _1318_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout31[0] + 2 * gout10[1] + 4 * gout36[1];
    ...
    auto lut89idx0 = [](long I) -> long {
        /* GATE 163 (LUT3 _1292_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut89idx1 = [](long I) -> long {
        /* GATE 208 (LUT3 _1337_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout9[1] + 2 * gout41[0] + 4 * gout0[0];
    ...
    auto lut90idx0 = [](long I) -> long {
        /* GATE 281 (LUT3 _1410_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut90idx1 = [](long I) -> long {
        /* GATE 235 (LUT3 _1364_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout10[0] + 2 * gout44[0] + 4 * gout28[1];
    ...
    auto lut91idx0 = [](long I) -> long {
        /* GATE 301 (LUT3 _1430_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut91idx1 = [](long I) -> long {
        /* GATE 255 (LUT3 _1384_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout54[0] + 2 * gout34[0] + 4 * gout15[0];
    ...
    auto lut92idx0 = [](long I) -> long {
        /* GATE 323 (LUT3 _1452_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut92idx1 = [](long I) -> long {
        /* GATE 282 (LUT3 _1411_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout44[1] + 2 * gout58[0] + 4 * gout42[0];
    ...
    auto lut93idx0 = [](long I) -> long {
        /* GATE 116 (LUT3 _1245_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut93idx1 = [](long I) -> long {
        /* GATE 152 (LUT3 _1281_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout41[1] + 2 * gout32[0] + 4 * gout24[0];
    ...
    auto lut94idx0 = [](long I) -> long {
        /* GATE 254 (LUT3 _1383_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut94idx1 = [](long I) -> long {
        /* GATE 209 (LUT3 _1338_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout0[1] + 2 * gout76[1] + 4 * gout54[1];
    ...
    auto lut95idx0 = [](long I) -> long {
        /* GATE 113 (LUT3 _1242_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut95idx1 = [](long I) -> long {
        /* GATE 160 (LUT3 _1289_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout66[0] + 2 * gout86[1] + 4 * gout93[0];
    ...
    auto lut96idx0 = [](long I) -> long {
        /* GATE 359 (LUT4 _1488_ INIT 0xe8 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut96idx1 = [](long I) -> long {
        /* GATE 322 (LUT4 _1451_ INIT 0xe817 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * ct_out119 + 2 * ct_out103 + 4 * ct_out111 + 8 * gout92[0];
    ...
    auto lut97idx0 = [](long I) -> long {
        /* GATE 9 (LUT3 _1138_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut97idx1 = [](long I) -> long {
        /* GATE 35 (LUT3 _1164_ INIT 0x60 PERM 120) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout55[1] + 2 * gout62[0] + 4 * gout19[0];
    ...
    auto lut98idx0 = [](long I) -> long {
        /* GATE 3 (LUT3 _1132_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut98idx1 = [](long I) -> long {
        /* GATE 19 (LUT3 _1148_ INIT 0x60 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut98idx2 = [](long I) -> long {
        /* GATE 18 (LUT2 _1147_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    lut98.push_back(ctx.genrate_lut(lut98idx2));
    flut98.push_back(lut98idx2);
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout21[0] + 2 * gout63[1] + 4 * gout65[0];
    ...
    auto lut99idx0 = [](long I) -> long {
        /* GATE 74 (LUT3 _1203_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut99idx1 = [](long I) -> long {
        /* GATE 106 (LUT3 _1235_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * gout30[1] + 2 * gout50[1] + 4 * gout16[1];
    ...
    auto lut100idx0 = [](long I) -> long {
        /* GATE 363 (LUT3 _1492_ INIT 0xe8 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut100idx1 = [](long I) -> long {
        /* GATE 327 (LUT3 _1456_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout79[0] + 2 * gout84[0] + 4 * gout27[1];
    ...
    auto lut101idx0 = [](long I) -> long {
        /* GATE 24 (LUT3 _1153_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut101idx1 = [](long I) -> long {
        /* GATE 64 (LUT3 _1193_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * gout65[1] + 2 * gout63[0] + 4 * gout49[1];
    ...
    auto lut102idx0 = [](long I) -> long {
        /* GATE 335 (LUT3 _1464_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut102idx1 = [](long I) -> long {
        /* GATE 362 (LUT3 _1491_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * gout67[1] + 2 * gout17[1] + 4 * gout23[0];
    ...
    auto lut103idx0 = [](long I) -> long {
        /* GATE 173 (LUT3 _1302_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut103idx1 = [](long I) -> long {
        /* GATE 102 (LUT3 _1231_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * gout51[0] + 2 * gout29[0] + 4 * gout37[0];
    ...
    auto lut104idx0 = [](long I) -> long {
        /* GATE 186 (LUT3 _1315_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut104idx1 = [](long I) -> long {
        /* GATE 141 (LUT3 _1270_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * gout46[1] + 2 * gout69[0] + 4 * gout26[0];
    ...
    auto lut105idx0 = [](long I) -> long {
        /* GATE 53 (LUT3 _1182_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut105idx1 = [](long I) -> long {
        /* GATE 20 (LUT3 _1149_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * gout21[1] + 2 * gout48[1] + 4 * gout56[1];
    ...
    auto lut106idx0 = [](long I) -> long {
        /* GATE 62 (LUT3 _1191_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut106idx1 = [](long I) -> long {
        /* GATE 100 (LUT3 _1229_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT106   ";
    Ciphertext gin106 = 1 * gout64[1] + 2 * gout101[1] + 4 * gout66[1];
    ...
    auto lut107idx0 = [](long I) -> long {
        /* GATE 233 (LUT3 _1362_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut107idx1 = [](long I) -> long {
        /* GATE 279 (LUT3 _1408_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * gout88[0] + 2 * gout90[1] + 4 * gout83[1];
    ...
    auto lut108idx0 = [](long I) -> long {
        /* GATE 193 (LUT3 _1322_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut108idx1 = [](long I) -> long {
        /* GATE 245 (LUT3 _1374_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * gout20[1] + 2 * gout4[1] + 4 * gout60[0];
    ...
    auto lut109idx0 = [](long I) -> long {
        /* GATE 219 (LUT3 _1348_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut109idx1 = [](long I) -> long {
        /* GATE 167 (LUT3 _1296_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * gout29[1] + 2 * gout22[1] + 4 * gout73[1];
    ...
    auto lut110idx0 = [](long I) -> long {
        /* GATE 154 (LUT3 _1283_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut110idx1 = [](long I) -> long {
        /* GATE 198 (LUT3 _1327_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * gout24[1] + 2 * gout35[0] + 4 * gout76[0];
    ...
    auto lut111idx0 = [](long I) -> long {
        /* GATE 290 (LUT3 _1419_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut111idx1 = [](long I) -> long {
        /* GATE 334 (LUT3 _1463_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * gout77[0] + 2 * gout83[0] + 4 * gout79[1];
    ...
    auto lut112idx0 = [](long I) -> long {
        /* GATE 151 (LUT3 _1280_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut112idx1 = [](long I) -> long {
        /* GATE 206 (LUT3 _1335_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * gout93[1] + 2 * gout80[1] + 4 * gout110[0];
    ...
    auto lut113idx0 = [](long I) -> long {
        /* GATE 34 (LUT3 _1163_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut113idx1 = [](long I) -> long {
        /* GATE 83 (LUT3 _1212_ INIT 0x60 PERM 120) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut113idx2 = [](long I) -> long {
        /* GATE 71 (LUT2 _1200_ INIT 0x8 PERM 12) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    lut113.push_back(ctx.genrate_lut(lut113idx2));
    flut113.push_back(lut113idx2);
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * gout97[1] + 2 * gout78[1] + 4 * gout85[0];
    ...
    auto lut114idx0 = [](long I) -> long {
        /* GATE 360 (LUT4 _1489_ INIT 0xe8 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut114idx1 = [](long I) -> long {
        /* GATE 324 (LUT4 _1453_ INIT 0xe817 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * ct_out143 + 2 * ct_out127 + 4 * ct_out135 + 8 * gout75[0];
    ...
    auto lut115idx0 = [](long I) -> long {
        /* GATE 321 (LUT2 _1450_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * gout96[1] + 2 * gout114[1];
    ...
    auto lut116idx0 = [](long I) -> long {
        /* GATE 375 (LUT3 _1504_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut116idx1 = [](long I) -> long {
        /* GATE 361 (LUT3 _1490_ INIT 0x96 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT116   ";
    Ciphertext gin116 = 1 * gout102[1] + 2 * gout17[0] + 4 * gout100[0];
    ...
    auto lut117idx0 = [](long I) -> long {
        /* GATE 265 (LUT3 _1394_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut117idx1 = [](long I) -> long {
        /* GATE 213 (LUT3 _1342_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout22[0] + 2 * gout47[0] + 4 * gout74[1];
    ...
    auto lut118idx0 = [](long I) -> long {
        /* GATE 243 (LUT3 _1372_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut118idx1 = [](long I) -> long {
        /* GATE 299 (LUT3 _1428_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * gout53[0] + 2 * gout108[1] + 4 * gout77[1];
    ...
    auto lut119idx0 = [](long I) -> long {
        /* GATE 280 (LUT3 _1409_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut119idx1 = [](long I) -> long {
        /* GATE 326 (LUT3 _1455_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout90[0] + 2 * gout92[1] + 4 * gout84[1];
    ...
    auto lut120idx0 = [](long I) -> long {
        /* GATE 197 (LUT3 _1326_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut120idx1 = [](long I) -> long {
        /* GATE 252 (LUT3 _1381_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * gout110[1] + 2 * gout26[1] + 4 * gout53[1];
    ...
    auto lut121idx0 = [](long I) -> long {
        /* GATE 333 (LUT3 _1462_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut121idx1 = [](long I) -> long {
        /* GATE 300 (LUT3 _1429_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout91[0] + 2 * gout67[0] + 4 * gout82[1];
    ...
    auto lut122idx0 = [](long I) -> long {
        /* GATE 2 (LUT2 _1131_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut122idx1 = [](long I) -> long {
        /* GATE 16 (LUT2 _1145_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * gout98[0] + 2 * gout33[0];
    ...
    auto lut123idx0 = [](long I) -> long {
        /* GATE 159 (LUT3 _1288_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut123idx1 = [](long I) -> long {
        /* GATE 101 (LUT3 _1230_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * gout103[1] + 2 * gout99[1] + 4 * gout70[0];
    ...
    auto lut124idx0 = [](long I) -> long {
        /* GATE 140 (LUT3 _1269_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut124idx1 = [](long I) -> long {
        /* GATE 121 (LUT3 _1250_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * gout80[0] + 2 * gout71[0] + 4 * gout46[0];
    ...
    auto lut125idx0 = [](long I) -> long {
        /* GATE 17 (LUT4 _1146_ INIT 0x6996 PERM 0312) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut125idx1 = [](long I) -> long {
        /* GATE 51 (LUT3 _1180_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * gout98[2] + 2 * gout105[1] + 4 * gout101[0] + 8 * gout98[1];
    ...
    auto lut126idx0 = [](long I) -> long {
        /* GATE 253 (LUT3 _1382_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut126idx1 = [](long I) -> long {
        /* GATE 298 (LUT3 _1427_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * gout94[0] + 2 * gout91[1] + 4 * gout81[0];
    ...
    auto lut127idx0 = [](long I) -> long {
        /* GATE 207 (LUT3 _1336_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut127idx1 = [](long I) -> long {
        /* GATE 251 (LUT3 _1380_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout89[1] + 2 * gout94[1] + 4 * gout117[1];
    ...
    auto lut128idx0 = [](long I) -> long {
        /* GATE 14 (LUT2 _1143_ INIT 0x8 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut128idx1 = [](long I) -> long {
        /* GATE 1 (LUT2 _1130_ INIT 0x6 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout122[0] + 2 * gout97[0];
    ...
    auto lut129idx0 = [](long I) -> long {
        /* GATE 52 (LUT3 _1181_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut129idx1 = [](long I) -> long {
        /* GATE 120 (LUT3 _1249_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * gout105[0] + 2 * gout71[1] + 4 * gout86[0];
    ...
    auto lut130idx0 = [](long I) -> long {
        /* GATE 139 (LUT3 _1268_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut130idx1 = [](long I) -> long {
        /* GATE 184 (LUT3 _1313_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout124[0] + 2 * gout104[1] + 4 * gout112[0];
    ...
    auto lut131idx0 = [](long I) -> long {
        /* GATE 99 (LUT3 _1228_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut131idx1 = [](long I) -> long {
        /* GATE 72 (LUT3 _1201_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * gout78[0] + 2 * gout99[0] + 4 * gout68[0];
    ...
    auto lut132idx0 = [](long I) -> long {
        /* GATE 48 (LUT4 _1177_ INIT 0x7117 PERM 0321) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut132idx1 = [](long I) -> long {
        /* GATE 15 (LUT4 _1144_ INIT 0x6996 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout122[1] + 2 * gout125[0] + 4 * gout72[0] + 8 * gout113[0];
    ...
    auto lut133idx0 = [](long I) -> long {
        /* GATE 278 (LUT3 _1407_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut133idx1 = [](long I) -> long {
        /* GATE 331 (LUT3 _1460_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * gout107[1] + 2 * gout119[0] + 4 * gout111[0];
    ...
    auto lut134idx0 = [](long I) -> long {
        /* GATE 358 (LUT4 _1487_ INIT 0x7007 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut134idx1 = [](long I) -> long {
        /* GATE 374 (LUT2 _1503_ INIT 0x8 PERM 23) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * gout96[1] + 2 * gout114[1] + 4 * gout96[0] + 8 * gout114[0];
    ...
    auto lut135idx0 = [](long I) -> long {
        /* GATE 112 (LUT3 _1241_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut135idx1 = [](long I) -> long {
        /* GATE 138 (LUT3 _1267_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * gout95[0] + 2 * gout129[1] + 4 * gout124[1];
    ...
    auto lut136idx0 = [](long I) -> long {
        /* GATE 172 (LUT4 _1301_ INIT 0x718e PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut136idx1 = [](long I) -> long {
        /* GATE 98 (LUT3 _1227_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout131[0] + 2 * gout106[1] + 4 * gout123[1] + 8 * gout103[0];
    ...
    auto lut137idx0 = [](long I) -> long {
        /* GATE 320 (LUT3 _1449_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut137idx1 = [](long I) -> long {
        /* GATE 357 (LUT3 _1486_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * gout115[0] + 2 * gout119[1] + 4 * gout100[1];
    ...
    auto lut138idx0 = [](long I) -> long {
        /* GATE 187 (LUT3 _1316_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut138idx1 = [](long I) -> long {
        /* GATE 232 (LUT3 _1361_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout69[1] + 2 * gout88[1] + 4 * gout108[0];
    ...
    auto lut139idx0 = [](long I) -> long {
        /* GATE 131 (LUT3 _1260_ INIT 0xd4 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut139idx1 = [](long I) -> long {
        /* GATE 82 (LUT3 _1211_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * gout113[1] + 2 * gout85[1] + 4 * gout59[1];
    ...
    auto lut140idx0 = [](long I) -> long {
        /* GATE 161 (LUT3 _1290_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut140idx1 = [](long I) -> long {
        /* GATE 205 (LUT3 _1334_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout70[1] + 2 * gout89[0] + 4 * gout109[1];
    ...
    auto lut141idx0 = [](long I) -> long {
        /* GATE 332 (LUT3 _1461_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut141idx1 = [](long I) -> long {
        /* GATE 365 (LUT3 _1494_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout121[0] + 2 * gout111[1] + 4 * gout102[0];
    ...
    auto lut142idx0 = [](long I) -> long {
        /* GATE 185 (LUT3 _1314_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut142idx1 = [](long I) -> long {
        /* GATE 230 (LUT3 _1359_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * gout104[0] + 2 * gout138[0] + 4 * gout120[0];
    ...
    auto lut143idx0 = [](long I) -> long {
        /* GATE 342 (LUT3 _1471_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut143idx1 = [](long I) -> long {
        /* GATE 297 (LUT3 _1426_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * gout126[1] + 2 * gout118[1] + 4 * gout121[1];
    ...
    auto lut144idx0 = [](long I) -> long {
        /* GATE 46 (LUT3 _1175_ INIT 0x17 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut144idx1 = [](long I) -> long {
        /* GATE 13 (LUT3 _1142_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout128[0] + 2 * gout132[1] + 4 * gout87[0];
    ...
    auto lut145idx0 = [](long I) -> long {
        /* GATE 49 (LUT3 _1178_ INIT 0x53 PERM 201) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout98[1] + 2 * gout125[0] + 4 * gout72[0];
    ...
    auto lut146idx0 = [](long I) -> long {
        /* GATE 221 (LUT3 _1350_ INIT 0xca PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut146idx1 = [](long I) -> long {
        /* GATE 171 (LUT2 _1300_ INIT 0x9 PERM 21) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * gout103[0] + 2 * gout37[1] + 4 * gout136[0];
    ...
    auto lut147idx0 = [](long I) -> long {
        /* GATE 366 (LUT3 _1495_ INIT 0xe8 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut147idx1 = [](long I) -> long {
        /* GATE 341 (LUT3 _1470_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout143[0] + 2 * gout82[0] + 4 * gout52[1];
    ...
    auto lut148idx0 = [](long I) -> long {
        /* GATE 277 (LUT3 _1406_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut148idx1 = [](long I) -> long {
        /* GATE 231 (LUT3 _1360_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * gout138[1] + 2 * gout107[0] + 4 * gout118[0];
    ...
    auto lut149idx0 = [](long I) -> long {
        /* GATE 50 (LUT3 _1179_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut149idx1 = [](long I) -> long {
        /* GATE 111 (LUT3 _1240_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * gout125[1] + 2 * gout129[0] + 4 * gout106[0];
    ...
    auto lut150idx0 = [](long I) -> long {
        /* GATE 250 (LUT3 _1379_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut150idx1 = [](long I) -> long {
        /* GATE 311 (LUT3 _1440_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout127[1] + 2 * gout120[1] + 4 * gout126[0];
    ...
    auto lut151idx0 = [](long I) -> long {
        /* GATE 275 (LUT3 _1404_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut151idx1 = [](long I) -> long {
        /* GATE 229 (LUT3 _1358_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout142[1] + 2 * gout148[1] + 4 * gout150[0];
    ...
    auto lut152idx0 = [](long I) -> long {
        /* GATE 218 (LUT4 _1347_ INIT 0x718e PERM 1230) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut152idx1 = [](long I) -> long {
        /* GATE 158 (LUT3 _1287_ INIT 0x96 PERM 123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT152   ";
    Ciphertext gin152 = 1 * gout109[0] + 2 * gout123[0] + 4 * gout95[1] + 8 * gout140[0];
    ...
    auto lut153idx0 = [](long I) -> long {
        /* GATE 319 (LUT3 _1448_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut153idx1 = [](long I) -> long {
        /* GATE 355 (LUT3 _1484_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout137[0] + 2 * gout133[1] + 4 * gout141[0];
    ...
    auto lut154idx0 = [](long I) -> long {
        /* GATE 93 (LUT4 _1222_ INIT 0xe817 PERM 1230) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut154idx1 = [](long I) -> long {
        /* GATE 69 (LUT3 _1198_ INIT 0x96 PERM 123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout68[1] + 2 * gout72[1] + 4 * gout113[2] + 8 * gout131[1];
    ...
    auto lut155idx0 = [](long I) -> long {
        /* GATE 47 (LUT4 _1176_ INIT 0x6996 PERM 3012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut155idx1 = [](long I) -> long {
        /* GATE 96 (LUT3 _1225_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * gout145[0] + 2 * gout149[0] + 4 * gout154[1] + 8 * gout132[0];
    ...
    auto lut156idx0 = [](long I) -> long {
        /* GATE 267 (LUT3 _1396_ INIT 0xca PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut156idx1 = [](long I) -> long {
        /* GATE 217 (LUT2 _1346_ INIT 0x9 PERM 12) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout109[0] + 2 * gout152[0] + 4 * gout73[0];
    ...
    auto lut157idx0 = [](long I) -> long {
        /* GATE 346 (LUT3 _1475_ INIT 0xe8 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut157idx1 = [](long I) -> long {
        /* GATE 310 (LUT3 _1439_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout150[1] + 2 * gout81[1] + 4 * gout18[1];
    ...
    auto lut158idx0 = [](long I) -> long {
        /* GATE 356 (LUT3 _1485_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut158idx1 = [](long I) -> long {
        /* GATE 373 (LUT3 _1502_ INIT 0xb2 PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout137[1] + 2 * gout134[0] + 4 * gout116[1];
    ...
    auto lut159idx0 = [](long I) -> long {
        /* GATE 136 (LUT3 _1265_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut159idx1 = [](long I) -> long {
        /* GATE 97 (LUT3 _1226_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * gout136[1] + 2 * gout149[1] + 4 * gout135[0];
    ...
    auto lut160idx0 = [](long I) -> long {
        /* GATE 137 (LUT3 _1266_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut160idx1 = [](long I) -> long {
        /* GATE 182 (LUT3 _1311_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout135[1] + 2 * gout130[0] + 4 * gout152[1];
    ...
    auto lut161idx0 = [](long I) -> long {
        /* GATE 175 (LUT3 _1304_ INIT 0xca PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut161idx1 = [](long I) -> long {
        /* GATE 92 (LUT2 _1221_ INIT 0x9 PERM 12) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout68[1] + 2 * gout154[0] + 4 * gout8[1];
    ...
    auto lut162idx0 = [](long I) -> long {
        /* GATE 264 (LUT4 _1393_ INIT 0x718e PERM 1230) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut162idx1 = [](long I) -> long {
        /* GATE 204 (LUT3 _1333_ INIT 0x96 PERM 123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout117[0] + 2 * gout140[1] + 4 * gout112[1] + 8 * gout127[0];
    ...
    auto lut163idx0 = [](long I) -> long {
        /* GATE 90 (LUT3 _1219_ INIT 0x5c PERM 201) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout132[0] + 2 * gout155[0] + 4 * gout139[1];
    ...
    auto lut164idx0 = [](long I) -> long {
        /* GATE 276 (LUT3 _1405_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut164idx1 = [](long I) -> long {
        /* GATE 340 (LUT3 _1469_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout148[0] + 2 * gout133[0] + 4 * gout143[1];
    ...
    auto lut165idx0 = [](long I) -> long {
        /* GATE 354 (LUT3 _1483_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut165idx1 = [](long I) -> long {
        /* GATE 372 (LUT3 _1501_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout153[1] + 2 * gout158[0] + 4 * gout141[1];
    ...
    auto lut166idx0 = [](long I) -> long {
        /* GATE 135 (LUT3 _1264_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut166idx1 = [](long I) -> long {
        /* GATE 180 (LUT3 _1309_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout159[0] + 2 * gout160[0] + 4 * gout146[1];
    ...
    auto lut167idx0 = [](long I) -> long {
        /* GATE 45 (LUT4 _1174_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut167idx1 = [](long I) -> long {
        /* GATE 89 (LUT4 _1218_ INIT 0xb22b PERM 0321) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * gout144[0] + 2 * gout155[0] + 4 * gout139[1] + 8 * gout87[1];
    ...
    auto lut168idx0 = [](long I) -> long {
        /* GATE 318 (LUT3 _1447_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut168idx1 = [](long I) -> long {
        /* GATE 353 (LUT3 _1482_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout153[0] + 2 * gout164[1] + 4 * gout147[1];
    ...
    auto lut169idx0 = [](long I) -> long {
        /* GATE 345 (LUT3 _1474_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut169idx1 = [](long I) -> long {
        /* GATE 274 (LUT3 _1403_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout151[0] + 2 * gout164[0] + 4 * gout157[1];
    ...
    auto lut170idx0 = [](long I) -> long {
        /* GATE 183 (LUT3 _1312_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut170idx1 = [](long I) -> long {
        /* GATE 228 (LUT3 _1357_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * gout130[1] + 2 * gout142[0] + 4 * gout162[1];
    ...
    auto lut171idx0 = [](long I) -> long {
        /* GATE 314 (LUT3 _1443_ INIT 0xca PERM 021) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut171idx1 = [](long I) -> long {
        /* GATE 263 (LUT2 _1392_ INIT 0x9 PERM 12) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout117[0] + 2 * gout162[0] + 4 * gout74[0];
    ...
    auto lut172idx0 = [](long I) -> long {
        /* GATE 352 (LUT3 _1481_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut172idx1 = [](long I) -> long {
        /* GATE 370 (LUT3 _1499_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout168[1] + 2 * gout165[0] + 4 * gout147[0];
    ...
    auto lut173idx0 = [](long I) -> long {
        /* GATE 181 (LUT3 _1310_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut173idx1 = [](long I) -> long {
        /* GATE 226 (LUT3 _1355_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout160[1] + 2 * gout170[0] + 4 * gout156[1];
    ...
    auto lut174idx0 = [](long I) -> long {
        /* GATE 91 (LUT3 _1220_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut174idx1 = [](long I) -> long {
        /* GATE 134 (LUT3 _1263_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout161[1] + 2 * gout155[1] + 4 * gout159[1];
    ...
    auto lut175idx0 = [](long I) -> long {
        /* GATE 380 (LUT4 _1509_ INIT 0x9669 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut175idx1 = [](long I) -> long {
        /* GATE 88 (LUT4 _1217_ INIT 0x4114 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut175idx2 = [](long I) -> long {
        /* GATE 132 (LUT3 _1261_ INIT 0xb2 PERM 123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    lut175.push_back(ctx.genrate_lut(lut175idx2));
    flut175.push_back(lut175idx2);
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout167[1] + 2 * gout163[0] + 4 * gout174[0] + 8 * gout139[0];
    ...
    auto lut176idx0 = [](long I) -> long {
        /* GATE 179 (LUT3 _1308_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut176idx1 = [](long I) -> long {
        /* GATE 224 (LUT3 _1353_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout166[1] + 2 * gout173[0] + 4 * gout146[0];
    ...
    auto lut177idx0 = [](long I) -> long {
        /* GATE 371 (LUT4 _1500_ INIT 0x9669 PERM 0213) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut177idx1 = [](long I) -> long {
        /* GATE 379 (LUT4 _1508_ INIT 0xb220 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * gout165[1] + 2 * gout134[1] + 4 * gout158[1] + 8 * gout116[0];
    ...
    auto lut178idx0 = [](long I) -> long {
        /* GATE 273 (LUT3 _1402_ INIT 0x2b PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut178idx1 = [](long I) -> long {
        /* GATE 227 (LUT3 _1356_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout170[1] + 2 * gout151[1] + 4 * gout171[1];
    ...
    auto lut179idx0 = [](long I) -> long {
        /* GATE 271 (LUT3 _1400_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut179idx1 = [](long I) -> long {
        /* GATE 225 (LUT3 _1354_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout173[1] + 2 * gout178[1] + 4 * gout156[0];
    ...
    auto lut180idx0 = [](long I) -> long {
        /* GATE 351 (LUT3 _1480_ INIT 0xd4 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut180idx1 = [](long I) -> long {
        /* GATE 317 (LUT3 _1446_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout168[0] + 2 * gout169[0] + 4 * gout157[0];
    ...
    auto lut181idx0 = [](long I) -> long {
        /* GATE 378 (LUT2 _1507_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut181idx1 = [](long I) -> long {
        /* GATE 369 (LUT2 _1498_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout172[1] + 2 * gout177[0];
    ...
    auto lut182idx0 = [](long I) -> long {
        /* GATE 272 (LUT3 _1401_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut182idx1 = [](long I) -> long {
        /* GATE 347 (LUT3 _1476_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * gout178[0] + 2 * gout169[1] + 4 * gout171[0];
    ...
    auto lut183idx0 = [](long I) -> long {
        /* GATE 367 (LUT2 _1496_ INIT 0x4 PERM 10) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut183idx1 = [](long I) -> long {
        /* GATE 350 (LUT2 _1479_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout180[0] + 2 * gout172[0];
    ...
    auto lut184idx0 = [](long I) -> long {
        /* GATE 133 (LUT3 _1262_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut184idx1 = [](long I) -> long {
        /* GATE 178 (LUT3 _1307_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout174[1] + 2 * gout166[0] + 4 * gout161[0];
    ...
    auto lut185idx0 = [](long I) -> long {
        /* GATE 270 (LUT2 _1399_ INIT 0x4 PERM 01) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut185idx1 = [](long I) -> long {
        /* GATE 223 (LUT2 _1352_ INIT 0x9 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout176[1] + 2 * gout179[1];
    ...
    auto lut186idx0 = [](long I) -> long {
        /* GATE 87 (LUT3 _1216_ INIT 0x69 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut186idx1 = [](long I) -> long {
        /* GATE 177 (LUT3 _1306_ INIT 0x71 PERM 021) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout175[1] + 2 * gout175[2] + 4 * gout184[0];
    ...
    auto lut187idx0 = [](long I) -> long {
        /* GATE 222 (LUT4 _1351_ INIT 0x8e71 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut187idx1 = [](long I) -> long {
        /* GATE 269 (LUT4 _1398_ INIT 0x7100 PERM 0123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut187idx2 = [](long I) -> long {
        /* GATE 176 (LUT3 _1305_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    lut187.push_back(ctx.genrate_lut(lut187idx2));
    flut187.push_back(lut187idx2);
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout186[1] + 2 * gout184[1] + 4 * gout176[0] + 8 * gout185[1];
    ...
    auto lut188idx0 = [](long I) -> long {
        /* GATE 316 (LUT4 _1445_ INIT 0x222b PERM 2301) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut188idx1 = [](long I) -> long {
        /* GATE 268 (LUT4 _1397_ INIT 0x1ee1 PERM 0123) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout187[1] + 2 * gout185[0] + 4 * gout179[0] + 8 * gout182[0];
    ...
    auto lut189idx0 = [](long I) -> long {
        /* GATE 315 (LUT3 _1444_ INIT 0x96 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    auto lut189idx1 = [](long I) -> long {
        /* GATE 349 (LUT3 _1478_ INIT 0xb2 PERM 012) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout188[0] + 2 * gout180[1] + 4 * gout182[1];
    ...
    auto lut190idx0 = [](long I) -> long {
        /* GATE 377 (LUT4 _1506_ INIT 0xb00 PERM 1320) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 0;
    ...
    auto lut190idx1 = [](long I) -> long {
        /* GATE 368 (LUT4 _1497_ INIT 0xf20d PERM 3120) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 1;
    ...
    auto lut190idx2 = [](long I) -> long {
        /* GATE 348 (LUT3 _1477_ INIT 0x1e PERM 123) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    lut190.push_back(ctx.genrate_lut(lut190idx2));
    flut190.push_back(lut190idx2);
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout181[1] + 2 * gout183[1] + 4 * gout183[0] + 8 * gout189[1];
    ...
    auto lut191idx0 = [](long I) -> long {
        /* GATE 376 (LUT3 _1505_ INIT 0xe1 PERM 012) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    auto lut191idx1 = [](long I) -> long {
        /* GATE 381 (LUT3 _1510_ INIT 0xe PERM 102) */
        switch (I) {
            case  0: return 0;
            case  1: return 1;
            case  2: return 1;
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout190[0] + 2 * gout181[0] + 4 * gout177[1];
    std::vector<Ciphertext> gout191 = ctx.eval_lut_amortized(&gin191, lut191);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout128[1])); /* out192 */
    test_out.push_back(ctx.decrypt(&gout144[1])); /* out193 */
    test_out.push_back(ctx.decrypt(&gout167[0])); /* out194 */
    test_out.push_back(ctx.decrypt(&gout175[0])); /* out195 */
    test_out.push_back(ctx.decrypt(&gout186[0])); /* out196 */
    test_out.push_back(ctx.decrypt(&gout187[2])); /* out197 */
    test_out.push_back(ctx.decrypt(&gout187[0])); /* out198 */
    test_out.push_back(ctx.decrypt(&gout188[1])); /* out199 */
    test_out.push_back(ctx.decrypt(&gout189[0])); /* out200 */
    test_out.push_back(ctx.decrypt(&gout190[2])); /* out201 */
    test_out.push_back(ctx.decrypt(&gout190[1])); /* out202 */
    test_out.push_back(ctx.decrypt(&gout191[0])); /* out203 */
    test_out.push_back(ctx.decrypt(&gout191[1])); /* out204 */
    return test_out;
}

static void
BM_sum3d_lut4(benchmark::State& state)
{
    FHEContext ctx;
...
BENCHMARK(BM_sum3d_lut4)->Unit(benchmark::kSecond);
BENCHMARK_MAIN();
