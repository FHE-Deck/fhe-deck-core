...
test_sum3d_lut3(FHEContext& ctx, std::vector<uint64_t> out = { 0 })
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_out70 + 2 * ct_out54 + 4 * ct_out62;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_out137 + 2 * ct_out121 + 4 * ct_out129;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_out93 + 2 * ct_out77 + 4 * ct_out85;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_out184 + 2 * ct_out168 + 4 * ct_out176;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_out136 + 2 * ct_out120 + 4 * ct_out128;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_out90 + 2 * ct_out74 + 4 * ct_out82;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_out20 + 2 * ct_out4 + 4 * ct_out12;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_out17 + 2 * ct_out1 + 4 * ct_out9;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_out64 + 2 * ct_out48 + 4 * ct_out56;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_out95 + 2 * ct_out79 + 4 * ct_out87;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_out163 + 2 * ct_out147 + 4 * ct_out155;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_out42 + 2 * ct_out26 + 4 * ct_out34;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_out23 + 2 * ct_out7 + 4 * ct_out15;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_out189 + 2 * ct_out173 + 4 * ct_out181;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_out71 + 2 * ct_out55 + 4 * ct_out63;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_out167 + 2 * ct_out151 + 4 * ct_out159;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_out112 + 2 * ct_out96 + 4 * ct_out104;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_out118 + 2 * ct_out102 + 4 * ct_out110;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_out44 + 2 * ct_out28 + 4 * ct_out36;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_out162 + 2 * ct_out146 + 4 * ct_out154;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_out68 + 2 * ct_out52 + 4 * ct_out60;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_out140 + 2 * ct_out124 + 4 * ct_out132;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_out89 + 2 * ct_out73 + 4 * ct_out81;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_out117 + 2 * ct_out101 + 4 * ct_out109;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_out186 + 2 * ct_out170 + 4 * ct_out178;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_out138 + 2 * ct_out122 + 4 * ct_out130;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_out19 + 2 * ct_out3 + 4 * ct_out11;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_out185 + 2 * ct_out169 + 4 * ct_out177;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_out114 + 2 * ct_out98 + 4 * ct_out106;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_out69 + 2 * ct_out53 + 4 * ct_out61;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_out47 + 2 * ct_out31 + 4 * ct_out39;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_out166 + 2 * ct_out150 + 4 * ct_out158;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * ct_out142 + 2 * ct_out126 + 4 * ct_out134;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * ct_out67 + 2 * ct_out51 + 4 * ct_out59;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout0[1] + 2 * gout14[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_out119 + 2 * ct_out103 + 4 * ct_out111;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_out161 + 2 * ct_out145 + 4 * ct_out153;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout31[0] + 2 * gout32[0] + 4 * gout15[0];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * ct_out16 + 2 * ct_out0 + 4 * ct_out8;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_out65 + 2 * ct_out49 + 4 * ct_out57;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_out21 + 2 * ct_out5 + 4 * ct_out13;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_out94 + 2 * ct_out78 + 4 * ct_out86;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_out190 + 2 * ct_out174 + 4 * ct_out182;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * ct_out160 + 2 * ct_out144 + 4 * ct_out152;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * ct_out191 + 2 * ct_out175 + 4 * ct_out183;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * ct_out18 + 2 * ct_out2 + 4 * ct_out10;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout16[0] + 2 * gout4[1];
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout29[1] + 2 * gout0[0] + 4 * gout41[1];
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * ct_out91 + 2 * ct_out75 + 4 * ct_out83;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_out46 + 2 * ct_out30 + 4 * ct_out38;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * ct_out188 + 2 * ct_out172 + 4 * ct_out180;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * ct_out45 + 2 * ct_out29 + 4 * ct_out37;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * ct_out41 + 2 * ct_out25 + 4 * ct_out33;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * ct_out116 + 2 * ct_out100 + 4 * ct_out108;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * ct_out164 + 2 * ct_out148 + 4 * ct_out156;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * ct_out92 + 2 * ct_out76 + 4 * ct_out84;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * ct_out88 + 2 * ct_out72 + 4 * ct_out80;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_out22 + 2 * ct_out6 + 4 * ct_out14;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * ct_out43 + 2 * ct_out27 + 4 * ct_out35;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * ct_out187 + 2 * ct_out171 + 4 * ct_out179;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * ct_out40 + 2 * ct_out24 + 4 * ct_out32;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * ct_out165 + 2 * ct_out149 + 4 * ct_out157;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout3[0] + 2 * gout27[1] + 4 * gout7[0];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * ct_out115 + 2 * ct_out99 + 4 * ct_out107;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * ct_out143 + 2 * ct_out127 + 4 * ct_out135;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * ct_out139 + 2 * ct_out123 + 4 * ct_out131;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * ct_out66 + 2 * ct_out50 + 4 * ct_out58;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * ct_out113 + 2 * ct_out97 + 4 * ct_out105;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * ct_out141 + 2 * ct_out125 + 4 * ct_out133;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout64[0] + 2 * gout15[1];
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * gout13[0] + 2 * gout42[1] + 4 * gout57[1];
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout49[0] + 2 * gout57[0] + 4 * gout30[0];
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout60[1] + 2 * gout38[0] + 4 * gout52[0];
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout12[1] + 2 * gout30[1];
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout27[0] + 2 * gout24[0] + 4 * gout45[1];
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout65[0] + 2 * gout28[1] + 4 * gout63[0];
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout26[0] + 2 * gout24[1] + 4 * gout59[1];
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * gout11[0] + 2 * gout45[0] + 4 * gout58[0];
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout61[0] + 2 * gout68[0] + 4 * gout31[1];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout19[0] + 2 * gout25[0] + 4 * gout10[0];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * gout36[0] + 2 * gout1[1] + 4 * gout19[1];
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * gout16[1] + 2 * gout67[0] + 4 * gout1[0];
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * gout20[0] + 2 * gout29[0] + 4 * gout2[0];
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout17[0] + 2 * gout35[0] + 4 * gout64[1];
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout43[0] + 2 * gout4[0] + 4 * gout36[1];
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout3[1] + 2 * gout38[1];
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout51[0] + 2 * gout40[0] + 4 * gout49[1];
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout46[1] + 2 * gout81[0] + 4 * gout84[0];
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout63[1] + 2 * gout53[1] + 4 * gout21[0];
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout39[1] + 2 * gout66[1] + 4 * gout5[0];
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout83[1] + 2 * gout35[1];
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout23[1] + 2 * gout17[1] + 4 * gout32[1];
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout8[0] + 2 * gout39[0] + 4 * gout22[1];
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout90[0] + 2 * gout69[0];
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout86[0] + 2 * gout71[0] + 4 * gout34[1];
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout8[1] + 2 * gout56[0];
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout50[1] + 2 * gout13[1] + 4 * gout40[1];
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout59[0] + 2 * gout50[0] + 4 * gout6[0];
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout52[1] + 2 * gout7[1] + 4 * gout11[1];
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * gout42[0] + 2 * gout44[1] + 4 * gout12[0];
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout58[1] + 2 * gout26[1] + 4 * gout18[0];
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * gout18[1] + 2 * gout6[1] + 4 * gout51[1];
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * gout100[1] + 2 * gout101[0] + 4 * gout82[1];
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * gout46[0] + 2 * gout43[1];
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * gout33[0] + 2 * gout20[1] + 4 * gout55[0];
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * gout95[1] + 2 * gout60[0];
    ...
    std::cerr << "\rLUT106   ";
    Ciphertext gin106 = 1 * gout10[1] + 2 * gout65[1] + 4 * gout54[1];
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * gout70[0] + 2 * gout78[1] + 4 * gout99[1];
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * gout66[0] + 2 * gout33[1] + 4 * gout48[0];
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * gout54[0] + 2 * gout21[1] + 4 * gout61[1];
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * gout67[1] + 2 * gout28[0] + 4 * gout25[1];
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * gout97[0] + 2 * gout106[1] + 4 * gout96[1];
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * gout95[0] + 2 * gout56[1];
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * gout101[1] + 2 * gout86[1] + 4 * gout47[1];
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * gout53[0] + 2 * gout23[0] + 4 * gout68[1];
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * gout62[0] + 2 * gout84[1] + 4 * gout74[1];
    ...
    std::cerr << "\rLUT116   ";
    Ciphertext gin116 = 1 * gout71[1] + 2 * gout73[1] + 4 * gout14[1];
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout85[0] + 2 * gout62[1];
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * gout108[1] + 2 * gout98[1] + 4 * gout77[1];
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout90[1] + 2 * gout69[1];
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * gout102[1] + 2 * gout111[0] + 4 * gout113[1];
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout77[0] + 2 * gout100[0] + 4 * gout104[1];
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * gout114[0] + 2 * gout91[1] + 4 * gout78[0];
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * gout120[0] + 2 * gout47[0] + 4 * gout41[0];
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * gout74[0] + 2 * gout80[1] + 4 * gout76[0];
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * gout103[1] + 2 * gout85[1];
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * gout119[1] + 2 * gout90[0] + 4 * gout69[0];
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout81[1] + 2 * gout110[1] + 4 * gout80[0];
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout91[0] + 2 * gout83[0] + 4 * gout37[0];
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * gout76[1] + 2 * gout79[1] + 4 * gout97[1];
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout103[0] + 2 * gout87[1] + 4 * gout117[1];
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * gout72[1] + 2 * gout98[0] + 4 * gout89[0];
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout99[0] + 2 * gout37[1] + 4 * gout44[0];
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * gout125[0] + 2 * gout105[1];
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * gout72[0] + 2 * gout92[1];
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * gout117[0] + 2 * gout134[1] + 4 * gout131[0];
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout131[1] + 2 * gout115[1] + 4 * gout118[0];
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * gout118[1] + 2 * gout124[1] + 4 * gout121[0];
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout75[0] + 2 * gout88[0] + 4 * gout106[0];
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * gout79[0] + 2 * gout110[0] + 4 * gout75[1];
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout122[1] + 2 * gout128[0] + 4 * gout107[0];
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout137[1] + 2 * gout104[0] + 4 * gout55[1];
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * gout88[1] + 2 * gout114[1] + 4 * gout109[0];
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * gout139[1] + 2 * gout138[0] + 4 * gout129[0];
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout96[0] + 2 * gout109[1] + 4 * gout70[1];
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout142[1] + 2 * gout122[0] + 4 * gout144[0];
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * gout135[0] + 2 * gout89[1] + 4 * gout5[1];
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout138[1] + 2 * gout142[0] + 4 * gout111[1];
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * gout87[0] + 2 * gout127[0] + 4 * gout115[0];
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * gout105[0] + 2 * gout134[0];
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout147[1] + 2 * gout145[0] + 4 * gout120[1];
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout116[0] + 2 * gout73[0] + 4 * gout132[1];
    ...
    std::cerr << "\rLUT152   ";
    Ciphertext gin152 = 1 * gout94[1] + 2 * gout116[1] + 4 * gout107[1];
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout121[1] + 2 * gout102[0] + 4 * gout129[1];
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout136[1] + 2 * gout108[0] + 4 * gout48[1];
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * gout149[0] + 2 * gout92[0] + 4 * gout22[0];
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout113[0] + 2 * gout144[1] + 4 * gout94[0];
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout125[1] + 2 * gout130[1] + 4 * gout149[1];
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout119[0] + 2 * gout128[1] + 4 * gout132[0];
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * gout130[0] + 2 * gout148[0] + 4 * gout135[1];
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout143[0] + 2 * gout147[0] + 4 * gout153[0];
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout153[1] + 2 * gout82[0] + 4 * gout2[1];
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout160[1] + 2 * gout150[0] + 4 * gout161[1];
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout124[0] + 2 * gout127[1] + 4 * gout139[0];
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout157[1] + 2 * gout159[0] + 4 * gout155[0];
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout158[1] + 2 * gout126[0] + 4 * gout151[0];
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout136[0] + 2 * gout148[1] + 4 * gout163[1];
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * gout146[0] + 2 * gout159[1] + 4 * gout166[1];
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout133[0] + 2 * gout157[0] + 4 * gout112[1];
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout156[1] + 2 * gout34[0] + 4 * gout9[1];
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * gout163[0] + 2 * gout143[1] + 4 * gout137[0];
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout164[1] + 2 * gout167[0] + 4 * gout155[1];
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout145[1] + 2 * gout140[0] + 4 * gout156[0];
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout158[0] + 2 * gout140[1] + 4 * gout152[0];
    ...
    lut174.push_back(ctx.genrate_lut(lut174idx2));
    flut174.push_back(lut174idx2);
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout151[1] + 2 * gout165[1] + 4 * gout93[0];
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout168[0] + 2 * gout164[0] + 4 * gout112[0];
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout173[1] + 2 * gout172[1] + 4 * gout169[0];
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * gout170[1] + 2 * gout160[0] + 4 * gout141[1];
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout166[0] + 2 * gout170[0] + 4 * gout154[0];
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout178[1] + 2 * gout177[0] + 4 * gout154[1];
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout173[0] + 2 * gout165[0] + 4 * gout152[1];
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout150[1] + 2 * gout172[0] + 4 * gout123[0];
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * gout167[1] + 2 * gout178[0] + 4 * gout146[1];
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout175[1] + 2 * gout171[0];
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout162[1] + 2 * gout181[0] + 4 * gout161[0];
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout177[1] + 2 * gout162[0] + 4 * gout141[0];
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout183[0] + 2 * gout171[1] + 4 * gout182[0];
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout174[2] + 2 * gout180[0] + 4 * gout174[1];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout174[0] + 2 * gout187[0];
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout176[1] + 2 * gout180[1] + 4 * gout169[1];
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout176[0] + 2 * gout181[1] + 4 * gout123[1];
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout190[1] + 2 * gout189[1];
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout186[0] + 2 * gout182[1] + 4 * gout179[0];
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * gout192[1] + 2 * gout179[1] + 4 * gout185[1];
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout193[1] + 2 * gout185[0] + 4 * gout184[1];
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout194[1] + 2 * gout190[0] + 4 * gout184[0];
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout191[1] + 2 * gout191[0] + 4 * gout195[0];
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout196[1] + 2 * gout189[0] + 4 * gout187[1];
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout197[1] + 2 * gout188[0];
    std::vector<Ciphertext> gout198 = ctx.eval_lut_amortized(&gin198, lut198);

    std::cerr << "\r          \r";
    std::vector<long> test_out;
    test_out.push_back(ctx.decrypt(&gout133[1])); /* out192 */
    test_out.push_back(ctx.decrypt(&gout168[1])); /* out193 */
    test_out.push_back(ctx.decrypt(&gout175[0])); /* out194 */
    test_out.push_back(ctx.decrypt(&gout183[1])); /* out195 */
    test_out.push_back(ctx.decrypt(&gout186[1])); /* out196 */
    test_out.push_back(ctx.decrypt(&gout192[0])); /* out197 */
    test_out.push_back(ctx.decrypt(&gout193[0])); /* out198 */
    test_out.push_back(ctx.decrypt(&gout194[0])); /* out199 */
    test_out.push_back(ctx.decrypt(&gout195[1])); /* out200 */
    test_out.push_back(ctx.decrypt(&gout196[0])); /* out201 */
    test_out.push_back(ctx.decrypt(&gout197[0])); /* out202 */
    test_out.push_back(ctx.decrypt(&gout198[1])); /* out203 */
    test_out.push_back(ctx.decrypt(&gout198[0])); /* out204 */
    return test_out;
}
