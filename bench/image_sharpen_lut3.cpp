...
test_image_sharpen_lut3(FHEContext& ctx, uint64_t window = 0)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_window10 + 2 * ct_window42 + 4 * ct_window34;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_window31 + 2 * ct_window63 + 4 * ct_window15;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_window24 + 2 * ct_window56 + 4 * ct_window8;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_window43 + 2 * ct_window35 + 4 * ct_window33;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_window41 + 2 * ct_window33;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_window25 + 2 * ct_window57 + 4 * ct_window9;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_window29 + 2 * ct_window61 + 4 * ct_window13;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_window28 + 2 * ct_window60 + 4 * ct_window12;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_window26 + 2 * ct_window58;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * gout2[1] + 2 * gout6[1] + 4 * gout4[1];
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout2[0] + 2 * ct_window40 + 4 * ct_window32;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_window44 + 2 * ct_window36 + 4 * ct_window34;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_window45 + 2 * ct_window37 + 4 * ct_window35;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout9[0] + 2 * gout6[0] + 4 * gout0[0];
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * gout10[1] + 2 * gout15[1] + 4 * gout4[0];
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_window27 + 2 * ct_window59 + 4 * ct_window11;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_window30 + 2 * ct_window62 + 4 * ct_window14;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * gout8[0] + 2 * gout7[0] + 4 * gout14[0];
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout11[2] + 2 * gout10[0] + 4 * gout13[0];
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_window46 + 2 * ct_window38 + 4 * ct_window36;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * gout9[1] + 2 * gout17[0] + 4 * gout3[1];
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * gout13[0] + 2 * gout20[1] + 4 * gout11[1];
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_window40 + 2 * ct_window32 + 4 * gout20[1];
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout11[1] + 2 * gout24[0];
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout7[1] + 2 * gout18[1] + 4 * gout21[0];
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout18[0] + 2 * gout5[0];
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout17[1] + 2 * gout8[1] + 4 * gout12[1];
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout20[0] + 2 * gout16[1];
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout24[1] + 2 * gout29[1] + 4 * gout23[0];
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout19[0] + 2 * gout26[1] + 4 * gout14[1];
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * gout15[0] + 2 * gout22[0] + 4 * gout0[1];
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout28[0] + 2 * gout19[1] + 4 * gout12[0];
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * gout26[0] + 2 * gout27[0] + 4 * gout1[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout16[0] + 2 * gout32[0];
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout22[1] + 2 * gout28[1] + 4 * gout3[0];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout31[0] + 2 * gout34[0] + 4 * gout21[1];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout30[0] + 2 * gout29[0] + 4 * gout35[1];
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout32[1] + 2 * gout36[1];
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout36[0] + 2 * gout33[0];
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout38[1] + 2 * gout35[0] + 4 * gout39[1];
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout33[1] + 2 * gout31[1] + 4 * gout37[0];
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout39[0] + 2 * gout40[0];
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout41[1] + 2 * gout41[0] + 4 * gout43[0];
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout40[1] + 2 * gout42[1];
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout39[0] + 2 * gout40[0] + 4 * gout41[0];
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout44[0] + 2 * gout30[1] + 4 * gout38[0];
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout46[0] + 2 * gout45[0] + 4 * gout44[0];
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout40[1] + 2 * gout42[1] + 4 * gout46[0];
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout49[0] + 2 * gout42[0] + 4 * gout48[0];
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout47[0] + 2 * gout46[0] + 4 * gout45[0];
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout51[0] + 2 * gout50[1] + 4 * gout50[0];
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * gout25[0] + 2 * gout50[0] + 4 * gout52[0];
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout50[0] + 2 * gout38[0] + 4 * gout52[0];
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout11[0] + 2 * gout50[0] + 4 * gout52[0];
