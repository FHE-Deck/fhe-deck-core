...
test_sqrt_lut4(FHEContext& ctx, uint16_t num = 0)
{
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_num4 + 2 * ct_num3 + 4 * ct_num2;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_num11 + 2 * ct_num12 + 4 * ct_num10;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_num14 + 2 * ct_num13 + 4 * ct_num12 + 8 * ct_num15;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * gout3[1] + 2 * ct_num10 + 4 * ct_num9 + 8 * ct_num8;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * gout2[1] + 2 * ct_num12 + 4 * gout3[1] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_num13 + 2 * gout2[0] + 4 * ct_num15;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * gout6[0] + 2 * ct_num12 + 4 * gout3[2];
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * gout3[1] + 2 * gout2[0];
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_num11 + 2 * ct_num12 + 4 * gout3[1] + 8 * ct_num10;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * gout7[0] + 2 * gout6[0] + 4 * ct_num12;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * gout5[0] + 2 * gout10[0] + 4 * gout3[0];
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * gout11[0] + 2 * gout8[0] + 4 * gout12[0] + 8 * ct_num15;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_num9 + 2 * ct_num8 + 4 * gout13[0] + 8 * gout9[0];
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * gout5[0] + 2 * gout10[0] + 4 * gout13[0] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * gout11[0] + 2 * gout8[0] + 4 * gout12[0] + 8 * gout13[0];
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout14[0] + 2 * ct_num10;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * gout16[0] + 2 * gout14[1] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout17[0] + 2 * gout15[0] + 4 * gout3[2];
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * gout20[1] + 2 * gout19[0] + 4 * gout18[0] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_num7 + 2 * ct_num6 + 4 * gout22[0];
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * gout16[0] + 2 * gout14[1] + 4 * gout22[0] + 8 * gout9[0];
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * gout19[0] + 2 * gout18[0] + 4 * gout22[0] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * gout15[0] + 2 * gout25[0] + 4 * gout22[0] + 8 * gout3[2];
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * gout4[0] + 2 * ct_num6 + 4 * gout22[0];
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * gout0[0] + 2 * gout16[1] + 4 * gout22[0] + 8 * gout9[0];
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * gout28[1] + 2 * gout9[0];
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * gout28[0] + 2 * gout27[0] + 4 * gout23[0] + 8 * gout13[0];
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * gout30[0] + 2 * gout29[0] + 4 * gout24[0] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout27[0] + 2 * gout23[0] + 4 * gout32[0] + 8 * gout13[0];
    ...
    lut34.push_back(ctx.genrate_lut(lut34idx2));
    flut34.push_back(lut34idx2);
    auto lut34idx3 = [](long I) -> long {
    ...
    lut34.push_back(ctx.genrate_lut(lut34idx3));
    flut34.push_back(lut34idx3);
    auto lut34idx4 = [](long I) -> long {
    ...
    lut34.push_back(ctx.genrate_lut(lut34idx4));
    flut34.push_back(lut34idx4);
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_num5 + 2 * ct_num4 + 4 * gout22[0] + 8 * gout32[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * gout34[3] + 2 * gout1[0] + 4 * gout34[1];
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout31[0] + 2 * gout25[0] + 4 * gout32[0] + 8 * gout3[2];
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * gout30[1] + 2 * gout28[1] + 4 * gout32[0] + 8 * gout9[0];
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * gout31[1] + 2 * gout24[0] + 4 * gout32[0] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * gout4[0] + 2 * ct_num6 + 4 * gout22[0] + 8 * gout32[0];
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * gout34[0] + 2 * gout39[0] + 4 * gout13[0];
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * gout34[3] + 2 * gout1[0] + 4 * gout22[0] + 8 * gout34[2];
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * gout39[0] + 2 * gout13[0] + 4 * gout33[0] + 8 * gout9[0];
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout40[0] + 2 * gout42[0] + 4 * gout42[1] + 8 * gout41[0];
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout41[0] + 2 * gout39[0] + 4 * gout13[0];
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout43[0] + 2 * gout37[0] + 4 * gout3[0];
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * gout36[0] + 2 * gout38[0] + 4 * gout3[2];
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout46[1] + 2 * gout46[0] + 4 * gout45[0] + 8 * ct_num15;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout34[2] + 2 * gout35[0] + 4 * gout13[0] + 8 * gout47[0];
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_num3 + 2 * ct_num2 + 4 * gout47[0];
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * gout41[0] + 2 * gout39[0] + 4 * gout13[0] + 8 * gout47[0];
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * gout34[4] + 2 * gout1[1] + 4 * gout22[0] + 8 * gout47[0];
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout44[0] + 2 * gout33[0] + 4 * gout9[0] + 8 * gout47[0];
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * ct_num0 + 2 * ct_num1 + 4 * ct_num2 + 8 * gout47[0];
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * gout43[0] + 2 * gout37[0] + 4 * gout3[0] + 8 * gout47[0];
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * gout47[0] + 2 * gout45[0] + 4 * gout38[0] + 8 * gout3[2];
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * gout52[0] + 2 * gout3[0] + 4 * gout3[2] + 8 * gout54[0];
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * gout48[0] + 2 * gout50[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * gout48[1] + 2 * gout51[0];
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * gout50[0] + 2 * gout9[0] + 4 * gout52[0] + 8 * gout3[0];
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout53[0] + 2 * gout32[0] + 4 * gout49[0] + 8 * gout51[1];
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout60[0] + 2 * gout58[0] + 4 * gout57[0] + 8 * gout59[0];
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * gout3[2] + 2 * gout54[0] + 4 * gout55[0];
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout61[0] + 2 * gout56[0] + 4 * gout62[0] + 8 * ct_num15;
    ...
    test_out.push_back(ctx.decrypt(&gout9[0])); /* out5 */
    test_out.push_back(ctx.decrypt(&gout3[0])); /* out6 */
    test_out.push_back(ctx.decrypt(&gout3[2])); /* out7 */
    return test_out;
}
