...
KluczniakSchildFunctionalBootstrapPublicKey::KluczniakSchildFunctionalBootstrapPublicKey(
...
std::vector<LWECT> KluczniakSchildFunctionalBootstrapPublicKey::full_domain_bootstrap(
...
void KluczniakSchildFunctionalBootstrapPublicKey::full_domain_bootstrap(fhe_deck::LWECT *lwe_ct_out,
