...
void test_rot_poly(){
    ...
    std::cout << "poly_2: " << Utils::to_string(poly_2.coefs, N) << std::endl;  
...
void test_eval_poly(){
    ...
    std::cout << "Poly (Encoded): " << Utils::to_string(poly.coefs, N) << std::endl;
    poly.decode();
    std::cout << "Poly (Decoded): " << Utils::to_string(poly.coefs, N) << std::endl;
    poly.encode();
    std::cout << "Poly (Encoded): " << Utils::to_string(poly.coefs, N) << std::endl;

    poly.to_amortization_form();
    std::cout << "Poly (Amortized Form): " << Utils::to_string(poly.coefs, N) << std::endl;
    ...
    Utils::negacyclic_rotate_poly(rot_poly, poly.coefs, N, phase); 
