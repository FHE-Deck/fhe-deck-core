...
class Gadget{
    ...
    virtual void sample(VectorArray& out, const std::vector<int64_t>& in) = 0;
...
class SignedDecompositionGadget : public Gadget{
    ...
    void sample(VectorArray& out, const std::vector<int64_t>& in);
 
    void decomp(VectorArray& out, const std::vector<int64_t>& poly);
...
class DiscreteGaussianSamplingGadget : public Gadget{
    ...
    // Stuff for perturb_B
    std::vector<double> c_pert;
    std::vector<int64_t> z_pert;
    ...
    std::array<int64_t, 4> xoshiro256_s;
    ...
    void decomp(VectorArray& out, const std::vector<int64_t>& in);

    void signed_decomp(VectorArray& out, const std::vector<int64_t>& in);

    void gaussian_sample(VectorArray& out, const std::vector<int64_t>& in);
  
    void gaussian_sample_modulus_power_of_base(VectorArray& out, const std::vector<int64_t>& in);

    void gaussian_sample_general_modulus(VectorArray& out, const std::vector<int64_t>& in);
    ...
    void base_decomposition(std::vector<int64_t>& out, int64_t in);
