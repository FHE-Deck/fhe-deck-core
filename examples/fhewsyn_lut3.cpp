...
test_add4_lut3(FHEContext& ctx, uint8_t a, uint8_t b)
{
    ...
    out.push_back(ctx.decrypt(&gout1[1])); /* out1 */
...
test_calculator_lut3(FHEContext& ctx, uint8_t op, uint16_t x, uint16_t y)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_x2 + 2 * ct_y0;
    std::vector<Ciphertext> gout0 = ctx.eval_lut_amortized(&gin0, lut0);
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_x4 + 2 * ct_y10;
    std::vector<Ciphertext> gout1 = ctx.eval_lut_amortized(&gin1, lut1);
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_y6 + 2 * ct_x8;
    std::vector<Ciphertext> gout2 = ctx.eval_lut_amortized(&gin2, lut2);
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_y0 + 2 * ct_x14;
    std::vector<Ciphertext> gout3 = ctx.eval_lut_amortized(&gin3, lut3);
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_y11 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_x11 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_y7 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_x4 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_y5 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_x10 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_y3 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_x8 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_y7 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_x6 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_y5 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_y12 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_x9 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_y4 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_y2 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_y2 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_x2 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_x6 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_y6 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_y14 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_y5 + 2 * ct_x4;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_op6 + 2 * ct_op7;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_x13 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_y7 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_x9 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_y9 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * ct_y1 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * gout32[0] + 2 * gout19[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_y7 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_y0 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * ct_y9 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * ct_y2 + 2 * ct_x11;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_y1 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_x13 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_y4 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_y3 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * gout42[0] + 2 * ct_y4 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * ct_y13 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * gout44[0] + 2 * gout24[0] + 4 * gout15[0];
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * ct_x3 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * ct_y6 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * ct_y6 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_y1 + 2 * ct_x12;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * ct_y3 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * ct_y14 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * ct_x0 + 2 * ct_y15 + 4 * gout51[0];
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * ct_y2 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * ct_y11 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * ct_y2 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * ct_x9 + 2 * ct_y6;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_y5 + 2 * ct_x10 + 4 * gout56[0];
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * ct_x9 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * ct_x9 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * ct_y8 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * gout29[0] + 2 * gout60[0] + 4 * gout47[0];
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * ct_y2 + 2 * ct_y1 + 4 * ct_y0;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout62[0] + 2 * ct_y3 + 4 * ct_y4;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * ct_op4 + 2 * ct_op5 + 4 * gout27[0];
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * ct_y12 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * ct_y11 + 2 * ct_x4 + 4 * gout65[0];
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * ct_y8 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * ct_y2 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * ct_x4 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * ct_x10 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * ct_y6 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout71[0] + 2 * ct_y7 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * ct_y12 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout73[0] + 2 * ct_y13 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * ct_y3 + 2 * ct_x12;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * ct_y5 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * ct_y5 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout46[0] + 2 * gout25[0] + 4 * gout69[0];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * gout34[0] + 2 * gout21[0] + 4 * gout2[0];
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * ct_y0 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * ct_y3 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * ct_x8 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout82[0] + 2 * gout76[0] + 4 * gout58[0];
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * ct_y7 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * ct_op2 + 2 * ct_op1 + 4 * ct_op3;
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * ct_op0 + 2 * gout85[0] + 4 * gout64[0];
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * ct_y9 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout87[0] + 2 * ct_y10 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * ct_x4 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * ct_y6 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout49[0] + 2 * gout38[0] + 4 * gout40[0];
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * ct_y6 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * ct_y0 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * ct_y1 + 2 * gout94[0] + 4 * ct_x0;
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout63[0] + 2 * ct_y5 + 4 * ct_y6;
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * gout96[0] + 2 * ct_y7 + 4 * ct_y8;
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * ct_y8 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * gout84[0] + 2 * gout98[0] + 4 * gout22[0];
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * ct_x9 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * ct_y2 + 2 * ct_x13 + 4 * gout75[0];
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * ct_y0 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * ct_y8 + 2 * ct_x7 + 4 * gout37[0];
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * ct_x11 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * gout70[0] + 2 * gout100[0] + 4 * gout104[0];
    ...
    std::cerr << "\rLUT106   ";
    Ciphertext gin106 = 1 * ct_x3 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * gout23[0] + 2 * gout106[0] + 4 * gout93[0];
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * ct_x8 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * gout16[0] + 2 * gout108[0] + 4 * gout9[0];
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * ct_x4 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * gout12[0] + 2 * gout110[0] + 4 * gout90[0];
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * ct_y2 + 2 * ct_x12;
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * gout28[0] + 2 * gout112[0] + 4 * gout3[0];
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * ct_x10 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * gout30[0] + 2 * gout14[0] + 4 * gout114[0];
    ...
    std::cerr << "\rLUT116   ";
    Ciphertext gin116 = 1 * ct_x4 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout116[0] + 2 * gout91[0] + 4 * gout81[0];
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * ct_y1 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout118[0] + 2 * gout53[0] + 4 * gout0[0];
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout35[0] + 2 * gout7[0] + 4 * gout13[0];
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * ct_x8 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * gout122[0] + 2 * gout55[0] + 4 * gout59[0];
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * ct_y10 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * gout124[0] + 2 * gout54[0] + 4 * gout31[0];
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * gout88[0] + 2 * gout125[0];
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout41[0] + 2 * gout26[0] + 4 * gout10[0];
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout33[0] + 2 * gout123[1] + 4 * gout127[0];
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * ct_x4 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout85[1] + 2 * ct_op0 + 4 * gout64[0];
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * gout97[0] + 2 * ct_y9 + 4 * gout130[0];
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout131[0] + 2 * ct_x9;
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * gout96[0] + 2 * ct_y7 + 4 * gout130[0];
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * gout133[0] + 2 * ct_x8 + 4 * ct_y8;
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * gout131[0] + 2 * ct_x9 + 4 * gout134[0];
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout63[0] + 2 * ct_y5 + 4 * gout130[0];
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * gout62[0] + 2 * gout130[0] + 4 * ct_y3;
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout130[0] + 2 * ct_y1 + 4 * ct_y0;
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * gout138[0] + 2 * ct_y2;
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout138[1] + 2 * gout80[0] + 4 * ct_x1;
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout140[0] + 2 * gout139[0] + 4 * ct_x2;
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * gout141[0] + 2 * gout137[1] + 4 * ct_x3;
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * gout85[0] + 2 * gout64[0] + 4 * gout130[0];
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout95[0] + 2 * gout86[0] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout140[1] + 2 * gout144[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * ct_y5 + 2 * ct_x1;
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * ct_x3 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * gout39[0] + 2 * gout18[0] + 4 * gout147[0];
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * ct_y7 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout149[0] + 2 * gout67[0] + 4 * gout48[0];
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * ct_x8 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout152[0] + 2 * gout68[0] + 4 * gout102[0];
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout153[0] + 2 * gout33[1] + 4 * gout117[1];
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * ct_y3 + 2 * ct_x11;
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * ct_y5 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * ct_y3 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout119[0] + 2 * gout148[1] + 4 * gout157[0];
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * ct_y10 + 2 * gout103[0] + 4 * ct_x5;
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout159[0] + 2 * gout66[0];
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout111[1] + 2 * gout150[0] + 4 * gout83[0];
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * ct_y9 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout137[0] + 2 * ct_y4;
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * ct_y5 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout142[0] + 2 * gout163[0] + 4 * ct_x4;
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * ct_y1 + 2 * ct_y15 + 4 * ct_x14;
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * ct_x15 + 2 * gout166[0] + 4 * ct_y0;
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout101[0] + 2 * gout167[0];
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * ct_x9 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * ct_x3 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout170[0] + 2 * gout156[0] + 4 * gout129[0];
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout121[1] + 2 * gout153[1] + 4 * gout171[0];
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout17[0] + 2 * gout157[0];
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout136[1] + 2 * ct_y6;
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout131[1] + 2 * ct_x10 + 4 * ct_y10;
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout133[1] + 2 * ct_x7;
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * ct_y0 + 2 * ct_x0 + 4 * gout86[0];
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout177[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * ct_x10 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout179[0] + 2 * gout169[0] + 4 * gout155[0];
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout92[0] + 2 * gout113[1] + 4 * gout180[1];
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * ct_y3 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout8[0] + 2 * gout182[0] + 4 * gout17[0];
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout183[0] + 2 * ct_y6 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * ct_y4 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout185[0] + 2 * gout77[0] + 4 * gout50[0];
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout123[0] + 2 * gout109[1] + 4 * gout186[1];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout61[1] + 2 * gout99[1] + 4 * gout117[0];
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout188[0] + 2 * gout88[1];
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout118[0] + 2 * gout80[0];
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout190[0] + 2 * gout119[1];
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout191[0] + 2 * gout158[1];
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * gout191[1] + 2 * gout141[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout193[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout165[1] + 2 * gout136[0] + 4 * ct_x5;
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout195[0] + 2 * gout174[0] + 4 * ct_x6;
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout196[0] + 2 * gout133[1] + 4 * ct_x7;
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout132[0] + 2 * gout197[0] + 4 * gout134[1];
    ...
    std::cerr << "\rLUT199   ";
    Ciphertext gin199 = 1 * gout198[0] + 2 * gout135[0] + 4 * gout175[1];
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout134[0] + 2 * gout197[0] + 4 * gout134[1];
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout200[0] + 2 * gout132[0];
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout201[0] + 2 * gout86[0] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout176[0] + 2 * gout196[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * ct_y11 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT205   ";
    Ciphertext gin205 = 1 * gout1[0] + 2 * gout204[0] + 4 * gout162[0];
    ...
    std::cerr << "\rLUT206   ";
    Ciphertext gin206 = 1 * ct_y13 + 2 * ct_x2 + 4 * gout205[0];
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout78[0] + 2 * gout205[1] + 4 * gout45[1];
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * ct_y12 + 2 * ct_x0;
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout208[0] + 2 * gout44[0];
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * ct_y6 + 2 * ct_x4;
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * ct_y2 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT212   ";
    Ciphertext gin212 = 1 * gout57[0] + 2 * ct_x8 + 4 * ct_y7;
    ...
    std::cerr << "\rLUT213   ";
    Ciphertext gin213 = 1 * gout212[0] + 2 * gout180[0] + 4 * gout79[0];
    ...
    std::cerr << "\rLUT214   ";
    Ciphertext gin214 = 1 * gout192[0] + 2 * gout142[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT215   ";
    Ciphertext gin215 = 1 * gout214[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT216   ";
    Ciphertext gin216 = 1 * ct_y4 + 2 * ct_x11 + 4 * gout113[0];
    ...
    std::cerr << "\rLUT217   ";
    Ciphertext gin217 = 1 * gout213[0] + 2 * gout207[0] + 4 * gout216[0];
    ...
    std::cerr << "\rLUT218   ";
    Ciphertext gin218 = 1 * ct_y4 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT219   ";
    Ciphertext gin219 = 1 * gout218[0] + 2 * gout164[0] + 4 * gout151[0];
    ...
    std::cerr << "\rLUT220   ";
    Ciphertext gin220 = 1 * gout107[0] + 2 * gout111[0] + 4 * gout219[0];
    ...
    std::cerr << "\rLUT221   ";
    Ciphertext gin221 = 1 * gout109[0] + 2 * gout105[0] + 4 * gout219[1];
    ...
    std::cerr << "\rLUT222   ";
    Ciphertext gin222 = 1 * gout72[0] + 2 * gout171[1] + 4 * gout61[0];
    ...
    std::cerr << "\rLUT223   ";
    Ciphertext gin223 = 1 * gout222[0] + 2 * ct_y9 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT224   ";
    Ciphertext gin224 = 1 * gout172[0] + 2 * gout154[1] + 4 * gout222[1];
    ...
    std::cerr << "\rLUT225   ";
    Ciphertext gin225 = 1 * ct_y2 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT226   ";
    Ciphertext gin226 = 1 * gout150[1] + 2 * gout79[1] + 4 * gout115[1];
    ...
    std::cerr << "\rLUT227   ";
    Ciphertext gin227 = 1 * gout160[0] + 2 * gout226[0] + 4 * gout206[0];
    ...
    std::cerr << "\rLUT228   ";
    Ciphertext gin228 = 1 * ct_y9 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT229   ";
    Ciphertext gin229 = 1 * gout20[0] + 2 * gout4[0] + 4 * gout228[0];
    ...
    std::cerr << "\rLUT230   ";
    Ciphertext gin230 = 1 * gout125[1] + 2 * gout229[0] + 4 * gout208[0];
    ...
    std::cerr << "\rLUT231   ";
    Ciphertext gin231 = 1 * ct_x10 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT232   ";
    Ciphertext gin232 = 1 * ct_x2 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT233   ";
    Ciphertext gin233 = 1 * gout6[0] + 2 * gout232[0] + 4 * gout210[0];
    ...
    std::cerr << "\rLUT234   ";
    Ciphertext gin234 = 1 * gout233[0] + 2 * gout186[0] + 4 * gout107[1];
    ...
    std::cerr << "\rLUT235   ";
    Ciphertext gin235 = 1 * gout126[1] + 2 * gout230[1] + 4 * gout234[0];
    ...
    std::cerr << "\rLUT236   ";
    Ciphertext gin236 = 1 * gout187[0] + 2 * gout221[1] + 4 * gout234[1];
    ...
    std::cerr << "\rLUT237   ";
    Ciphertext gin237 = 1 * gout99[0] + 2 * gout127[1] + 4 * gout233[1];
    ...
    std::cerr << "\rLUT238   ";
    Ciphertext gin238 = 1 * gout237[0] + 2 * gout126[0];
    ...
    std::cerr << "\rLUT239   ";
    Ciphertext gin239 = 1 * gout128[0] + 2 * gout187[1] + 4 * gout237[1];
    ...
    std::cerr << "\rLUT241   ";
    Ciphertext gin241 = 1 * ct_x3 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT242   ";
    Ciphertext gin242 = 1 * gout241[0] + 2 * gout211[0] + 4 * gout89[0];
    ...
    std::cerr << "\rLUT243   ";
    Ciphertext gin243 = 1 * gout148[0] + 2 * gout242[1] + 4 * gout43[0];
    ...
    std::cerr << "\rLUT244   ";
    Ciphertext gin244 = 1 * gout158[0] + 2 * gout243[1];
    ...
    std::cerr << "\rLUT245   ";
    Ciphertext gin245 = 1 * gout192[1] + 2 * gout244[1];
    ...
    std::cerr << "\rLUT246   ";
    Ciphertext gin246 = 1 * gout245[1] + 2 * gout165[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT247   ";
    Ciphertext gin247 = 1 * gout246[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT248   ";
    Ciphertext gin248 = 1 * ct_y0 + 2 * ct_x12;
    ...
    std::cerr << "\rLUT249   ";
    Ciphertext gin249 = 1 * gout5[0] + 2 * gout231[0] + 4 * gout248[0];
    ...
    std::cerr << "\rLUT250   ";
    Ciphertext gin250 = 1 * gout249[0] + 2 * gout92[1] + 4 * gout115[0];
    ...
    std::cerr << "\rLUT251   ";
    Ciphertext gin251 = 1 * gout250[0] + 2 * gout181[0] + 4 * gout226[1];
    ...
    std::cerr << "\rLUT252   ";
    Ciphertext gin252 = 1 * gout105[1] + 2 * gout249[1] + 4 * gout83[1];
    ...
    std::cerr << "\rLUT253   ";
    Ciphertext gin253 = 1 * gout252[0] + 2 * gout250[1] + 4 * gout161[1];
    ...
    std::cerr << "\rLUT254   ";
    Ciphertext gin254 = 1 * gout221[0] + 2 * gout252[1] + 4 * gout220[1];
    ...
    std::cerr << "\rLUT255   ";
    Ciphertext gin255 = 1 * gout236[0] + 2 * gout254[1] + 4 * gout235[1];
    ...
    std::cerr << "\rLUT256   ";
    Ciphertext gin256 = 1 * gout240[0] + 2 * gout255[1] + 4 * gout238[0];
    ...
    std::cerr << "\rLUT257   ";
    Ciphertext gin257 = 1 * gout154[0] + 2 * gout128[1] + 4 * gout188[1];
    ...
    std::cerr << "\rLUT258   ";
    Ciphertext gin258 = 1 * gout257[0] + 2 * gout239[1] + 4 * gout189[1];
    ...
    std::cerr << "\rLUT259   ";
    Ciphertext gin259 = 1 * gout258[0] + 2 * gout240[1] + 4 * gout189[0];
    ...
    std::cerr << "\rLUT260   ";
    Ciphertext gin260 = 1 * gout259[0] + 2 * gout256[1];
    ...
    std::cerr << "\rLUT261   ";
    Ciphertext gin261 = 1 * gout224[0] + 2 * gout257[1] + 4 * gout223[1];
    ...
    std::cerr << "\rLUT262   ";
    Ciphertext gin262 = 1 * gout261[0] + 2 * gout258[1] + 4 * gout223[0];
    ...
    std::cerr << "\rLUT263   ";
    Ciphertext gin263 = 1 * gout262[0] + 2 * gout259[1];
    ...
    std::cerr << "\rLUT264   ";
    Ciphertext gin264 = 1 * ct_x4 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT265   ";
    Ciphertext gin265 = 1 * gout264[0] + 2 * gout225[0] + 4 * gout36[0];
    ...
    std::cerr << "\rLUT266   ";
    Ciphertext gin266 = 1 * gout242[0] + 2 * gout265[1] + 4 * gout183[1];
    ...
    std::cerr << "\rLUT267   ";
    Ciphertext gin267 = 1 * gout243[0] + 2 * gout266[1] + 4 * gout173[0];
    ...
    std::cerr << "\rLUT268   ";
    Ciphertext gin268 = 1 * gout244[0] + 2 * gout267[1];
    ...
    std::cerr << "\rLUT269   ";
    Ciphertext gin269 = 1 * gout245[0] + 2 * gout268[1];
    ...
    std::cerr << "\rLUT270   ";
    Ciphertext gin270 = 1 * gout269[1] + 2 * gout195[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT271   ";
    Ciphertext gin271 = 1 * gout270[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT272   ";
    Ciphertext gin272 = 1 * gout251[0] + 2 * gout181[1] + 4 * gout168[0];
    ...
    std::cerr << "\rLUT273   ";
    Ciphertext gin273 = 1 * gout229[1] + 2 * gout78[1] + 4 * gout74[0];
    ...
    std::cerr << "\rLUT274   ";
    Ciphertext gin274 = 1 * gout273[0] + 2 * gout207[1] + 4 * gout161[0];
    ...
    std::cerr << "\rLUT275   ";
    Ciphertext gin275 = 1 * gout274[0] + 2 * gout52[0] + 4 * gout45[0];
    ...
    std::cerr << "\rLUT276   ";
    Ciphertext gin276 = 1 * gout253[0] + 2 * gout251[1] + 4 * gout274[1];
    ...
    std::cerr << "\rLUT277   ";
    Ciphertext gin277 = 1 * gout276[0] + 2 * gout227[0] + 4 * gout217[0];
    ...
    std::cerr << "\rLUT278   ";
    Ciphertext gin278 = 1 * gout277[0] + 2 * gout275[0] + 4 * gout272[0];
    ...
    std::cerr << "\rLUT279   ";
    Ciphertext gin279 = 1 * gout230[0] + 2 * gout273[1] + 4 * gout220[0];
    ...
    std::cerr << "\rLUT280   ";
    Ciphertext gin280 = 1 * gout279[0] + 2 * gout209[0];
    ...
    std::cerr << "\rLUT281   ";
    Ciphertext gin281 = 1 * gout254[0] + 2 * gout253[1] + 4 * gout279[1];
    ...
    std::cerr << "\rLUT282   ";
    Ciphertext gin282 = 1 * gout281[0] + 2 * gout276[1] + 4 * gout280[1];
    ...
    std::cerr << "\rLUT283   ";
    Ciphertext gin283 = 1 * gout255[0] + 2 * gout281[1] + 4 * gout235[0];
    ...
    std::cerr << "\rLUT284   ";
    Ciphertext gin284 = 1 * gout283[0] + 2 * gout282[1] + 4 * gout280[0];
    ...
    std::cerr << "\rLUT285   ";
    Ciphertext gin285 = 1 * gout278[0] + 2 * gout284[0] + 4 * gout282[0];
    ...
    std::cerr << "\rLUT286   ";
    Ciphertext gin286 = 1 * gout256[0] + 2 * gout283[1];
    ...
    std::cerr << "\rLUT287   ";
    Ciphertext gin287 = 1 * gout260[0] + 2 * gout286[1];
    ...
    std::cerr << "\rLUT288   ";
    Ciphertext gin288 = 1 * gout97[0] + 2 * ct_y9 + 4 * ct_y10;
    ...
    std::cerr << "\rLUT289   ";
    Ciphertext gin289 = 1 * gout288[0] + 2 * ct_y11 + 4 * gout130[0];
    ...
    std::cerr << "\rLUT290   ";
    Ciphertext gin290 = 1 * gout289[0] + 2 * ct_y12 + 4 * gout130[0];
    ...
    std::cerr << "\rLUT291   ";
    Ciphertext gin291 = 1 * gout290[0] + 2 * gout130[0] + 4 * ct_y13;
    ...
    std::cerr << "\rLUT292   ";
    Ciphertext gin292 = 1 * gout291[0] + 2 * gout130[0] + 4 * ct_y14;
    ...
    std::cerr << "\rLUT293   ";
    Ciphertext gin293 = 1 * gout292[0] + 2 * ct_x15 + 4 * ct_y15;
    ...
    std::cerr << "\rLUT294   ";
    Ciphertext gin294 = 1 * gout291[1] + 2 * ct_x13;
    ...
    std::cerr << "\rLUT295   ";
    Ciphertext gin295 = 1 * gout289[1] + 2 * ct_x11 + 4 * gout175[0];
    ...
    std::cerr << "\rLUT296   ";
    Ciphertext gin296 = 1 * gout295[0] + 2 * gout199[0] + 4 * gout295[1];
    ...
    std::cerr << "\rLUT297   ";
    Ciphertext gin297 = 1 * gout296[0] + 2 * gout290[1] + 4 * ct_x12;
    ...
    std::cerr << "\rLUT298   ";
    Ciphertext gin298 = 1 * gout297[0] + 2 * gout291[1] + 4 * ct_x13;
    ...
    std::cerr << "\rLUT299   ";
    Ciphertext gin299 = 1 * gout298[0] + 2 * gout292[1] + 4 * ct_x14;
    ...
    std::cerr << "\rLUT300   ";
    Ciphertext gin300 = 1 * gout293[0] + 2 * gout299[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT301   ";
    Ciphertext gin301 = 1 * gout294[0] + 2 * gout297[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT302   ";
    Ciphertext gin302 = 1 * gout199[0] + 2 * gout175[0] + 4 * gout295[1];
    ...
    std::cerr << "\rLUT303   ";
    Ciphertext gin303 = 1 * gout302[0] + 2 * gout86[0] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT304   ";
    Ciphertext gin304 = 1 * ct_y4 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT305   ";
    Ciphertext gin305 = 1 * gout304[0] + 2 * gout146[0] + 4 * gout120[0];
    ...
    std::cerr << "\rLUT306   ";
    Ciphertext gin306 = 1 * gout305[0] + 2 * gout72[1];
    ...
    std::cerr << "\rLUT307   ";
    Ciphertext gin307 = 1 * gout265[0] + 2 * gout121[0] + 4 * gout305[1];
    ...
    std::cerr << "\rLUT308   ";
    Ciphertext gin308 = 1 * gout307[0] + 2 * gout172[1] + 4 * gout306[1];
    ...
    std::cerr << "\rLUT309   ";
    Ciphertext gin309 = 1 * gout308[0] + 2 * gout224[1] + 4 * gout306[0];
    ...
    std::cerr << "\rLUT310   ";
    Ciphertext gin310 = 1 * gout309[0] + 2 * gout261[1];
    ...
    std::cerr << "\rLUT311   ";
    Ciphertext gin311 = 1 * gout310[0] + 2 * gout262[1];
    ...
    std::cerr << "\rLUT312   ";
    Ciphertext gin312 = 1 * gout311[0] + 2 * gout263[1];
    ...
    std::cerr << "\rLUT313   ";
    Ciphertext gin313 = 1 * gout266[0] + 2 * gout307[1] + 4 * gout184[1];
    ...
    std::cerr << "\rLUT314   ";
    Ciphertext gin314 = 1 * gout313[0] + 2 * gout308[1] + 4 * gout184[0];
    ...
    std::cerr << "\rLUT317   ";
    Ciphertext gin317 = 1 * gout267[0] + 2 * gout313[1];
    ...
    std::cerr << "\rLUT318   ";
    Ciphertext gin318 = 1 * gout317[0] + 2 * gout314[1];
    ...
    std::cerr << "\rLUT321   ";
    Ciphertext gin321 = 1 * gout268[0] + 2 * gout317[1];
    ...
    std::cerr << "\rLUT322   ";
    Ciphertext gin322 = 1 * gout321[0] + 2 * gout318[1];
    ...
    std::cerr << "\rLUT323   ";
    Ciphertext gin323 = 1 * gout269[0] + 2 * gout321[1];
    ...
    std::cerr << "\rLUT324   ";
    Ciphertext gin324 = 1 * gout323[0] + 2 * gout318[1];
    ...
    std::cerr << "\rLUT325   ";
    Ciphertext gin325 = 1 * gout324[0] + 2 * gout322[0] + 4 * gout319[1];
    ...
    std::cerr << "\rLUT326   ";
    Ciphertext gin326 = 1 * gout319[0] + 2 * gout316[1] + 4 * gout325[0];
    ...
    std::cerr << "\rLUT327   ";
    Ciphertext gin327 = 1 * gout326[0] + 2 * gout316[0] + 4 * gout311[1];
    ...
    std::cerr << "\rLUT328   ";
    Ciphertext gin328 = 1 * gout311[0] + 2 * gout263[1] + 4 * gout327[0];
    ...
    std::cerr << "\rLUT329   ";
    Ciphertext gin329 = 1 * gout328[0] + 2 * gout263[0] + 4 * gout260[1];
    ...
    std::cerr << "\rLUT330   ";
    Ciphertext gin330 = 1 * gout329[0] + 2 * gout260[0] + 4 * gout286[1];
    ...
    std::cerr << "\rLUT331   ";
    Ciphertext gin331 = 1 * gout330[0] + 2 * gout286[0] + 4 * gout284[1];
    ...
    std::cerr << "\rLUT332   ";
    Ciphertext gin332 = 1 * gout331[0] + 2 * gout285[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT333   ";
    Ciphertext gin333 = 1 * gout300[0] + 2 * gout332[0] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT334   ";
    Ciphertext gin334 = 1 * gout331[1] + 2 * gout299[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT335   ";
    Ciphertext gin335 = 1 * gout334[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT336   ";
    Ciphertext gin336 = 1 * gout287[0] + 2 * gout329[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT337   ";
    Ciphertext gin337 = 1 * gout301[0] + 2 * gout336[0] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT338   ";
    Ciphertext gin338 = 1 * gout329[1] + 2 * gout297[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT339   ";
    Ciphertext gin339 = 1 * gout338[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT340   ";
    Ciphertext gin340 = 1 * gout327[0] + 2 * gout312[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT341   ";
    Ciphertext gin341 = 1 * gout340[0] + 2 * gout303[0];
    ...
    std::cerr << "\rLUT342   ";
    Ciphertext gin342 = 1 * gout327[1] + 2 * gout199[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT343   ";
    Ciphertext gin343 = 1 * gout342[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT344   ";
    Ciphertext gin344 = 1 * gout325[0] + 2 * gout320[0] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT345   ";
    Ciphertext gin345 = 1 * gout344[0] + 2 * gout202[0];
    ...
    std::cerr << "\rLUT346   ";
    Ciphertext gin346 = 1 * gout325[1] + 2 * gout198[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT347   ";
    Ciphertext gin347 = 1 * gout346[0] + 2 * gout143[0];
    ...
    std::cerr << "\rLUT348   ";
    Ciphertext gin348 = 1 * gout323[0] + 2 * gout321[0] + 4 * gout318[1];
    ...
    std::cerr << "\rLUT349   ";
    Ciphertext gin349 = 1 * gout348[0] + 2 * gout86[0];
    ...
    std::cerr << "\rLUT350   ";
    Ciphertext gin350 = 1 * gout349[0] + 2 * gout203[0] + 4 * gout143[0];
    ...
    std::cerr << "\rLUT351   ";
    Ciphertext gin351 = 1 * gout323[1] + 2 * gout196[1] + 4 * gout86[0];
    ...
    std::cerr << "\rLUT352   ";
    Ciphertext gin352 = 1 * gout351[0] + 2 * gout143[0];
    std::vector<Ciphertext> gout352 = ctx.eval_lut_amortized(&gin352, lut352);

    std::cerr << "\r          \r";
    std::vector<long> out;
    out.push_back(ctx.decrypt(&gout178[0])); /* out0 */
    out.push_back(ctx.decrypt(&gout145[0])); /* out1 */
    out.push_back(ctx.decrypt(&gout194[0])); /* out2 */
    out.push_back(ctx.decrypt(&gout215[0])); /* out3 */
    out.push_back(ctx.decrypt(&gout247[0])); /* out4 */
    out.push_back(ctx.decrypt(&gout271[0])); /* out5 */
    out.push_back(ctx.decrypt(&gout352[0])); /* out6 */
    out.push_back(ctx.decrypt(&gout350[0])); /* out7 */
    out.push_back(ctx.decrypt(&gout347[0])); /* out8 */
    out.push_back(ctx.decrypt(&gout345[0])); /* out9 */
    out.push_back(ctx.decrypt(&gout343[0])); /* out10 */
    out.push_back(ctx.decrypt(&gout341[0])); /* out11 */
    out.push_back(ctx.decrypt(&gout339[0])); /* out12 */
    out.push_back(ctx.decrypt(&gout337[0])); /* out13 */
    out.push_back(ctx.decrypt(&gout335[0])); /* out14 */
    out.push_back(ctx.decrypt(&gout333[0])); /* out15 */
    return out;
}
