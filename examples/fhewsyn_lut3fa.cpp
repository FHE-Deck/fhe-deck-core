...
test_calculator_lut3fa(FHEContext& ctx, uint8_t op, uint16_t x, uint16_t y)
{
    ...
    gout3.push_back(1 - ct_y2);

    std::cerr << "\rINV4   ";
    std::vector<Ciphertext> gout4;
    gout4.push_back(1 - ct_y4);

    std::cerr << "\rINV5   ";
    std::vector<Ciphertext> gout5;
    gout5.push_back(1 - ct_y3);

    std::cerr << "\rINV6   ";
    std::vector<Ciphertext> gout6;
    gout6.push_back(1 - ct_y10);
    ...
    gout8.push_back(1 - ct_y14);

    std::cerr << "\rINV9   ";
    std::vector<Ciphertext> gout9;
    gout9.push_back(1 - ct_y9);
    ...
    gout11.push_back(1 - ct_y7);

    std::cerr << "\rINV12   ";
    std::vector<Ciphertext> gout12;
    gout12.push_back(1 - ct_y15);

    std::cerr << "\rINV13   ";
    std::vector<Ciphertext> gout13;
    gout13.push_back(1 - ct_y6);

    std::cerr << "\rINV14   ";
    std::vector<Ciphertext> gout14;
    gout14.push_back(1 - ct_y1);

    std::cerr << "\rINV15   ";
    std::vector<Ciphertext> gout15;
    gout15.push_back(1 - ct_y5);
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_y1 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_y5 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * ct_y6 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_x2 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * ct_y2 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_y2 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_y7 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_y3 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_x4 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_y0 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_y5 + 2 * ct_x3;
    std::vector<Ciphertext> gout26 = ctx.eval_lut_amortized(&gin26, lut26);

    std::cerr << "\rFA27    ";
    Ciphertext gin27 = 1 * ct_x0 + 2 * ct_x1 + 1 * ct_y0 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_y12 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_y2 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_x2 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_x8 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * ct_x6 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * ct_y7 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_x8 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_x10 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_y6 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * ct_x2 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_y6 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_x11 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_x1 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_y4 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * ct_x1 + 2 * ct_y12;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * gout43[0] + 2 * ct_x0 + 4 * ct_y13;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * ct_x9 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * ct_x1 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * gout47[0] + 2 * ct_x0 + 4 * ct_y4;
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * ct_y4 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * ct_x4 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * ct_x14 + 2 * ct_y1 + 4 * ct_y15;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * ct_y0 + 2 * ct_x15 + 4 * gout52[0];
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * ct_x4 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * ct_y4 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * ct_x2 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_x1 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * ct_x1 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * ct_y6 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * ct_y3 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * ct_x12 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * ct_x2 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * ct_x10 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * ct_x8 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout49[0] + 2 * gout17[0] + 4 * gout64[0];
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * ct_x10 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * ct_x4 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * ct_x1 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout68[0] + 2 * ct_x0 + 4 * ct_y1;
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * ct_x12 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * ct_x8 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * ct_x0 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * ct_x1 + 2 * ct_y6;
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout73[0] + 2 * ct_x0 + 4 * ct_y7;
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * ct_x11 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * ct_y2 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * ct_x2 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * ct_y3 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * ct_x13 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * ct_y0 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * ct_x0 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * ct_y4 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * ct_x4 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * gout83[0] + 2 * gout21[0] + 4 * gout45[0];
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * ct_y7 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * ct_y4 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout86[0] + 2 * gout56[0] + 4 * gout24[0];
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * ct_x0 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * ct_y1 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * ct_x1 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * gout37[0] + 2 * gout90[0] + 4 * gout78[0];
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * ct_x1 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout81[0] + 2 * gout92[0];
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * ct_op1 + 2 * ct_op2 + 4 * ct_op3;
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * ct_x4 + 2 * gout28[0] + 4 * ct_y11;
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * ct_y3 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout16[0] + 2 * gout97[0] + 4 * gout71[0];
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * ct_x1 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout99[0] + 2 * ct_x0 + 4 * ct_y10;
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * gout91[0] + 2 * gout74[1];
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * ct_x12 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * gout79[0] + 2 * gout70[0] + 4 * gout38[0];
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * ct_x4 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * ct_x2 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT106   ";
    Ciphertext gin106 = 1 * ct_x6 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * ct_y8 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * ct_y6 + 2 * ct_x4;
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * ct_x10 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * gout46[0] + 2 * gout34[0] + 4 * gout109[0];
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * ct_y5 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * gout82[0] + 2 * gout111[0] + 4 * gout96[0];
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * ct_y0 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * gout75[0] + 2 * gout66[0] + 4 * gout102[0];
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * ct_x0 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout61[0] + 2 * gout40[0] + 4 * gout116[0];
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * ct_x1 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout118[0] + 2 * gout88[0] + 4 * gout59[0];
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * gout74[0] + 2 * gout119[0] + 4 * gout87[0];
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout120[0] + 2 * ct_x0 + 4 * ct_y9;
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * ct_x12 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * ct_x13 + 2 * ct_y2 + 4 * gout122[0];
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * gout123[0] + 2 * gout53[0];
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * ct_y8 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * ct_y7 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout126[0] + 2 * gout50[0] + 4 * gout39[0];
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout42[0] + 2 * gout67[0] + 4 * gout23[0];
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * ct_y1 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout129[0] + 2 * gout51[0] + 4 * gout80[0];
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * gout84[0] + 2 * gout130[1] + 4 * gout91[1];
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * ct_y4 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * ct_y9 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * ct_y3 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * ct_x2 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout135[0] + 2 * gout58[0] + 4 * gout25[0];
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * ct_y10 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * ct_x0 + 2 * ct_y12;
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * ct_x4 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT140   ";
    Ciphertext gin140 = 1 * gout139[0] + 2 * gout125[0] + 4 * gout36[0];
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout140[0] + 2 * gout127[1] + 4 * gout65[0];
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * ct_x11 + 2 * ct_y4 + 4 * gout103[0];
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * gout85[0] + 2 * gout30[0] + 4 * gout108[0];
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout92[0] + 2 * gout115[0] + 4 * gout77[0];
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout144[0] + 2 * ct_x0 + 4 * ct_y6;
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * ct_x2 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout137[0] + 2 * gout146[0] + 4 * gout54[0];
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * ct_x1 + 2 * ct_y11;
    std::vector<Ciphertext> gout148 = ctx.eval_lut_amortized(&gin148, lut148);

    std::cerr << "\rFA149    ";
    Ciphertext gin149 = 1 + 1 * ct_x0 + 2 * ct_x1 + 1 * gout7[0] + 2 * gout14[0];
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * ct_y5 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout55[0] + 2 * gout150[0] + 4 * gout134[0];
    ...
    std::cerr << "\rLUT152   ";
    Ciphertext gin152 = 1 * ct_y1 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout152[0] + 2 * gout19[0] + 4 * gout104[0];
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout136[0] + 2 * gout153[1] + 4 * gout48[0];
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * ct_x2 + 2 * ct_y13 + 4 * gout95[0];
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * ct_x8 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout132[0] + 2 * gout156[0] + 4 * gout63[0];
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout114[0] + 2 * gout117[1] + 4 * gout157[0];
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * ct_x0 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * ct_y6 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout33[0] + 2 * gout106[0] + 4 * gout160[0];
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * ct_y6 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * gout22[0] + 2 * gout107[0] + 4 * gout162[0];
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout127[0] + 2 * gout163[1] + 4 * gout112[0];
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout89[0] + 2 * gout76[0] + 4 * gout113[0];
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * ct_x5 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * ct_x2 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout167[0] + 2 * gout148[0] + 4 * gout133[0];
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout168[0] + 2 * gout147[0] + 4 * gout44[0];
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * ct_x2 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout57[0] + 2 * gout72[0] + 4 * gout170[0];
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout171[0] + 2 * gout136[1] + 4 * gout81[0];
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout172[0] + 2 * gout154[0];
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout69[0] + 2 * gout171[1];
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * ct_x10 + 2 * gout18[0] + 4 * ct_y5;
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * ct_x8 + 2 * ct_y7 + 4 * gout176[0];
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * ct_x4 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout178[0] + 2 * gout26[0] + 4 * gout60[0];
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout165[0] + 2 * gout98[0] + 4 * gout179[1];
    std::vector<Ciphertext> gout180 = ctx.eval_lut_amortized(&gin180, lut180);

    std::cerr << "\rFA181    ";
    Ciphertext gin181 = gout27[2] + 1 * ct_x2 + 2 * ct_x3 + 1 * ct_y2 + 2 * ct_y3;
    std::vector<Ciphertext> gout181 = ctx.eval_lut_amortized(&gin181, decomp);

    std::cerr << "\rFA182    ";
    Ciphertext gin182 = gout181[2] + 1 * ct_x4 + 2 * ct_x5 + 1 * ct_y4 + 2 * ct_y5;
    std::vector<Ciphertext> gout182 = ctx.eval_lut_amortized(&gin182, decomp);

    std::cerr << "\rFA183    ";
    Ciphertext gin183 = gout182[2] + 1 * ct_x6 + 2 * ct_x7 + 1 * ct_y6 + 2 * ct_y7;
    std::vector<Ciphertext> gout183 = ctx.eval_lut_amortized(&gin183, decomp);

    std::cerr << "\rFA184    ";
    Ciphertext gin184 = gout183[2] + 1 * ct_x8 + 2 * ct_x9 + 1 * ct_y8 + 2 * ct_y9;
    std::vector<Ciphertext> gout184 = ctx.eval_lut_amortized(&gin184, decomp);

    std::cerr << "\rFA185    ";
    Ciphertext gin185 = gout184[2] + 1 * ct_x10 + 2 * ct_x11 + 1 * ct_y10 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * ct_x1 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * gout186[0] + 2 * gout159[0] + 4 * gout105[0];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout187[0] + 2 * gout168[1] + 4 * gout138[0];
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout188[0] + 2 * gout169[1] + 4 * gout141[0];
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout100[0] + 2 * gout187[1];
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * ct_x1 + 2 * ct_y13;
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout191[0] + 2 * ct_y12 + 4 * ct_x2;
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * gout138[0] + 2 * gout191[0];
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout189[0] + 2 * gout193[0];
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout192[1] + 2 * ct_y14 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * ct_x1 + 2 * ct_y14;
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * ct_x0 + 2 * gout196[0] + 4 * ct_y15;
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout195[0] + 2 * gout192[0] + 4 * gout197[0];
    ...
    std::cerr << "\rLUT199   ";
    Ciphertext gin199 = 1 * ct_y6 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout62[0] + 2 * gout41[0] + 4 * gout199[0];
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout119[1] + 2 * gout200[1] + 4 * gout179[0];
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout201[0] + 2 * gout100[1];
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout175[0] + 2 * gout173[1];
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * ct_x4 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT205   ";
    Ciphertext gin205 = 1 * gout204[0] + 2 * ct_y9 + 4 * ct_x5;
    ...
    std::cerr << "\rLUT206   ";
    Ciphertext gin206 = 1 * gout205[0] + 2 * ct_x3 + 4 * ct_y11;
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout54[0] + 2 * gout206[0] + 4 * gout166[0];
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * gout206[1] + 2 * gout195[1] + 4 * gout147[1];
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout208[0] + 2 * gout169[0] + 4 * gout164[0];
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * gout209[0] + 2 * gout198[0];
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * gout163[0] + 2 * gout161[1] + 4 * gout157[1];
    ...
    std::cerr << "\rLUT212   ";
    Ciphertext gin212 = 1 * ct_x9 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT213   ";
    Ciphertext gin213 = 1 * gout31[0] + 2 * gout20[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT214   ";
    Ciphertext gin214 = 1 * gout213[0] + 2 * gout110[0] + 4 * gout151[1];
    ...
    std::cerr << "\rLUT215   ";
    Ciphertext gin215 = 1 * gout98[1] + 2 * gout213[1] + 4 * gout128[0];
    ...
    std::cerr << "\rLUT216   ";
    Ciphertext gin216 = 1 * gout180[0] + 2 * gout215[1] + 4 * gout201[1];
    ...
    std::cerr << "\rLUT217   ";
    Ciphertext gin217 = 1 * ct_x11 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT218   ";
    Ciphertext gin218 = 1 * gout35[0] + 2 * gout29[0] + 4 * gout217[0];
    ...
    std::cerr << "\rLUT219   ";
    Ciphertext gin219 = 1 * gout218[0] + 2 * gout114[1] + 4 * gout112[1];
    ...
    std::cerr << "\rLUT220   ";
    Ciphertext gin220 = 1 * gout219[0] + 2 * gout158[0] + 4 * gout164[1];
    ...
    std::cerr << "\rLUT221   ";
    Ciphertext gin221 = 1 * gout110[1] + 2 * gout218[1] + 4 * gout65[1];
    ...
    std::cerr << "\rLUT222   ";
    Ciphertext gin222 = 1 * gout221[1] + 2 * gout219[1] + 4 * gout141[1];
    ...
    std::cerr << "\rLUT223   ";
    Ciphertext gin223 = 1 * gout222[0] + 2 * gout220[1] + 4 * gout189[1];
    std::vector<Ciphertext> gout223 = ctx.eval_lut_amortized(&gin223, lut223);

    std::cerr << "\rFA224    ";
    Ciphertext gin224 = gout149[2] + 1 * ct_x2 + 2 * ct_x3 + 1 * gout3[0] + 2 * gout5[0];
    std::vector<Ciphertext> gout224 = ctx.eval_lut_amortized(&gin224, decomp);

    std::cerr << "\rFA225    ";
    Ciphertext gin225 = gout224[2] + 1 * ct_x4 + 2 * ct_x5 + 1 * gout4[0] + 2 * gout15[0];
    ...
    std::cerr << "\rLUT226   ";
    Ciphertext gin226 = 1 * gout153[0] + 2 * gout84[1] + 4 * gout144[1];
    ...
    std::cerr << "\rLUT227   ";
    Ciphertext gin227 = 1 * gout226[0] + 2 * gout131[0] + 4 * gout145[1];
    ...
    std::cerr << "\rLUT228   ";
    Ciphertext gin228 = 1 * gout154[1] + 2 * gout226[1] + 4 * gout93[0];
    ...
    std::cerr << "\rLUT229   ";
    Ciphertext gin229 = 1 * gout228[0] + 2 * gout227[1];
    ...
    std::cerr << "\rLUT230   ";
    Ciphertext gin230 = 1 * gout173[0] + 2 * gout228[1];
    ...
    std::cerr << "\rLUT231   ";
    Ciphertext gin231 = 1 * gout230[0] + 2 * gout229[1];
    ...
    std::cerr << "\rLUT232   ";
    Ciphertext gin232 = 1 * gout203[0] + 2 * gout230[1];
    ...
    std::cerr << "\rLUT233   ";
    Ciphertext gin233 = 1 * gout231[1] + 2 * gout232[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT234   ";
    Ciphertext gin234 = 1 * ct_op6 + 2 * ct_op7;
    ...
    std::cerr << "\rLUT235   ";
    Ciphertext gin235 = 1 * ct_op4 + 2 * ct_op5 + 4 * gout234[0];
    ...
    std::cerr << "\rLUT236   ";
    Ciphertext gin236 = 1 * ct_op1 + 2 * ct_op0 + 4 * gout235[0];
    ...
    std::cerr << "\rLUT237   ";
    Ciphertext gin237 = 1 * gout236[0] + 2 * ct_op2 + 4 * ct_op3;
    ...
    std::cerr << "\rLUT238   ";
    Ciphertext gin238 = 1 * gout182[0] + 2 * gout225[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT239   ";
    Ciphertext gin239 = 1 * gout181[1] + 2 * gout224[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT240   ";
    Ciphertext gin240 = 1 * gout181[0] + 2 * gout224[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT241   ";
    Ciphertext gin241 = 1 * gout27[1] + 2 * gout149[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT242   ";
    Ciphertext gin242 = 1 * gout27[0] + 2 * gout149[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT243   ";
    Ciphertext gin243 = 1 * gout94[0] + 2 * gout235[0];
    ...
    std::cerr << "\rLUT244   ";
    Ciphertext gin244 = 1 * gout243[0] + 2 * gout237[0];
    ...
    std::cerr << "\rLUT245   ";
    Ciphertext gin245 = 1 * ct_op0 + 2 * gout243[0];
    ...
    std::cerr << "\rLUT246   ";
    Ciphertext gin246 = 1 * gout231[1] + 2 * gout232[0] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT247   ";
    Ciphertext gin247 = 1 * gout203[0] + 2 * gout230[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT248   ";
    Ciphertext gin248 = 1 * gout238[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT249   ";
    Ciphertext gin249 = 1 * gout175[0] + 2 * gout173[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT250   ";
    Ciphertext gin250 = 1 * gout249[0] + 2 * gout248[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT251   ";
    Ciphertext gin251 = 1 * gout239[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT252   ";
    Ciphertext gin252 = 1 * gout174[0] + 2 * gout172[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT253   ";
    Ciphertext gin253 = 1 * gout252[0] + 2 * gout251[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT254   ";
    Ciphertext gin254 = 1 * gout240[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT255   ";
    Ciphertext gin255 = 1 * gout69[0] + 2 * gout171[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT256   ";
    Ciphertext gin256 = 1 * gout255[0] + 2 * gout254[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT257   ";
    Ciphertext gin257 = 1 * gout241[0] + 2 * gout69[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT258   ";
    Ciphertext gin258 = 1 * ct_x0 + 2 * ct_y0 + 4 * gout245[0];
    ...
    std::cerr << "\rLUT259   ";
    Ciphertext gin259 = 1 * gout242[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT260   ";
    Ciphertext gin260 = 1 * gout259[0] + 2 * gout258[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT261   ";
    Ciphertext gin261 = 1 * gout182[1] + 2 * gout225[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT262   ";
    Ciphertext gin262 = 1 * gout261[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT263   ";
    Ciphertext gin263 = 1 * gout247[0] + 2 * gout262[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT264   ";
    Ciphertext gin264 = 1 * gout130[0] + 2 * gout165[1] + 4 * gout87[1];
    ...
    std::cerr << "\rLUT265   ";
    Ciphertext gin265 = 1 * gout264[0] + 2 * gout180[1] + 4 * gout120[1];
    ...
    std::cerr << "\rLUT266   ";
    Ciphertext gin266 = 1 * gout265[0] + 2 * gout216[1] + 4 * gout121[1];
    ...
    std::cerr << "\rLUT267   ";
    Ciphertext gin267 = 1 * gout131[1] + 2 * gout264[1] + 4 * gout101[1];
    ...
    std::cerr << "\rLUT268   ";
    Ciphertext gin268 = 1 * gout267[0] + 2 * gout265[1] + 4 * gout101[0];
    ...
    std::cerr << "\rLUT269   ";
    Ciphertext gin269 = 1 * gout268[0] + 2 * gout266[1];
    ...
    std::cerr << "\rLUT270   ";
    Ciphertext gin270 = 1 * gout227[0] + 2 * gout267[1] + 4 * gout145[0];
    ...
    std::cerr << "\rLUT271   ";
    Ciphertext gin271 = 1 * gout270[0] + 2 * gout268[1];
    ...
    std::cerr << "\rLUT272   ";
    Ciphertext gin272 = 1 * gout271[0] + 2 * gout269[1];
    ...
    std::cerr << "\rLUT273   ";
    Ciphertext gin273 = 1 * gout229[0] + 2 * gout270[1];
    ...
    std::cerr << "\rLUT274   ";
    Ciphertext gin274 = 1 * gout273[0] + 2 * gout271[1];
    ...
    std::cerr << "\rLUT275   ";
    Ciphertext gin275 = 1 * gout274[0] + 2 * gout272[1];
    ...
    std::cerr << "\rLUT276   ";
    Ciphertext gin276 = 1 * gout233[0] + 2 * gout273[1];
    ...
    std::cerr << "\rLUT277   ";
    Ciphertext gin277 = 1 * gout231[0] + 2 * gout273[1];
    ...
    std::cerr << "\rLUT278   ";
    Ciphertext gin278 = 1 * gout277[0] + 2 * gout274[1];
    ...
    std::cerr << "\rLUT279   ";
    Ciphertext gin279 = 1 * gout274[0] + 2 * gout272[1] + 4 * gout278[0];
    ...
    std::cerr << "\rLUT280   ";
    Ciphertext gin280 = 1 * gout231[1] + 2 * gout232[0] + 4 * gout273[1];
    ...
    std::cerr << "\rLUT281   ";
    Ciphertext gin281 = 1 * gout274[1] + 2 * gout280[0];
    ...
    std::cerr << "\rLUT282   ";
    Ciphertext gin282 = 1 * gout281[0] + 2 * gout275[0];
    ...
    std::cerr << "\rLUT283   ";
    Ciphertext gin283 = 1 * gout282[0] + 2 * gout279[0];
    ...
    std::cerr << "\rLUT284   ";
    Ciphertext gin284 = 1 * gout278[0] + 2 * gout281[0];
    ...
    std::cerr << "\rLUT285   ";
    Ciphertext gin285 = 1 * gout284[0] + 2 * gout275[0] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT286   ";
    Ciphertext gin286 = 1 * gout278[1] + 2 * gout280[0] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT287   ";
    Ciphertext gin287 = 1 * gout257[0] + 2 * gout244[0];
    ...
    std::cerr << "\rLUT288   ";
    Ciphertext gin288 = 1 * gout208[1] + 2 * gout142[0] + 4 * gout161[0];
    ...
    std::cerr << "\rLUT289   ";
    Ciphertext gin289 = 1 * gout143[1] + 2 * gout140[1] + 4 * gout151[0];
    ...
    std::cerr << "\rLUT290   ";
    Ciphertext gin290 = 1 * gout190[0] + 2 * gout188[1] + 4 * gout289[0];
    ...
    std::cerr << "\rLUT291   ";
    Ciphertext gin291 = 1 * gout214[0] + 2 * gout221[0] + 4 * gout289[1];
    ...
    std::cerr << "\rLUT292   ";
    Ciphertext gin292 = 1 * gout291[0] + 2 * gout222[1] + 4 * gout290[1];
    ...
    std::cerr << "\rLUT293   ";
    Ciphertext gin293 = 1 * gout292[0] + 2 * gout223[1] + 4 * gout290[0];
    ...
    std::cerr << "\rLUT294   ";
    Ciphertext gin294 = 1 * gout200[0] + 2 * gout143[0] + 4 * gout128[1];
    ...
    std::cerr << "\rLUT295   ";
    Ciphertext gin295 = 1 * gout294[0] + 2 * gout190[1];
    ...
    std::cerr << "\rLUT296   ";
    Ciphertext gin296 = 1 * gout215[0] + 2 * gout214[1] + 4 * gout294[1];
    ...
    std::cerr << "\rLUT297   ";
    Ciphertext gin297 = 1 * gout296[0] + 2 * gout291[1] + 4 * gout295[1];
    ...
    std::cerr << "\rLUT298   ";
    Ciphertext gin298 = 1 * gout297[0] + 2 * gout292[1] + 4 * gout295[0];
    ...
    std::cerr << "\rLUT299   ";
    Ciphertext gin299 = 1 * gout298[0] + 2 * gout293[1];
    ...
    std::cerr << "\rLUT300   ";
    Ciphertext gin300 = 1 * gout216[0] + 2 * gout296[1] + 4 * gout202[1];
    ...
    std::cerr << "\rLUT301   ";
    Ciphertext gin301 = 1 * gout300[0] + 2 * gout297[1] + 4 * gout202[0];
    ...
    std::cerr << "\rLUT304   ";
    Ciphertext gin304 = 1 * gout266[0] + 2 * gout300[1] + 4 * gout121[0];
    ...
    std::cerr << "\rLUT306   ";
    Ciphertext gin306 = 1 * gout305[0] + 2 * gout302[1];
    ...
    std::cerr << "\rLUT307   ";
    Ciphertext gin307 = 1 * gout269[0] + 2 * gout304[1];
    ...
    std::cerr << "\rLUT308   ";
    Ciphertext gin308 = 1 * gout307[0] + 2 * gout305[1];
    ...
    std::cerr << "\rLUT309   ";
    Ciphertext gin309 = 1 * gout272[0] + 2 * gout307[1];
    ...
    std::cerr << "\rLUT310   ";
    Ciphertext gin310 = 1 * gout282[0] + 2 * gout279[0] + 4 * gout309[1];
    ...
    std::cerr << "\rLUT311   ";
    Ciphertext gin311 = 1 * gout310[0] + 2 * gout309[0] + 4 * gout308[1];
    ...
    std::cerr << "\rLUT312   ";
    Ciphertext gin312 = 1 * gout308[0] + 2 * gout311[0] + 4 * gout306[1];
    ...
    std::cerr << "\rLUT313   ";
    Ciphertext gin313 = 1 * gout312[0] + 2 * gout306[0] + 4 * gout303[1];
    ...
    std::cerr << "\rLUT314   ";
    Ciphertext gin314 = 1 * gout303[0] + 2 * gout313[0];
    ...
    std::cerr << "\rLUT315   ";
    Ciphertext gin315 = 1 * gout313[1] + 2 * gout303[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT316   ";
    Ciphertext gin316 = 1 * gout312[1] + 2 * gout306[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT317   ";
    Ciphertext gin317 = 1 * gout311[1] + 2 * gout308[1] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT318   ";
    Ciphertext gin318 = 1 * gout283[0] + 2 * gout309[1] + 4 * gout245[0];
    std::vector<Ciphertext> gout318 = ctx.eval_lut_amortized(&gin318, lut318);

    std::cerr << "\rFA319    ";
    Ciphertext gin319 = gout225[2] + 1 * ct_x6 + 2 * ct_x7 + 1 * gout13[0] + 2 * gout11[0];
    ...
    std::cerr << "\rLUT320   ";
    Ciphertext gin320 = 1 * gout183[0] + 2 * gout319[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT321   ";
    Ciphertext gin321 = 1 * gout320[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT322   ";
    Ciphertext gin322 = 1 * gout246[0] + 2 * gout321[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT323   ";
    Ciphertext gin323 = 1 * gout183[1] + 2 * gout319[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT324   ";
    Ciphertext gin324 = 1 * gout323[0] + 2 * gout276[0] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT325   ";
    Ciphertext gin325 = 1 * gout244[0] + 2 * gout324[0];
    std::vector<Ciphertext> gout325 = ctx.eval_lut_amortized(&gin325, lut325);

    std::cerr << "\rFA326    ";
    Ciphertext gin326 = gout319[2] + 1 * ct_x8 + 2 * ct_x9 + 1 * gout10[0] + 2 * gout9[0];
    std::vector<Ciphertext> gout326 = ctx.eval_lut_amortized(&gin326, decomp);
    ...
    std::cerr << "\rLUT327   ";
    Ciphertext gin327 = 1 * gout184[0] + 2 * gout326[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT328   ";
    Ciphertext gin328 = 1 * gout327[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT329   ";
    Ciphertext gin329 = 1 * gout286[0] + 2 * gout328[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT330   ";
    Ciphertext gin330 = 1 * gout184[1] + 2 * gout326[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT331   ";
    Ciphertext gin331 = 1 * gout330[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT332   ";
    Ciphertext gin332 = 1 * gout285[0] + 2 * gout331[0] + 4 * gout244[0];
    std::vector<Ciphertext> gout332 = ctx.eval_lut_amortized(&gin332, lut332);

    std::cerr << "\rFA333    ";
    Ciphertext gin333 = gout326[2] + 1 * ct_x10 + 2 * ct_x11 + 1 * gout6[0] + 2 * gout2[0];
    std::vector<Ciphertext> gout333 = ctx.eval_lut_amortized(&gin333, decomp);
    ...
    std::cerr << "\rLUT334   ";
    Ciphertext gin334 = 1 * gout185[0] + 2 * gout333[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT335   ";
    Ciphertext gin335 = 1 * gout334[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT336   ";
    Ciphertext gin336 = 1 * gout318[0] + 2 * gout335[0] + 4 * gout244[0];
    std::vector<Ciphertext> gout336 = ctx.eval_lut_amortized(&gin336, lut336);

    std::cerr << "\rFA337    ";
    Ciphertext gin337 = gout333[2] + 1 * ct_x12 + 2 * ct_x13 + 1 * gout1[0] + 2 * gout0[0];
    std::vector<Ciphertext> gout337 = ctx.eval_lut_amortized(&gin337, decomp);

    std::cerr << "\rFA338    ";
    Ciphertext gin338 = gout337[2] + 1 * ct_x14 + 2 * ct_x15 + 1 * gout8[0] + 2 * gout12[0];
    std::vector<Ciphertext> gout338 = ctx.eval_lut_amortized(&gin338, decomp);
    ...
    std::cerr << "\rLUT339   ";
    Ciphertext gin339 = 1 * gout185[1] + 2 * gout333[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT340   ";
    Ciphertext gin340 = 1 * gout339[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT341   ";
    Ciphertext gin341 = 1 * gout317[0] + 2 * gout340[0] + 4 * gout244[0];
    std::vector<Ciphertext> gout341 = ctx.eval_lut_amortized(&gin341, lut341);

    std::cerr << "\rFA342    ";
    Ciphertext gin342 = gout185[2] + 1 * ct_x12 + 2 * ct_x13 + 1 * ct_y12 + 2 * ct_y13;
    ...
    std::cerr << "\rLUT343   ";
    Ciphertext gin343 = 1 * gout342[0] + 2 * gout337[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT344   ";
    Ciphertext gin344 = 1 * gout343[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT345   ";
    Ciphertext gin345 = 1 * gout316[0] + 2 * gout344[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT346   ";
    Ciphertext gin346 = 1 * gout342[1] + 2 * gout337[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT347   ";
    Ciphertext gin347 = 1 * gout346[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT348   ";
    Ciphertext gin348 = 1 * gout315[0] + 2 * gout347[0] + 4 * gout244[0];
    std::vector<Ciphertext> gout348 = ctx.eval_lut_amortized(&gin348, lut348);

    std::cerr << "\rFA349    ";
    Ciphertext gin349 = gout342[2] + 1 * ct_x14 + 2 * ct_x15 + 1 * ct_y14 + 2 * ct_y15;
    ...
    std::cerr << "\rLUT350   ";
    Ciphertext gin350 = 1 * gout349[0] + 2 * gout338[0] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT351   ";
    Ciphertext gin351 = 1 * gout350[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT352   ";
    Ciphertext gin352 = 1 * gout349[1] + 2 * gout338[1] + 4 * gout237[0];
    ...
    std::cerr << "\rLUT353   ";
    Ciphertext gin353 = 1 * gout352[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT354   ";
    Ciphertext gin354 = 1 * ct_x7 + 2 * ct_y8 + 4 * gout32[0];
    ...
    std::cerr << "\rLUT355   ";
    Ciphertext gin355 = 1 * gout207[0] + 2 * gout155[0] + 4 * gout354[0];
    ...
    std::cerr << "\rLUT356   ";
    Ciphertext gin356 = 1 * ct_x10 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT357   ";
    Ciphertext gin357 = 1 * gout356[0] + 2 * ct_x11 + 4 * ct_y3;
    ...
    std::cerr << "\rLUT358   ";
    Ciphertext gin358 = 1 * gout357[1] + 2 * ct_x9 + 4 * ct_y5;
    ...
    std::cerr << "\rLUT359   ";
    Ciphertext gin359 = 1 * gout358[0] + 2 * gout357[0] + 4 * gout177[0];
    ...
    std::cerr << "\rLUT360   ";
    Ciphertext gin360 = 1 * gout355[0] + 2 * gout359[0] + 4 * gout124[0];
    ...
    std::cerr << "\rLUT361   ";
    Ciphertext gin361 = 1 * gout358[1] + 2 * gout103[1] + 4 * gout117[0];
    ...
    std::cerr << "\rLUT362   ";
    Ciphertext gin362 = 1 * gout361[1] + 2 * gout211[1] + 4 * gout158[1];
    ...
    std::cerr << "\rLUT363   ";
    Ciphertext gin363 = 1 * gout362[0] + 2 * gout361[0] + 4 * gout211[0];
    ...
    std::cerr << "\rLUT364   ";
    Ciphertext gin364 = 1 * gout360[0] + 2 * gout363[0] + 4 * gout288[0];
    ...
    std::cerr << "\rLUT365   ";
    Ciphertext gin365 = 1 * gout362[1] + 2 * gout209[1] + 4 * gout220[0];
    ...
    std::cerr << "\rLUT366   ";
    Ciphertext gin366 = 1 * gout364[0] + 2 * gout365[0] + 4 * gout210[0];
    ...
    std::cerr << "\rLUT367   ";
    Ciphertext gin367 = 1 * gout365[1] + 2 * gout194[1] + 4 * gout223[0];
    ...
    std::cerr << "\rLUT368   ";
    Ciphertext gin368 = 1 * gout366[0] + 2 * gout367[0];
    ...
    std::cerr << "\rLUT369   ";
    Ciphertext gin369 = 1 * gout293[0] + 2 * gout367[1];
    ...
    std::cerr << "\rLUT370   ";
    Ciphertext gin370 = 1 * gout368[0] + 2 * gout369[0] + 4 * gout194[0];
    ...
    std::cerr << "\rLUT371   ";
    Ciphertext gin371 = 1 * gout299[0] + 2 * gout369[1];
    ...
    std::cerr << "\rLUT372   ";
    Ciphertext gin372 = 1 * gout303[0] + 2 * gout313[0] + 4 * gout371[0];
    ...
    std::cerr << "\rLUT373   ";
    Ciphertext gin373 = 1 * gout299[0] + 2 * gout369[1] + 4 * gout372[0];
    ...
    std::cerr << "\rLUT374   ";
    Ciphertext gin374 = 1 * gout373[0] + 2 * gout370[0] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT375   ";
    Ciphertext gin375 = 1 * gout374[0] + 2 * gout353[0] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT376   ";
    Ciphertext gin376 = 1 * gout314[0] + 2 * gout371[0] + 4 * gout245[0];
    ...
    std::cerr << "\rLUT377   ";
    Ciphertext gin377 = 1 * gout376[0] + 2 * gout351[0] + 4 * gout244[0];
    std::vector<Ciphertext> gout377 = ctx.eval_lut_amortized(&gin377, lut377);

    std::cerr << "\r          \r";
    std::vector<long> out;
    out.push_back(ctx.decrypt(&gout260[0])); /* out0 */
    out.push_back(ctx.decrypt(&gout287[0])); /* out1 */
    out.push_back(ctx.decrypt(&gout256[0])); /* out2 */
    out.push_back(ctx.decrypt(&gout253[0])); /* out3 */
    out.push_back(ctx.decrypt(&gout250[0])); /* out4 */
    out.push_back(ctx.decrypt(&gout263[0])); /* out5 */
    out.push_back(ctx.decrypt(&gout322[0])); /* out6 */
    out.push_back(ctx.decrypt(&gout325[0])); /* out7 */
    out.push_back(ctx.decrypt(&gout329[0])); /* out8 */
    out.push_back(ctx.decrypt(&gout332[0])); /* out9 */
    out.push_back(ctx.decrypt(&gout336[0])); /* out10 */
    out.push_back(ctx.decrypt(&gout341[0])); /* out11 */
    out.push_back(ctx.decrypt(&gout345[0])); /* out12 */
    out.push_back(ctx.decrypt(&gout348[0])); /* out13 */
    out.push_back(ctx.decrypt(&gout377[0])); /* out14 */
    out.push_back(ctx.decrypt(&gout375[0])); /* out15 */
    return out;
}
