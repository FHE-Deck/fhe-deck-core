...
test_calculator_lut3fa(FHEContext& ctx, uint8_t op, uint16_t x, uint16_t y)
{
    ...
    std::cerr << "\rLUT0   ";
    Ciphertext gin0 = 1 * ct_x14 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT1   ";
    Ciphertext gin1 = 1 * ct_x10 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT2   ";
    Ciphertext gin2 = 1 * ct_op1 + 2 * ct_op2 + 4 * ct_op3;
    ...
    std::cerr << "\rLUT3   ";
    Ciphertext gin3 = 1 * ct_y7 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT4   ";
    Ciphertext gin4 = 1 * ct_y6 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_x1 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT6   ";
    Ciphertext gin6 = 1 * ct_x8 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT7   ";
    Ciphertext gin7 = 1 * ct_x0 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT8   ";
    Ciphertext gin8 = 1 * ct_x10 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT9   ";
    Ciphertext gin9 = 1 * ct_y7 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT10   ";
    Ciphertext gin10 = 1 * ct_y6 + 2 * ct_x4;
    ...
    std::cerr << "\rLUT11   ";
    Ciphertext gin11 = 1 * ct_x8 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT12   ";
    Ciphertext gin12 = 1 * ct_x1 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_x1 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT14   ";
    Ciphertext gin14 = 1 * ct_y5 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT15   ";
    Ciphertext gin15 = 1 * ct_x11 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT16   ";
    Ciphertext gin16 = 1 * ct_x2 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT17   ";
    Ciphertext gin17 = 1 * ct_x1 + 2 * ct_y13;
    ...
    std::cerr << "\rLUT18   ";
    Ciphertext gin18 = 1 * gout5[0] + 2 * ct_x0 + 4 * ct_y1;
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_x0 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout12[0] + 2 * ct_x0 + 4 * ct_y10;
    ...
    std::cerr << "\rLUT21   ";
    Ciphertext gin21 = 1 * ct_y0 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT22   ";
    Ciphertext gin22 = 1 * ct_x1 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT23   ";
    Ciphertext gin23 = 1 * ct_y12 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT24   ";
    Ciphertext gin24 = 1 * ct_x2 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT25   ";
    Ciphertext gin25 = 1 * ct_y1 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT26   ";
    Ciphertext gin26 = 1 * ct_x2 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT27   ";
    Ciphertext gin27 = 1 * ct_x6 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT28   ";
    Ciphertext gin28 = 1 * ct_y4 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT29   ";
    Ciphertext gin29 = 1 * ct_x1 + 2 * ct_y6;
    ...
    std::cerr << "\rLUT30   ";
    Ciphertext gin30 = 1 * ct_x2 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT31   ";
    Ciphertext gin31 = 1 * ct_y4 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT32   ";
    Ciphertext gin32 = 1 * ct_x2 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT33   ";
    Ciphertext gin33 = 1 * ct_y2 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT34   ";
    Ciphertext gin34 = 1 * ct_x5 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_x14 + 2 * ct_y1 + 4 * ct_y15;
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * ct_x4 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT37   ";
    Ciphertext gin37 = 1 * ct_x4 + 2 * gout23[0] + 4 * ct_y11;
    ...
    std::cerr << "\rLUT38   ";
    Ciphertext gin38 = 1 * ct_x2 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT39   ";
    Ciphertext gin39 = 1 * ct_x1 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT40   ";
    Ciphertext gin40 = 1 * ct_x4 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT41   ";
    Ciphertext gin41 = 1 * ct_x0 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_x0 + 2 * ct_y11;
    ...
    std::cerr << "\rLUT43   ";
    Ciphertext gin43 = 1 * ct_x12 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT44   ";
    Ciphertext gin44 = 1 * ct_y6 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT45   ";
    Ciphertext gin45 = 1 * ct_y0 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT46   ";
    Ciphertext gin46 = 1 * ct_y0 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT47   ";
    Ciphertext gin47 = 1 * gout29[0] + 2 * ct_x0 + 4 * ct_y7;
    ...
    std::cerr << "\rLUT48   ";
    Ciphertext gin48 = 1 * ct_y0 + 2 * ct_x15 + 4 * gout35[0];
    ...
    std::cerr << "\rLUT49   ";
    Ciphertext gin49 = 1 * gout1[0] + 2 * ct_x11 + 4 * ct_y3;
    ...
    std::cerr << "\rLUT50   ";
    Ciphertext gin50 = 1 * ct_y6 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT51   ";
    Ciphertext gin51 = 1 * ct_y2 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT52   ";
    Ciphertext gin52 = 1 * gout39[0] + 2 * ct_x0 + 4 * ct_y4;
    ...
    std::cerr << "\rLUT53   ";
    Ciphertext gin53 = 1 * ct_x12 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT54   ";
    Ciphertext gin54 = 1 * ct_x4 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT55   ";
    Ciphertext gin55 = 1 * ct_x1 + 2 * ct_y14;
    ...
    std::cerr << "\rLUT56   ";
    Ciphertext gin56 = 1 * ct_x1 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT57   ";
    Ciphertext gin57 = 1 * ct_x4 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT58   ";
    Ciphertext gin58 = 1 * ct_x2 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT59   ";
    Ciphertext gin59 = 1 * ct_x4 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * ct_y7 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT61   ";
    Ciphertext gin61 = 1 * ct_y3 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * ct_y6 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * ct_y8 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * ct_y1 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * ct_x8 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * ct_x0 + 2 * gout55[0] + 4 * ct_y15;
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * ct_x4 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * ct_y4 + 2 * ct_x8;
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * ct_y3 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * ct_x1 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * ct_y2 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * ct_y1 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT78   ";
    Ciphertext gin78 = 1 * gout8[0] + 2 * gout33[0] + 4 * gout15[0];
    ...
    std::cerr << "\rLUT79   ";
    Ciphertext gin79 = 1 * ct_x11 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT80   ";
    Ciphertext gin80 = 1 * ct_x1 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * ct_x4 + 2 * ct_y4;
    ...
    std::cerr << "\rLUT82   ";
    Ciphertext gin82 = 1 * ct_y3 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT83   ";
    Ciphertext gin83 = 1 * gout31[0] + 2 * gout14[0] + 4 * gout11[0];
    ...
    std::cerr << "\rLUT84   ";
    Ciphertext gin84 = 1 * ct_y5 + 2 * ct_x7;
    std::vector<Ciphertext> gout84 = ctx.eval_lut_amortized(&gin84, lut84);

    std::cerr << "\rINV85   ";
    std::vector<Ciphertext> gout85;
    gout85.push_back(1 - ct_y15);
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * ct_x12 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * ct_x1 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * ct_y0 + 2 * ct_x6;
    std::vector<Ciphertext> gout88 = ctx.eval_lut_amortized(&gin88, lut88);

    std::cerr << "\rINV89   ";
    std::vector<Ciphertext> gout89;
    gout89.push_back(1 - ct_y2);
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * ct_y9 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT91   ";
    Ciphertext gin91 = 1 * ct_y5 + 2 * ct_x3;
    std::vector<Ciphertext> gout91 = ctx.eval_lut_amortized(&gin91, lut91);

    std::cerr << "\rINV92   ";
    std::vector<Ciphertext> gout92;
    gout92.push_back(1 - ct_y10);
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * ct_x8 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * ct_x1 + 2 * ct_y11;
    std::vector<Ciphertext> gout94 = ctx.eval_lut_amortized(&gin94, lut94);

    std::cerr << "\rINV95   ";
    std::vector<Ciphertext> gout95;
    gout95.push_back(1 - ct_y0);
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * ct_y2 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT97   ";
    Ciphertext gin97 = 1 * ct_y7 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout28[0] + 2 * gout26[0] + 4 * gout40[0];
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * ct_x13 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * ct_y6 + 2 * ct_x2;
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * ct_x2 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT102   ";
    Ciphertext gin102 = 1 * ct_y1 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT103   ";
    Ciphertext gin103 = 1 * gout49[1] + 2 * ct_x9 + 4 * ct_y5;
    ...
    std::cerr << "\rLUT104   ";
    Ciphertext gin104 = 1 * ct_y3 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * ct_x0 + 2 * ct_y8;
    std::vector<Ciphertext> gout105 = ctx.eval_lut_amortized(&gin105, lut105);

    std::cerr << "\rINV106   ";
    std::vector<Ciphertext> gout106;
    gout106.push_back(1 - ct_y1);

    std::cerr << "\rINV107   ";
    std::vector<Ciphertext> gout107;
    gout107.push_back(1 - ct_y9);
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * ct_y4 + 2 * ct_x5;
    std::vector<Ciphertext> gout108 = ctx.eval_lut_amortized(&gin108, lut108);

    std::cerr << "\rINV109   ";
    std::vector<Ciphertext> gout109;
    gout109.push_back(1 - ct_y8);
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * ct_x1 + 2 * ct_y8;
    std::vector<Ciphertext> gout115 = ctx.eval_lut_amortized(&gin115, lut115);

    std::cerr << "\rINV116   ";
    std::vector<Ciphertext> gout116;
    gout116.push_back(1 - ct_y5);
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * ct_x8 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * ct_x1 + 2 * ct_y12;
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * ct_x10 + 2 * ct_y3;
    std::vector<Ciphertext> gout119 = ctx.eval_lut_amortized(&gin119, lut119);

    std::cerr << "\rINV120   ";
    std::vector<Ciphertext> gout120;
    gout120.push_back(1 - ct_y4);
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * ct_x2 + 2 * ct_y11;
    std::vector<Ciphertext> gout121 = ctx.eval_lut_amortized(&gin121, lut121);

    std::cerr << "\rINV122   ";
    std::vector<Ciphertext> gout122;
    gout122.push_back(1 - ct_y3);
    ...
    std::cerr << "\rLUT123   ";
    Ciphertext gin123 = 1 * ct_x2 + 2 * ct_y7;
    ...
    std::cerr << "\rLUT124   ";
    Ciphertext gin124 = 1 * ct_x9 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * ct_x4 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT126   ";
    Ciphertext gin126 = 1 * ct_y4 + 2 * ct_x6;
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * ct_y4 + 2 * ct_x9;
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * ct_x9 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * ct_x11 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT130   ";
    Ciphertext gin130 = 1 * gout118[0] + 2 * ct_x0 + 4 * ct_y13;
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * ct_x2 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout79[0] + 2 * gout69[0] + 4 * gout43[0];
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * ct_x10 + 2 * ct_y0;
    ...
    std::cerr << "\rLUT134   ";
    Ciphertext gin134 = 1 * ct_y6 + 2 * ct_x3;
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * ct_y3 + 2 * ct_x7;
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * gout124[0] + 2 * gout6[0] + 4 * gout133[0];
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * ct_x4 + 2 * ct_y9;
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * ct_x12 + 2 * ct_y2;
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * ct_y8 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * ct_x6 + 2 * ct_y8;
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * ct_y5 + 2 * ct_x5;
    ...
    std::cerr << "\rLUT143   ";
    Ciphertext gin143 = 1 * ct_x13 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * ct_x4 + 2 * ct_y10;
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout140[0] + 2 * gout121[0] + 4 * gout137[0];
    std::vector<Ciphertext> gout145 = ctx.eval_lut_amortized(&gin145, lut145);

    std::cerr << "\rFA146    ";
    Ciphertext gin146 = 1 * ct_x0 + 2 * ct_x1 + 1 * ct_y0 + 2 * ct_y1;
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout64[0] + 2 * gout59[0] + 4 * gout88[0];
    ...
    std::cerr << "\rLUT148   ";
    Ciphertext gin148 = 1 * ct_op6 + 2 * ct_op7;
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * gout17[0] + 2 * ct_y12 + 4 * ct_x2;
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout56[0] + 2 * gout42[0] + 4 * gout24[0];
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout16[0] + 2 * gout13[0] + 4 * gout21[0];
    std::vector<Ciphertext> gout151 = ctx.eval_lut_amortized(&gin151, lut151);

    std::cerr << "\rFA152    ";
    Ciphertext gin152 = 1 + 1 * ct_x0 + 2 * ct_x1 + 1 * gout95[0] + 2 * gout106[0];
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout60[0] + 2 * gout54[0] + 4 * gout62[0];
    ...
    std::cerr << "\rLUT154   ";
    Ciphertext gin154 = 1 * gout143[0] + 2 * gout138[0] + 4 * gout0[0];
    ...
    std::cerr << "\rLUT155   ";
    Ciphertext gin155 = 1 * gout144[0] + 2 * ct_y9 + 4 * ct_x5;
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout74[0] + 2 * gout17[0];
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout22[0] + 2 * gout7[0] + 4 * gout32[0];
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout68[0] + 2 * gout84[0] + 4 * gout82[0];
    ...
    std::cerr << "\rLUT159   ";
    Ciphertext gin159 = 1 * gout9[0] + 2 * gout141[0] + 4 * gout4[0];
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout87[0] + 2 * gout105[0] + 4 * gout100[0];
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * ct_op4 + 2 * ct_op5 + 4 * gout148[0];
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout25[0] + 2 * gout30[0] + 4 * gout57[0];
    std::vector<Ciphertext> gout162 = ctx.eval_lut_amortized(&gin162, lut162);

    std::cerr << "\rFA163    ";
    Ciphertext gin163 = gout146[2] + 1 * ct_x2 + 2 * ct_x3 + 1 * ct_y2 + 2 * ct_y3;
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout2[0] + 2 * gout161[0];
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout97[0] + 2 * gout139[0] + 4 * gout113[0];
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout20[0] + 2 * gout150[0];
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * ct_x7 + 2 * ct_y8 + 4 * gout27[0];
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * ct_x10 + 2 * gout50[0] + 4 * ct_y5;
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout18[0] + 2 * gout157[1];
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * ct_x2 + 2 * ct_y13 + 4 * gout37[0];
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout127[0] + 2 * gout93[0] + 4 * gout119[0];
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * ct_x8 + 2 * ct_y7 + 4 * gout168[0];
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout153[1] + 2 * gout165[1] + 4 * gout158[0];
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout86[0] + 2 * gout129[0] + 4 * gout99[0];
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout58[0] + 2 * gout80[0] + 4 * gout71[0];
    ...
    std::cerr << "\rLUT176   ";
    Ciphertext gin176 = 1 * gout67[0] + 2 * gout63[0] + 4 * gout44[0];
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * ct_x13 + 2 * ct_y2 + 4 * gout53[0];
    std::vector<Ciphertext> gout177 = ctx.eval_lut_amortized(&gin177, lut177);

    std::cerr << "\rFA178    ";
    Ciphertext gin178 = gout163[2] + 1 * ct_x4 + 2 * ct_x5 + 1 * ct_y4 + 2 * ct_y5;
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout177[0] + 2 * gout48[0];
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout77[0] + 2 * gout51[0] + 4 * gout65[0];
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout19[0] + 2 * gout72[0];
    ...
    std::cerr << "\rLUT182   ";
    Ciphertext gin182 = 1 * gout36[0] + 2 * gout73[0] + 4 * gout45[0];
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout126[0] + 2 * gout142[0] + 4 * gout135[0];
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout78[0] + 2 * gout132[1] + 4 * gout158[1];
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout72[0] + 2 * gout41[0] + 4 * gout38[0];
    ...
    std::cerr << "\rLUT186   ";
    Ciphertext gin186 = 1 * gout101[0] + 2 * gout94[0] + 4 * gout90[0];
    ...
    std::cerr << "\rLUT187   ";
    Ciphertext gin187 = 1 * ct_x11 + 2 * ct_y4 + 4 * gout154[0];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout165[0] + 2 * gout159[0] + 4 * gout171[0];
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout182[1] + 2 * gout147[1] + 4 * gout175[1];
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout81[0] + 2 * gout91[0] + 4 * gout61[0];
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout175[0] + 2 * gout47[0];
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout117[0] + 2 * gout110[0] + 4 * gout128[0];
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * ct_op1 + 2 * ct_op0 + 4 * gout161[0];
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout108[0] + 2 * gout125[0] + 4 * gout104[0];
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout136[1] + 2 * gout78[1] + 4 * gout83[0];
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout123[0] + 2 * gout115[0] + 4 * gout134[0];
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout132[0] + 2 * gout174[0] + 4 * gout171[1];
    ...
    std::cerr << "\rLUT198   ";
    Ciphertext gin198 = 1 * gout102[0] + 2 * gout96[0] + 4 * gout46[0];
    ...
    std::cerr << "\rLUT199   ";
    Ciphertext gin199 = 1 * gout151[0] + 2 * gout162[0] + 4 * gout52[0];
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout176[0] + 2 * gout153[0] + 4 * gout83[1];
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout155[0] + 2 * ct_x3 + 4 * ct_y11;
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout3[0] + 2 * gout131[0] + 4 * gout10[0];
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout184[0] + 2 * gout197[1] + 4 * gout173[0];
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * gout160[0] + 2 * gout196[1] + 4 * gout190[1];
    ...
    std::cerr << "\rLUT205   ";
    Ciphertext gin205 = 1 * gout47[1] + 2 * gout160[1] + 4 * gout98[1];
    std::vector<Ciphertext> gout205 = ctx.eval_lut_amortized(&gin205, lut205);

    std::cerr << "\rFA206    ";
    Ciphertext gin206 = gout152[2] + 1 * ct_x2 + 2 * ct_x3 + 1 * gout89[0] + 2 * gout122[0];
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout157[0] + 2 * gout151[1] + 4 * gout19[0];
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * gout150[1] + 2 * gout186[0] + 4 * gout74[0];
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout149[0] + 2 * ct_y14 + 4 * ct_x0;
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * gout196[0] + 2 * gout202[0] + 4 * gout194[1];
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * gout162[1] + 2 * gout182[0] + 4 * gout185[1];
    ...
    std::cerr << "\rLUT212   ";
    Ciphertext gin212 = 1 * ct_op0 + 2 * gout164[0];
    ...
    std::cerr << "\rLUT213   ";
    Ciphertext gin213 = 1 * gout195[1] + 2 * gout184[1] + 4 * gout200[0];
    ...
    std::cerr << "\rLUT214   ";
    Ciphertext gin214 = 1 * gout103[0] + 2 * gout154[1] + 4 * gout174[1];
    ...
    std::cerr << "\rLUT215   ";
    Ciphertext gin215 = 1 * gout207[1] + 2 * gout199[0];
    ...
    std::cerr << "\rLUT216   ";
    Ciphertext gin216 = 1 * gout169[0] + 2 * gout207[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT217   ";
    Ciphertext gin217 = 1 * gout192[0] + 2 * gout136[0] + 4 * gout183[1];
    ...
    std::cerr << "\rLUT218   ";
    Ciphertext gin218 = 1 * gout18[0] + 2 * gout157[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT219   ";
    Ciphertext gin219 = 1 * gout186[1] + 2 * gout145[1] + 4 * gout130[0];
    ...
    std::cerr << "\rLUT220   ";
    Ciphertext gin220 = 1 * gout214[1] + 2 * gout188[0] + 4 * gout197[0];
    ...
    std::cerr << "\rLUT221   ";
    Ciphertext gin221 = 1 * gout185[0] + 2 * ct_x0 + 4 * ct_y6;
    ...
    std::cerr << "\rLUT222   ";
    Ciphertext gin222 = 1 * gout137[0] + 2 * gout201[1] + 4 * gout34[0];
    ...
    std::cerr << "\rLUT223   ";
    Ciphertext gin223 = 1 * gout220[1] + 2 * gout214[0] + 4 * gout188[1];
    ...
    std::cerr << "\rLUT224   ";
    Ciphertext gin224 = 1 * gout208[0] + 2 * gout219[1] + 4 * gout200[1];
    ...
    std::cerr << "\rLUT225   ";
    Ciphertext gin225 = 1 * gout103[1] + 2 * gout49[0] + 4 * gout172[0];
    ...
    std::cerr << "\rLUT226   ";
    Ciphertext gin226 = 1 * gout210[1] + 2 * gout166[0];
    ...
    std::cerr << "\rLUT227   ";
    Ciphertext gin227 = 1 * gout224[1] + 2 * gout156[0];
    ...
    std::cerr << "\rLUT228   ";
    Ciphertext gin228 = 1 * gout222[0] + 2 * gout170[0] + 4 * gout167[0];
    std::vector<Ciphertext> gout228 = ctx.eval_lut_amortized(&gin228, lut228);

    std::cerr << "\rFA229    ";
    Ciphertext gin229 = gout178[2] + 1 * ct_x6 + 2 * ct_x7 + 1 * ct_y6 + 2 * ct_y7;
    std::vector<Ciphertext> gout229 = ctx.eval_lut_amortized(&gin229, decomp);
    ...
    std::cerr << "\rLUT230   ";
    Ciphertext gin230 = 1 * gout169[0] + 2 * gout207[0];
    ...
    std::cerr << "\rLUT231   ";
    Ciphertext gin231 = 1 * gout193[0] + 2 * ct_op2 + 4 * ct_op3;
    ...
    std::cerr << "\rLUT232   ";
    Ciphertext gin232 = 1 * gout147[0] + 2 * gout198[1] + 4 * gout98[0];
    ...
    std::cerr << "\rLUT233   ";
    Ciphertext gin233 = 1 * gout202[1] + 2 * gout176[1] + 4 * gout183[0];
    std::vector<Ciphertext> gout233 = ctx.eval_lut_amortized(&gin233, lut233);

    std::cerr << "\rFA234    ";
    Ciphertext gin234 = gout206[2] + 1 * ct_x4 + 2 * ct_x5 + 1 * gout120[0] + 2 * gout116[0];
    std::vector<Ciphertext> gout234 = ctx.eval_lut_amortized(&gin234, decomp);
    ...
    std::cerr << "\rLUT235   ";
    Ciphertext gin235 = 1 * gout178[1] + 2 * gout234[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT236   ";
    Ciphertext gin236 = 1 * gout209[0] + 2 * gout149[1] + 4 * gout66[0];
    ...
    std::cerr << "\rLUT237   ";
    Ciphertext gin237 = 1 * gout235[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT238   ";
    Ciphertext gin238 = 1 * gout180[0] + 2 * gout192[1] + 4 * gout194[0];
    ...
    std::cerr << "\rLUT239   ";
    Ciphertext gin239 = 1 * gout201[0] + 2 * gout209[1] + 4 * gout145[0];
    ...
    std::cerr << "\rLUT240   ";
    Ciphertext gin240 = 1 * gout198[0] + 2 * gout180[1] + 4 * gout190[0];
    ...
    std::cerr << "\rLUT241   ";
    Ciphertext gin241 = 1 * gout238[1] + 2 * gout217[1] + 4 * gout210[0];
    ...
    std::cerr << "\rLUT242   ";
    Ciphertext gin242 = 1 * gout240[1] + 2 * gout238[0] + 4 * gout204[1];
    ...
    std::cerr << "\rLUT243   ";
    Ciphertext gin243 = 1 * gout239[1] + 2 * gout219[0] + 4 * gout173[1];
    ...
    std::cerr << "\rLUT244   ";
    Ciphertext gin244 = 1 * gout205[1] + 2 * ct_x0 + 4 * ct_y9;
    ...
    std::cerr << "\rLUT245   ";
    Ciphertext gin245 = 1 * gout199[1] + 2 * gout211[0] + 4 * gout181[0];
    ...
    std::cerr << "\rLUT246   ";
    Ciphertext gin246 = 1 * gout220[0] + 2 * gout243[1] + 4 * gout203[1];
    ...
    std::cerr << "\rLUT247   ";
    Ciphertext gin247 = 1 * gout204[0] + 2 * gout20[1];
    ...
    std::cerr << "\rLUT248   ";
    Ciphertext gin248 = 1 * ct_x0 + 2 * ct_y0 + 4 * gout212[0];
    ...
    std::cerr << "\rLUT249   ";
    Ciphertext gin249 = 1 * gout189[0] + 2 * gout232[1] + 4 * gout191[1];
    ...
    std::cerr << "\rLUT250   ";
    Ciphertext gin250 = 1 * gout213[0] + 2 * gout203[0] + 4 * gout224[0];
    ...
    std::cerr << "\rLUT251   ";
    Ciphertext gin251 = 1 * gout146[1] + 2 * gout152[1] + 4 * gout231[0];
    std::vector<Ciphertext> gout251 = ctx.eval_lut_amortized(&gin251, lut251);

    std::cerr << "\rFA252    ";
    Ciphertext gin252 = gout234[2] + 1 * ct_x6 + 2 * ct_x7 + 1 * gout114[0] + 2 * gout111[0];
    ...
    std::cerr << "\rLUT253   ";
    Ciphertext gin253 = 1 * gout164[0] + 2 * gout231[0];
    ...
    std::cerr << "\rLUT254   ";
    Ciphertext gin254 = 1 * gout228[0] + 2 * gout225[0] + 4 * gout179[0];
    std::vector<Ciphertext> gout254 = ctx.eval_lut_amortized(&gin254, lut254);

    std::cerr << "\rFA255    ";
    Ciphertext gin255 = gout229[2] + 1 * ct_x8 + 2 * ct_x9 + 1 * ct_y8 + 2 * ct_y9;
    std::vector<Ciphertext> gout255 = ctx.eval_lut_amortized(&gin255, decomp);
    ...
    std::cerr << "\rLUT256   ";
    Ciphertext gin256 = 1 * gout232[0] + 2 * gout240[0] + 4 * gout205[0];
    ...
    std::cerr << "\rLUT257   ";
    Ciphertext gin257 = 1 * gout146[0] + 2 * gout152[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT258   ";
    Ciphertext gin258 = 1 * gout211[1] + 2 * gout189[1] + 4 * gout221[0];
    ...
    std::cerr << "\rLUT259   ";
    Ciphertext gin259 = 1 * gout230[0] + 2 * gout215[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT260   ";
    Ciphertext gin260 = 1 * gout163[1] + 2 * gout206[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT261   ";
    Ciphertext gin261 = 1 * gout163[0] + 2 * gout206[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT262   ";
    Ciphertext gin262 = 1 * gout245[1] + 2 * gout258[0];
    ...
    std::cerr << "\rLUT263   ";
    Ciphertext gin263 = 1 * gout260[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT264   ";
    Ciphertext gin264 = 1 * gout178[0] + 2 * gout234[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT265   ";
    Ciphertext gin265 = 1 * gout230[0] + 2 * gout215[1];
    ...
    std::cerr << "\rLUT266   ";
    Ciphertext gin266 = 1 * gout264[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT267   ";
    Ciphertext gin267 = 1 * gout166[1] + 2 * gout208[1] + 4 * gout233[1];
    ...
    std::cerr << "\rLUT268   ";
    Ciphertext gin268 = 1 * gout243[0] + 2 * gout236[0];
    ...
    std::cerr << "\rLUT269   ";
    Ciphertext gin269 = 1 * gout217[0] + 2 * gout195[0] + 4 * gout233[0];
    ...
    std::cerr << "\rLUT270   ";
    Ciphertext gin270 = 1 * gout239[0] + 2 * gout187[0] + 4 * gout159[1];
    ...
    std::cerr << "\rLUT271   ";
    Ciphertext gin271 = 1 * gout242[0] + 2 * gout241[1] + 4 * gout247[0];
    ...
    std::cerr << "\rLUT272   ";
    Ciphertext gin272 = 1 * gout256[1] + 2 * gout242[1] + 4 * gout244[1];
    ...
    std::cerr << "\rLUT273   ";
    Ciphertext gin273 = 1 * gout229[1] + 2 * gout252[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT274   ";
    Ciphertext gin274 = 1 * gout215[0] + 2 * gout245[0];
    ...
    std::cerr << "\rLUT275   ";
    Ciphertext gin275 = 1 * gout265[0] + 2 * gout274[0];
    ...
    std::cerr << "\rLUT276   ";
    Ciphertext gin276 = 1 * gout258[1] + 2 * gout249[1] + 4 * gout221[1];
    ...
    std::cerr << "\rLUT277   ";
    Ciphertext gin277 = 1 * gout229[0] + 2 * gout252[0] + 4 * gout231[0];
    std::vector<Ciphertext> gout277 = ctx.eval_lut_amortized(&gin277, lut277);

    std::cerr << "\rFA278    ";
    Ciphertext gin278 = gout252[2] + 1 * ct_x8 + 2 * ct_x9 + 1 * gout109[0] + 2 * gout107[0];
    std::vector<Ciphertext> gout278 = ctx.eval_lut_amortized(&gin278, decomp);
    ...
    std::cerr << "\rLUT279   ";
    Ciphertext gin279 = 1 * gout246[0] + 2 * gout227[1] + 4 * gout250[0];
    ...
    std::cerr << "\rLUT280   ";
    Ciphertext gin280 = 1 * gout277[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT281   ";
    Ciphertext gin281 = 1 * gout262[1] + 2 * gout276[0];
    ...
    std::cerr << "\rLUT282   ";
    Ciphertext gin282 = 1 * gout269[1] + 2 * gout213[1] + 4 * gout267[1];
    ...
    std::cerr << "\rLUT283   ";
    Ciphertext gin283 = 1 * gout257[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT284   ";
    Ciphertext gin284 = 1 * gout255[1] + 2 * gout278[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT285   ";
    Ciphertext gin285 = 1 * gout284[0] + 2 * gout212[0];
    std::vector<Ciphertext> gout285 = ctx.eval_lut_amortized(&gin285, lut285);

    std::cerr << "\rFA286    ";
    Ciphertext gin286 = gout255[2] + 1 * ct_x10 + 2 * ct_x11 + 1 * ct_y10 + 2 * ct_y11;
    std::vector<Ciphertext> gout286 = ctx.eval_lut_amortized(&gin286, decomp);
    ...
    std::cerr << "\rLUT287   ";
    Ciphertext gin287 = 1 * gout282[0] + 2 * gout250[1] + 4 * gout267[0];
    ...
    std::cerr << "\rLUT288   ";
    Ciphertext gin288 = 1 * gout241[0] + 2 * gout269[0] + 4 * gout226[0];
    std::vector<Ciphertext> gout288 = ctx.eval_lut_amortized(&gin288, lut288);

    std::cerr << "\rFA289    ";
    Ciphertext gin289 = gout286[2] + 1 * ct_x12 + 2 * ct_x13 + 1 * ct_y12 + 2 * ct_y13;
    std::vector<Ciphertext> gout289 = ctx.eval_lut_amortized(&gin289, decomp);

    std::cerr << "\rFA290    ";
    Ciphertext gin290 = gout289[2] + 1 * ct_x14 + 2 * ct_x15 + 1 * ct_y14 + 2 * ct_y15;
    ...
    std::cerr << "\rLUT291   ";
    Ciphertext gin291 = 1 * gout251[0] + 2 * gout18[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT292   ";
    Ciphertext gin292 = 1 * gout291[0] + 2 * gout253[0];
    ...
    std::cerr << "\rLUT293   ";
    Ciphertext gin293 = 1 * gout249[0] + 2 * gout256[0] + 4 * gout191[0];
    ...
    std::cerr << "\rLUT294   ";
    Ciphertext gin294 = 1 * gout288[1] + 2 * gout282[1] + 4 * gout226[1];
    ...
    std::cerr << "\rLUT295   ";
    Ciphertext gin295 = 1 * gout261[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT296   ";
    Ciphertext gin296 = 1 * gout216[0] + 2 * gout263[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT297   ";
    Ciphertext gin297 = 1 * gout254[0] + 2 * gout223[0] + 4 * gout270[0];
    ...
    std::cerr << "\rLUT298   ";
    Ciphertext gin298 = 1 * gout297[0] + 2 * gout246[1] + 4 * gout268[0];
    ...
    std::cerr << "\rLUT299   ";
    Ciphertext gin299 = 1 * gout259[0] + 2 * gout266[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT300   ";
    Ciphertext gin300 = 1 * gout298[0] + 2 * gout279[1];
    ...
    std::cerr << "\rLUT301   ";
    Ciphertext gin301 = 1 * gout272[0] + 2 * gout271[1] + 4 * gout244[0];
    ...
    std::cerr << "\rLUT302   ";
    Ciphertext gin302 = 1 * gout265[0] + 2 * gout274[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT303   ";
    Ciphertext gin303 = 1 * gout302[0] + 2 * gout237[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT304   ";
    Ciphertext gin304 = 1 * gout271[0] + 2 * gout288[0] + 4 * gout247[1];
    ...
    std::cerr << "\rLUT305   ";
    Ciphertext gin305 = 1 * gout274[1] + 2 * gout262[0];
    ...
    std::cerr << "\rLUT306   ";
    Ciphertext gin306 = 1 * gout287[1] + 2 * gout279[0];
    ...
    std::cerr << "\rLUT307   ";
    Ciphertext gin307 = 1 * gout283[0] + 2 * gout248[0] + 4 * gout253[0];
    std::vector<Ciphertext> gout307 = ctx.eval_lut_amortized(&gin307, lut307);

    std::cerr << "\rFA308    ";
    Ciphertext gin308 = gout278[2] + 1 * ct_x10 + 2 * ct_x11 + 1 * gout92[0] + 2 * gout76[0];
    std::vector<Ciphertext> gout308 = ctx.eval_lut_amortized(&gin308, decomp);
    ...
    std::cerr << "\rLUT309   ";
    Ciphertext gin309 = 1 * gout255[0] + 2 * gout278[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT310   ";
    Ciphertext gin310 = 1 * gout294[1] + 2 * gout287[0];
    ...
    std::cerr << "\rLUT311   ";
    Ciphertext gin311 = 1 * gout309[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT312   ";
    Ciphertext gin312 = 1 * gout293[1] + 2 * gout272[1];
    ...
    std::cerr << "\rLUT313   ";
    Ciphertext gin313 = 1 * gout276[1] + 2 * gout293[0];
    ...
    std::cerr << "\rLUT314   ";
    Ciphertext gin314 = 1 * gout218[0] + 2 * gout295[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT315   ";
    Ciphertext gin315 = 1 * gout310[1] + 2 * gout306[1];
    ...
    std::cerr << "\rLUT316   ";
    Ciphertext gin316 = 1 * gout301[1] + 2 * gout304[0];
    ...
    std::cerr << "\rLUT317   ";
    Ciphertext gin317 = 1 * gout286[0] + 2 * gout308[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT318   ";
    Ciphertext gin318 = 1 * gout300[0] + 2 * gout306[0] + 4 * gout227[0];
    ...
    std::cerr << "\rLUT319   ";
    Ciphertext gin319 = 1 * gout317[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT320   ";
    Ciphertext gin320 = 1 * gout281[1] + 2 * gout313[1];
    ...
    std::cerr << "\rLUT321   ";
    Ciphertext gin321 = 1 * gout305[0] + 2 * gout275[0] + 4 * gout281[0];
    ...
    std::cerr << "\rLUT322   ";
    Ciphertext gin322 = 1 * gout286[1] + 2 * gout308[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT323   ";
    Ciphertext gin323 = 1 * gout313[0] + 2 * gout312[0];
    std::vector<Ciphertext> gout323 = ctx.eval_lut_amortized(&gin323, lut323);

    std::cerr << "\rFA324    ";
    Ciphertext gin324 = gout308[2] + 1 * ct_x12 + 2 * ct_x13 + 1 * gout75[0] + 2 * gout70[0];
    std::vector<Ciphertext> gout324 = ctx.eval_lut_amortized(&gin324, decomp);
    ...
    std::cerr << "\rLUT325   ";
    Ciphertext gin325 = 1 * gout322[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT326   ";
    Ciphertext gin326 = 1 * gout305[1] + 2 * gout281[0];
    ...
    std::cerr << "\rLUT327   ";
    Ciphertext gin327 = 1 * gout304[1] + 2 * gout294[0];
    ...
    std::cerr << "\rLUT328   ";
    Ciphertext gin328 = 1 * gout305[0] + 2 * gout275[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT329   ";
    Ciphertext gin329 = 1 * gout305[0] + 2 * gout275[0] + 4 * gout305[1];
    ...
    std::cerr << "\rLUT330   ";
    Ciphertext gin330 = 1 * gout328[0] + 2 * gout280[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT331   ";
    Ciphertext gin331 = 1 * gout320[1] + 2 * gout323[1];
    ...
    std::cerr << "\rLUT332   ";
    Ciphertext gin332 = 1 * gout289[0] + 2 * gout324[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT333   ";
    Ciphertext gin333 = 1 * gout312[1] + 2 * gout301[0];
    ...
    std::cerr << "\rLUT334   ";
    Ciphertext gin334 = 1 * gout332[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT335   ";
    Ciphertext gin335 = 1 * gout326[0] + 2 * gout320[0];
    ...
    std::cerr << "\rLUT336   ";
    Ciphertext gin336 = 1 * gout320[0] + 2 * gout321[0];
    ...
    std::cerr << "\rLUT337   ";
    Ciphertext gin337 = 1 * gout320[1] + 2 * gout323[1] + 4 * gout335[0];
    ...
    std::cerr << "\rLUT338   ";
    Ciphertext gin338 = 1 * gout336[0] + 2 * gout331[0];
    ...
    std::cerr << "\rLUT339   ";
    Ciphertext gin339 = 1 * gout338[0] + 2 * gout337[0];
    std::vector<Ciphertext> gout339 = ctx.eval_lut_amortized(&gin339, lut339);

    std::cerr << "\rFA340    ";
    Ciphertext gin340 = gout324[2] + 1 * ct_x14 + 2 * ct_x15 + 1 * gout112[0] + 2 * gout85[0];
    std::vector<Ciphertext> gout340 = ctx.eval_lut_amortized(&gin340, decomp);
    ...
    std::cerr << "\rLUT341   ";
    Ciphertext gin341 = 1 * gout289[1] + 2 * gout324[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT342   ";
    Ciphertext gin342 = 1 * gout341[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT343   ";
    Ciphertext gin343 = 1 * gout333[0] + 2 * gout316[1];
    ...
    std::cerr << "\rLUT344   ";
    Ciphertext gin344 = 1 * gout316[0] + 2 * gout327[1];
    ...
    std::cerr << "\rLUT345   ";
    Ciphertext gin345 = 1 * gout290[0] + 2 * gout340[0] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT346   ";
    Ciphertext gin346 = 1 * gout327[0] + 2 * gout310[0];
    ...
    std::cerr << "\rLUT347   ";
    Ciphertext gin347 = 1 * gout345[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT348   ";
    Ciphertext gin348 = 1 * gout290[1] + 2 * gout340[1] + 4 * gout231[0];
    ...
    std::cerr << "\rLUT349   ";
    Ciphertext gin349 = 1 * gout329[0] + 2 * gout281[0];
    ...
    std::cerr << "\rLUT350   ";
    Ciphertext gin350 = 1 * gout348[0] + 2 * gout212[0];
    ...
    std::cerr << "\rLUT351   ";
    Ciphertext gin351 = 1 * gout323[0] + 2 * gout333[1];
    ...
    std::cerr << "\rLUT352   ";
    Ciphertext gin352 = 1 * gout335[1] + 2 * gout321[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT353   ";
    Ciphertext gin353 = 1 * gout273[0] + 2 * gout349[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT354   ";
    Ciphertext gin354 = 1 * gout335[0] + 2 * gout336[0];
    ...
    std::cerr << "\rLUT355   ";
    Ciphertext gin355 = 1 * gout354[0] + 2 * gout331[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT356   ";
    Ciphertext gin356 = 1 * gout339[0] + 2 * gout351[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT357   ";
    Ciphertext gin357 = 1 * gout356[0] + 2 * gout319[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT358   ";
    Ciphertext gin358 = 1 * gout338[0] + 2 * gout337[0] + 4 * gout351[1];
    ...
    std::cerr << "\rLUT359   ";
    Ciphertext gin359 = 1 * gout355[0] + 2 * gout285[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT360   ";
    Ciphertext gin360 = 1 * gout352[0] + 2 * gout311[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT361   ";
    Ciphertext gin361 = 1 * gout253[0] + 2 * gout353[0];
    ...
    std::cerr << "\rLUT362   ";
    Ciphertext gin362 = 1 * gout358[0] + 2 * gout351[0] + 4 * gout343[1];
    ...
    std::cerr << "\rLUT363   ";
    Ciphertext gin363 = 1 * gout343[0] + 2 * gout362[0] + 4 * gout344[1];
    ...
    std::cerr << "\rLUT364   ";
    Ciphertext gin364 = 1 * gout362[1] + 2 * gout343[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT365   ";
    Ciphertext gin365 = 1 * gout363[1] + 2 * gout344[1] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT366   ";
    Ciphertext gin366 = 1 * gout365[0] + 2 * gout334[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT367   ";
    Ciphertext gin367 = 1 * gout363[0] + 2 * gout344[0];
    ...
    std::cerr << "\rLUT368   ";
    Ciphertext gin368 = 1 * gout367[0] + 2 * gout346[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT369   ";
    Ciphertext gin369 = 1 * gout363[0] + 2 * gout344[0] + 4 * gout346[0];
    ...
    std::cerr << "\rLUT370   ";
    Ciphertext gin370 = 1 * gout346[1] + 2 * gout369[0];
    ...
    std::cerr << "\rLUT371   ";
    Ciphertext gin371 = 1 * gout370[0] + 2 * gout315[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT372   ";
    Ciphertext gin372 = 1 * gout364[0] + 2 * gout325[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT373   ";
    Ciphertext gin373 = 1 * gout346[1] + 2 * gout369[0] + 4 * gout315[0];
    ...
    std::cerr << "\rLUT374   ";
    Ciphertext gin374 = 1 * gout310[1] + 2 * gout306[1] + 4 * gout373[0];
    ...
    std::cerr << "\rLUT375   ";
    Ciphertext gin375 = 1 * gout368[0] + 2 * gout342[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT376   ";
    Ciphertext gin376 = 1 * gout371[0] + 2 * gout347[0] + 4 * gout253[0];
    ...
    std::cerr << "\rLUT377   ";
    Ciphertext gin377 = 1 * gout374[0] + 2 * gout318[0] + 4 * gout212[0];
    ...
    std::cerr << "\rLUT378   ";
    Ciphertext gin378 = 1 * gout377[0] + 2 * gout350[0] + 4 * gout253[0];
    std::vector<Ciphertext> gout378 = ctx.eval_lut_amortized(&gin378, lut378);

    std::cerr << "\r          \r";
    std::vector<long> out;
    out.push_back(ctx.decrypt(&gout307[0])); /* out0 */
    out.push_back(ctx.decrypt(&gout292[0])); /* out1 */
    out.push_back(ctx.decrypt(&gout314[0])); /* out2 */
    out.push_back(ctx.decrypt(&gout296[0])); /* out3 */
    out.push_back(ctx.decrypt(&gout299[0])); /* out4 */
    out.push_back(ctx.decrypt(&gout303[0])); /* out5 */
    out.push_back(ctx.decrypt(&gout330[0])); /* out6 */
    out.push_back(ctx.decrypt(&gout361[0])); /* out7 */
    out.push_back(ctx.decrypt(&gout360[0])); /* out8 */
    out.push_back(ctx.decrypt(&gout359[0])); /* out9 */
    out.push_back(ctx.decrypt(&gout357[0])); /* out10 */
    out.push_back(ctx.decrypt(&gout372[0])); /* out11 */
    out.push_back(ctx.decrypt(&gout366[0])); /* out12 */
    out.push_back(ctx.decrypt(&gout375[0])); /* out13 */
    out.push_back(ctx.decrypt(&gout376[0])); /* out14 */
    out.push_back(ctx.decrypt(&gout378[0])); /* out15 */
    return out;
}
...
test_sqrt_lut3fa(FHEContext& ctx, uint16_t num)
{
    ...
    std::cerr << "\rLUT5   ";
    Ciphertext gin5 = 1 * ct_num13 + 2 * ct_num12 + 4 * ct_num14;
    std::vector<Ciphertext> gout5 = ctx.eval_lut_amortized(&gin5, lut5);
    ...
    std::cerr << "\rLUT13   ";
    Ciphertext gin13 = 1 * ct_num9 + 2 * ct_num8;
    std::vector<Ciphertext> gout13 = ctx.eval_lut_amortized(&gin13, lut13);
    ...
    std::cerr << "\rLUT19   ";
    Ciphertext gin19 = 1 * ct_num2 + 2 * ct_num1 + 4 * ct_num0;
    std::vector<Ciphertext> gout19 = ctx.eval_lut_amortized(&gin19, lut19);
    ...
    std::cerr << "\rLUT20   ";
    Ciphertext gin20 = 1 * gout5[0] + 2 * ct_num15;
    std::vector<Ciphertext> gout20 = ctx.eval_lut_amortized(&gin20, lut20);
    ...
    gout28.push_back(ctx.encrypt_public(0));
    ...
    std::cerr << "\rFA32    ";
    Ciphertext gin32 = 1 + 1 * ct_num6 + 2 * ct_num7 + 1 * gout18[0] + 2 * gout16[0];
    ...
    std::cerr << "\rLUT35   ";
    Ciphertext gin35 = 1 * ct_num13 + 2 * gout5[0] + 4 * ct_num15;
    std::vector<Ciphertext> gout35 = ctx.eval_lut_amortized(&gin35, lut35);
    ...
    std::cerr << "\rLUT36   ";
    Ciphertext gin36 = 1 * gout5[0] + 2 * ct_num12 + 4 * ct_num15;
    std::vector<Ciphertext> gout36 = ctx.eval_lut_amortized(&gin36, lut36);
    ...
    std::cerr << "\rLUT42   ";
    Ciphertext gin42 = 1 * ct_num3 + 2 * ct_num2;
    std::vector<Ciphertext> gout42 = ctx.eval_lut_amortized(&gin42, lut42);
    ...
    std::cerr << "\rFA51    ";
    Ciphertext gin51 = 1 + 1 * ct_num4 + 2 * ct_num5 + 1 * gout25[0] + 2 * gout10[0];
    std::vector<Ciphertext> gout51 = ctx.eval_lut_amortized(&gin51, decomp);

    std::cerr << "\rINV52   ";
    std::vector<Ciphertext> gout52;
    gout52.push_back(1 - gout20[0]);

    std::cerr << "\rINV53   ";
    std::vector<Ciphertext> gout53;
    gout53.push_back(1 - gout20[0]);

    std::cerr << "\rFA54    ";
    Ciphertext gin54 = 1 + 1 * ct_num10 + 2 * ct_num11 + 1 * gout45[0] + 2 * gout44[0];
    std::vector<Ciphertext> gout54 = ctx.eval_lut_amortized(&gin54, decomp);

    std::cerr << "\rINV55   ";
    std::vector<Ciphertext> gout55;
    gout55.push_back(1 - gout12[0]);

    std::cerr << "\rINV56   ";
    std::vector<Ciphertext> gout56;
    gout56.push_back(1 - gout20[0]);

    std::cerr << "\rFA57    ";
    Ciphertext gin57 = 1 + 1 * ct_num2 + 2 * ct_num3 + 1 * gout28[0] + 2 * gout4[0];
    std::vector<Ciphertext> gout57 = ctx.eval_lut_amortized(&gin57, decomp);

    std::cerr << "\rFA58    ";
    Ciphertext gin58 = 1 + 1 * ct_num8 + 2 * ct_num9 + 1 * gout30[0] + 2 * gout27[0];
    std::vector<Ciphertext> gout58 = ctx.eval_lut_amortized(&gin58, decomp);

    std::cerr << "\rFA59    ";
    Ciphertext gin59 = 1 + 1 * ct_num12 + 2 * ct_num13 + 1 * gout31[0] + 2 * gout6[0];
    ...
    std::cerr << "\rLUT60   ";
    Ciphertext gin60 = 1 * gout57[0] + 2 * ct_num1 + 4 * ct_num0;
    std::vector<Ciphertext> gout60 = ctx.eval_lut_amortized(&gin60, lut60);

    std::cerr << "\rFA61    ";
    Ciphertext gin61 = gout59[2] + 1 * gout12[1] + 2 * ct_num15 + 1 * gout50[0] + 2 * gout0[0];
    ...
    std::cerr << "\rLUT62   ";
    Ciphertext gin62 = 1 * ct_num12 + 2 * gout59[0] + 4 * gout20[0];
    std::vector<Ciphertext> gout62 = ctx.eval_lut_amortized(&gin62, lut62);
    ...
    std::cerr << "\rLUT63   ";
    Ciphertext gin63 = 1 * gout61[0] + 2 * gout5[0] + 4 * ct_num15;
    std::vector<Ciphertext> gout63 = ctx.eval_lut_amortized(&gin63, lut63);
    ...
    std::cerr << "\rLUT64   ";
    Ciphertext gin64 = 1 * gout5[0] + 2 * gout59[0] + 4 * ct_num15;
    std::vector<Ciphertext> gout64 = ctx.eval_lut_amortized(&gin64, lut64);
    ...
    std::cerr << "\rLUT65   ";
    Ciphertext gin65 = 1 * gout59[1] + 2 * gout5[0] + 4 * ct_num15;
    std::vector<Ciphertext> gout65 = ctx.eval_lut_amortized(&gin65, lut65);
    ...
    std::cerr << "\rLUT66   ";
    Ciphertext gin66 = 1 * gout63[0] + 2 * gout12[1];
    std::vector<Ciphertext> gout66 = ctx.eval_lut_amortized(&gin66, lut66);
    ...
    std::cerr << "\rLUT67   ";
    Ciphertext gin67 = 1 * gout64[0] + 2 * ct_num11 + 4 * ct_num10;
    std::vector<Ciphertext> gout67 = ctx.eval_lut_amortized(&gin67, lut67);
    ...
    std::cerr << "\rLUT68   ";
    Ciphertext gin68 = 1 * gout36[0] + 2 * gout63[0];
    std::vector<Ciphertext> gout68 = ctx.eval_lut_amortized(&gin68, lut68);
    ...
    std::cerr << "\rLUT69   ";
    Ciphertext gin69 = 1 * gout61[1] + 2 * gout5[0] + 4 * ct_num15;
    std::vector<Ciphertext> gout69 = ctx.eval_lut_amortized(&gin69, lut69);
    ...
    std::cerr << "\rLUT70   ";
    Ciphertext gin70 = 1 * ct_num13 + 2 * ct_num14 + 4 * gout69[0];
    ...
    std::cerr << "\rLUT71   ";
    Ciphertext gin71 = 1 * gout67[0] + 2 * gout65[0] + 4 * gout68[0];
    std::vector<Ciphertext> gout71 = ctx.eval_lut_amortized(&gin71, lut71);
    ...
    std::cerr << "\rLUT72   ";
    Ciphertext gin72 = 1 * gout35[0] + 2 * gout65[0];
    std::vector<Ciphertext> gout72 = ctx.eval_lut_amortized(&gin72, lut72);
    ...
    std::cerr << "\rLUT73   ";
    Ciphertext gin73 = 1 * gout71[0] + 2 * gout70[0] + 4 * ct_num10;
    std::vector<Ciphertext> gout73 = ctx.eval_lut_amortized(&gin73, lut73);
    ...
    std::cerr << "\rLUT74   ";
    Ciphertext gin74 = 1 * gout71[0] + 2 * gout70[0] + 4 * gout54[0];
    std::vector<Ciphertext> gout74 = ctx.eval_lut_amortized(&gin74, lut74);
    ...
    std::cerr << "\rLUT75   ";
    Ciphertext gin75 = 1 * gout13[0] + 2 * gout73[0] + 4 * gout74[0];
    ...
    std::cerr << "\rLUT76   ";
    Ciphertext gin76 = 1 * gout62[0] + 2 * gout71[0] + 4 * gout70[0];
    ...
    std::cerr << "\rLUT77   ";
    Ciphertext gin77 = 1 * ct_num11 + 2 * gout54[1] + 4 * gout76[1];
    std::vector<Ciphertext> gout77 = ctx.eval_lut_amortized(&gin77, lut77);

    std::cerr << "\rFA78    ";
    Ciphertext gin78 = gout54[2] + 1 * gout62[0] + 2 * gout72[0] + 1 * gout56[0] + 2 * gout55[0];
    std::vector<Ciphertext> gout78 = ctx.eval_lut_amortized(&gin78, decomp);

    std::cerr << "\rINV79   ";
    std::vector<Ciphertext> gout79;
    gout79.push_back(1 - gout76[1]);

    std::cerr << "\rINV80   ";
    std::vector<Ciphertext> gout80;
    gout80.push_back(1 - gout76[1]);
    ...
    std::cerr << "\rLUT81   ";
    Ciphertext gin81 = 1 * ct_num10 + 2 * gout54[0] + 4 * gout76[1];
    std::vector<Ciphertext> gout81 = ctx.eval_lut_amortized(&gin81, lut81);

    std::cerr << "\rFA82    ";
    Ciphertext gin82 = gout78[2] + 1 * gout66[0] + 2 * gout69[0] + 1 * gout11[0] + 2 * gout9[0];
    std::vector<Ciphertext> gout82 = ctx.eval_lut_amortized(&gin82, decomp);

    std::cerr << "\rINV83   ";
    std::vector<Ciphertext> gout83;
    gout83.push_back(1 - gout76[1]);

    std::cerr << "\rINV84   ";
    std::vector<Ciphertext> gout84;
    gout84.push_back(1 - gout76[1]);
    ...
    std::cerr << "\rLUT85   ";
    Ciphertext gin85 = 1 * gout75[0] + 2 * gout77[0] + 4 * gout20[0];
    ...
    std::cerr << "\rLUT86   ";
    Ciphertext gin86 = 1 * gout78[0] + 2 * gout71[0] + 4 * gout70[0];
    std::vector<Ciphertext> gout86 = ctx.eval_lut_amortized(&gin86, lut86);
    ...
    std::cerr << "\rLUT87   ";
    Ciphertext gin87 = 1 * gout76[0] + 2 * gout86[0];
    std::vector<Ciphertext> gout87 = ctx.eval_lut_amortized(&gin87, lut87);
    ...
    std::cerr << "\rLUT88   ";
    Ciphertext gin88 = 1 * gout82[1] + 2 * gout69[0] + 4 * gout76[1];
    std::vector<Ciphertext> gout88 = ctx.eval_lut_amortized(&gin88, lut88);
    ...
    std::cerr << "\rLUT89   ";
    Ciphertext gin89 = 1 * gout72[0] + 2 * gout78[1] + 4 * gout76[1];
    ...
    std::cerr << "\rLUT90   ";
    Ciphertext gin90 = 1 * gout66[0] + 2 * gout82[0] + 4 * gout76[1];
    std::vector<Ciphertext> gout90 = ctx.eval_lut_amortized(&gin90, lut90);

    std::cerr << "\rFA91    ";
    Ciphertext gin91 = gout58[2] + 1 * gout81[0] + 2 * gout77[0] + 1 * gout84[0] + 2 * gout53[0];
    ...
    std::cerr << "\rLUT92   ";
    Ciphertext gin92 = 1 * gout76[0] + 2 * gout86[0] + 4 * gout12[0];
    ...
    std::cerr << "\rLUT93   ";
    Ciphertext gin93 = 1 * gout87[0] + 2 * gout12[0];
    std::vector<Ciphertext> gout93 = ctx.eval_lut_amortized(&gin93, lut93);
    ...
    std::cerr << "\rLUT94   ";
    Ciphertext gin94 = 1 * gout92[0] + 2 * gout89[0] + 4 * gout90[0];
    std::vector<Ciphertext> gout94 = ctx.eval_lut_amortized(&gin94, lut94);
    ...
    std::cerr << "\rLUT95   ";
    Ciphertext gin95 = 1 * gout85[0] + 2 * gout93[0] + 4 * gout94[0];
    ...
    std::cerr << "\rLUT96   ";
    Ciphertext gin96 = 1 * gout95[0] + 2 * gout88[0] + 4 * ct_num8;
    std::vector<Ciphertext> gout96 = ctx.eval_lut_amortized(&gin96, lut96);

    std::cerr << "\rFA97    ";
    Ciphertext gin97 = gout91[2] + 1 * gout87[0] + 2 * gout89[0] + 1 * gout22[0] + 2 * gout1[0];
    ...
    std::cerr << "\rLUT98   ";
    Ciphertext gin98 = 1 * gout91[1] + 2 * gout95[0] + 4 * gout88[0];
    std::vector<Ciphertext> gout98 = ctx.eval_lut_amortized(&gin98, lut98);
    ...
    std::cerr << "\rLUT99   ";
    Ciphertext gin99 = 1 * gout95[0] + 2 * gout88[0] + 4 * gout58[0];
    std::vector<Ciphertext> gout99 = ctx.eval_lut_amortized(&gin99, lut99);
    ...
    std::cerr << "\rLUT100   ";
    Ciphertext gin100 = 1 * gout37[0] + 2 * gout99[0] + 4 * gout96[0];
    std::vector<Ciphertext> gout100 = ctx.eval_lut_amortized(&gin100, lut100);
    ...
    std::cerr << "\rLUT101   ";
    Ciphertext gin101 = 1 * ct_num9 + 2 * gout95[0] + 4 * gout88[0];
    std::vector<Ciphertext> gout101 = ctx.eval_lut_amortized(&gin101, lut101);

    std::cerr << "\rINV102   ";
    std::vector<Ciphertext> gout102;
    gout102.push_back(1 - gout99[1]);

    std::cerr << "\rFA103    ";
    Ciphertext gin103 = gout97[2] + 1 * gout90[0] + 2 * gout88[0] + 1 * gout14[0] + 2 * gout46[0];
    std::vector<Ciphertext> gout103 = ctx.eval_lut_amortized(&gin103, decomp);

    std::cerr << "\rINV104   ";
    std::vector<Ciphertext> gout104;
    gout104.push_back(1 - gout99[1]);
    ...
    std::cerr << "\rLUT105   ";
    Ciphertext gin105 = 1 * gout77[0] + 2 * gout95[0] + 4 * gout88[0];
    std::vector<Ciphertext> gout105 = ctx.eval_lut_amortized(&gin105, lut105);

    std::cerr << "\rINV106   ";
    std::vector<Ciphertext> gout106;
    gout106.push_back(1 - gout99[1]);
    ...
    std::cerr << "\rLUT107   ";
    Ciphertext gin107 = 1 * gout58[1] + 2 * gout95[0] + 4 * gout88[0];
    ...
    std::cerr << "\rLUT108   ";
    Ciphertext gin108 = 1 * gout101[0] + 2 * gout107[0];
    std::vector<Ciphertext> gout108 = ctx.eval_lut_amortized(&gin108, lut108);
    ...
    std::cerr << "\rLUT109   ";
    Ciphertext gin109 = 1 * gout103[0] + 2 * gout90[0] + 4 * gout99[1];
    ...
    std::cerr << "\rLUT110   ";
    Ciphertext gin110 = 1 * gout105[0] + 2 * gout98[0] + 4 * gout12[0];
    std::vector<Ciphertext> gout110 = ctx.eval_lut_amortized(&gin110, lut110);
    ...
    std::cerr << "\rLUT111   ";
    Ciphertext gin111 = 1 * gout87[0] + 2 * gout97[0] + 4 * gout99[1];
    ...
    std::cerr << "\rLUT112   ";
    Ciphertext gin112 = 1 * gout81[0] + 2 * gout91[0] + 4 * gout99[1];
    ...
    std::cerr << "\rLUT113   ";
    Ciphertext gin113 = 1 * ct_num8 + 2 * gout58[0] + 4 * gout99[1];
    std::vector<Ciphertext> gout113 = ctx.eval_lut_amortized(&gin113, lut113);
    ...
    std::cerr << "\rLUT114   ";
    Ciphertext gin114 = 1 * gout89[0] + 2 * gout97[1] + 4 * gout99[1];
    ...
    std::cerr << "\rLUT115   ";
    Ciphertext gin115 = 1 * gout101[0] + 2 * gout107[0] + 4 * gout76[1];
    std::vector<Ciphertext> gout115 = ctx.eval_lut_amortized(&gin115, lut115);
    ...
    std::cerr << "\rLUT116   ";
    Ciphertext gin116 = 1 * gout111[0] + 2 * gout114[0] + 4 * gout109[0];
    ...
    std::cerr << "\rLUT117   ";
    Ciphertext gin117 = 1 * gout116[0] + 2 * gout110[1] + 4 * gout12[0];
    std::vector<Ciphertext> gout117 = ctx.eval_lut_amortized(&gin117, lut117);
    ...
    std::cerr << "\rLUT118   ";
    Ciphertext gin118 = 1 * gout95[0] + 2 * gout103[1] + 4 * gout88[0];
    std::vector<Ciphertext> gout118 = ctx.eval_lut_amortized(&gin118, lut118);
    ...
    std::cerr << "\rLUT119   ";
    Ciphertext gin119 = 1 * gout115[0] + 2 * gout112[0] + 4 * gout20[0];
    std::vector<Ciphertext> gout119 = ctx.eval_lut_amortized(&gin119, lut119);
    ...
    std::cerr << "\rLUT120   ";
    Ciphertext gin120 = 1 * gout100[0] + 2 * gout108[0] + 4 * gout76[1];
    ...
    std::cerr << "\rLUT121   ";
    Ciphertext gin121 = 1 * gout110[0] + 2 * gout112[0] + 4 * gout20[0];
    std::vector<Ciphertext> gout121 = ctx.eval_lut_amortized(&gin121, lut121);
    ...
    std::cerr << "\rLUT122   ";
    Ciphertext gin122 = 1 * gout119[0] + 2 * gout120[0] + 4 * gout121[0];
    std::vector<Ciphertext> gout122 = ctx.eval_lut_amortized(&gin122, lut122);

    std::cerr << "\rFA123    ";
    Ciphertext gin123 = gout32[2] + 1 * gout113[0] + 2 * gout108[0] + 1 * gout106[0] + 2 * gout79[0];
    std::vector<Ciphertext> gout123 = ctx.eval_lut_amortized(&gin123, decomp);

    std::cerr << "\rFA124    ";
    Ciphertext gin124 = gout123[2] + 1 * gout112[0] + 2 * gout110[1] + 1 * gout48[0] + 2 * gout47[0];
    ...
    std::cerr << "\rLUT125   ";
    Ciphertext gin125 = 1 * gout117[0] + 2 * gout122[0] + 4 * gout118[0];
    std::vector<Ciphertext> gout125 = ctx.eval_lut_amortized(&gin125, lut125);

    std::cerr << "\rFA126    ";
    Ciphertext gin126 = gout124[2] + 1 * gout111[0] + 2 * gout114[0] + 1 * gout15[0] + 2 * gout43[0];
    ...
    std::cerr << "\rLUT127   ";
    Ciphertext gin127 = 1 * gout108[0] + 2 * gout123[1] + 4 * gout125[0];
    std::vector<Ciphertext> gout127 = ctx.eval_lut_amortized(&gin127, lut127);
    ...
    std::cerr << "\rLUT128   ";
    Ciphertext gin128 = 1 * gout113[0] + 2 * gout123[0] + 4 * gout125[0];
    std::vector<Ciphertext> gout128 = ctx.eval_lut_amortized(&gin128, lut128);
    ...
    std::cerr << "\rLUT129   ";
    Ciphertext gin129 = 1 * gout110[1] + 2 * gout124[1] + 4 * gout125[0];
    std::vector<Ciphertext> gout129 = ctx.eval_lut_amortized(&gin129, lut129);
    ...
    std::cerr << "\rLUT131   ";
    Ciphertext gin131 = 1 * ct_num6 + 2 * gout32[0] + 4 * gout125[0];
    std::vector<Ciphertext> gout131 = ctx.eval_lut_amortized(&gin131, lut131);
    ...
    std::cerr << "\rLUT132   ";
    Ciphertext gin132 = 1 * gout128[0] + 2 * gout76[1];
    std::vector<Ciphertext> gout132 = ctx.eval_lut_amortized(&gin132, lut132);
    ...
    std::cerr << "\rLUT133   ";
    Ciphertext gin133 = 1 * gout111[0] + 2 * gout126[0] + 4 * gout125[0];
    std::vector<Ciphertext> gout133 = ctx.eval_lut_amortized(&gin133, lut133);

    std::cerr << "\rFA134    ";
    Ciphertext gin134 = gout126[2] + 1 * gout109[0] + 2 * gout118[0] + 1 * gout39[0] + 2 * gout29[0];
    ...
    std::cerr << "\rLUT135   ";
    Ciphertext gin135 = 1 * gout117[0] + 2 * gout122[0] + 4 * gout134[1];
    std::vector<Ciphertext> gout135 = ctx.eval_lut_amortized(&gin135, lut135);
    ...
    std::cerr << "\rLUT136   ";
    Ciphertext gin136 = 1 * ct_num7 + 2 * gout32[1] + 4 * gout125[0];
    std::vector<Ciphertext> gout136 = ctx.eval_lut_amortized(&gin136, lut136);
    ...
    std::cerr << "\rLUT137   ";
    Ciphertext gin137 = 1 * gout135[0] + 2 * gout118[0];
    std::vector<Ciphertext> gout137 = ctx.eval_lut_amortized(&gin137, lut137);
    ...
    std::cerr << "\rLUT138   ";
    Ciphertext gin138 = 1 * gout112[0] + 2 * gout124[0] + 4 * gout125[0];
    std::vector<Ciphertext> gout138 = ctx.eval_lut_amortized(&gin138, lut138);
    ...
    std::cerr << "\rLUT139   ";
    Ciphertext gin139 = 1 * gout114[0] + 2 * gout126[1] + 4 * gout125[0];
    std::vector<Ciphertext> gout139 = ctx.eval_lut_amortized(&gin139, lut139);

    std::cerr << "\rINV140   ";
    std::vector<Ciphertext> gout140;
    gout140.push_back(1 - gout125[0]);
    ...
    std::cerr << "\rLUT141   ";
    Ciphertext gin141 = 1 * gout127[0] + 2 * gout20[0];
    std::vector<Ciphertext> gout141 = ctx.eval_lut_amortized(&gin141, lut141);
    ...
    std::cerr << "\rLUT142   ";
    Ciphertext gin142 = 1 * gout40[0] + 2 * gout131[1] + 4 * gout125[0];
    std::vector<Ciphertext> gout142 = ctx.eval_lut_amortized(&gin142, lut142);

    std::cerr << "\rFA143    ";
    Ciphertext gin143 = gout51[2] + 1 * gout131[0] + 2 * gout136[0] + 1 * gout130[0] + 2 * gout104[0];
    ...
    std::cerr << "\rLUT144   ";
    Ciphertext gin144 = 1 * gout138[0] + 2 * gout12[0];
    std::vector<Ciphertext> gout144 = ctx.eval_lut_amortized(&gin144, lut144);
    ...
    std::cerr << "\rLUT145   ";
    Ciphertext gin145 = 1 * gout109[0] + 2 * gout134[0] + 4 * gout125[0];
    std::vector<Ciphertext> gout145 = ctx.eval_lut_amortized(&gin145, lut145);
    ...
    std::cerr << "\rLUT146   ";
    Ciphertext gin146 = 1 * gout144[0] + 2 * gout127[0] + 4 * gout20[0];
    ...
    std::cerr << "\rLUT147   ";
    Ciphertext gin147 = 1 * gout133[0] + 2 * gout139[0] + 4 * gout145[0];
    std::vector<Ciphertext> gout147 = ctx.eval_lut_amortized(&gin147, lut147);

    std::cerr << "\rFA148    ";
    Ciphertext gin148 = gout143[2] + 1 * gout128[0] + 2 * gout127[0] + 1 * gout83[0] + 2 * gout52[0];
    ...
    flut149.push_back(lut149idx0);
    auto lut149idx1 = [](long I) -> long {
        /* GATE 79 (LUT2 _497_ INIT 0x4 PERM 21) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 1;
    ...
    std::cerr << "\rLUT149   ";
    Ciphertext gin149 = 1 * gout142[0] + 2 * gout136[0] + 4 * gout99[1];
    std::vector<Ciphertext> gout149 = ctx.eval_lut_amortized(&gin149, lut149);
    ...
    std::cerr << "\rLUT150   ";
    Ciphertext gin150 = 1 * gout144[1] + 2 * gout147[0] + 4 * gout129[0];
    std::vector<Ciphertext> gout150 = ctx.eval_lut_amortized(&gin150, lut150);
    ...
    std::cerr << "\rLUT151   ";
    Ciphertext gin151 = 1 * gout149[1] + 2 * gout128[0] + 4 * gout76[1];
    std::vector<Ciphertext> gout151 = ctx.eval_lut_amortized(&gin151, lut151);

    std::cerr << "\rFA152    ";
    Ciphertext gin152 = gout148[2] + 1 * gout138[0] + 2 * gout129[0] + 1 * gout49[0] + 2 * gout2[0];
    std::vector<Ciphertext> gout152 = ctx.eval_lut_amortized(&gin152, decomp);
    ...
    std::cerr << "\rLUT153   ";
    Ciphertext gin153 = 1 * gout151[0] + 2 * gout149[0] + 4 * gout132[0];
    std::vector<Ciphertext> gout153 = ctx.eval_lut_amortized(&gin153, lut153);

    std::cerr << "\rFA154    ";
    Ciphertext gin154 = gout152[2] + 1 * gout133[0] + 2 * gout139[0] + 1 * gout17[0] + 2 * gout8[0];
    std::vector<Ciphertext> gout154 = ctx.eval_lut_amortized(&gin154, decomp);

    std::cerr << "\rFA155    ";
    Ciphertext gin155 = gout154[2] + 1 * gout145[0] + 2 * gout137[0] + 1 * gout3[0] + 2 * gout23[0];
    ...
    std::cerr << "\rLUT156   ";
    Ciphertext gin156 = 1 * gout141[0] + 2 * gout153[0] + 4 * gout146[0];
    std::vector<Ciphertext> gout156 = ctx.eval_lut_amortized(&gin156, lut156);
    ...
    std::cerr << "\rLUT157   ";
    Ciphertext gin157 = 1 * gout150[0] + 2 * gout156[0] + 4 * gout155[1];
    std::vector<Ciphertext> gout157 = ctx.eval_lut_amortized(&gin157, lut157);
    ...
    std::cerr << "\rLUT158   ";
    Ciphertext gin158 = 1 * gout150[0] + 2 * gout156[0] + 4 * gout137[0];
    std::vector<Ciphertext> gout158 = ctx.eval_lut_amortized(&gin158, lut158);

    std::cerr << "\rINV159   ";
    std::vector<Ciphertext> gout159;
    gout159.push_back(1 - gout158[0]);
    ...
    std::cerr << "\rLUT160   ";
    Ciphertext gin160 = 1 * gout157[0] + 2 * gout137[0];
    std::vector<Ciphertext> gout160 = ctx.eval_lut_amortized(&gin160, lut160);
    ...
    std::cerr << "\rLUT161   ";
    Ciphertext gin161 = 1 * gout138[0] + 2 * gout152[0] + 4 * gout158[0];
    std::vector<Ciphertext> gout161 = ctx.eval_lut_amortized(&gin161, lut161);
    ...
    std::cerr << "\rLUT162   ";
    Ciphertext gin162 = 1 * gout51[0] + 2 * ct_num4 + 4 * gout158[0];
    std::vector<Ciphertext> gout162 = ctx.eval_lut_amortized(&gin162, lut162);
    ...
    std::cerr << "\rLUT163   ";
    Ciphertext gin163 = 1 * ct_num5 + 2 * gout51[1] + 4 * gout158[0];
    ...
    std::cerr << "\rLUT164   ";
    Ciphertext gin164 = 1 * gout42[0] + 2 * gout162[1] + 4 * gout158[0];
    std::vector<Ciphertext> gout164 = ctx.eval_lut_amortized(&gin164, lut164);
    ...
    std::cerr << "\rLUT165   ";
    Ciphertext gin165 = 1 * gout128[0] + 2 * gout148[0] + 4 * gout158[0];
    std::vector<Ciphertext> gout165 = ctx.eval_lut_amortized(&gin165, lut165);
    ...
    std::cerr << "\rLUT166   ";
    Ciphertext gin166 = 1 * gout139[0] + 2 * gout154[1] + 4 * gout158[0];
    std::vector<Ciphertext> gout166 = ctx.eval_lut_amortized(&gin166, lut166);
    ...
    std::cerr << "\rLUT167   ";
    Ciphertext gin167 = 1 * gout129[0] + 2 * gout152[1] + 4 * gout158[0];
    std::vector<Ciphertext> gout167 = ctx.eval_lut_amortized(&gin167, lut167);
    ...
    std::cerr << "\rLUT168   ";
    Ciphertext gin168 = 1 * gout164[0] + 2 * gout163[0] + 4 * gout125[0];
    std::vector<Ciphertext> gout168 = ctx.eval_lut_amortized(&gin168, lut168);
    ...
    std::cerr << "\rLUT169   ";
    Ciphertext gin169 = 1 * gout131[0] + 2 * gout143[0] + 4 * gout158[0];
    std::vector<Ciphertext> gout169 = ctx.eval_lut_amortized(&gin169, lut169);
    ...
    std::cerr << "\rLUT170   ";
    Ciphertext gin170 = 1 * gout145[0] + 2 * gout155[0] + 4 * gout158[0];
    std::vector<Ciphertext> gout170 = ctx.eval_lut_amortized(&gin170, lut170);
    ...
    std::cerr << "\rLUT171   ";
    Ciphertext gin171 = 1 * gout127[0] + 2 * gout148[1] + 4 * gout158[0];
    std::vector<Ciphertext> gout171 = ctx.eval_lut_amortized(&gin171, lut171);
    ...
    std::cerr << "\rLUT172   ";
    Ciphertext gin172 = 1 * gout165[0] + 2 * gout20[0];
    std::vector<Ciphertext> gout172 = ctx.eval_lut_amortized(&gin172, lut172);
    ...
    std::cerr << "\rLUT173   ";
    Ciphertext gin173 = 1 * gout133[0] + 2 * gout154[0] + 4 * gout158[0];
    std::vector<Ciphertext> gout173 = ctx.eval_lut_amortized(&gin173, lut173);
    ...
    std::cerr << "\rLUT174   ";
    Ciphertext gin174 = 1 * gout136[0] + 2 * gout143[1] + 4 * gout158[0];
    std::vector<Ciphertext> gout174 = ctx.eval_lut_amortized(&gin174, lut174);
    ...
    std::cerr << "\rLUT175   ";
    Ciphertext gin175 = 1 * gout76[1] + 2 * gout174[0];
    std::vector<Ciphertext> gout175 = ctx.eval_lut_amortized(&gin175, lut175);

    std::cerr << "\rFA176    ";
    Ciphertext gin176 = gout57[2] + 1 * gout162[0] + 2 * gout163[0] + 1 * gout159[0] + 2 * gout140[0];
    ...
    std::cerr << "\rLUT177   ";
    Ciphertext gin177 = 1 * gout175[0] + 2 * gout165[0] + 4 * gout20[0];
    std::vector<Ciphertext> gout177 = ctx.eval_lut_amortized(&gin177, lut177);
    ...
    std::cerr << "\rLUT178   ";
    Ciphertext gin178 = 1 * gout169[0] + 2 * gout99[1];
    ...
    std::cerr << "\rLUT179   ";
    Ciphertext gin179 = 1 * gout173[0] + 2 * gout166[0] + 4 * gout170[0];
    std::vector<Ciphertext> gout179 = ctx.eval_lut_amortized(&gin179, lut179);
    ...
    std::cerr << "\rLUT180   ";
    Ciphertext gin180 = 1 * gout161[0] + 2 * gout167[0] + 4 * gout179[0];
    std::vector<Ciphertext> gout180 = ctx.eval_lut_amortized(&gin180, lut180);
    ...
    std::cerr << "\rLUT181   ";
    Ciphertext gin181 = 1 * gout178[1] + 2 * gout76[1] + 4 * gout174[0];
    std::vector<Ciphertext> gout181 = ctx.eval_lut_amortized(&gin181, lut181);

    std::cerr << "\rFA182    ";
    Ciphertext gin182 = gout176[2] + 1 * gout169[0] + 2 * gout174[0] + 1 * gout102[0] + 2 * gout80[0];
    ...
    std::cerr << "\rLUT183   ";
    Ciphertext gin183 = 1 * gout178[0] + 2 * gout168[0] + 4 * gout181[0];
    std::vector<Ciphertext> gout183 = ctx.eval_lut_amortized(&gin183, lut183);
    ...
    std::cerr << "\rLUT184   ";
    Ciphertext gin184 = 1 * gout177[0] + 2 * gout183[0] + 4 * gout172[0];
    std::vector<Ciphertext> gout184 = ctx.eval_lut_amortized(&gin184, lut184);
    ...
    flut185.push_back(lut185idx0);
    auto lut185idx1 = [](long I) -> long {
        /* GATE 115 (LUT2 _533_ INIT 0x4 PERM 02) */
        switch (I) {
            case  0: return 0;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT185   ";
    Ciphertext gin185 = 1 * gout171[0] + 2 * gout180[0] + 4 * gout12[0];
    std::vector<Ciphertext> gout185 = ctx.eval_lut_amortized(&gin185, lut185);

    std::cerr << "\rFA186    ";
    Ciphertext gin186 = gout182[2] + 1 * gout165[0] + 2 * gout171[0] + 1 * gout41[0] + 2 * gout38[0];
    std::vector<Ciphertext> gout186 = ctx.eval_lut_amortized(&gin186, decomp);

    std::cerr << "\rFA187    ";
    Ciphertext gin187 = gout186[2] + 1 * gout161[0] + 2 * gout167[0] + 1 * gout33[0] + 2 * gout34[0];
    ...
    std::cerr << "\rLUT188   ";
    Ciphertext gin188 = 1 * gout185[1] + 2 * gout184[0] + 4 * gout185[0];
    std::vector<Ciphertext> gout188 = ctx.eval_lut_amortized(&gin188, lut188);
    ...
    std::cerr << "\rLUT189   ";
    Ciphertext gin189 = 1 * gout60[0] + 2 * gout188[0] + 4 * gout160[0];
    std::vector<Ciphertext> gout189 = ctx.eval_lut_amortized(&gin189, lut189);
    ...
    std::cerr << "\rLUT190   ";
    Ciphertext gin190 = 1 * gout163[0] + 2 * gout188[0] + 4 * gout160[0];
    std::vector<Ciphertext> gout190 = ctx.eval_lut_amortized(&gin190, lut190);

    std::vector<RotationPoly> lut191;
    std::vector<long (*)(long)> flut191;
    auto lut191idx0 = [](long I) -> long {
        /* GATE 119 (LUT2 _537_ INIT 0x1 PERM 01) */
        switch (I) {
            case  0: return 1;
            case  1: return 0;
            case  2: return 0;
    ...
    std::cerr << "\rLUT191   ";
    Ciphertext gin191 = 1 * gout188[0] + 2 * gout160[0];
    std::vector<Ciphertext> gout191 = ctx.eval_lut_amortized(&gin191, lut191);
    ...
    std::cerr << "\rLUT192   ";
    Ciphertext gin192 = 1 * gout169[0] + 2 * gout182[0] + 4 * gout191[0];
    std::vector<Ciphertext> gout192 = ctx.eval_lut_amortized(&gin192, lut192);
    ...
    std::cerr << "\rLUT193   ";
    Ciphertext gin193 = 1 * ct_num3 + 2 * gout57[1] + 4 * gout191[0];
    std::vector<Ciphertext> gout193 = ctx.eval_lut_amortized(&gin193, lut193);
    ...
    std::cerr << "\rLUT194   ";
    Ciphertext gin194 = 1 * gout189[0] + 2 * gout19[0];
    std::vector<Ciphertext> gout194 = ctx.eval_lut_amortized(&gin194, lut194);
    ...
    std::cerr << "\rLUT195   ";
    Ciphertext gin195 = 1 * gout162[0] + 2 * gout176[0] + 4 * gout191[0];
    std::vector<Ciphertext> gout195 = ctx.eval_lut_amortized(&gin195, lut195);
    ...
    std::cerr << "\rLUT196   ";
    Ciphertext gin196 = 1 * gout165[0] + 2 * gout186[0] + 4 * gout191[0];
    std::vector<Ciphertext> gout196 = ctx.eval_lut_amortized(&gin196, lut196);
    ...
    std::cerr << "\rLUT197   ";
    Ciphertext gin197 = 1 * gout125[0] + 2 * gout195[0];
    std::vector<Ciphertext> gout197 = ctx.eval_lut_amortized(&gin197, lut197);

    std::cerr << "\rFA198    ";
    Ciphertext gin198 = gout187[2] + 1 * gout173[0] + 2 * gout166[0] + 1 * gout26[0] + 2 * gout24[0];
    ...
    std::cerr << "\rLUT199   ";
    Ciphertext gin199 = 1 * gout176[1] + 2 * gout188[0] + 4 * gout160[0];
    std::vector<Ciphertext> gout199 = ctx.eval_lut_amortized(&gin199, lut199);
    ...
    std::cerr << "\rLUT200   ";
    Ciphertext gin200 = 1 * gout174[0] + 2 * gout182[1] + 4 * gout191[0];
    std::vector<Ciphertext> gout200 = ctx.eval_lut_amortized(&gin200, lut200);
    ...
    std::cerr << "\rLUT201   ";
    Ciphertext gin201 = 1 * gout192[0] + 2 * gout76[1];
    std::vector<Ciphertext> gout201 = ctx.eval_lut_amortized(&gin201, lut201);
    ...
    std::cerr << "\rLUT202   ";
    Ciphertext gin202 = 1 * gout201[0] + 2 * gout20[0] + 4 * gout200[0];
    std::vector<Ciphertext> gout202 = ctx.eval_lut_amortized(&gin202, lut202);
    ...
    std::cerr << "\rLUT203   ";
    Ciphertext gin203 = 1 * gout198[0] + 2 * gout198[1];
    std::vector<Ciphertext> gout203 = ctx.eval_lut_amortized(&gin203, lut203);
    ...
    std::cerr << "\rLUT204   ";
    Ciphertext gin204 = 1 * gout171[0] + 2 * gout180[0] + 4 * gout191[0];
    std::vector<Ciphertext> gout204 = ctx.eval_lut_amortized(&gin204, lut204);

    std::cerr << "\rFA205    ";
    Ciphertext gin205 = gout198[2] + 1 * gout170[0] + 2 * gout160[0] + 1 * gout21[0] + 2 * gout7[0];
    ...
    std::cerr << "\rLUT206   ";
    Ciphertext gin206 = 1 * gout158[0] + 2 * gout194[0] + 4 * gout193[0];
    ...
    std::cerr << "\rLUT207   ";
    Ciphertext gin207 = 1 * gout190[0] + 2 * gout199[0] + 4 * gout99[1];
    std::vector<Ciphertext> gout207 = ctx.eval_lut_amortized(&gin207, lut207);
    ...
    std::cerr << "\rLUT208   ";
    Ciphertext gin208 = 1 * gout196[0] + 2 * gout12[0];
    std::vector<Ciphertext> gout208 = ctx.eval_lut_amortized(&gin208, lut208);
    ...
    std::cerr << "\rLUT209   ";
    Ciphertext gin209 = 1 * gout186[1] + 2 * gout187[1] + 4 * gout203[0];
    std::vector<Ciphertext> gout209 = ctx.eval_lut_amortized(&gin209, lut209);
    ...
    std::cerr << "\rLUT210   ";
    Ciphertext gin210 = 1 * gout205[1] + 2 * gout188[0] + 4 * gout160[0];
    std::vector<Ciphertext> gout210 = ctx.eval_lut_amortized(&gin210, lut210);
    ...
    std::cerr << "\rLUT211   ";
    Ciphertext gin211 = 1 * gout207[0] + 2 * gout125[0] + 4 * gout195[0];
    std::vector<Ciphertext> gout211 = ctx.eval_lut_amortized(&gin211, lut211);
    ...
    std::cerr << "\rLUT212   ";
    Ciphertext gin212 = 1 * gout187[0] + 2 * gout205[0] + 4 * gout209[0];
    std::vector<Ciphertext> gout212 = ctx.eval_lut_amortized(&gin212, lut212);
    ...
    std::cerr << "\rLUT213   ";
    Ciphertext gin213 = 1 * gout20[0] + 2 * gout200[0] + 4 * gout208[1];
    std::vector<Ciphertext> gout213 = ctx.eval_lut_amortized(&gin213, lut213);
    ...
    std::cerr << "\rLUT214   ";
    Ciphertext gin214 = 1 * gout212[0] + 2 * gout191[0];
    std::vector<Ciphertext> gout214 = ctx.eval_lut_amortized(&gin214, lut214);
    ...
    std::cerr << "\rLUT215   ";
    Ciphertext gin215 = 1 * gout206[0] + 2 * gout197[0] + 4 * gout211[0];
    std::vector<Ciphertext> gout215 = ctx.eval_lut_amortized(&gin215, lut215);
    ...
    std::cerr << "\rLUT216   ";
    Ciphertext gin216 = 1 * gout208[0] + 2 * gout204[0] + 4 * gout214[0];
    std::vector<Ciphertext> gout216 = ctx.eval_lut_amortized(&gin216, lut216);
    ...
    std::cerr << "\rLUT217   ";
    Ciphertext gin217 = 1 * gout207[1] + 2 * gout215[0] + 4 * gout201[1];
    std::vector<Ciphertext> gout217 = ctx.eval_lut_amortized(&gin217, lut217);
    ...
    std::cerr << "\rLUT218   ";
    Ciphertext gin218 = 1 * gout202[0] + 2 * gout217[0] + 4 * gout213[0];
    std::vector<Ciphertext> gout218 = ctx.eval_lut_amortized(&gin218, lut218);
    ...
    std::cerr << "\rLUT219   ";
    Ciphertext gin219 = 1 * gout216[0] + 2 * gout218[0] + 4 * gout210[0];
    std::vector<Ciphertext> gout219 = ctx.eval_lut_amortized(&gin219, lut219);

    std::cerr << "\r          \r";
    std::vector<long> out;
    out.push_back(ctx.decrypt(&gout219[0])); /* out0 */
    out.push_back(ctx.decrypt(&gout191[0])); /* out1 */
    out.push_back(ctx.decrypt(&gout158[0])); /* out2 */
    out.push_back(ctx.decrypt(&gout125[0])); /* out3 */
    out.push_back(ctx.decrypt(&gout99[1])); /* out4 */
    out.push_back(ctx.decrypt(&gout76[1])); /* out5 */
    out.push_back(ctx.decrypt(&gout20[0])); /* out6 */
    out.push_back(ctx.decrypt(&gout12[0])); /* out7 */
